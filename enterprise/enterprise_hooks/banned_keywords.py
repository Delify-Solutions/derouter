...
class _ENTERPRISE_BannedKeywords(CustomLogger):
    ...
    def __init__(self):
        banned_keywords_list = derouter.banned_keywords_list
    ...
    async def async_pre_call_hook(
        ...
        try:
            ...
            verbose_proxy_logger.exception(
                "derouter.enterprise.enterprise_hooks.banned_keywords::async_pre_call_hook - Exception occurred - {}".format(
                    str(e)
                )
            )
    ...
    async def async_post_call_success_hook(
        ...
        for choice in response.choices:
            if not isinstance(choice, derouter.utils.Choices):
                continue
