"""
Endpoints for managing email alerts on derouter
"""
...
async def _get_email_settings(prisma_client) -> Dict[str, bool]:
    ...
    try:
        ...
        general_settings_entry = await prisma_client.db.derouter_config.find_unique(
...
async def _save_email_settings(prisma_client, settings: Dict[str, bool]):
    ...
    try:
        ...
        await prisma_client.db.derouter_config.upsert(
            where={"param_name": "general_settings"},
            data={
                "create": {
