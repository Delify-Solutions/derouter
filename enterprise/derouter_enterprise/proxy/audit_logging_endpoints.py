...
from derouter_enterprise.types.proxy.audit_logging_endpoints import (
    AuditLogResponse,
...
async def get_audit_logs(
    ...
    audit_log_table: Final[TableActions[prisma_models.DeRouter_AuditLog]] = AuditLogRepository(prisma_client).table
