...
from derouter.llms.base_llm.managed_resources import BaseManagedResource
...
class _PROXY_DeRouterManagedVectorStores(
    ...
    def table_name(self) -> str:
        ...
        # Prisma converts model name DeRouter_ManagedVectorStoreTable to derouter_managedvectorstoretable
        return "derouter_managedvectorstoretable"
    ...
    def get_unified_resource_id_format(
        ...
        Format:
        derouter_proxy:vector_store;unified_id,<uuid>;target_model_names,<models>;resource_id,<vs_id>;model_id,<model_id>
        """
