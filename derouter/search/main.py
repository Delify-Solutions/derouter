"""
Main Search function for DeRouter.
"""
...
from derouter.utils import ProviderConfigManager, client, filter_out_derouter_params
...
def search(
    ...
    **kwargs,
    ...
    try:
        ...
        # Filter out internal DeRouter parameters from kwargs
        filtered_kwargs: Final = filter_out_derouter_params(kwargs=kwargs)
