...
from derouter.types.rerank import RerankRequest
...
class ModelParamHelper:
    ...
    def _get_all_llm_api_params() -> set[str]:
        ...
        read-only.
        """
        chat_completion_kwargs: Final = ModelParamHelper._get_derouter_supported_chat_completion_kwargs()
        text_completion_kwargs: Final = ModelParamHelper._get_derouter_supported_text_completion_kwargs()
        embedding_kwargs: Final = ModelParamHelper._get_derouter_supported_embedding_kwargs()
        transcription_kwargs: Final = ModelParamHelper._get_derouter_supported_transcription_kwargs()
        rerank_kwargs: Final = ModelParamHelper._get_derouter_supported_rerank_kwargs()
        responses_api_kwargs: Final = ModelParamHelper._get_derouter_supported_responses_api_kwargs()
        anthropic_messages_kwargs: Final = ModelParamHelper._get_derouter_supported_anthropic_messages_kwargs()
    ...
    @staticmethod
    def get_derouter_provider_specific_params_for_chat_params() -> set[str]:
        return set(["thinking"])

    @staticmethod
    def _get_derouter_supported_chat_completion_kwargs() -> set[str]:
        """
        Get the derouter supported chat completion kwargs
        ...
        derouter_provider_specific_params: Final[set[str]] = (
            ModelParamHelper.get_derouter_provider_specific_params_for_chat_params()
        )
        all_chat_completion_kwargs: Final[set[str]] = non_streaming_params.union(streaming_params).union(
            derouter_provider_specific_params
        )
        return all_chat_completion_kwargs

    @staticmethod
    def _get_derouter_supported_text_completion_kwargs() -> set[str]:
        """
        Get the derouter supported text completion kwargs
    ...
    @staticmethod
    def _get_derouter_supported_rerank_kwargs() -> set[str]:
        """
        Get the derouter supported rerank kwargs
        """
        return set(RerankRequest.model_fields.keys())

    @staticmethod
    def _get_derouter_supported_embedding_kwargs() -> set[str]:
        """
        Get the derouter supported embedding kwargs
    ...
    @staticmethod
    def _get_derouter_supported_transcription_kwargs() -> set[str]:
        """
        Get the derouter supported transcription kwargs
    ...
    @staticmethod
    def _get_derouter_supported_responses_api_kwargs() -> set[str]:
        """
        Get the derouter supported responses API kwargs
    ...
    @staticmethod
    def _get_derouter_supported_anthropic_messages_kwargs() -> frozenset[str]:
        """
        Get the derouter supported Anthropic /v1/messages kwargs
        """
    ...
    def _get_exclude_kwargs() -> set[str]:
        ...
        """
        return set(["metadata", "derouter_metadata"])
