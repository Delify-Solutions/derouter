...
import derouter
from derouter._logging import redact_internal_details_from_client_message, verbose_logger
...
from derouter.types.realtime import ALL_DELTA_TYPES

from .derouter_logging import Logging as DeRouterLogging
...
class RealTimeStreaming:
    def __init__(
        ...
        _logged_real_time_event_types = derouter.logged_real_time_event_types
    ...
    def _enforce_transcription_session_model(self, message: str) -> str:
        ...
        a resolved DeRouter model before opening the backend websocket. If a
