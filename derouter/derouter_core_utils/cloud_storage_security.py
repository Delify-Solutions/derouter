...
VERTEX_AI_MANAGED_GCS_PREFIX: Final = "derouter-vertex-files/"
BEDROCK_MANAGED_S3_BATCH_PREFIX: Final = "derouter-bedrock-files-"
BEDROCK_MANAGED_S3_UPLOAD_PREFIX: Final = "derouter-bedrock-files/"
BEDROCK_MANAGED_S3_OUTPUT_PREFIX: Final = "derouter-batch-outputs/"
...
def should_allow_legacy_cloud_file_ids(
    derouter_params: Mapping[str, Any] | None = None,
) -> bool:
    value = None
...
def validate_managed_cloud_file_id(
    ...
    raise ValueError("file_id must reference a DeRouter-managed storage object")
