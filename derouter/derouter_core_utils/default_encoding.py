...
try:
    ...
    filename = str(resources.files(derouter).joinpath("derouter_core_utils/tokenizers"))
except (ImportError, AttributeError):
    # Old way to access resources, which setuptools deprecated some time ago
    import pkg_resources

    filename = pkg_resources.resource_filename(__name__, "derouter_core_utils/tokenizers")
...
os.environ["TIKTOKEN_CACHE_DIR"] = (
    cache_dir  # use local copy of tiktoken b/c of - https://github.com/Delify-Solutions/derouter/issues/1071
)
