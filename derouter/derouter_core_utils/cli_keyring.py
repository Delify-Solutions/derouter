...
KEYRING_SERVICE: Final = "derouter-cli"
KEYRING_ACCOUNT: Final = "credential"
KEYRING_PREFLIGHT_ACCOUNT: Final = "credential-preflight"
DISABLE_KEYRING_ENV_VAR: Final = "DEROUTER_CLI_DISABLE_KEYRING"
...
def _answers_a_write(api: KeyringApi, timeout_seconds: float) -> bool:
    ...
    threading.Thread(target=ask, daemon=True, name="derouter-cli-keyring-preflight").start()
