...
class BoundedLoggingThreadPoolExecutor(ThreadPoolExecutor):
    ...
    def __init__(
        ...
        super().__init__(max_workers=max_workers, thread_name_prefix="derouter-logging")
    ...
    def _record_drop(self) -> None:
        ...
        self._logger.warning(
            "derouter logging executor backlog is full (max_pending_tasks=%s); dropped %s logging task(s) "
