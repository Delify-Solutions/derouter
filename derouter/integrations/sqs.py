...
from derouter.types.integrations.base_health_check import IntegrationHealthCheckStatus
...
class SQSLogger(CustomBatchLogger, BaseAWSLLM):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            verbose_logger.debug("in init sqs logger - sqs_callback_params %s", derouter.aws_sqs_callback_params)
    ...
    def _init_sqs_params(
        ...
        derouter.aws_sqs_callback_params = derouter.aws_sqs_callback_params or {}

        # read in .env variables - example os.environ/AWS_BUCKET_NAME
        for key, value in derouter.aws_sqs_callback_params.items():
            if isinstance(value, str) and value.startswith("os.environ/"):
                derouter.aws_sqs_callback_params[key] = derouter.get_secret(value)

        self.sqs_queue_url = derouter.aws_sqs_callback_params.get("sqs_queue_url") or sqs_queue_url
        self.sqs_region_name = derouter.aws_sqs_callback_params.get("sqs_region_name") or sqs_region_name
        self.sqs_api_version = derouter.aws_sqs_callback_params.get("sqs_api_version") or sqs_api_version
        self.sqs_use_ssl = derouter.aws_sqs_callback_params.get("sqs_use_ssl", True) or sqs_use_ssl
        self.sqs_verify = derouter.aws_sqs_callback_params.get("sqs_verify") or sqs_verify
        self.sqs_endpoint_url = derouter.aws_sqs_callback_params.get("sqs_endpoint_url") or sqs_endpoint_url
        self.sqs_aws_access_key_id = (
            derouter.aws_sqs_callback_params.get("sqs_aws_access_key_id") or sqs_aws_access_key_id
        )

        self.sqs_aws_secret_access_key = (
            derouter.aws_sqs_callback_params.get("sqs_aws_secret_access_key") or sqs_aws_secret_access_key
        )

        self.sqs_aws_session_token = (
            derouter.aws_sqs_callback_params.get("sqs_aws_session_token") or sqs_aws_session_token
        )

        self.sqs_aws_session_name = derouter.aws_sqs_callback_params.get("sqs_aws_session_name") or sqs_aws_session_name

        self.sqs_aws_profile_name = derouter.aws_sqs_callback_params.get("sqs_aws_profile_name") or sqs_aws_profile_name

        self.sqs_aws_role_name = derouter.aws_sqs_callback_params.get("sqs_aws_role_name") or sqs_aws_role_name

        self.sqs_aws_web_identity_token = (
            derouter.aws_sqs_callback_params.get("sqs_aws_web_identity_token") or sqs_aws_web_identity_token
        )

        self.sqs_aws_sts_endpoint = derouter.aws_sqs_callback_params.get("sqs_aws_sts_endpoint") or sqs_aws_sts_endpoint
        self.sqs_strip_base64_files = (
            derouter.aws_sqs_callback_params.get("sqs_strip_base64_files", False) or sqs_strip_base64_files
        )

        self.sqs_aws_use_application_level_encryption = (
            derouter.aws_sqs_callback_params.get("sqs_aws_use_application_level_encryption", False)
            or sqs_aws_use_application_level_encryption
        )
        self.sqs_app_encryption_key_b64 = (
            derouter.aws_sqs_callback_params.get("sqs_app_encryption_key_b64") or sqs_app_encryption_key_b64
        )
        self.sqs_app_encryption_aad = (
            derouter.aws_sqs_callback_params.get("sqs_app_encryption_aad") or sqs_app_encryption_aad
        )
        self.app_crypto: AppCrypto | None = None
        if self.sqs_aws_use_application_level_encryption:
            from derouter.derouter_core_utils.app_crypto import AppCrypto
        ...
        self.sqs_config = derouter.aws_sqs_callback_params.get("sqs_config") or sqs_config
