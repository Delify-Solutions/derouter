...
the factory in ``derouter_logging`` can resolve a name and build a single
...
from derouter.integrations.otel.presets.agentops import agentops_preset
from derouter.integrations.otel.presets.arize import arize_dynamic_headers, arize_preset
from derouter.integrations.otel.presets.base import Preset
from derouter.integrations.otel.presets.langfuse import (
    langfuse_dynamic_headers,
    langfuse_preset,
)
from derouter.integrations.otel.presets.langtrace import langtrace_preset
from derouter.integrations.otel.presets.levo import levo_preset
from derouter.integrations.otel.presets.newrelic import (
    newrelic_dynamic_endpoint,
    newrelic_dynamic_headers,
    newrelic_preset,
)
from derouter.integrations.otel.presets.phoenix import (
    phoenix_preset,
    phoenix_project_headers,
)
from derouter.integrations.otel.presets.weave import weave_dynamic_headers, weave_preset
