...
class DeRouterSpanKind(str, Enum):
    SERVER = "server"
    CLIENT = "client"
    INTERNAL = "internal"
    PRODUCER = "producer"
...
class SpanSpec:
    role: SpanRole
    kind: DeRouterSpanKind
    parent: SpanRole | None


SPAN_REGISTRY: Final[dict[SpanRole, SpanSpec]] = {
    SpanRole.PROXY_REQUEST: SpanSpec(SpanRole.PROXY_REQUEST, DeRouterSpanKind.SERVER, parent=None),
    SpanRole.LLM_CALL: SpanSpec(SpanRole.LLM_CALL, DeRouterSpanKind.CLIENT, parent=SpanRole.PROXY_REQUEST),
    ...
    SpanRole.MCP_TOOL_CALL: SpanSpec(SpanRole.MCP_TOOL_CALL, DeRouterSpanKind.CLIENT, parent=SpanRole.PROXY_REQUEST),
    SpanRole.MCP_LIST_TOOLS: SpanSpec(SpanRole.MCP_LIST_TOOLS, DeRouterSpanKind.CLIENT, parent=SpanRole.PROXY_REQUEST),
    SpanRole.GUARDRAIL: SpanSpec(SpanRole.GUARDRAIL, DeRouterSpanKind.INTERNAL, parent=SpanRole.PROXY_REQUEST),
    SpanRole.DB_CALL: SpanSpec(SpanRole.DB_CALL, DeRouterSpanKind.CLIENT, parent=SpanRole.PROXY_REQUEST),
    SpanRole.SERVICE: SpanSpec(SpanRole.SERVICE, DeRouterSpanKind.INTERNAL, parent=SpanRole.PROXY_REQUEST),
}
...
# redis-backed spend queues. Any service not mapped here is derouter-internal work
