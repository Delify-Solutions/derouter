...
class GenericAPILogger(CustomBatchLogger):
    ...
    def _get_headers(self, headers: dict | None = None):
        ...
        # 2. Update with derouter generic headers if available
        if derouter.generic_logger_headers:
            headers_dict.update(derouter.generic_logger_headers)
    ...
    def _should_retry_exception(self, exception: Exception) -> bool:
        if isinstance(exception, (derouter.Timeout, httpx.TransportError)):
            return True
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            if derouter.generic_api_use_v1 is True:
