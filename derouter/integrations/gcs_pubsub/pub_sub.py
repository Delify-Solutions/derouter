...
This is the PubSub logger for GCS PubSub, this sends DeRouter SpendLogs Payloads to GCS PubSub.
...
class GcsPubSubLogger(CustomBatchLogger):
    ...
    async def construct_request_headers(self) -> dict[str, str]:
        ...
        from derouter import vertex_chat_completion
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            if derouter.gcs_pub_sub_use_v1 is True:
