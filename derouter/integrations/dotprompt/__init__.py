...
def set_global_prompt_directory(directory: str) -> None:
    ...
    derouter.global_prompt_directory = directory
...
def prompt_initializer(derouter_params: "PromptDeRouterParams", prompt_spec: "PromptSpec") -> "CustomPromptManagement":
    ...
    """
    prompt_directory: Final = getattr(derouter_params, "prompt_directory", None)
    prompt_data = getattr(derouter_params, "prompt_data", None)
    ...
    prompt_file: Final = getattr(derouter_params, "prompt_file", None)

    # Handle dotprompt_content from database
    dotprompt_content: Final = getattr(derouter_params, "dotprompt_content", None)
