"""
Dotprompt manager that integrates with DeRouter's prompt management system.
...
class DotpromptManager(CustomPromptManagement):
    ...
    This class enables using .prompt files with the derouter completion() function
    by implementing the PromptManagementBase interface.

    Usage:
        # Set global prompt directory
        derouter.prompt_directory = "path/to/prompts"
    ...
    def __init__(
        ...
        self.prompt_directory = prompt_directory or derouter.global_prompt_directory
        ...
        if self._prompt_manager is None:
            if self.prompt_directory is None and not self.prompt_data and not self.prompt_file:
                raise ValueError(
                    ...
                    "Set derouter.global_prompt_directory, initialize with prompt_directory parameter, or provide prompt_data."
                )
    ...
    def get_chat_completion_prompt(
        ...
        from derouter.integrations.prompt_management_base import PromptManagementBase
