# What is this?
## On Success events log cost to OpenMeter - https://github.com/Delify-Solutions/derouter/issues/1268
...
class OpenMeterLogger(CustomLogger):
    ...
    def _common_logic(self, kwargs: dict, response_obj):
        call_id: Final = response_obj.get("id", kwargs.get("derouter_call_id"))
        ...
        return {
            "specversion": "1.0",
            "type": os.getenv("OPENMETER_EVENT_TYPE", "derouter_tokens"),
            "id": call_id,
            "time": dt,
            "subject": subject,
