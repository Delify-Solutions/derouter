"""
AgentOps integration for DeRouter - Provides OpenTelemetry tracing for LLM calls
"""
...
class AgentOps(OpenTelemetry):
    ...
    Example usage:
        ...
        derouter.success_callback = ["agentops"]
    ...
    def __init__(
        ...
        resource_attrs: Final = {
            "service.name": config.service_name or "derouter",
