"""
Generic prompt manager that integrates with DeRouter's prompt management system.
Fetches prompts from any API that implements the /beta/derouter_prompt_management endpoint.
"""
...
from derouter.integrations.prompt_management_base import (
...
class GenericPromptManager(CustomPromptManagement):
    ...
    /beta/derouter_prompt_management endpoint.
    ...
    def _fetch_prompt_from_api(self, prompt_id: str | None, prompt_spec: PromptSpec | None) -> dict[str, Any]:
        ...
        url: Final = f"{self.api_base}/beta/derouter_prompt_management"
        params: Final = {
            "prompt_id": prompt_id,
    ...
    async def async_fetch_prompt_from_api(
        ...
        params: Final = {
            "prompt_id": prompt_id,
            **(
                prompt_spec.derouter_params.provider_specific_query_params
                if prompt_spec and prompt_spec.derouter_params.provider_specific_query_params
                else {}
            ),
        }
    ...
    def should_run_prompt_management(
        ...
        if prompt_id is not None or (
            prompt_spec is not None and prompt_spec.derouter_params.provider_specific_query_params is not None
        ):
            return True
        return False
