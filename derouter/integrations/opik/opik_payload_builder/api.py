...
from derouter.integrations.opik import utils
...
def build_opik_payload(
    ...
    """
    Build Opik trace and span payloads from DeRouter completion data.

    This is the main public API for creating Opik payloads. It:
    1. Extracts all necessary data from DeRouter kwargs and response
    ...
    Args:
        kwargs: DeRouter kwargs containing request metadata and logging data
        response_obj: DeRouter response object containing model response
    ...
    # Extract derouter params and metadata
    derouter_params: Final = kwargs.get("derouter_params", {}) or {}
    derouter_metadata: Final = derouter_params.get("metadata", {}) or {}
    standard_logging_metadata: Final = standard_logging_object.get("metadata", {}) or {}

    # Extract and merge Opik metadata
    opik_metadata: Final = extractors.extract_opik_metadata(derouter_metadata, standard_logging_metadata)
    ...
    proxy_request: Final = derouter_params.get("proxy_server_request", {}) or {}
