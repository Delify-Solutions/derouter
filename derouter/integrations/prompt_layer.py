...
class PromptLayerLogger:
    ...
    def log_event(self, kwargs, response_obj, start_time, end_time, print_verbose):
        ...
        try:
            ...
            tags = []
            metadata = {}
            if "metadata" in kwargs["derouter_params"]:
                if "pl_tags" in kwargs["derouter_params"]["metadata"]:
                    tags = kwargs["derouter_params"]["metadata"]["pl_tags"]

                # Remove "pl_tags" from metadata
                metadata = {k: v for k, v in kwargs["derouter_params"]["metadata"].items() if k != "pl_tags"}
            ...
            request_response: Final = derouter.module_level_client.post(
