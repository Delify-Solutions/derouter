...
from derouter.integrations.helicone_mock_client import (
...
class HeliconeLogger:
    ...
    @staticmethod
    def add_metadata_from_header(derouter_params: dict, metadata: dict) -> dict:
        """
        ...
        if "derouter_parent_otel_span" in metadata:
            metadata.pop("derouter_parent_otel_span")
    ...
    def log_success(self, model, messages, response_obj, start_time, end_time, print_verbose, kwargs):
        ...
        try:
            ...
            kwargs.get("derouter_call_id", None)
            ...
            if isinstance(response_obj, derouter.EmbeddingResponse) or isinstance(response_obj, derouter.ModelResponse):
            ...
            response: Final = derouter.module_level_client.post(url, headers=headers, json=data)
