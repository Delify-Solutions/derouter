...
This module provides a base class for implementing custom secret managers in DeRouter.
...
Usage:
    ...
    derouter.secret_manager_client = MySecretManager()
...
class CustomSecretManager(BaseSecretManager):
    ...
    integrations in DeRouter. Users can extend this class to integrate their own secret
    management systems.
