...
DEROUTER_LOGO_URL: Final = "https://derouter-listing.s3.amazonaws.com/derouter_logo.png"
DEROUTER_SUPPORT_CONTACT: Final = "support@berri.ai"
...
async def send_team_budget_alert(webhook_event: WebhookEvent) -> bool:
    ...
    <img src="{email_logo_url}" alt="DeRouter Logo" width="150" height="50" /> <br/><br/><br/>
    ...
    email_event: Final = {
        ...
        "subject": f"DeRouter {event_name} for Team {team_alias}",
