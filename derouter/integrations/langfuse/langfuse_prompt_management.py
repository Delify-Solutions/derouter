"""
Call Hook for DeRouter Proxy which allows Langfuse prompt management.
"""
...
from derouter.types.llms.openai import AllMessageValues, ChatCompletionSystemMessage
...
from ...derouter_core_utils.specialty_caches.dynamic_logging_cache import (
    DynamicLoggingCache,
)
...
def langfuse_client_init(
    ...
    if Version(langfuse.version.__version__) >= Version("2.7.3"):
        ...
        parameters["httpx_client"] = httpx.Client(
            ...
            cert=os.getenv("SSL_CERTIFICATE", derouter.ssl_certificate),
        )
