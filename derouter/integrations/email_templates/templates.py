"""
Email Templates used by the DeRouter Email Service in slack_alerting.py
"""
...
KEY_CREATED_EMAIL_TEMPLATE: Final = """
                    ...
                    Detailed Documentation on <a href="https://router.delify.vn/docs/proxy/user_keys">Usage with OpenAI Python SDK, Langchain, LlamaIndex, Curl</a>
...
SOFT_BUDGET_ALERT_EMAIL_TEMPLATE: Final = """
                    ...
                    Your DeRouter API key has crossed its <b>soft budget limit of {soft_budget}</b>. <br /> <br />
                    ...
                    You can view your usage and manage your budget in the <a href="{base_url}">DeRouter Dashboard</a>. <br /> <br />
...
TEAM_SOFT_BUDGET_ALERT_EMAIL_TEMPLATE: Final = """
                    ...
                    Your DeRouter team has crossed its <b>soft budget limit of {soft_budget}</b>. <br /> <br />
...
MAX_BUDGET_ALERT_EMAIL_TEMPLATE: Final = """
                    ...
                    Your DeRouter API key has reached <b>{percentage}% of its maximum budget</b>. <br /> <br />
