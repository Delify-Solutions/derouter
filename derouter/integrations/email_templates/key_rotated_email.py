...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="message">
                <p><strong>Your DeRouter API key has been rotated</strong> as part of our ongoing commitment to security best practices.</p>
...
&nbsp;&nbsp;]<br>
            ...
            <a href="https://router.delify.vn/docs/proxy/user_keys" class="btn" style="color: #ffffff;">View Documentation</a>
