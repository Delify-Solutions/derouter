...
from derouter.integrations.langsmith_mock_client import (
...
from derouter.types.integrations.langsmith import *
from derouter.types.utils import StandardCallbackDynamicParams, StandardLoggingPayload
...
class LangsmithLogger(CustomBatchLogger):
    def __init__(
        ...
        **kwargs,
        ...
        _batch_size: Final = os.getenv("LANGSMITH_BATCH_SIZE", None) or derouter.langsmith_batch_size
    ...
    def get_credentials_from_env(
        ...
        if allow_env_credentials is False and langsmith_base_url is not None:
            ...
            _credentials_project = langsmith_project or "derouter-completion"
            _credentials_base_url = langsmith_base_url
            _credentials_tenant_id = langsmith_tenant_id
        else:
            _credentials_api_key = langsmith_api_key or os.getenv("LANGSMITH_API_KEY")
            _credentials_project = langsmith_project or os.getenv("LANGSMITH_PROJECT") or "derouter-completion"
    ...
    def _prepare_log_data(
        ...
        try:
            ...
            metadata = _derouter_params.get("metadata", {}) or {}
