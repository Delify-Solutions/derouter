"""
Arize Phoenix prompt manager that integrates with DeRouter's prompt management system.
...
class ArizePhoenixPromptManager(CustomPromptManagement):
    ...
    derouter completion() function by implementing the PromptManagementBase interface.
    ...
    def pre_call_hook(
        ...
        **kwargs,
        ...
        """
        if not prompt_id:
            return messages, derouter_params
        ...
        try:
            ...
            # Update derouter_params with prompt metadata
            ...
            if prompt_metadata.get("model") and not self.ignore_prompt_manager_model:
                derouter_params["model"] = prompt_metadata["model"]
            ...
            if not self.ignore_prompt_manager_optional_params:
                for param in [
                    ...
                    if param in prompt_metadata:
                        derouter_params[param] = prompt_metadata[param]

            return final_messages, derouter_params
