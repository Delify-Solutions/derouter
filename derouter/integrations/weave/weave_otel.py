...
from derouter.types.integrations.weave_otel import WeaveOtelConfig, WeaveSpanAttributes
...
def _set_weave_specific_attributes(span: Span, kwargs: Mapping[str, Any], response_obj: Any):
    ...
    custom_llm_provider: Final = derouter_params.get("custom_llm_provider") or ""
...
class WeaveOtelLogger(OpenTelemetry):
    """
    Weave (W&B) OpenTelemetry Logger for DeRouter.
    ...
    Usage:
        derouter.callbacks = ["weave_otel"]

        Or manually:
        from derouter.integrations.weave.weave_otel import WeaveOtelLogger
        weave_logger = WeaveOtelLogger(callback_name="weave_otel")
        derouter.callbacks = [weave_logger]
    ...
    def _start_primary_span(
        ...
        from the DeRouter LLM call spans, creating proper nesting in Weave.
        """
    ...
    def _handle_success(self, kwargs, response_obj, start_time, end_time):
        ...
        they should be managed by the user code, not ended by DeRouter.
        """
