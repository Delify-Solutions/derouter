...
# CHANGELOG: 2025-01-19 - Initial database module for DeRouter data extraction (erik.peterson)

"""Database connection and data extraction for DeRouter."""
...
class DeRouterDatabase:
    """Handle DeRouter PostgreSQL database connections and queries."""
    ...
    async def get_usage_data(
        ...
        """Retrieve usage data from DeRouter daily user spend table."""
        ...
        FROM "DeRouter_DailyUserSpend" dus
        LEFT JOIN "DeRouter_VerificationToken" vt ON dus.api_key = vt.token
        LEFT JOIN "DeRouter_TeamTable" tt ON vt.team_id = tt.team_id
        LEFT JOIN "DeRouter_UserTable" ut ON dus.user_id = ut.user_id
