...
from derouter.constants import DEROUTER_ASYNCIO_QUEUE_MAXSIZE
from derouter.integrations.additional_logging_utils import AdditionalLoggingUtils
from derouter.integrations.gcs_bucket.gcs_bucket_base import GCSBucketBase
...
from derouter.types.integrations.gcs_bucket import *
...
class GCSBucketLogger(GCSBucketBase, AdditionalLoggingUtils):
    def __init__(self, bucket_name: str | None = None) -> None:
        ...
        self.log_queue: asyncio.Queue[GCSLogQueueItem] = asyncio.Queue(maxsize=DEROUTER_ASYNCIO_QUEUE_MAXSIZE)
    ...
    def _get_object_name(self, kwargs: dict, logging_payload: StandardLoggingPayload, response_obj: Any) -> str:
        ...
        _metadata: Final = _derouter_params.get("metadata", None) or {}
