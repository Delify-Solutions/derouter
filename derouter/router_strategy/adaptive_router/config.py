...
from derouter.types.router import RequestType  # re-export for convenience  # noqa: F401
...
MIN_QUALITY_TIER_HEADER: Final[str] = "x-derouter-min-quality-tier"
...
ADAPTIVE_ROUTER_RESPONSE_HEADER: Final[str] = "x-derouter-adaptive-router-model"
