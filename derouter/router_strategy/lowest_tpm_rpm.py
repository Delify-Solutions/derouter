...
class LowestTPMLoggingHandler(CustomLogger):
    ...
    def log_success_event(self, kwargs, response_obj, start_time, end_time):
        try:
            ...
            """
            if "derouter_params" not in kwargs or kwargs["derouter_params"] is None:
                return
            ...
            verbose_router_logger.error(
                "derouter.router_strategy.lowest_tpm_rpm.py::async_log_success_event(): Exception occured - %s", e
            )
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        try:
            ...
            if kwargs["derouter_params"].get("metadata") is None:
                ...
                model_info: Final = kwargs["derouter_params"].get("model_info")
                id = None
