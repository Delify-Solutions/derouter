...
from derouter.types.utils import AUTOROUTER_CLASSIFIER_CALL_ORIGIN
...
if TYPE_CHECKING:
    ...
    from derouter.router_strategy.auto_router.derouter_encoder import DeRouterRouterEncoder
...
class AutoRouter(CustomLogger):
    ...
    def __init__(
        ...
        Args:
            ...
            derouter_router_instance: The instance of the DeRouter Router.
        ...
        self.derouter_router_instance: Router = derouter_router_instance
        self.encoder: DeRouterRouterEncoder = DeRouterRouterEncoder(
        ...
        try:
            ...
            query_vector: Final = (
                await self.encoder.aencode_queries(
                    ...
                    derouter_metadata=forwarded_internal_call_metadata(
                        caller.derouter_metadata, AUTOROUTER_CLASSIFIER_CALL_ORIGIN
                    ),
