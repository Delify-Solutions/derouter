...
from derouter.constants import SECRET_MANAGER_REFRESH_INTERVAL
...
from derouter.proxy._types import CommonProxyErrors, KeyManagementSystem
...
class GoogleSecretManager(GCSBucketBase):
    def __init__(
        ...
        derouter.secret_manager_client = self
        derouter._key_management_system = KeyManagementSystem.GOOGLE_SECRET_MANAGER
