...
Relevant issue: https://github.com/Delify-Solutions/derouter/issues/1235
...
def load_google_kms(use_google_kms: bool | None):
    ...
    try:
        ...
        derouter._key_management_system = KeyManagementSystem.GOOGLE_KMS
        derouter._google_kms_resource_name = os.getenv("GOOGLE_KMS_RESOURCE_NAME")
