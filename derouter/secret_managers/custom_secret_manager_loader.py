...
def load_custom_secret_manager(config_file_path: str | None = None) -> None:
    ...
    if derouter._key_management_settings is None:
        raise ValueError(
    ...
    custom_secret_manager_path: Final[str | None] = getattr(
        derouter._key_management_settings, "custom_secret_manager", None
    )
    ...
    derouter.secret_manager_client = _secret_manager_instance
