...
from derouter.types.llms.openai import FileTypes, OpenAIFilesPurpose
...
def _get_router_metadata_variable_name(function_name: str | None) -> str:
    ...
    """
    ROUTER_METHODS_USING_DEROUTER_METADATA: Final = set(
        [
            "batch",
            "generic_api_call",
            "_acreate_batch",
    ...
    if function_name and any(method in function_name for method in ROUTER_METHODS_USING_DEROUTER_METADATA):
