...
class ModelRateLimitingCheck(CustomLogger):
    ...
    def _get_deployment_limits(self, deployment: dict) -> tuple[int | None, int | None]:
        ...
        # Check derouter_params
        if tpm is None:
            tpm = deployment.get("derouter_params", {}).get("tpm")
        if rpm is None:
            rpm = deployment.get("derouter_params", {}).get("rpm")
    ...
    def pre_call_check(self, deployment: dict) -> dict | None:
        ...
        try:
            ...
            model_id: Final = deployment.get("model_info", {}).get("id")
            model_name: Final = deployment.get("derouter_params", {}).get("model")
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        try:
            ...
            model: Final = standard_logging_object.get("hidden_params", {}).get("derouter_model_name")
