...
def create_eval(
    ...
    **kwargs,
    ...
    try:
        ...
        headers = evals_api_provider_config.validate_environment(headers=headers, derouter_params=derouter_params)
        ...
        api_base: Final = derouter_params.api_base or DEFAULT_OPENAI_API_BASE
...
def update_eval(
    ...
    **kwargs,
    ...
    try:
        ...
        # Filter metadata to exclude internal DeRouter fields
        if metadata is not None:
            # List of internal DeRouter metadata keys that should NOT be sent to OpenAI
            internal_keys: Final = {
                "headers",
                "requester_metadata",
                "user_api_key_hash",
