"""
Budget repository for database operations on DeRouter_BudgetTable.
"""
...
class BudgetRepository(BaseRepository[DeRouter_BudgetTable]):
    """Repository for budget database operations."""

    @property
    def table(self) -> TableActions["prisma_models.DeRouter_BudgetTable"]:
        return self.prisma_client.db.derouter_budgettable

    @property
    def model_class(self) -> type[DeRouter_BudgetTable]:
        return DeRouter_BudgetTable

    async def find_by_id(self, budget_id: str, id_field: str = "budget_id") -> DeRouter_BudgetTable | None:
    ...
    async def delete_budget(self, budget_id: str) -> DeRouter_BudgetTable | None:
