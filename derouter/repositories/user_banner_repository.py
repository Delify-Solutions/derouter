...
from derouter.repositories.table_repositories import PrismaTableRepository
...
class UserBannerRepository(PrismaTableRepository["prisma_models.DeRouter_UISettings"]):
