...
class PrismaBatch(Protocol):
    @property
    def derouter_verificationtoken(self) -> BatchTable: ...

    @property
    def derouter_usertable(self) -> BatchTable: ...

    @property
    def derouter_teamtable(self) -> BatchTable: ...

    @property
    def derouter_budgettable(self) -> BatchTable: ...

    @property
    def derouter_teammembership(self) -> BatchTable: ...

    @property
    def derouter_organizationtable(self) -> BatchTable: ...

    @property
    def derouter_tagtable(self) -> BatchTable: ...

    @property
    def derouter_endusertable(self) -> BatchTable: ...

    @property
    def derouter_modelaccessgroupbudgettable(self) -> BatchTable: ...
