"""
DeRouter RAG (Retrieval Augmented Generation) Module.

Provides an all-in-one API for document ingestion:
Upload -> (OCR) -> Chunk -> Embed -> Vector Store
"""

from derouter.rag.main import aingest, aquery, ingest, query

__all__ = ["aingest", "aquery", "ingest", "query"]


# Expose at derouter.rag level for convenience
