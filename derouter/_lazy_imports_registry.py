...
# Litellm logging names that support lazy loading via _lazy_import_derouter_logging
DEROUTER_LOGGING_NAMES: Final = (
    "Logging",
    "modify_integration",
)
...
# Common types from derouter.types.utils that support lazy loading via
# _lazy_import_types_utils
TYPES_UTILS_NAMES: Final = (
    "ImageObject",
    "BudgetConfig",
    "all_derouter_params",
    "_derouter_completion_params",
    "CredentialItem",
...
# These are attributes accessed from derouter.utils module
...
_UTILS_IMPORT_MAP: Final = {
    ...
    "get_derouter_params": (".utils", "get_derouter_params"),
    ...
    "get_llm_provider": (
        "derouter.derouter_core_utils.get_llm_provider_logic",
        "get_llm_provider",
    ),
    "remove_index_from_tool_calls": (
        "derouter.derouter_core_utils.core_helpers",
        "remove_index_from_tool_calls",
    ),
}
...
_TYPES_UTILS_IMPORT_MAP: Final = {
    ...
    "all_derouter_params": (".types.utils", "all_derouter_params"),
    "_derouter_completion_params": (".types.utils", "all_derouter_params"),  # Alias
...
_TOKEN_COUNTER_IMPORT_MAP: Final = {
    "get_modified_max_tokens": (
        "derouter.derouter_core_utils.token_counter",
        "get_modified_max_tokens",
    ),
}
...
_BEDROCK_TYPES_IMPORT_MAP: Final = {
    "COHERE_EMBEDDING_INPUT_TYPES": (
        "derouter.types.llms.bedrock",
        "COHERE_EMBEDDING_INPUT_TYPES",
    ),
}

_CACHING_IMPORT_MAP: Final = {
    "Cache": ("derouter.caching.caching", "Cache"),
    "DualCache": ("derouter.caching.caching", "DualCache"),
    "RedisCache": ("derouter.caching.caching", "RedisCache"),
    "InMemoryCache": ("derouter.caching.caching", "InMemoryCache"),
}

_DEROUTER_LOGGING_IMPORT_MAP: Final = {
    "Logging": ("derouter.derouter_core_utils.derouter_logging", "Logging"),
    "modify_integration": (
...
_DOTPROMPT_IMPORT_MAP: Final = {
    "global_prompt_manager": (
        "derouter.integrations.dotprompt",
        "global_prompt_manager",
    ),
    "global_prompt_directory": (
        "derouter.integrations.dotprompt",
...
_TYPES_IMPORT_MAP: Final = {
    "GuardrailItem": ("derouter.types.guardrails", "GuardrailItem"),
    "DefaultTeamSSOParams": (
        "derouter.types.proxy.management_endpoints.ui_sso",
        "DefaultTeamSSOParams",
    ),
    "DeRouter_UpperboundKeyGenerateParams": (
        "derouter.types.proxy.management_endpoints.ui_sso",
    ...
    "KeyManagementSystem": (
        "derouter.types.secret_managers.main",
        "KeyManagementSystem",
    ),
    "PriorityReservationSettings": (
        "derouter.types.utils",
        "PriorityReservationSettings",
    ),
    "CustomLogger": ("derouter.integrations.custom_logger", "CustomLogger"),
    "LoggingCallbackManager": (
        "derouter.derouter_core_utils.logging_callback_manager",
        "LoggingCallbackManager",
    ),
    "DatadogLLMObsInitParams": (
        "derouter.types.integrations.datadog_llm_obs",
        "DatadogLLMObsInitParams",
    ),
}
...
_LLM_CONFIGS_IMPORT_MAP: Final = {
    ...
    "OpenAITextCompletionConfig": (
        "derouter.llms.openai.completion.transformation",
        "OpenAITextCompletionConfig",
    ),
    ...
    "DeRouterProxyResponsesAPIConfig": (
        ".llms.derouter_proxy.responses.transformation",
        "DeRouterProxyResponsesAPIConfig",
    ),
    "HostedVLLMResponsesAPIConfig": (
    ...
    "DeRouterProxyChatConfig": (
        ".llms.derouter_proxy.chat.transformation",
        "DeRouterProxyChatConfig",
    ),
...
_UTILS_MODULE_IMPORT_MAP: Final = {
    "encoding": ("derouter.main", "encoding"),
    "BaseVectorStore": (
        "derouter.integrations.vector_store_integrations.base_vector_store",
        "BaseVectorStore",
    ),
    "CredentialAccessor": (
        "derouter.derouter_core_utils.credential_accessor",
        "CredentialAccessor",
    ),
    "exception_type": (
        "derouter.derouter_core_utils.exception_mapping_utils",
        "exception_type",
    ),
    "get_error_message": (
        "derouter.derouter_core_utils.exception_mapping_utils",
    ...
    "get_supported_openai_params": (
        "derouter.derouter_core_utils.get_supported_openai_params",
        "get_supported_openai_params",
    ),
    "DeRouterResponseObjectHandler": (
        "derouter.derouter_core_utils.llm_response_utils.convert_dict_to_response",
        "DeRouterResponseObjectHandler",
    ),
    "_handle_invalid_parallel_tool_calls": (
        "derouter.derouter_core_utils.llm_response_utils.convert_dict_to_response",
    ...
    "get_api_base": (
        "derouter.derouter_core_utils.llm_response_utils.get_api_base",
        "get_api_base",
    ),
    "ResponseMetadata": (
        "derouter.derouter_core_utils.llm_response_utils.response_metadata",
        "ResponseMetadata",
    ),
    "_parse_content_for_reasoning": (
        "derouter.derouter_core_utils.prompt_templates.common_utils",
        "_parse_content_for_reasoning",
    ),
    "DeRouterLoggingObject": (
        "derouter.derouter_core_utils.redact_messages",
        "DeRouterLoggingObject",
    ),
    "redact_message_input_output_from_logging": (
        "derouter.derouter_core_utils.redact_messages",
    ...
    "CustomStreamWrapper": (
        "derouter.derouter_core_utils.streaming_handler",
        "CustomStreamWrapper",
    ),
    "BaseGoogleGenAIGenerateContentConfig": (
        "derouter.llms.base_llm.google_genai.transformation",
        "BaseGoogleGenAIGenerateContentConfig",
    ),
    "BaseOCRConfig": ("derouter.llms.base_llm.ocr.transformation", "BaseOCRConfig"),
    "BaseSearchConfig": (
        "derouter.llms.base_llm.search.transformation",
        "BaseSearchConfig",
    ),
    "BaseTextToSpeechConfig": (
        "derouter.llms.base_llm.text_to_speech.transformation",
        "BaseTextToSpeechConfig",
    ),
    "BedrockModelInfo": ("derouter.llms.bedrock.common_utils", "BedrockModelInfo"),
    "CohereModelInfo": ("derouter.llms.cohere.common_utils", "CohereModelInfo"),
    "MistralOCRConfig": ("derouter.llms.mistral.ocr.transformation", "MistralOCRConfig"),
    "Rules": ("derouter.derouter_core_utils.rules", "Rules"),
    "AsyncHTTPHandler": ("derouter.llms.custom_httpx.http_handler", "AsyncHTTPHandler"),
    "HTTPHandler": ("derouter.llms.custom_httpx.http_handler", "HTTPHandler"),
    "get_num_retries_from_retry_policy": (
        "derouter.router_utils.get_retry_from_policy",
        "get_num_retries_from_retry_policy",
    ),
    "reset_retry_policy": (
        "derouter.router_utils.get_retry_from_policy",
    ...
    "get_coroutine_checker": (
        "derouter.derouter_core_utils.cached_imports",
        "get_coroutine_checker",
    ),
    "get_derouter_logging_class": (
        "derouter.derouter_core_utils.cached_imports",
    ...
    "delete_nested_value": (
        "derouter.derouter_core_utils.dot_notation_indexing",
        "delete_nested_value",
    ),
    "is_nested_path": (
        "derouter.derouter_core_utils.dot_notation_indexing",
    ...
    "_get_base_model_from_derouter_call_metadata": (
        "derouter.derouter_core_utils.get_derouter_params",
        "_get_base_model_from_derouter_call_metadata",
    ),
    "get_derouter_params": (
        "derouter.derouter_core_utils.get_derouter_params",
    ...
    "_ensure_extra_body_is_safe": (
        "derouter.derouter_core_utils.llm_request_utils",
        "_ensure_extra_body_is_safe",
    ),
    "get_formatted_prompt": (
        "derouter.derouter_core_utils.llm_response_utils.get_formatted_prompt",
        "get_formatted_prompt",
    ),
    "get_response_headers": (
        "derouter.derouter_core_utils.llm_response_utils.get_headers",
        "get_response_headers",
    ),
    "update_response_metadata": (
        "derouter.derouter_core_utils.llm_response_utils.response_metadata",
    ...
    "executor": ("derouter.derouter_core_utils.thread_pool_executor", "executor"),
    "BaseAnthropicMessagesConfig": (
        "derouter.llms.base_llm.anthropic_messages.transformation",
        "BaseAnthropicMessagesConfig",
    ),
    "BaseAudioTranscriptionConfig": (
        "derouter.llms.base_llm.audio_transcription.transformation",
        "BaseAudioTranscriptionConfig",
    ),
    "BaseBatchesConfig": (
        "derouter.llms.base_llm.batches.transformation",
        "BaseBatchesConfig",
    ),
    "BaseContainerConfig": (
        "derouter.llms.base_llm.containers.transformation",
        "BaseContainerConfig",
    ),
    "BaseEmbeddingConfig": (
        "derouter.llms.base_llm.embedding.transformation",
        "BaseEmbeddingConfig",
    ),
    "BaseImageEditConfig": (
        "derouter.llms.base_llm.image_edit.transformation",
        "BaseImageEditConfig",
    ),
    "BaseImageGenerationConfig": (
        "derouter.llms.base_llm.image_generation.transformation",
        "BaseImageGenerationConfig",
    ),
    "BaseImageVariationConfig": (
        "derouter.llms.base_llm.image_variations.transformation",
        "BaseImageVariationConfig",
    ),
    "BasePassthroughConfig": (
        "derouter.llms.base_llm.passthrough.transformation",
        "BasePassthroughConfig",
    ),
    "BaseRealtimeConfig": (
        "derouter.llms.base_llm.realtime.transformation",
        "BaseRealtimeConfig",
    ),
    "BaseRerankConfig": (
        "derouter.llms.base_llm.rerank.transformation",
        "BaseRerankConfig",
    ),
    "BaseVectorStoreConfig": (
        "derouter.llms.base_llm.vector_store.transformation",
        "BaseVectorStoreConfig",
    ),
    "BaseVectorStoreFilesConfig": (
        "derouter.llms.base_llm.vector_store_files.transformation",
        "BaseVectorStoreFilesConfig",
    ),
    "BaseVideoConfig": (
        "derouter.llms.base_llm.videos.transformation",
        "BaseVideoConfig",
    ),
    "ANTHROPIC_API_ONLY_HEADERS": (
        "derouter.types.llms.anthropic",
        "ANTHROPIC_API_ONLY_HEADERS",
    ),
    "AnthropicThinkingParam": (
        "derouter.types.llms.anthropic",
    ...
    "RerankResponse": ("derouter.types.rerank", "RerankResponse"),
    "ChatCompletionDeltaToolCallChunk": (
        "derouter.types.llms.openai",
        "ChatCompletionDeltaToolCallChunk",
    ),
    "ChatCompletionToolCallChunk": (
        "derouter.types.llms.openai",
    ...
    "DeRouter_Params": ("derouter.types.router", "DeRouter_Params"),
}
