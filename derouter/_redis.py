...
from derouter import get_secret, get_secret_str
...
def _get_redis_client_logic(**env_overrides):
    ...
    # derouter.print_verbose(f"redis_kwargs: {redis_kwargs}")
...
def get_redis_async_client(
    ...
    **env_overrides,
    ...
    if "startup_nodes" in redis_kwargs:
        ...
        from derouter.caching.redis_cluster_node_isolation import (
            get_derouter_async_redis_cluster_class,
        )

        async_redis_cluster_class: Final = get_derouter_async_redis_cluster_class()
