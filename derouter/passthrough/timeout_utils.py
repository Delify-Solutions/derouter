...
def resolve_pass_through_request_timeout(
    ...
    try:
        proxy_server: Final = sys.modules.get("derouter.proxy.proxy_server")
...
def resolve_llm_passthrough_timeout(
    ...
    Precedence: kwargs timeout/request_timeout -> derouter_params timeout/request_timeout
    -> router_timeout -> general_settings.pass_through_request_timeout -> 600s default.
    """
    kwargs = kwargs or {}
    derouter_params = derouter_params or {}

    for source in (kwargs, derouter_params):
