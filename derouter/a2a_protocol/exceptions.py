...
Custom exception types for A2A protocol operations, following DeRouter's exception pattern.
"""
...
class A2AError(Exception):
    ...
    Follows the same pattern as DeRouter's main exceptions.
    """
    ...
    def __init__(
        ...
        self.message = f"derouter.A2AError: {message}"
        ...
        self.response = response or httpx.Response(
            ...
            request=httpx.Request(method="POST", url="https://router.delify.vn"),
        )
