...
class A2AClient:
    """
    DeRouter wrapper for A2A agent invocation.

    Creates the underlying A2A client once on first use and reuses it.

    Example:
        ```python
        from derouter.a2a_protocol import A2AClient
    ...
    async def get_agent_card(self) -> "AgentCard":
        ...
        from derouter.a2a_protocol.main import aget_agent_card
    ...
    async def send_message(self, request: "SendMessageRequest") -> DeRouterSendMessageResponse:
        """Send a message to the A2A agent."""
        from derouter.a2a_protocol.main import asend_message
    ...
    async def send_message_streaming(
        ...
        from derouter.a2a_protocol.main import asend_message_streaming
