...
class CustomSSOLoginHandler(CustomLogger):
    ...
    Useful when you have an OAuth proxy in front of DeRouter
    ...
    async def handle_custom_ui_sso_sign_in(
        ...
        return OpenID(
            id=request_headers_dict.get("x-derouter-user-id") or "123",
            email=request_headers_dict.get("x-derouter-user-email") or "test@test.com",
            first_name="Test",
            last_name="Test",
            display_name="Test",
