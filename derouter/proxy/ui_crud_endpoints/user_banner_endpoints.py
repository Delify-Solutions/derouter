...
from derouter.proxy._types import LitellmTableNames, LitellmUserRoles, UserAPIKeyAuth
from derouter.proxy.auth.user_api_key_auth import user_api_key_auth
from derouter.repositories.user_banner_repository import USER_BANNER_ROW_ID, UserBannerRepository
...
async def update_user_banner(
    ...
    """
    from derouter.proxy.proxy_server import create_config_audit_log, prisma_client
