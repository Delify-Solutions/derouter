...
The committed JSON is generated by `python -m derouter.proxy._lazy_openapi_snapshot`
...
the JSON, then run `npm run gen:api` in ui/derouter-dashboard and commit schema.d.ts.
"""
