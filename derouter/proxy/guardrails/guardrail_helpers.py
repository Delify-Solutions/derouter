...
from derouter.proxy.proxy_server import DeRouter_TeamTable, UserAPIKeyAuth
from derouter.types.guardrails import *

sys.path.insert(0, os.path.abspath("../.."))  # Adds the parent directory to the system path


def can_modify_guardrails(team_obj: DeRouter_TeamTable | None) -> bool:
    if team_obj is None:
        return True
        ...
        if "guardrails" in data["metadata"]:
            ...
            if isinstance(request_guardrails, dict):
                ...
                for _guardrail_name, should_run in request_guardrails.items():
                    ...
                    guardrail_item: GuardrailItem = derouter.guardrail_name_config_map[_guardrail_name]
