...
_GUARD_ENDPOINT: Final = "/api/v1/ai-gateway/derouter"
    ...
    def _build_payload(
        ...
        if not request_data:
            ...
            singulr_req_object: Final = SingulrGuardrailRequest(
                ...
                derouter_metadata=request_data.get("derouter_metadata"),
            )
            payload = SingulrGuardrailPayload(
                derouter_call_id=request_data.get("derouter_call_id"),
