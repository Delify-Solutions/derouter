"""
Custom code guardrail for DeRouter.
...
with access to DeRouter-provided primitives for common guardrail operations.
...
class CustomCodeGuardrail(CustomGuardrail):
    ...
    - Access to DeRouter primitives (regex_match, json_parse, etc.)
