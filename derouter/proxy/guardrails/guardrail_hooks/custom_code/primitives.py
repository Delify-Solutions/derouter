...
from derouter.llms.custom_httpx.http_handler import AsyncHTTPHandler, get_async_httpx_client
...
async def http_request(
    ...
    Uses DeRouter's global cached AsyncHTTPHandler for connection pooling
