# +-------------------------------------------------------------+
#
#           Noma Security Guardrail Integration for DeRouter
#                       https://noma.security
#
# +-------------------------------------------------------------+
...
import derouter
from derouter import DualCache, ModelResponse
...
class NomaGuardrail(CustomGuardrail):
    """
    Noma Security Guardrail for DeRouter
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._responses_transform_handler = DeRouterResponsesTransformationHandler()
        ...
        self.default_application_id = "derouter"
    ...
    async def _process_llm_response_check(
        ...
        for choice in response.choices:
            if isinstance(choice, derouter.Choices) and choice.message.content:
    ...
    async def _call_noma_api(
        ...
        call_id: Final = request_data.get("derouter_call_id")
        headers: Final = {
