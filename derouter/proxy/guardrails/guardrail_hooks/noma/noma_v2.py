# +-------------------------------------------------------------+
#
#      Noma Security V2 Guardrail Integration for DeRouter
#
# +-------------------------------------------------------------+
...
_AIDR_SCAN_ENDPOINT: Final = "/derouter/guardrail"
...
class NomaV2Guardrail(CustomGuardrail):
    ...
    def _build_scan_payload(
        ...
        if logging_obj is not None:
            ...
            payload_request_data["derouter_logging_obj"] = (
                {
                    key: value
    ...
    async def apply_guardrail(
        ...
        if application_id is None:
            application_id = self._get_non_empty_str(
                request_data.get("derouter_metadata", {}).get("user_api_key_alias")
