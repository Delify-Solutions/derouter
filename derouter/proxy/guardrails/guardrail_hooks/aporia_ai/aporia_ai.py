...
from derouter.derouter_core_utils.logging_utils import (
    convert_derouter_response_object_to_str,
)
...
'
    ...
    async def async_post_call_success_hook(
        ...
        response_str: Final[str | None] = convert_derouter_response_object_to_str(response)
    ...
    async def async_moderation_hook(
        ...
        from derouter.proxy.guardrails.guardrail_helpers import (
    ...
    def get_config_model() -> type["GuardrailConfigModel"] | None:
        from derouter.types.proxy.guardrails.guardrail_hooks.aporia_ai import (
