...
from derouter.proxy.guardrails._content_utils import build_inspection_messages
...
class RepelloAIGuardrail(CustomGuardrail):
    ...
    async def async_post_call_streaming_iterator_hook(
        ...
        assembled = derouter_main.stream_chunk_builder(  # pyright: ignore[reportUnknownMemberType, reportUnknownVariableType]
            chunks=chunks
        )
