"""MCP JWT Signer guardrail — built-in DeRouter guardrail for zero trust MCP auth."""
...
def initialize_guardrail(derouter_params: "LitellmParams", guardrail: "Guardrail") -> MCPJWTSigner:
    import derouter
    ...
    derouter.logging_callback_manager.add_derouter_callback(signer)
    return signer
