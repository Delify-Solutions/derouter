"""
Content Filter Guardrail for DeRouter.
...
class ContentFilterGuardrail(CustomGuardrail):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.guardrail_provider = "derouter_content_filter"
    ...
    def _resolve_category_file_path(self, file_path: str) -> str:
        ...
        relative paths like "derouter/proxy/.../policy_templates/file.yaml".
        ...
        ``DEROUTER_CONTENT_FILTER_ALLOW_EXTERNAL_PATHS=true``.  Use only in
        ...
        Raises:
            ValueError: If the resolved path escapes the module directory
                and ``DEROUTER_CONTENT_FILTER_ALLOW_EXTERNAL_PATHS`` is not set.
        """
        module_dir: Final = os.path.dirname(__file__)
        allow_external: Final = os.environ.get("DEROUTER_CONTENT_FILTER_ALLOW_EXTERNAL_PATHS", "").lower() == "true"
        ...
        if os.path.isabs(file_path) or os.path.exists(file_path):
            if not allow_external:
                ...
                verbose_proxy_logger.warning(
                    "DEROUTER_CONTENT_FILTER_ALLOW_EXTERNAL_PATHS is set — "
