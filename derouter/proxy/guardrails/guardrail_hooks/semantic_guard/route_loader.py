...
from derouter.constants import DEFAULT_SEMANTIC_GUARD_SIMILARITY_THRESHOLD
...
class SemanticGuardRouteLoader:
    ...
    def build_semantic_router(
        ...
        """Build the SemanticRouter with DeRouterRouterEncoder."""
        from semantic_router.routers import SemanticRouter
        ...
        encoder: Final = DeRouterRouterEncoder(
