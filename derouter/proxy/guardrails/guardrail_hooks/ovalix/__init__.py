...
def initialize_guardrail(derouter_params: "LitellmParams", guardrail: "Guardrail"):
    ...
    tracker_api_base: Final = getattr(derouter_params, "tracker_api_base", None)
    tracker_api_key: Final = getattr(derouter_params, "tracker_api_key", None)
    application_id: Final = getattr(derouter_params, "application_id", None)
    pre_checkpoint_id: Final = getattr(derouter_params, "pre_checkpoint_id", None)
    post_checkpoint_id: Final = getattr(derouter_params, "post_checkpoint_id", None)
    ...
    derouter.logging_callback_manager.add_derouter_callback(_ovalix_callback)
