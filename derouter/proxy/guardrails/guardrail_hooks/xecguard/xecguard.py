"""
XecGuard guardrail integration for DeRouter.
...
class XecGuardGuardrail(CustomGuardrail):
    ...
    async def async_logging_hook(
        ...
        if (
            ...
            and "derouter_params" in kwargs
            and "metadata" in kwargs["derouter_params"]
            and "standard_logging_guardrail_information" in kwargs["derouter_params"]["metadata"]
            and kwargs["derouter_params"]["metadata"]["standard_logging_guardrail_information"]
        ):
    ...
    def _extract_grounding_documents(request_data: dict) -> list[dict]:
        metadata: Final = request_data.get("metadata") or request_data.get("derouter_metadata")
