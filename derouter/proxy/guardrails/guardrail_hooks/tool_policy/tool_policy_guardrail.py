...
Reads input_policy / output_policy from DeRouter_ToolTable and enforces them.
...
from derouter.proxy.guardrails.tool_name_extraction import extract_request_tool_names
...
def _get_request_route_from_data(request_data: dict) -> str | None:
    ...
    if route:
        return route
    meta: Final = request_data.get("metadata") or request_data.get("derouter_metadata") or {}
