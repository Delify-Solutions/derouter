#!/usr/bin/env python3
"""
Azure Text Moderation Native Guardrail Integrationfor DeRouter
"""
...
from derouter.types.utils import CallTypesLiteral, GenericGuardrailAPIInputs, LLMResponseTypes
...
if TYPE_CHECKING:
    ...
    from derouter.types.proxy.guardrails.guardrail_hooks.azure.azure_text_moderation import (
...
class AzureContentSafetyTextModerationGuardrail(AzureGuardrailBase, CustomGuardrail):
    """
    DeRouter Built-in Guardrail for Azure Content Safety (Text Moderation).
