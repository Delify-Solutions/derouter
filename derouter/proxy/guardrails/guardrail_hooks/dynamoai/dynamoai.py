...
from derouter.types.proxy.guardrails.guardrail_hooks.dynamoai import (
    DynamoAIProcessedResult,
    DynamoAIRequest,
    DynamoAIResponse,
)
from derouter.types.utils import CallTypesLiteral, GuardrailStatus, ModelResponseStream
...
class DynamoAIGuardrails(CustomGuardrail):
    """
    DynamoAI Guardrails integration for DeRouter.
