# derouter/proxy/guardrails/guardrail_hooks/pangea.py
import os
...
class PangeaHandler(CustomGuardrail):
        ...
        **kwargs,
        ...
        if not self.api_key:
            raise PangeaGuardrailMissingSecrets(
                "Pangea API Key not found. Set PANGEA_API_KEY environment variable or pass it in derouter_params."
            )
    ...
    def get_config_model() -> type["GuardrailConfigModel"] | None:
        from derouter.types.proxy.guardrails.guardrail_hooks.pangea import (
