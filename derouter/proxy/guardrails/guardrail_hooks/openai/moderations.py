#!/usr/bin/env python3
"""
OpenAI Moderation Guardrail Integration for DeRouter
"""
...
if TYPE_CHECKING:
    from derouter.types.llms.openai import OpenAIModerationResponse
...
class OpenAIModerationGuardrail(OpenAIGuardrailBase, CustomGuardrail):
    """
    DeRouter Built-in Guardrail for OpenAI Content Moderation.
    ...
    def get_config_model() -> type["GuardrailConfigModel"] | None:
        ...
        """
        from derouter.types.proxy.guardrails.guardrail_hooks.openai.openai_moderation import (
