...
class AimGuardrail(CustomGuardrail):
    ...
    async def call_aim_guardrail(self, data: dict, hook: str, key_alias: str | None) -> dict:
        ...
        call_id: Final = data.get("derouter_call_id")
        ...
        return (
            {
                ...
                "x-aim-derouter-hook": hook,
                # Used by Aim to track DeRouter version and provide backward compatibility.
                "x-aim-derouter-version": derouter_version,
            }
            # Used by Aim to track together single call input and output
            | ({"x-aim-call-id": derouter_call_id} if derouter_call_id else {})
    ...
    def get_config_model() -> type["GuardrailConfigModel"] | None:
        from derouter.types.proxy.guardrails.guardrail_hooks.aim import (
