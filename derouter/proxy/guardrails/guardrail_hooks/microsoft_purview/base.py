...
class PurviewGuardrailBase:
    ...
    def _resolve_user_id(self, data: Mapping[str, object], user_api_key_dict: "UserAPIKeyAuth") -> str | None:
        ...
        decreasing trust order:
            ...
            1. ``user_api_key_dict.user_id`` — DeRouter key / JWT-bound user
        ...
        metadata_value: Final[object] = data.get("metadata") or data.get("derouter_metadata") or {}
    ...
    def _logging_kwargs_metadata(kwargs: Mapping[str, object]) -> Mapping[str, object]:
        ...
        derouter_params: Final[object] = kwargs.get("derouter_params") or {}
        if not isinstance(derouter_params, dict):
            return {}
        md: Final = derouter_params.get("metadata")
    ...
    def _resolve_trusted_user_id(self, data: Mapping[str, object], user_api_key_dict: "UserAPIKeyAuth") -> str | None:
        ...
        Uses only ``UserAPIKeyAuth.user_id`` (bound on the DeRouter key or JWT).
