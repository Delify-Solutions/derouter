...
_DEEPKEEP_GUARDRAIL_ENDPOINT: Final = "/v3/openai/beta/derouter_basic_guardrail_api"
...
class DeepKeepGuardrail(CustomGuardrail):
    """
    DeepKeep AI Firewall integration for DeRouter.
    ...
    Configuration example (derouter config YAML):
        guardrails:
        ...
        **kwargs: Any,
        ...
        if extra_headers is not None and not isinstance(extra_headers, Mapping):
            verbose_proxy_logger.warning(
                ...
                "`derouter_params.extra_headers` is a list of header names to forward and is not supported by this guardrail",
    ...
    def _extract_user_api_key_metadata(self, request_data: _DeepKeepMetadataSource) -> dict[str, object]:
        ...
        metadata_dict: Final[Mapping[str, object]] = {**top_level_metadata, **derouter_metadata}
    ...
    async def apply_guardrail(
        ...
        This is the main method called by the DeRouter framework for guardrail evaluation.
    ...
    def get_config_model() -> type | None:
        from derouter.types.proxy.guardrails.guardrail_hooks.deepkeep import (
