...
class MCPEndUserPermissionGuardrail(CustomGuardrail):
    ...
    def _get_end_user_id_from_request_data(request_data: dict) -> str | None:
        return request_data.get("user_api_key_end_user_id") or request_data.get("derouter_metadata", {}).get(
    ...
    def get_config_model() -> type["GuardrailConfigModel"] | None:
        from derouter.types.proxy.guardrails.guardrail_hooks.mcp_end_user_permission import (
