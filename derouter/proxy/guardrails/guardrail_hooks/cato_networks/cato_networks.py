        ...
        return (
            {
                ...
                "x-cato-derouter-hook": hook,
                # Used by Cato Networks to track DeRouter version and provide backward compatibility.
                "x-cato-derouter-version": derouter_version,
            }
            # Used by Cato Networks to track together single call input and output
            | ({"x-cato-call-id": derouter_call_id} if derouter_call_id else {})
