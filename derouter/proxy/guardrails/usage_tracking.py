...
from derouter.derouter_core_utils.llm_cost_calc.guardrail_cost import billed_guardrail_cost_by_unit
...
async def _upsert_usage_unit_row(
    ...
    row: Final[prisma_types.DeRouter_DailyGuardrailUsageUnitsCreateInput] = {
    ...
    data: Final[prisma_types.DeRouter_DailyGuardrailUsageUnitsUpsertInput] = {
        "create": row,
        "update": {
