...
# v2 implementation
from derouter.types.guardrails import Guardrail, GuardrailItem, GuardrailItemSpec
...
def _populate_router_guardrail_list(guardrail_list: list[Guardrail]) -> None:
    ...
    from derouter.types.router import GuardrailTypedDict
    ...
    for guardrail in guardrail_list:
        ...
        derouter_params: Any = guardrail.get("derouter_params", {})
        ...
        # Build derouter_params dict for the router
        params_dict = derouter_params.model_dump() if hasattr(derouter_params, "model_dump") else dict(derouter_params)
    ...
    try:
        ...
        for item in guardrails_config:
            ...
            for k, v in item.items():
                ...
                derouter.guardrail_name_config_map[k] = guardrail_item
        ...
        for guardrail in all_guardrails:
            ...
            if guardrail.default_on is True:
                # add these to derouter callbacks if they don't exist
                for callback in guardrail.callbacks:
                    if callback not in derouter.callbacks:
        ...
        return derouter.guardrail_name_config_map
