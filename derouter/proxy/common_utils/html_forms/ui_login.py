...
def build_ui_login_form(
    ...
    info_box_html: Final = (
        ...
        <div class="info-box">
            ...
            <p>By default, Username is <code>admin</code> and Password is your set DeRouter Proxy <code>MASTER_KEY</code>.</p>
            <p>Need to set UI credentials or SSO? <a href="https://router.delify.vn/docs/proxy/ui" target="_blank">Check the documentation</a>.</p>
        </div>
        """
    )
...
<body>
    <form action="{url_to_redirect_to}" method="post">
        ...
        <h2>Login</h2>
        <p class="subtitle">Access your DeRouter Admin UI.</p>
        {info_box_html}
