...
from derouter.proxy.common_utils.banner import DEROUTER_BANNER
...
def render_cli_sso_success_page() -> str:
    ...
    <head>
        <meta charset="UTF-8">
        <title>CLI Authentication Successful - DeRouter</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="banner">{DEROUTER_BANNER}</div>
            ...
            <div class="success-box">
                ...
                <p>Your DeRouter CLI has been successfully authenticated and is ready to use.</p>
            </div>
            ...
            <div class="instructions">
                ...
                <p>You can now use DeRouter CLI commands with your authenticated session.</p>
            </div>
