...
<title>Authorize CLI access - DeRouter</title>
<style>
body {{
...
<p>A command-line client at <code>{escape(client_origin)}</code> wants to call DeRouter as <strong>{escape(user_id)}</strong>.</p>
