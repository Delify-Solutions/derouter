...
def decode_secret_map(value: object, *, key: str) -> Mapping[str, str] | None:
    ...
    try:
        ...
        raise SecretMapDecodeError(f"Cannot decode encrypted MCP {key}; check DEROUTER_SALT_KEY") from None
