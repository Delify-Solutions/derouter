...
def get_file_contents_from_s3(bucket_name, object_key):
    try:
        ...
        from derouter.main import bedrock_converse_chat_completion
        ...
        # this is most likely if a user is not using the derouter docker container
...
# # Example usage
# bucket_name = 'derouter-proxy'
# object_key = 'derouter_proxy_config.yaml'
