...
if TYPE_CHECKING:
    from prisma.types import (
        DeRouter_AgentsTableInclude,
        DeRouter_AgentsTableWhereUniqueInput,
        DeRouter_GuardrailsTableWhereInput,
        DeRouter_ProxyModelTableWhereInput,
    )
...
async def _resync_model_deployments(model_name: str) -> bool:
    ...
    name_filter: Final[DeRouter_ProxyModelTableWhereInput] = {"model_name": model_name}
    id_filter: Final[DeRouter_ProxyModelTableWhereInput] = {"model_id": model_name}
...
async def _resync_guardrails(guardrail_name: str) -> bool:
    ...
    prisma_client: Final = proxy_server.prisma_client
    assert prisma_client is not None
    active_row_filter: Final[DeRouter_GuardrailsTableWhereInput] = {
...
async def _resync_agents(agent_id_or_name: str) -> bool:
    ...
    id_filter: Final[DeRouter_AgentsTableWhereUniqueInput] = {"agent_id": agent_id_or_name}
    name_filter: Final[DeRouter_AgentsTableWhereUniqueInput] = {"agent_name": agent_id_or_name}
    include_permission: Final[DeRouter_AgentsTableInclude] = {"object_permission": True}
...
def _initialized_guardrail(guardrail_name: str) -> "CustomGuardrail | None":
    from derouter.proxy.guardrails import guardrail_endpoints
