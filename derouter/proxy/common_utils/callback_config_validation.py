...
def _newrelic_config_error(callback_vars: Mapping[str, str]) -> str | None:
    ...
    from derouter.integrations.otel.presets.newrelic import NEWRELIC_OTLP_ENDPOINT_BY_REGION

    if not is_otel_v2_enabled():
        return "Per-team New Relic routing requires the proxy to run with DEROUTER_OTEL_V2=true."
