...
Deletes expired virtual keys created for DeRouter dashboard sessions.
"""
...
from derouter.proxy._types import KeyRequest, UserAPIKeyAuth
...
class ExpiredUISessionKeyCleanupManager:
    ...
    async def _find_expired_ui_session_keys(self) -> Sequence[_ExpiredSessionKeyRow]:
        """
        Find expired DeRouter dashboard session keys.
        """
