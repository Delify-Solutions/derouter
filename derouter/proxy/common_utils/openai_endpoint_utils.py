...
def remove_sensitive_info_from_deployment(
    ...
    """
    deployment_dict["derouter_params"].pop("api_key", None)
    deployment_dict["derouter_params"].pop("client_secret", None)
    deployment_dict["derouter_params"].pop("vertex_credentials", None)
    deployment_dict["derouter_params"].pop("vertex_ai_credentials", None)
    deployment_dict["derouter_params"].pop("aws_access_key_id", None)
    deployment_dict["derouter_params"].pop("aws_secret_access_key", None)
    ...
    deployment_dict["derouter_params"] = SENSITIVE_DATA_MASKER.mask_dict(
        deployment_dict["derouter_params"], excluded_keys=_excluded
    )
