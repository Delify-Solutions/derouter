...
async def create_realtime_client_secret(
    ...
    try:
        ...
        verbose_proxy_logger.error(
            "derouter.proxy.realtime_endpoints.webrtc.create_realtime_client_secret(): Exception - %s",
            str(e),
        )
...
async def proxy_realtime_calls(
    ...
    try:
        ...
        verbose_proxy_logger.error(
            "derouter.proxy.realtime_endpoints.webrtc.proxy_realtime_calls(): Exception - %s",
            str(e),
        )
        if isinstance(e, HTTPException):
            raise ProxyException(
...
async def create_realtime_transcription_session(
    ...
    try:
        ...
        verbose_proxy_logger.error(
            "derouter.proxy.realtime_endpoints.create_realtime_transcription_session(): Exception - %s",
            str(e),
        )
        if isinstance(e, ProxyException):
            raise e
