...
async def image_generation(
    ...
    from derouter.proxy.derouter_pre_call_utils import reject_url_valued_destination
    ...
    try:
        ...
        verbose_proxy_logger.error("derouter.proxy.proxy_server.image_generation(): Exception occured - %s", e)
