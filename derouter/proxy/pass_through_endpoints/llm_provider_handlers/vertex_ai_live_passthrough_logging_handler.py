...
from derouter.types.utils import LlmProviders, ModelResponse, Usage
...
class VertexAILivePassthroughLoggingHandler(BasePassthroughLoggingHandler):
    ...
    def _create_usage_object_from_metadata(
        ...
        """
        Create a DeRouter Usage object from Live API usage metadata.
    ...
    def vertex_ai_live_passthrough_handler(
        ...
        **kwargs,
        ...
        try:
            ...
            # Create Usage object for standard DeRouter logging
            ...
            derouter_model_response: Final = ModelResponse(
