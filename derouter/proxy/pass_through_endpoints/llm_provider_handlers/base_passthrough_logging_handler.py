...
from derouter.types.utils import LlmProviders, ModelResponse, TextCompletionResponse
...
class BasePassthroughLoggingHandler(ABC):
    ...
    def passthrough_chat_handler(
        ...
        **kwargs,
        ...
        derouter_model_response: Final[ModelResponse] = provider_config.transform_response(
