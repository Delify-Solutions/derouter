...
async def create_eval(
    ...
    - Pass model via header: `x-derouter-model: gpt-4-account-1`
...
async def create_run(
    ...
    model: Final = (
        request.headers.get("x-derouter-model")
...
async def list_runs(
    ...
    model: Final = request.headers.get("x-derouter-model") or request.query_params.get("model")
    if model:
        data["model"] = model
