...
from derouter.repositories.table_repositories import PolicyAttachmentRepository
...
if TYPE_CHECKING:
    ...
    from prisma.models import DeRouter_PolicyAttachmentTable
...
class AttachmentRegistry:
    ...
    async def add_attachment_to_db(
        ...
        """
        try:
            created_attachment: Final[DeRouter_PolicyAttachmentTable] = await PolicyAttachmentRepository(
                prisma_client
            ).table.create(
                data={
    ...
    async def delete_attachment_from_db(
        ...
        try:
            ...
            attachment: Final[DeRouter_PolicyAttachmentTable | None] = await PolicyAttachmentRepository(
                prisma_client
    ...
    async def get_all_attachments_from_db(
        ...
        """
        try:
            attachments: Final[Sequence[DeRouter_PolicyAttachmentTable]] = await PolicyAttachmentRepository(
                prisma_client
            ).table.find_many(
