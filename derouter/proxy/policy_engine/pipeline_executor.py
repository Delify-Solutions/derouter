...
from derouter.constants import LOGS_GUARDRAIL_INFORMATION_MARKER
...
from derouter.types.utils import GenericGuardrailAPIInputs, StandardLoggingGuardrailInformation
...
class PipelineExecutor:
    ...
    def find_guardrail_callback(guardrail_name: str) -> CustomGuardrail | None:
        """Look up an initialized guardrail callback by name from derouter.callbacks."""
