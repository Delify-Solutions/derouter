    ...
    try:
        ...
        fastapi_response.headers.update(
            ProxyBaseLLMRequestProcessing.get_custom_headers(
                user_api_key_dict=user_api_key_dict,
                call_id=hidden_params.get("derouter_call_id", None) or data.get("derouter_call_id", None),
                model_id=model_id,
                cache_key=cache_key,
                api_base=api_base,
                version=version,
        ...
        verbose_proxy_logger.error("derouter.proxy.proxy_server.rerank(): Exception occured - %s", e)
