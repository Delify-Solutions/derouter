...
The opt-in is a single env var, ``DEROUTER_SUPPRESS_SPEND_LOG_TRACEBACKS=true``,
...
SUPPRESS_SPEND_LOG_TRACEBACKS_ENV: Final = "DEROUTER_SUPPRESS_SPEND_LOG_TRACEBACKS"
...
def spend_log_error(
    ...
    *args: Any,
    ...
    renders its traceback. When ``DEROUTER_SUPPRESS_SPEND_LOG_TRACEBACKS`` is
