...
class ColdStorageHandler:
    ...
    resolved from the configured ``derouter.cold_storage_custom_logger``.
    """
    ...
    def _resolve_cold_storage_logger(self) -> CustomLogger | None:
        ...
        if custom_logger_name is None:
            return None
        return derouter.logging_callback_manager.get_active_custom_logger_for_callback_name(custom_logger_name)
    ...
    def _select_custom_logger_for_cold_storage(
        ...
        cold_storage_custom_logger: Final[_custom_logger_compatible_callbacks_literal | None] = (
            derouter.cold_storage_custom_logger
        )
