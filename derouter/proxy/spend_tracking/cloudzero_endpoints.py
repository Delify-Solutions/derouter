...
from derouter.types.proxy.cloudzero_endpoints import (
...
class _CloudZeroConfigRow(Protocol):
    """The ``DeRouter_Config`` row holding ``cloudzero_settings``, as this module reads it."""
...
def is_cloudzero_setup_in_config() -> bool:
    ...
    return "cloudzero" in derouter.callbacks
