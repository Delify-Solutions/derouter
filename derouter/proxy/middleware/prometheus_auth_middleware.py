...
class PrometheusAuthMiddleware:
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        if derouter.require_auth_for_metrics_endpoint is not False:
            ...
            try:
                await user_api_key_auth(
                    ...
                    custom_derouter_key_header=request.headers.get(SpecialHeaders.custom_derouter_api_key.value),
                )
                ...
                body: Final = json.dumps(
                    ...
                    f"`derouter_settings.require_auth_for_metrics_endpoint: false` "
