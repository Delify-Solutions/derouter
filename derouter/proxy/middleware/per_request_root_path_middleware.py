...
def get_request_root_path() -> str:
    ...
    falls back through :func:`~derouter.proxy.utils.get_server_root_path` (i.e.
    ...
    existing ``monkeypatch.setattr("derouter.proxy.utils.get_server_root_path"``
    ...
    from derouter.proxy.utils import get_server_root_path  # noqa: PLC0415  # lazy import breaks a two-way dep
