...
from derouter._uuid import uuid as uuid_module
from derouter.llms.base_llm.files.storage_backend_factory import get_storage_backend
...
class StorageBackendFileService:
    ...
    def _create_unified_file_id(
        ...
        """
        unified_file_id_str: Final = SpecialEnums.DEROUTER_MANAGED_FILE_COMPLETE_STR.value.format(
            file_type,
