...
from derouter.integrations.custom_guardrail import is_guardrail_intervention
...
from derouter.types.utils import CallTypes, CallTypesLiteral
...
_SCAN_METADATA_KEY: Final = "derouter_metadata"
...
# Mirrors the record classifier in derouter/llms/bedrock/files/transformation.py, so a record
# derouter already accepts without a url keeps working.
