...
from derouter.constants import DEFAULT_COMPETITOR_DISCOVERY_MODEL
...
TABLE_DAILY_USER_SPEND: Final = "derouter_dailyuserspend"
TABLE_DAILY_TEAM_SPEND: Final = "derouter_dailyteamspend"
TABLE_DAILY_TAG_SPEND: Final = "derouter_dailytagspend"
...
_SYSTEM_PROMPT_BASE: Final = (
    "You are an AI assistant embedded in the DeRouter Usage dashboard. "
...
async def _stream_final_response(model: str, chat_messages: list[Mapping[str, object]]) -> AsyncIterator[str]:
    ...
    response: Final = await derouter.acompletion(
        model=model,
