...
like `from derouter.proxy.management_endpoints.policy_endpoints import router`
continue to work. Patch targets also resolve correctly since names
are imported directly into this namespace.
"""

from derouter.proxy.management_endpoints.policy_endpoints.endpoints import *  # noqa: F403
from derouter.proxy.management_endpoints.policy_endpoints.endpoints import (  # noqa: F401
