"""
Convert Anthropic MCP connector definitions into DeRouter MCP server create requests.
...
from derouter.proxy._types import MCPApprovalStatus, NewMCPServerRequest
from derouter.types.mcp import MCPAuth, MCPAuthType, MCPCredentials, MCPTransport
