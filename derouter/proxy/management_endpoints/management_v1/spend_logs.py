...
# Rows the facet query may read out of DeRouter_SpendLogs before DISTINCT. Matches
...
async def _list_spend_log_facet(
    ...
    try:
        ...
        verbose_proxy_logger.exception(
            "derouter.proxy.management_endpoints.management_v1.spend_logs._list_spend_log_facet(): Exception occured - %s",
            e,
        )
        raise ManagementProblem(
            ProblemDetail(
