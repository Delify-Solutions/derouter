...
from derouter.repositories.table_repositories import JWTKeyMappingRepository

router: Final = APIRouter()


class _JWTKeyMappingRecord(Protocol):
    """A ``DeRouter_JWTKeyMapping`` row, viewed through the columns these endpoints read."""
