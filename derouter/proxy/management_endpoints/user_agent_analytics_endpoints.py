...
if TYPE_CHECKING:
    from prisma.models import DeRouter_DailyTagSpend as PrismaDailyTagSpendRow
    from prisma.models import DeRouter_UserTable as PrismaUserRow
...
from derouter.repositories.table_repositories import DailyTagSpendRepository
...
async def get_distinct_user_agent_tags(
    ...
    try:
        ...
        FROM "DeRouter_DailyTagSpend" dts
...
async def get_daily_active_users(
    ...
    try:
        ...
        FROM "DeRouter_DailyTagSpend" dts
        INNER JOIN "DeRouter_VerificationToken" vt ON dts.api_key = vt.token
        {where_clause}
...
async def get_tag_summary(
    ...
    try:
        ...
        FROM "DeRouter_DailyTagSpend" dts
        LEFT JOIN "DeRouter_VerificationToken" vt ON dts.api_key = vt.token
        {where_clause}
        GROUP BY dts.tag
