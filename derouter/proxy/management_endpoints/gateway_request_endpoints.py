...
Source of truth is DeRouter_DailyGatewayRequests, written at the ASGI edge by
BillableRequestMetricsMiddleware. This counts what the proxy answered, so it is
independent of whether a request reached derouter's logging callbacks.
...
from derouter.types.proxy.gateway_requests import (
...
_AGGREGATE_SQL: Final = """
    ...
    FROM "DeRouter_DailyGatewayRequests"
