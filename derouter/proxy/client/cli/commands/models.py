...
def _get_model_info_obj_from_yaml(model: dict[str, Any]) -> ModelYamlInfo:
    ...
    model_params: Final[dict[str, Any]] = model["derouter_params"]
...
@click.group()
def models() -> None:
    """Manage models on your DeRouter proxy server"""
    ...
    if output_format == "json":
        ...
        column_configs: Final[dict[str, _ModelInfoColumnConfig]] = {
            ...
            "upstream_model": {
                ...
                "style": "green",
                "get_value": lambda m: str(m.get("derouter_params", {}).get("model", "")),
            },
            "credential_name": {
                "header": "Credential Name",
                "style": "yellow",
                "get_value": lambda m: str(m.get("derouter_params", {}).get("derouter_credential_name", "")),
            },
            "created_at": {
                "header": "Created At",
                "style": "magenta",
...
def _filter_model(model, model_regex, access_group_regex):
    ...
    model_params: Final = model.get("derouter_params")
...
@click.option(
    ...
    default=None,
    help="Only import models where derouter_params.model matches the given regex.",
)
@click.option(
