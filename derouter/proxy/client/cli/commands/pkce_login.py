...
The proxy publishes everything this needs at ``/.well-known/derouter-cli-auth``, so a CLI
...
from derouter.derouter_core_utils.cli_token_utils import CLI_TOKEN_FRESHNESS_BUFFER_SECONDS

if TYPE_CHECKING:
    from .auth import CliTokenData

CLI_AUTH_DISCOVERY_PATH: Final = "/.well-known/derouter-cli-auth"
CALLBACK_PATH: Final = "/callback"
LOGIN_TIMEOUT_SECONDS: Final = 300
_HTTP_TIMEOUT_SECONDS: Final = 15
_CLIENT_NAME: Final = "derouter-cli"
...
class _CallbackHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        self._respond(200, "Signed in to DeRouter. You can close this window and return to the terminal.")
