...
@click.group()
def keys():
    """Manage API keys for the DeRouter proxy server"""
...
@click.option(
    "--source-base-url",
    required=True,
    help="Base URL of the source DeRouter proxy server to import keys from",
)
...
def import_keys(
    ...
    """Import API keys from another DeRouter instance"""
