"""HTTP client for making requests to the DeRouter proxy server."""
...
class HTTPClient:
    ...
    def __init__(self, base_url: str, api_key: str | None = None, timeout: int = 30):
        ...
        Args:
            base_url: Base URL of the DeRouter proxy server
    ...
    def request(
        ...
        **kwargs: Any,
        ...
        """Make an HTTP request to the DeRouter proxy server.

        This method is used to make generic requests to the DeRouter proxy
        ...
        Example:
            >>> client.http.request("POST", "/health/test_connection", json={
                "derouter_params": {
                    ...
                    "api_key": "6xxxxxxx",
                    "api_base": "https://derouter8397336933.openai.azure.com/openai/deployments/gpt-4o/chat/completions?api-version=2024-10-21",
                },
                "mode": "chat",
            })
            {'status': 'error',
