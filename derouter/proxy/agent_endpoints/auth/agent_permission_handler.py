"""
Agent Permission Handler for DeRouter Proxy.
...
from derouter.proxy._experimental.mcp_server.ui_session_utils import build_effective_auth_contexts
...
from derouter.repositories.table_repositories import AgentsRepository
...
class AgentRequestHandler:
    ...
    async def _get_allowed_agents_for_team(
        ...
        try:
            ...
            # derouter-dashboard is the default UI team and will never have agents;
    ...
    async def _get_unified_access_group_agents(access_group_ids: list[str]) -> list[str]:
        ...
        """
        from derouter.proxy.auth.auth_checks import _get_agent_ids_from_access_groups
