...
from derouter.proxy.auth.network import NetworkContext
...
from derouter.proxy.auth.roles import TeamRole, map_role, team_role

if TYPE_CHECKING:
    from derouter.caching.caching import DualCache
    from derouter.integrations.opentelemetry import Span
