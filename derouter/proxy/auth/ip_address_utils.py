...
from derouter.proxy.auth.auth_utils import _get_request_ip_address
...
class IPAddressUtils:
    ...
    def is_request_https(
        ...
        derouter only sees a plain-HTTP hop whenever TLS terminates at a
        ...
        that deployment shape. Resolved from the first trusted signal:
          ...
          3. The request's own literal scheme (direct TLS termination, or no
             reverse proxy in front of derouter).
        """
