...
Use this if you want to run custom code after derouter has retrieved information from your IDP (Identity Provider).

Flow:
- User lands on Admin UI
- DeRouter redirects user to your SSO provider
- Your SSO provider redirects user back to DeRouter
- DeRouter has retrieved user information from your IDP
...
from derouter.proxy._types import LitellmUserRoles, SSOUserDefinedValues
...
async def custom_sso_handler(userIDPInfo: OpenID) -> SSOUserDefinedValues:
    try:
        ...
        # check if user exists in derouter proxy DB
