...
`derouter_accessgrouptable.assigned_team_ids` and `derouter_teamtable.access_group_ids`
...
_READ_TEAM_SQL: Final = 'SELECT access_group_ids FROM "DeRouter_TeamTable" WHERE team_id = $1'
...
_AFFECTED_SQL: Final = """
SELECT access_group_id FROM "DeRouter_AccessGroupTable"
