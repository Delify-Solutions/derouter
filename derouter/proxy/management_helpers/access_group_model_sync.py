"""
Keep `derouter_accessgrouptable.access_model_names` pointing at deployment names that still exist.
...
from derouter.proxy.management_helpers.access_group_team_sync import invalidate_access_group_caches
from derouter.repositories.table_repositories import AccessGroupRepository
...
_BACKING_DEPLOYMENTS_SQL: Final = (
    'SELECT COUNT(*)::int AS deployment_count FROM "DeRouter_ProxyModelTable" WHERE "model_name" = $1'
)

_REPLACE_MODEL_NAME_SQL: Final = (
    'UPDATE "DeRouter_AccessGroupTable" '
