...
from derouter.proxy._types import ObjectPermissionDict, SpecialMCPServerName, SpecialMCPServerNames
...
async def handle_update_object_permission_common(
    ...
    4. Upserts to the DeRouter_ObjectPermissionTable
...
async def _set_object_permission(
    ...
    """
    Creates the DeRouter_ObjectPermissionTable record for the key/team.
...
async def _get_db_mcp_servers_by_identifiers(
    ...
    prisma_client: PrismaClient | None,
) -> "Sequence[prisma_models.DeRouter_MCPServerTable]":
...
async def _get_grandfathered_key_mcp_server_ids(
    existing_object_permission: Optional["DeRouter_ObjectPermissionTable"],
    prisma_client: PrismaClient | None,
) -> frozenset[str]:
    """
...
async def validate_key_mcp_servers_against_team(
    ...
    existing_key_object_permission: Optional["DeRouter_ObjectPermissionTable"] = None,
