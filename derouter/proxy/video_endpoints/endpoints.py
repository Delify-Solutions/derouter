...
from derouter.proxy.image_endpoints.endpoints import batch_to_bytesio
from derouter.proxy.video_endpoints.utils import (
...
async def video_status(
    ...
    # This allows the router to automatically inject derouter_params from the model config
