...
DAILY_SPEND_TABLES: Final[Mapping[DailySpendEntity, DailySpendTable]] = MappingProxyType(
    {
        "user": DailySpendTable(name="DeRouter_DailyUserSpend", entity_id_column="user_id"),
        "team": DailySpendTable(name="DeRouter_DailyTeamSpend", entity_id_column="team_id"),
        "org": DailySpendTable(name="DeRouter_DailyOrganizationSpend", entity_id_column="organization_id"),
        "end_user": DailySpendTable(name="DeRouter_DailyEndUserSpend", entity_id_column="end_user_id"),
        "agent": DailySpendTable(name="DeRouter_DailyAgentSpend", entity_id_column="agent_id"),
        "tag": DailySpendTable(name="DeRouter_DailyTagSpend", entity_id_column="tag", carries_request_id=True),
    }
)
