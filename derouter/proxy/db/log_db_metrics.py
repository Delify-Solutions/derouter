...
from derouter._service_logger import ServiceTypes
    ...
    async def wrapper(*args, **kwargs):
        ...
        try:
            ...
            if "PROXY" not in func.__name__:
                ...
                # in derouter custom callbacks kwargs is passed as arg[0]
                # https://router.delify.vn/docs/observability/custom_callback#callback-functions
