...
class SpendLogCleanup:
    ...
    When DeRouter_SpendLogs is range-partitioned, expired data is reclaimed by
    ...
    def __init__(
        ...
        from derouter.proxy.proxy_server import general_settings as default_settings
    ...
    async def _delete_old_autorouter_session_rows(
        ...
        return await self._delete_old_rows_batched(
            prisma_client,
            cutoff_date,
            table_name="DeRouter_AutoRouterSession",
