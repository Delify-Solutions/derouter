...
from derouter.proxy.db.db_transaction_queue.base_update_queue import (
    BaseUpdateQueue,
    service_logger_obj,
)
...
class SpendUpdateQueue(BaseUpdateQueue):
    ...
    def __init__(self):
        super().__init__()
        self.update_queue: asyncio.Queue[SpendUpdateQueueItem] = asyncio.Queue(maxsize=DEROUTER_ASYNCIO_QUEUE_MAXSIZE)
