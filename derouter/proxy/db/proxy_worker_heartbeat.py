...
BEAT_SQL: Final = """
INSERT INTO "DeRouter_ProxyWorkerHeartbeat" (worker_id, hostname, last_heartbeat_at)
VALUES ($1, $2, NOW())
ON CONFLICT (worker_id) DO UPDATE SET last_heartbeat_at = NOW()
"""

PRUNE_SQL: Final = """
DELETE FROM "DeRouter_ProxyWorkerHeartbeat"
WHERE last_heartbeat_at < NOW() - make_interval(secs => $1)
"""

COUNT_SQL: Final = """
SELECT COUNT(*)::int AS live_workers FROM "DeRouter_ProxyWorkerHeartbeat"
WHERE last_heartbeat_at > NOW() - make_interval(secs => $1)
"""

DEREGISTER_SQL: Final = """
DELETE FROM "DeRouter_ProxyWorkerHeartbeat" WHERE worker_id = $1
"""
