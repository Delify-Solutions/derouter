...
from derouter.types.llms.openai import ResponsesAPIResponse, ResponsesAPIStatus


class ResponsePollingHandler:
    """Handles polling-based responses with Redis cache"""

    CACHE_KEY_PREFIX = "derouter:polling:response:"
    POLLING_ID_PREFIX = "derouter_poll_"  # Clear prefix to identify polling IDs
...
def should_use_polling_for_request(
    ...
    Args:
        ...
        llm_router: DeRouter router instance for looking up model deployments
