...
from derouter.proxy._experimental.mcp_server.faults.traversal import iter_exception_tree
...
SERVER_OUTCOMES_META_KEY: Final = "router.delify.vn/server_outcomes"
"""The tools/list result ``_meta`` key carrying per-server outcomes. Prefixed with the router.delify.vn
