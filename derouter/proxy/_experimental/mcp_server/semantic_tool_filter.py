...
from derouter.exceptions import ContextWindowExceededError
from derouter.derouter_core_utils.exception_mapping_utils import ExceptionCheckers
from derouter.proxy._experimental.mcp_server.faults import iter_exception_tree
from derouter.proxy._experimental.mcp_server.utils import MCP_TOOL_PREFIX_SEPARATOR
...
class SemanticMCPToolFilter:
    ...
    def __init__(
        ...
        Args:
            ...
            derouter_router_instance: Router instance for embedding generation
        ...
        self.embedding_model = embedding_model
        self.router_instance = derouter_router_instance
        ...
        try:
            ...
            self.tool_router = SemanticRouter(
                ...
                encoder=DeRouterRouterEncoder(
                    derouter_router_instance=self.router_instance,
