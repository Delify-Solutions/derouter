...
from derouter.types.utils import StandardLoggingMCPToolCall
...
class MCPCostCalculator:
    ...
    def calculate_mcp_tool_call_cost(
        ...
        #########################################################
        response_cost: Final = derouter_logging_obj.model_call_details.get("response_cost", None)
        ...
        mcp_tool_call_metadata: Final[StandardLoggingMCPToolCall] = (
            cast(
                ...
                derouter_logging_obj.model_call_details.get("mcp_tool_call_metadata", {}),
            )
            or {}
        )
