...
from derouter.experimental_mcp_client.tools import transform_mcp_tool_to_openai_tool
...
class MCPGuardrailTranslationHandler(BaseTranslation):
    ...
    async def process_input_messages(
        ...
        # Convert MCP input via transform_mcp_tool_to_openai_tool, then map to derouter
