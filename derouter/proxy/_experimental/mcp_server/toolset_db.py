...
from derouter.repositories.table_repositories import MCPToolsetRepository
...
async def list_mcp_toolsets(
    ...
    try:
        ...
        verbose_proxy_logger.warning("derouter.proxy._experimental.mcp_server.toolset_db::list_mcp_toolsets - %s", e)
        return []
