...
def validate_header_name(raw: str) -> Result[str, CredError]:
    ...
    The grammar itself lives in ``derouter.types.mcp`` so the v1 model, the management endpoint and
...
class Subject(BaseModel):
    """The validated inbound principal. NOT the v1 request object and NOT the DeRouter key."""
