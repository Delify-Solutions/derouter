...
from derouter.experimental_mcp_client.client import strip_auth_scheme, to_basic_credentials
...
from derouter.types.mcp import DEFAULT_SUBJECT_TOKEN_TYPE, MCPAuth
...
def raise_token_exchange_challenge(
    ...
    *,
    ...
    the client re-authenticates directly with the IdP, and DeRouter then exchanges the resulting token.
