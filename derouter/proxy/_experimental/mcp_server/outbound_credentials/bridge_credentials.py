...
A DCR-bridge ``oauth_delegate`` client presents ONE bearer that is a derouter-signed
envelope (see :mod:`.envelope`) carrying both a derouter identity and the upstream OAuth
...
_SIGNING_KEY_DOMAIN: Final = b"derouter-mcp-bridge:envelope-signing:"
_ENCRYPTION_KEY_DOMAIN: Final = b"derouter-mcp-bridge:envelope-encryption:"
