"""Cross-replica ``TokenCacheBackend``: stores the token in DeRouter's shared ``DualCache``.
...
class AsyncCache(Protocol):
    """The slice of DeRouter's ``DualCache`` this backend needs (Redis-backed, shared across workers)."""
