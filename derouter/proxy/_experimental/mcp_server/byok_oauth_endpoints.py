...
DeRouter runs a minimal OAuth 2.1 authorization code flow.  The "authorization page" is
...
from derouter.proxy._experimental.mcp_server.db import store_user_credential
...
<title>Connect {server_name} &mdash; DeRouter</title>
<style>
...
<div class="modal">
  ...
  <div id="s1" class="step show">
    ...
    <div class="logos">
      <img src="/ui/assets/logos/derouter_logo.jpg" class="logo-img" alt="DeRouter">
      <span class="logo-arrow">&#8594;</span>
      <div class="logo logo-s">{server_initial}</div>
    </div>

    <h2 class="step-title">Connect {server_name} MCP</h2>
    <p class="step-subtitle">DeRouter needs access to {server_name} to complete your request.</p>
    ...
    <div class="info-box">
      ...
      <div>
        <h4>How it works</h4>
        <p>DeRouter acts as a secure bridge. Your requests are routed through our MCP client directly to {server_name}&rsquo;s API.</p>
      </div>
    </div>
...
async def byok_token(
    ...
    """
    from derouter.proxy.proxy_server import master_key, prisma_client
