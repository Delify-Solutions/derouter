"""
Sensitive Data Routing Hook for DeRouter Proxy.
...
from derouter.integrations.custom_guardrail import get_session_id_from_request_data
...
class _PROXY_SensitiveDataRoutingHandler(CustomLogger):
    ...
    def __init__(self, internal_usage_cache: InternalUsageCache):
        ...
        self.ttl = int(
            os.getenv(
                "DEROUTER_SENSITIVE_ROUTING_TTL",
