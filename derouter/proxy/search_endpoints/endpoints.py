...
async def search(
    ...
    ```bash
    curl -X POST "http://localhost:4000/v1/search/derouter-search" \
    ...
    if "search_tool_name" in data and data["search_tool_name"]:
        ...
        if llm_router is not None and hasattr(llm_router, "search_tools"):
            ...
            if matching_tools:
                ...
                search_provider: Final = search_tool.get("derouter_params", {}).get("search_provider")
    ...
    # add_derouter_data_to_request() also injects these values, but this keeps
        ...
        if llm_router is not None and hasattr(llm_router, "search_tools"):
            for tool in llm_router.search_tools:
                tool_info = {
                    ...
                    "search_provider": tool.get("derouter_params", {}).get("search_provider"),
                }
