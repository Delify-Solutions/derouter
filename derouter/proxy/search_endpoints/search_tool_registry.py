...
from derouter.repositories.table_repositories import SearchToolsRepository
from derouter.types.search import SearchTool
...
class SearchToolRegistry:
    ...
    async def add_search_tool_to_db(self, search_tool: SearchTool, prisma_client: PrismaClient):
        ...
        try:
            ...
            derouter_params: Final[str] = safe_dumps(dict(search_tool.get("derouter_params", {})))
