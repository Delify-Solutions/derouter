...
from derouter.proxy.utils import handle_exception_on_proxy, jsonify_object
from derouter.repositories.credentials_repository import CredentialsRepository
from derouter.types.utils import CreateCredentialItem, CredentialItem
...
async def delete_credential(
    ...
    try:
        ...
        ## DELETE FROM DEROUTER ##
        derouter.credential_list = [cred for cred in derouter.credential_list if cred.credential_name != credential_name]
...
async def update_credential(
    ...
    try:
        ...
        for cred in derouter.credential_list:
        ...
        if existing_in_memory is not None:
            ...
            if new_name != credential_name:
                derouter.credential_list = [c for c in derouter.credential_list if c.credential_name != credential_name]
