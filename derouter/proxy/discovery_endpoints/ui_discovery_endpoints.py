...
from derouter.types.proxy.discovery_endpoints.ui_discovery_endpoints import (
...
@router.get("/.well-known/derouter-ui-config", response_model=UiDiscoveryEndpoints)
@router.get("/derouter/.well-known/derouter-ui-config", response_model=UiDiscoveryEndpoints)  # if mounted at root path
async def get_ui_config():
    ...
    from derouter.proxy.utils import get_proxy_base_url, get_server_root_path
