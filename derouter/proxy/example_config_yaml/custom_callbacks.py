...
class MyCustomHandler(CustomLogger):
    def __init__(self):
        ...
        print_verbose(f"{blue_color_code}Initialized DeRouter custom logger")
        try:
    ...
    async def async_log_success_event(self, kwargs, response_obj, start_time, end_time):
        ...
        response_cost: Final = derouter.completion_cost(completion_response=response_obj)
...
# need to set derouter.callbacks = [customHandler] # on the proxy

# derouter.success_callback = [async_on_succes_logger]
