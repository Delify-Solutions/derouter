...
from derouter.proxy.proxy_server import DualCache, UserAPIKeyAuth
from derouter.types.utils import CallTypesLiteral


# This file includes the custom callbacks for DeRouter Proxy
# Once defined, these can be passed in proxy_config.yaml
class MyCustomHandler(CustomLogger):  # https://router.delify.vn/docs/observability/custom_callback#callback-class
