...
Canonical definition for ``derouter_verificationtoken``. Re-exported from
...
class DeRouter_VerificationToken(DeRouterPydanticObjectBase):
    token: str | None = None
    ...
    derouter_budget_table: dict | None = None
...
class DeRouter_DeletedVerificationToken(DeRouter_VerificationToken):
