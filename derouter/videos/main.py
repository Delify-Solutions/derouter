...
import derouter
from derouter.constants import DEFAULT_VIDEO_ENDPOINT_MODEL
...
from derouter.types.utils import CallTypes, FileTypes
from derouter.types.videos.main import (
    CharacterObject,
...
def video_generation(
    ...
    **kwargs,
    ...
    try:
        ...
        derouter_logging_obj.call_type = CallTypes.create_video.value
...
def video_content(
    ...
    **kwargs,
    ...
    Example:
        ...
        video_bytes = derouter.video_content(
            video_id="video_123"
        )
...
def video_remix(
    ...
    **kwargs,
    ...
    try:
        ...
        derouter_logging_obj.call_type = CallTypes.video_remix.value
...
async def avideo_list(
    ...
    **kwargs,
    ...
    try:
        ...
        # get custom llm provider so we can use this for mapping exceptions
        if custom_llm_provider is None:
            _, custom_llm_provider, _, _ = derouter.get_llm_provider(model="", api_base=local_vars.get("api_base", None))
...
def video_list(
    ...
    **kwargs,
    ...
    try:
        ...
        derouter_logging_obj.call_type = CallTypes.video_list.value
...
def video_status(
    ...
    **kwargs,
    ...
    Example:
        ...
        # Get video status
        video_status = derouter.video_status(
            video_id="video_123"
        )
    ...
    try:
        ...
        derouter_logging_obj.call_type = CallTypes.video_retrieve.value
    ...
    **kwargs,
    ...
    try:
        ...
        derouter_logging_obj.update_environment_variables(
            ...
            derouter_params={"derouter_call_id": derouter_call_id, **request_params},
            custom_llm_provider=custom_llm_provider,
        )

        derouter_logging_obj.call_type = CallTypes.video_create_character.value
...
def video_get_character(
    ...
    **kwargs,
    ...
    try:
        ...
        derouter_logging_obj.call_type = CallTypes.video_get_character.value
...
def video_edit(
    ...
    **kwargs,
    ...
    try:
        ...
        derouter_logging_obj.call_type = CallTypes.video_edit.value
...
def video_extension(
    ...
    **kwargs,
    ...
    try:
        ...
        derouter_logging_obj.call_type = CallTypes.video_extension.value
