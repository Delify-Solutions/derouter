"""DeRouter SDK functions for managing vector store files."""
...
from derouter.vector_store_files.utils import VectorStoreFileRequestUtils
...
def _prepare_registry_credentials(
    *,
    ...
    if derouter.vector_store_registry is None:
        return
    try:
        registry_credentials: Final = derouter.vector_store_registry.get_credentials_for_vector_store(vector_store_id)
