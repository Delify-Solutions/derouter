...
Similar to derouter/derouter_core_utils/exception_mapping_utils.py but for Anthropic response format.
"""
...
class AnthropicExceptionMapping:
    ...
    Similar pattern to ExceptionCheckers in derouter_core_utils/exception_mapping_utils.py
    """
