...
class DeRouterResponsesInteractionsConfig:
        ...
        **kwargs: object,
        ...
        if input is not None:
            responses_request["input"] = (
                DeRouterResponsesInteractionsConfig._transform_interactions_input_to_responses_input(input)
            )
    ...
    def _transform_interactions_input_to_responses_input(
        ...
        if isinstance(input, list):
            transformed: Final = (
                [
                    DeRouterResponsesInteractionsConfig._transform_history_item(item)
                    for item in input
                    if DeRouterResponsesInteractionsConfig._is_history_item(item)
                ]
                if any(DeRouterResponsesInteractionsConfig._is_history_item(item) for item in input)
                else [
                    {
                        "role": "user",
                        "content": DeRouterResponsesInteractionsConfig._transform_content_array(input, "user"),
                    }
                ]
            )
        ...
        if isinstance(input, dict):
            ...
            return cast(
                ...
                [
                    {
                        "role": "user",
                        "content": DeRouterResponsesInteractionsConfig._transform_content_array(content_items, "user"),
                    }
                ],
            )
    ...
    def _transform_history_item(item: object) -> Mapping[str, object]:
        ...
        role: Final = DeRouterResponsesInteractionsConfig._responses_role(fields)
        ...
        return {
            "role": role,
            "content": DeRouterResponsesInteractionsConfig._transform_content_array(content_items, role),
        }
    ...
    def _transform_content_array(content: Sequence[object], role: str) -> Sequence[Mapping[str, object]]:
        ...
        return [DeRouterResponsesInteractionsConfig._transform_content_item(item, role) for item in content]
    ...
    def _transform_content_item(item: object, role: str) -> Mapping[str, object]:
        ...
        if isinstance(item, BaseModel):
            return DeRouterResponsesInteractionsConfig._transform_content_item(item.model_dump(exclude_none=True), role)
