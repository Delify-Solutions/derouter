...
class DeRouterResponsesInteractionsStreamingIterator:
    """
    ...
    def __init__(
        self,
        model: str,
        derouter_custom_stream_wrapper: BaseResponsesAPIStreamingIterator,
        ...
        self.model = model
        self.responses_stream_iterator = derouter_custom_stream_wrapper
        self.request_input = request_input
        self.optional_params = optional_params
        self.custom_llm_provider = custom_llm_provider
        self.derouter_metadata = derouter_metadata or {}
        self.finished = False
        self.collected_text = ""
        ...
        self._use_legacy: bool = derouter.use_legacy_interactions_schema
