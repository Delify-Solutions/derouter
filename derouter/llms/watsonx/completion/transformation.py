...
from derouter.types.llms.watsonx import WatsonXAIEndpoint
from derouter.types.utils import GenericStreamingChunk, ModelResponse, Usage
from derouter.utils import map_finish_reason
...
class IBMWatsonXAIConfig(IBMWatsonXMixin, BaseConfig):
    ...
    max_new_tokens: int | None = None  # derouter.max_tokens
