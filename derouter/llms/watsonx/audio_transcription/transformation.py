...
import derouter
from derouter.derouter_core_utils.audio_utils.utils import process_audio_file
from derouter.types.llms.openai import (
    AllMessageValues,
    OpenAIAudioTranscriptionOptionalParams,
)
from derouter.types.llms.watsonx import WatsonXAudioTranscriptionRequestBody
...
class IBMWatsonXAudioTranscriptionConfig(IBMWatsonXMixin, OpenAIWhisperAudioTranscriptionConfig):
    ...
    def get_complete_url(
        ...
        api_version: Final = optional_params.get("api_version", None) or derouter.WATSONX_DEFAULT_API_VERSION
