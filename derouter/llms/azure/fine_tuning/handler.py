...
from derouter.llms.openai.fine_tuning.handler import (
    OpenAIFineTuningAPI,
    _derouter_fine_tuning_job_from_response,
)
...
class AzureOpenAIFineTuningAPI(OpenAIFineTuningAPI, BaseAzureLLM):
    ...
    async def acreate_fine_tuning_job(
        ...
        return _derouter_fine_tuning_job_from_response(response, is_azure=True)
    ...
    ) -> DeRouterFineTuningJob | Coroutine[Any, Any, DeRouterFineTuningJob]:
