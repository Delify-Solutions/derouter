...
_RESPONSE_COST_HEADER: Final = "llm_provider-x-derouter-response-cost"
...
def _default_entra_token_minter() -> str:
    from derouter.secret_managers.get_azure_ad_token_provider import get_azure_ad_token_provider
...
class BingGroundingSearchConfig(BaseSearchConfig):
    ...
    def validate_environment(
        ...
        **kwargs: object,  # kwargs-ok: BaseSearchConfig.validate_environment signature
        ...
        a second time after ``derouter/search/main.py`` already did, so it has to be idempotent.
        """
