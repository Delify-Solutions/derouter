...
class AzureOpenAIResponsesAPIConfig(OpenAIResponsesAPIConfig):
    ...
    def get_complete_url(
        ...
        - api_base: Base URL, e.g.,
            ...
            OR
            "https://derouter8397336933.openai.azure.com/openai/responses?api-version=2024-05-01-preview"
        - model: Model name.
    ...
    def transform_cancel_response_api_response(
        ...
        try:
            ...
            from derouter.llms.azure.chat.gpt_transformation import AzureOpenAIError
