...
from derouter.llms.openai.chat.gpt_5_transformation import (
    OpenAIGPT5Config,
    _get_effort_level,
            ...
            if derouter.drop_params is True or (drop_params is not None and drop_params is True):
                ...
                raise UnsupportedParamsError(
                    ...
                    message=(
                        ...
                        "To drop this parameter, set `derouter.drop_params=True` or for proxy:\n\n"
                        "`derouter_settings:\n drop_params: true`\n"
                        "Issue: https://github.com/Delify-Solutions/derouter/issues/16704"
                    ),
                )
