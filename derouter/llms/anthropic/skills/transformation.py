...
from derouter.llms.base_llm.skills.transformation import (
    BaseSkillsAPIConfig,
    DeRouterLoggingObj,
)
...
class AnthropicSkillsConfig(BaseSkillsAPIConfig):
    ...
    def validate_environment(self, headers: dict, derouter_params: GenericDeRouterParams | None) -> dict:
        ...
        # Get API key from derouter_params if available
        api_key = None
        api_base = None
    ...
    def transform_list_skills_request(
        ...
        api_base: Final = AnthropicModelInfo.get_api_base(derouter_params.api_base if derouter_params else None)
