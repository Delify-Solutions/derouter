...
class DeRouterAnthropicToResponsesAPIAdapter:
    """
    ...
    def translate_responses_api_usage_to_anthropic_usage(
        ...
        return DeRouterAnthropicMessagesAdapter._translate_openai_usage_to_anthropic_usage(chat_usage)
    ...
    def translate_request(
        ...
        derouter.responses() / derouter.aresponses() kwargs.
        """
