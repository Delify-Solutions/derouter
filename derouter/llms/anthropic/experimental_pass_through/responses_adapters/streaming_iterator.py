...
from derouter.types.llms.anthropic_messages.anthropic_response import AnthropicUsage
    ...
    def _process_event(self, event: object) -> None:
        ...
        if event_type in (
            ...
            anthropic_usage: Final[AnthropicUsage] = (
                DeRouterAnthropicToResponsesAPIAdapter.translate_responses_api_usage_to_anthropic_usage(
