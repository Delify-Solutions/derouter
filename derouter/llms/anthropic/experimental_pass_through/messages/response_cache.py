...
CACHED_STREAM_EVENTS_KEY: Final = "derouter_cached_anthropic_sse_events"
...
class AnthropicMessagesStreamCacheWriter:
    ...
    async def _persist(self) -> None:
        if self.persisted or derouter.cache is None:
            return
...
class CachedAnthropicMessagesStreamIterator(BaseAnthropicMessagesStreamingIterator):
    def __init__(
        ...
        super().__init__(derouter_logging_obj=derouter_logging_obj, request_body=body)
        ...
        derouter_logging_obj.model_call_details["cache_hit"] = True
