...
from derouter.types.utils import AdapterCompletionStreamWrapper, Delta
...
class AnthropicStreamWrapper(AdapterCompletionStreamWrapper):
    ...
    def __init__(
        ...
        if derouter_logging_obj is not None:
            derouter_logging_obj.record_streamed_anthropic_message_id(self._message_id)
    ...
    def _merge_usage_into_held_stop_reason_chunk(self, chunk: Any) -> MessageBlockDelta:
        ...
        usage_dict: UsageDelta = DeRouterAnthropicMessagesAdapter._translate_openai_usage_to_anthropic_usage_delta(
            chunk.usage
        )
    ...
    def __next__(self):
        ...
        try:
            ...
            for chunk in self.completion_stream:
                ...
                processed_chunk = DeRouterAnthropicMessagesAdapter().translate_streaming_openai_response_to_anthropic(
                    response=chunk,
    ...
    def _should_start_new_content_block(self, chunk: "ModelResponseStream") -> bool:
        ...
        if block_type == "tool_use":
            ...
            from derouter.types.llms.anthropic import ToolUseBlock
