...
def derouter_logging_obj_from_kwargs(kwargs: Mapping[str, object]) -> "DeRouterLoggingObject | None":
    ...
    candidate: Final = kwargs.get("derouter_logging_obj")
...
def is_reasoning_auto_summary_enabled() -> bool:
    ...
    return derouter.reasoning_auto_summary or os.getenv("DEROUTER_REASONING_AUTO_SUMMARY", "false").lower() == "true"
