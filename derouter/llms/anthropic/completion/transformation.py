...
class AnthropicTextConfig(BaseConfig):
    ...
    max_tokens_to_sample: int | None = derouter.max_tokens  # anthropic requires a default
    ...
    def transform_request(
        ...
        ## Load Config
        config: Final = derouter.AnthropicTextConfig.get_config()
    ...
    def map_openai_params(
        ...
        for param, value in non_default_params.items():
            ...
            if param == "stop" and (isinstance(value, str) or isinstance(value, list)):
                _value = derouter.AnthropicConfig()._map_stop_sequences(value)
    ...
    def _get_anthropic_text_prompt_from_messages(self, messages: list[AllMessageValues], model: str) -> str:
        custom_prompt_dict: Final = derouter.custom_prompt_dict
