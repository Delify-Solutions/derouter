...
from derouter.types.utils import CallTypes, LlmProviders, ModelResponse
        ...
        try:
            ...
            model_response.choices = [
                derouter.Choices(
                    finish_reason="stop",
                    index=0,
                    message=derouter.Message(content="", role="assistant"),
                )
            ]
            ...
            logging_obj: Final = Logging(
                ...
                derouter_call_id="batch_" + str(uuid.uuid4()),
                function_id="batch_processing",
                derouter_trace_id=str(uuid.uuid4()),
