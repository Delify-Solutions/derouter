...
from derouter.types.llms.openai import AllMessageValues, CreateBatchRequest
from derouter.types.utils import DeRouterBatch, LlmProviders, ModelResponse
...
class AnthropicBatchesConfig(BaseBatchesConfig):
    ...
    def transform_create_batch_response(
        ...
        """
        Transform Anthropic MessageBatch creation response to DeRouter format.
    ...
    def transform_retrieve_batch_response(
        ...
        """Transform Anthropic MessageBatch retrieval response to DeRouter format."""
        try:
