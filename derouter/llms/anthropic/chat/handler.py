...
from derouter.rust_bridge import chat_completions as rust_chat_completions_bridge
from derouter.rust_bridge.chat_completions import rust_chat_completions_accepts
...
async def make_call(
    ...
    if client is None:
        client = derouter.module_level_aclient
...
def make_sync_call(
    ...
    if client is None:
        client = derouter.module_level_client  # re-use a module level client
...
class AnthropicChatCompletion(BaseLLM):
    ...
    async def acompletion_stream_function(
        ...
        completion_stream, headers = await make_call(
            ...
            tool_name_reverse_map=(
                derouter_params.get(ANTHROPIC_TOOL_NAME_REVERSE_MAP_KEY) if isinstance(derouter_params, dict) else None
            ),
        )
    ...
    async def acompletion_function(
        ...
        async_handler: Final = client or get_async_httpx_client(llm_provider=derouter.LlmProviders.ANTHROPIC)
        ...
        if acompletion is True:
            ...
            if (
                ...
                completion_stream, headers = make_sync_call(
                    ...
                    speed=optional_params.get("speed") if optional_params else None,
                    tool_name_reverse_map=(
                        derouter_params.get(ANTHROPIC_TOOL_NAME_REVERSE_MAP_KEY)
...
class ModelResponseIterator:
    def __init__(
        ...
        # See: https://github.com/Delify-Solutions/derouter/issues/17473
        ...
        # See: https://github.com/Delify-Solutions/derouter/issues/17254
            ...
            if type_chunk == "content_block_delta":
                ...
                if content_block_start["content_block"]["type"] == "text":
                    ...
                    if content_type == "web_search_tool_result":
                        ...
                        # The full content comes in content_block_start, not in deltas
                        # Fixes: https://github.com/Delify-Solutions/derouter/issues/18137
                        self.web_search_results.append(content_block_start["content_block"])
                        provider_specific_fields["web_search_results"] = self.web_search_results
    ...
    def _handle_accumulated_json_chunk(self, data_str: str, is_final: bool = False) -> ModelResponseStream | None:
        ...
        across TCP packets. See: https://github.com/Delify-Solutions/derouter/issues/17473
