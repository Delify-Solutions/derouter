...
from derouter.llms.nvidia_nim.rerank.transformation import NvidiaNimRerankConfig
...
class NvidiaNimRankingConfig(NvidiaNimRerankConfig):
    ...
    ) -> dict:  # mutable-ok: DeRouter provider transforms return mutable request dictionaries
        """
    ...
    def transform_rerank_response(
        ...
        derouter_params: dict | None = None,  # mutable-ok: matches BaseRerankConfig's response contract
    ) -> RerankResponse:
        """
        ...
        resolved_derouter_params: Final = derouter_params or {}  # mutable-ok: the base transformer requires a dictionary
        ...
        response: Final = super().transform_rerank_response(
            ...
            derouter_params=resolved_derouter_params,
        )
