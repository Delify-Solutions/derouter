...
class NvidiaNimRerankConfig(BaseRerankConfig):
    ...
    def validate_environment(
        ...
        """
        if api_key is None:
            api_key = get_secret_str("NVIDIA_NIM_API_KEY") or derouter.api_key
    ...
    def transform_rerank_response(
        ...
        """
        Transform Nvidia NIM rerank response to DeRouter format.
        ...
        DeRouter expects (RerankResponse):
        {
            "results": [
                {
                    "index": 0,
        ...
        # Transform Nvidia NIM response to DeRouter format
