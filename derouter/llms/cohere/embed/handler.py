...
from derouter.types.llms.bedrock import CohereEmbeddingRequest
...
def validate_environment(api_key, headers: dict):
    ...
    if "request-source" not in existing_keys_lower:
        headers["Request-Source"] = "unspecified:derouter"
...
async def async_embedding(
    ...
    input: list,
    model_response: derouter.utils.EmbeddingResponse,
    ...
    if client is None:
        client = get_async_httpx_client(
            llm_provider=derouter.LlmProviders.COHERE,
