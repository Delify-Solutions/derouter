...
import derouter
from derouter.derouter_core_utils.prompt_templates.factory import cohere_messages_pt_v2
...
class CohereChatConfig(BaseConfig):
    ...
    def transform_request(
        ...
        ## Load Config
        for k, v in derouter.CohereChatConfig.get_config().items():
            if (
    ...
    def transform_response(
        ...
        if cohere_tools_response is not None and cohere_tools_response != []:
            ...
            _message: Final = derouter.Message(
