"""Cohere Parse (`POST /v2/parse`) exposed through DeRouter's OCR interface."""
...
from derouter.exceptions import BadRequestError, UnsupportedParamsError
...
from derouter.llms.cohere.common_utils import CohereError
...
def _requested_format(optional_params: Mapping[str, object] | None) -> OCRRequestFormat:
    if optional_params is None:
        return "derouter"
    return "native" if optional_params.get(OCR_REQUEST_FORMAT_PARAM) == "native" else "derouter"
