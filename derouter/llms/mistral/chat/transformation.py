...
from derouter.types.llms.mistral import MistralThinkingBlock, MistralToolCallMessage
...
class MistralConfig(OpenAIGPTConfig):
    ...
    def _transform_messages(
        ...
        - if `name` is passed, then drop it for mistral API: https://github.com/Delify-Solutions/derouter/issues/6696
    ...
    def _clean_tool_schema_for_mistral(cls, tools: list) -> list:
        ...
        from derouter.utils import _remove_json_schema_refs
    ...
    def _strip_output_only_fields(cls, message: AllMessageValues) -> AllMessageValues:
        ...
        DeRouter attaches to assistant responses. Mistral's input schema forbids
