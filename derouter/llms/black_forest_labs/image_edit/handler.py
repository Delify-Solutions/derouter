...
from derouter.types.utils import FileTypes, ImageResponse
...
class BlackForestLabsImageEdit:
    ...
    def image_edit(
        ...
        derouter_params: GenericDeRouterParams | dict,
    ...
    async def async_image_edit(
        ...
        if client is None:
            async_client = get_async_httpx_client(
                llm_provider=derouter.LlmProviders.BLACK_FOREST_LABS,
            )
        else:
            async_client = client
