...
class VertexSearchAPIVectorStoreConfig(BaseVectorStoreConfig, VertexBase):
    ...
    def get_complete_url(
        ...
        collection_id: Final = derouter_params.get("vertex_collection_id") or "default_collection"
        ...
        engine_id: Final = derouter_params.get("vertex_engine_id")
        if engine_id:
        ...
        datastore_id: Final = derouter_params.get("vector_store_id")
        if not datastore_id:
    ...
    def transform_search_vector_store_request(
        ...
        is_engine: Final = bool(derouter_params.get("vertex_engine_id"))
        ...
        derouter_logging_obj.model_call_details["query"] = request_body.get("query", query)
