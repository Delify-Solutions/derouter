...
from derouter.utils import ModelResponse
...
class VertexAIPartnerModels(VertexBase):
    ...
    def completion(
        ...
        try:
            ...
            from derouter.llms.anthropic.chat import AnthropicChatCompletion
            from derouter.llms.codestral.completion.handler import (
                CodestralTextCompletion,
            )
            from derouter.llms.openai_like.chat.handler import OpenAILikeChatHandler
        ...
        try:
            ...
            if "codestral" in model and derouter_params.get("text_completion") is True:
    ...
    async def count_tokens(
        ...
        Args:
            ...
            derouter_params: DeRouter parameters dict
        ...
        # Vertex on any DeRouter install without that extra. Stay SDK-free.
        try:
            ...
            # Prepare derouter_params with credentials
            _derouter_params: Final = derouter_params.copy()
            if vertex_project:
                _derouter_params["vertex_project"] = vertex_project
            if vertex_location:
                _derouter_params["vertex_location"] = vertex_location
            if vertex_credentials:
                _derouter_params["vertex_credentials"] = vertex_credentials
