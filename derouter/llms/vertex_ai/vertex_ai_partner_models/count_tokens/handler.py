...
class VertexAIPartnerModelsTokenCounter(VertexBase):
    ...
    async def handle_count_tokens_request(
        ...
        Args:
            ...
            derouter_params: DeRouter parameters containing credentials, project, location
        ...
        vertex_count_tokens_location: Final = derouter_params.get("vertex_count_tokens_location")
        vertex_location_raw: Final = self.get_vertex_ai_location(derouter_params)
