...
from derouter.types.llms.vertex_ai_gemini_transcription import (
...
class VertexGeminiAudioTranscriptionConfig(BaseAudioTranscriptionConfig, VertexBase):
    ...
    def validate_environment(
        ...
        vertex_params: Final = dict(derouter_params)
    ...
    def _resolve_project_id_from_credentials(self, derouter_params: Mapping[str, object]) -> str:
        vertex_params: Final = dict(derouter_params)
