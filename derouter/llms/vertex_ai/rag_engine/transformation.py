...
Handles transforming DeRouter's unified formats to Vertex AI RAG Engine API format.
"""
...
class VertexAIRAGTransformation(VertexBase):
    ...
    def transform_chunking_strategy_to_vertex_format(
        ...
        """
        Transform DeRouter's unified chunking_strategy to Vertex AI RAG format.

        DeRouter format (RAGChunkingStrategy):
            {
                "chunk_size": 1000,
                "chunk_overlap": 200,
                "separators": ["\n\n", "\n", " ", ""]
    ...
    def build_import_rag_files_request(
        ...
        Args:
            ...
            chunking_strategy: DeRouter unified chunking config
