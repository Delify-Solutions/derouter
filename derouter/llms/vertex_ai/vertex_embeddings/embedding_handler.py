...
from derouter.llms.vertex_ai.vertex_ai_non_gemini import VertexAIError
...
class VertexEmbedding(VertexBase):
    ...
    def embedding(
        ...
        vertex_request: Final[VertexEmbeddingRequest] = (
            derouter.vertexAITextEmbeddingConfig.transform_openai_request_to_vertex_embedding_request(
                input=input,
                optional_params=optional_params,
                model=model,
                derouter_params=derouter_params,
        ...
        model_response = derouter.vertexAITextEmbeddingConfig.transform_vertex_response_to_openai(
