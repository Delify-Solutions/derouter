...
from derouter.types.rerank import (
    RerankBilledUnits,
    RerankResponse,
    RerankResponseMeta,
...
class VertexAIRerankConfig(BaseRerankConfig, VertexBase):
    ...
    def get_complete_url(
        ...
        # Fallback to environment or derouter config
        project_id: Final = vertex_project or get_secret_str("VERTEXAI_PROJECT") or derouter.vertex_project

        if not project_id:
            raise ValueError(
                "Vertex AI project ID is required. Please set 'VERTEXAI_PROJECT', 'derouter.vertex_project', or pass 'vertex_project' parameter"
            )
    ...
    def transform_rerank_request(
        ...
        user_labels: Final = vertex_request_labels_from_derouter_params(derouter_params)
        if user_labels:
