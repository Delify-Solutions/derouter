...
import derouter
from derouter.constants import DEFAULT_GOOGLE_VIDEO_DURATION_SECONDS
...
from derouter.types.videos.main import VideoCreateOptionalRequestParams, VideoObject
...
if TYPE_CHECKING:
    ...
    from derouter.llms.base_llm.chat.transformation import (
...
class VertexAIVideoConfig(BaseVideoConfig, VertexBase):
    ...
    def validate_environment(
        ...
        derouter_params: GenericDeRouterParams | dict | None = None,
    ) -> dict:
        """
        ...
        # Use safe_get_* methods that don't mutate derouter_params dict
        # Ensure derouter_params is a dict for type checking
        params_dict: Final[dict[str, object]] = (
            cast(dict[str, object], derouter_params) if derouter_params is not None else {}
        )

        vertex_project: Final = VertexBase.safe_get_vertex_ai_project(derouter_params=params_dict)
        vertex_credentials: Final = VertexBase.safe_get_vertex_ai_credentials(derouter_params=params_dict)
    ...
    def get_complete_url(
        ...
        """
        vertex_project: Final = VertexBase.safe_get_vertex_ai_project(derouter_params)
        vertex_location = VertexBase.safe_get_vertex_ai_location(derouter_params)
    ...
    def transform_video_content_request(
        ...
        """
        return self.transform_video_status_retrieve_request(video_id, api_base, derouter_params, headers)
    ...
    def transform_video_create_character_request(self, name, video: object, api_base, derouter_params, headers):
    ...
    def transform_video_get_character_request(self, character_id, api_base, derouter_params, headers):
