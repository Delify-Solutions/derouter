...
from derouter.llms.vertex_ai.common_utils import VertexAIError, get_vertex_base_url
from derouter.llms.vertex_ai.gemini.vertex_and_google_ai_studio_gemini import VertexLLM
from derouter.llms.vertex_ai.vertex_llm_base import _graft_default_vertex_path
from derouter.types.llms.openai import CreateBatchRequest
...
class VertexAIBatchPrediction(VertexLLM):
    ...
    ) -> DeRouterBatch | Coroutine[object, object, DeRouterBatch]:
        if custom_endpoint:
            raise VertexAIError(
                status_code=400,
                message=(
