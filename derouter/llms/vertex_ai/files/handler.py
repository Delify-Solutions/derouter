...
from derouter.integrations.gcs_bucket.gcs_bucket_base import (
    GCSBucketBase,
    GCSLoggingConfig,
)
...
class VertexAIFilesHandler(GCSBucketBase):
    ...
    def _resolve_read_gcs_config(
        ...
        Sources them from the deployment's ``derouter_params`` (``gcs_bucket_name`` /
        ...
        """
        params: Final[Mapping[str, object]] = derouter_params or {}
    ...
    def _extract_bucket_and_object_from_file_id(
        ...
        Expected format: gs://bucket-name/derouter-vertex-files/path/to/file

        Returns:
            tuple: (bucket_name, object_path)
            - bucket_name: "bucket-name"
            - object_path: "derouter-vertex-files/path/to/file"
        """
    ...
    async def afile_content(
        ...
        return config.transform_file_content_response(
            raw_response=mock_response, logging_obj=logging_obj, derouter_params={}
        )
