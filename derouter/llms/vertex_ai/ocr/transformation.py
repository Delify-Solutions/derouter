...
from derouter.llms.base_llm.ocr.transformation import DocumentType, OCRRequestData
...
class VertexAIOCRConfig(MistralOCRConfig):
    ...
    def validate_environment(
        ...
        **kwargs,
        ...
        vertex_project: Final = VertexBase.safe_get_vertex_ai_project(derouter_params=derouter_params)
        vertex_credentials: Final = VertexBase.safe_get_vertex_ai_credentials(derouter_params=derouter_params)
    ...
    def get_complete_url(
        ...
        **kwargs,
        ...
        Args:
            ...
            derouter_params: DeRouter parameters containing vertex_project, vertex_location
        ...
        vertex_project: Final = VertexBase.safe_get_vertex_ai_project(derouter_params=derouter_params)
        vertex_location = VertexBase.safe_get_vertex_ai_location(derouter_params=derouter_params)
