...
from derouter.types.fine_tuning import OpenAIFineTuningHyperparameters
from derouter.types.llms.openai import FineTuningJobCreate
...
class VertexFineTuningAPI(VertexLLM):
    ...
    def convert_vertex_response_to_open_ai_response(self, response: ResponseTuningJob) -> DeRouterFineTuningJob:
