...
from derouter.derouter_core_utils.prompt_templates.image_handling import async_inline_remote_media
from derouter.llms.anthropic.chat.handler import ModelResponseIterator as AnthropicStreamParser
from derouter.llms.anthropic.chat.transformation import AnthropicConfig
from derouter.llms.anthropic.common_utils import normalize_cache_control_in_anthropic_payload
from derouter.types.llms.openai import AllMessageValues, ChatCompletionToolCallChunk, ChatCompletionToolMessage
...
class SnowflakeConfig(SnowflakeBaseConfig, OpenAIGPTConfig):
    ...
    async def async_transform_request(
        ...
        return self.transform_request(model, inlined_messages, optional_params, derouter_params, headers)
