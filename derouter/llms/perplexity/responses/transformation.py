...
from derouter.types.llms.openai import ResponseInputParam, ResponsesAPIResponse
...
class PerplexityResponsesConfig(OpenAIResponsesAPIConfig):
    ...
    def validate_environment(self, headers: dict, model: str, derouter_params: GenericDeRouterParams | None) -> dict:
        ...
        api_key: Final = (
            derouter_params.api_key or get_secret_str("PERPLEXITYAI_API_KEY") or get_secret_str("PERPLEXITY_API_KEY")
        )
        if api_key:
