...
from derouter.types.llms.openai import AllMessageValues, ChatCompletionAnnotation, ChatCompletionAnnotationURLCitation
...
class PerplexityChatConfig(OpenAIGPTConfig):
    ...
    def get_supported_openai_params(self, model: str) -> list:
        ...
        try:
            if derouter.supports_web_search(model=model, custom_llm_provider=self.custom_llm_provider):
    ...
    def _enhance_usage_with_perplexity_fields(self, model_response: ModelResponse, raw_response_json: dict) -> None:
        ...
        and add them to the usage object using standard DeRouter fields.
        """
