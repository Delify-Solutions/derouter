...
from derouter.types.llms.openrouter import OpenRouterErrorMessage
...
class OpenrouterConfig(OpenAIGPTConfig):
    def get_supported_openai_params(self, model: str) -> list:
        ...
        try:
            if derouter.supports_reasoning(model=model, custom_llm_provider="openrouter") or derouter.supports_reasoning(
                model=model
            ):
    ...
    def transform_request(
        ...
        response: Final = super().transform_request(model, messages, optional_params, derouter_params, headers)
        ...
        try:
            ...
            if "usage" in response_json and response_json["usage"]:
                ...
                if response_cost is not None:
                    ...
                    model_response._hidden_params["additional_headers"]["llm_provider-x-derouter-response-cost"] = float(
                        response_cost
                    )
        except Exception:
