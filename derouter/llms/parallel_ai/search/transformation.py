...
from derouter.llms.parallel_ai.search.cost_calculator import PARALLEL_AI_USAGE_PARAM
...
class ParallelAISearchConfig(BaseSearchConfig):
    ...
    def transform_search_request(
        ...
        **kwargs,
        ...
        # instead to keep v1beta's default tier (processor 'base') and derouter's
    ...
    def transform_search_response(
        ...
        **kwargs,
        ...
        """
        Transform Parallel AI v1 API response to DeRouter unified SearchResponse format.

        Parallel AI -> DeRouter mappings:
        ...
        - search_id / session_id / warnings are preserved as extra fields on the
          ...
          reserved for DeRouter's token-usage object)
        """
