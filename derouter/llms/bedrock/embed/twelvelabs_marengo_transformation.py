...
import derouter
from derouter.llms.bedrock.embed.twelvelabs_marengo_3_transformation import (
...
from derouter.types.utils import Embedding, EmbeddingResponse, PromptTokensDetailsWrapper, Usage
...
def drop_params_enabled(derouter_params: Mapping[str, object]) -> bool:
    return derouter.drop_params is True or derouter_params.get("drop_params") is True
