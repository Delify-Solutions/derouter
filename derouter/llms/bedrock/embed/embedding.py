...
import derouter
from derouter.constants import BEDROCK_EMBEDDING_PROVIDERS_LITERAL
from derouter.llms.cohere.embed.handler import embedding as cohere_embedding
...
class BedrockEmbedding(BaseAWSLLM):
    ...
    def _transform_response(
        ...
        if is_async_invoke and len(response_list) == 1 and "invocationArn" in response_list[0]:
            if provider == "twelvelabs":
                ...
                from derouter.types.utils import Embedding, Usage
        ...
        if provider == "cohere":
            ...
            for i in input:
                twelvelabs_request = TwelveLabsMarengoEmbeddingConfig(model=model)._transform_request(
                    ...
                    drop_params=drop_params_enabled(derouter_params),
                )
    ...
    async def _get_async_invoke_status(
        ...
        if logging_obj is not None:
            ...
            custom_curl = "\n\nGET Request Sent from DeRouter:\n"
