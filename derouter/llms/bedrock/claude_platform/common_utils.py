...
class BedrockClaudePlatformMixin(BaseAWSLLM):
    ...
    @staticmethod
    def _get_workspace_id(optional_params: dict, derouter_params: dict) -> str | None:
        workspace_id = (
            optional_params.get("workspace_id")
            or derouter_params.get("workspace_id")
            or optional_params.get("aws_workspace_id")
            or derouter_params.get("aws_workspace_id")
            or optional_params.get("anthropic-workspace-id")
            or derouter_params.get("anthropic-workspace-id")
        )
        if workspace_id is None:
            workspace_id = optional_params.get("anthropic_workspace_id") or derouter_params.get("anthropic_workspace_id")
