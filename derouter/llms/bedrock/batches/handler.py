...
class BedrockBatchesHandler:
    ...
    def cancel_batch(
        ...
        **kwargs: object,  # kwargs-ok: derouter.cancel_batch forwards arbitrary user kwargs verbatim
    ) -> "DeRouterBatch":
        try:
            import boto3
    ...
    def _handle_model_invocation_job_status(
        ...
        **kwargs,
        ...
        ``derouter/batches/main.py`` for the dispatch.
        ...
        Args:
            ...
            logging_obj: Optional derouter logging object.
        ...
        Returns:
            ``DeRouterBatch`` shaped like an OpenAI Batch resource.
        ...
        # `output_file_id` field on the DeRouterBatch itself does carry None
