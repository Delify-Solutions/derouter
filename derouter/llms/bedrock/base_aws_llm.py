...
from derouter.derouter_core_utils.aws_partition import contains_bedrock_arn, get_aws_dns_suffix
...
class BaseAWSLLM:
    ...
    def get_bedrock_model_id(
        ...
        if model_id is not None:
            ...
            model_id = model
            # Strip DeRouter routing prefixes (e.g. "bedrock/", "invoke/",
    ...
    def _get_aws_region_name(
        ...
        if aws_region_name is None:
            ...
            if (
                ...
                and derouter_aws_region_name is not None
                and isinstance(derouter_aws_region_name, str)
            ):
                aws_region_name = derouter_aws_region_name
    ...
    def get_aws_region_name_for_non_llm_api_calls(
        ...
        if aws_region_name is None:
            ...
            if derouter_aws_region_name is not None and isinstance(derouter_aws_region_name, str):
                aws_region_name = derouter_aws_region_name
    ...
    def _unverified_web_identity_audience(oidc_token: str) -> str | None:
        ...
        the audience DeRouter actually sent. The signature is never read, so no
        secret is exposed."""
    ...
    def _resolve_role_credentials(
        ...
        return self._auth_with_aws_role(
            ...
            aws_session_token=aws_session_token,
            aws_role_name=aws_role_name,
            aws_session_name=aws_session_name or f"derouter-session-{int(datetime.now().timestamp())}",
            aws_region_name=aws_region_name,
            aws_sts_endpoint=aws_sts_endpoint,
            aws_external_id=aws_external_id,
            ssl_verify=ssl_verify,
