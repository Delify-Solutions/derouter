...
Simplified handler leveraging existing DeRouter Bedrock infrastructure.
"""
...
from derouter.llms.bedrock.count_tokens.transformation import BedrockCountTokensConfig
...
class BedrockCountTokensHandler(BedrockCountTokensConfig):
    ...
    Uses existing DeRouter infrastructure for authentication and request handling.
    """
    ...
    async def handle_count_tokens_request(
        ...
        """
        Handle a CountTokens request using existing DeRouter patterns.

        Args:
            request_data: The incoming request payload
            derouter_params: DeRouter configuration parameters
        ...
        try:
            ...
            # Get AWS region using existing DeRouter function
            ...
            aws_bedrock_runtime_endpoint: Final = derouter_params.get("aws_bedrock_runtime_endpoint", None)
            ...
            api_key: Final = derouter_params.get("api_key", None)
            ...
            async_client: Final = get_async_httpx_client(llm_provider=derouter.LlmProviders.BEDROCK)
