...
class BedrockCountTokensConfig(BaseAWSLLM):
    ...
    def get_bedrock_count_tokens_endpoint(
        ...
        """
        Construct the AWS Bedrock CountTokens API endpoint using existing DeRouter functions.
        ...
        """
        # Use existing DeRouter function to get the base model ID (removes region prefix)
