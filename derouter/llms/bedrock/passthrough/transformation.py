...
class BedrockPassthroughConfig(BaseAWSLLM, BedrockModelInfo, BedrockEventStreamDecoderBase, BasePassthroughConfig):
    ...
    def get_complete_url(
        ...
        optional_params: Final = derouter_params.copy()
    ...
    def get_bedrock_bearer_token(self, derouter_params: Mapping[str, object]) -> str | None:
        return None
    ...
    def logging_non_streaming_response(
        ...
        derouter_model_response: Final[ModelResponse] = provider_chat_config.transform_response(
            model=model,
    ...
    def handle_logging_collected_chunks(
        ...
        from derouter.llms.bedrock.chat import get_bedrock_event_stream_decoder
