...
from derouter.types.integrations.rag.bedrock_knowledgebase import (
    BedrockKBContent,
    BedrockKBResponse,
...
class BedrockVectorStoreConfig(BaseVectorStoreConfig, BaseAWSLLM):
    ...
    def get_complete_url(self, api_base: str | None, derouter_params: dict) -> str:
        aws_region_name: Final = derouter_params.get("aws_region_name")
        endpoint_url, _ = self.get_runtime_endpoint(
            api_base=api_base,
            aws_bedrock_runtime_endpoint=derouter_params.get("aws_bedrock_runtime_endpoint"),
