...
from derouter.types.llms.openai import AllMessageValues, ChatCompletionAssistantToolCall
...
def handle_cohere_response(
    ...
    """Parse a non-streaming Cohere OCI response into a DeRouter ModelResponse."""
    try:
...
def handle_cohere_stream_chunk(
    ...
    """Parse a single Cohere SSE chunk into a DeRouter ModelResponseStream.
