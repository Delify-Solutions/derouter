...
from derouter.derouter_core_utils.prompt_templates.common_utils import extract_file_data
...
from derouter.types.files import TwoStepFileUploadConfig, TwoStepFileUploadRequest
...
class ManusFilesConfig(BaseFilesConfig):
    ...
    def validate_environment(
        ...
        """
        api_key = api_key or derouter.api_key or get_secret_str("MANUS_API_KEY")
    ...
    def get_complete_url(
        ...
        """
        api_base = api_base or derouter.api_base or get_secret_str("MANUS_API_BASE") or MANUS_API_BASE
    ...
    def transform_create_file_request(
        ...
        # Get API key
        api_key: Final = derouter_params.get("api_key") or derouter.api_key or get_secret_str("MANUS_API_KEY")
    ...
    def transform_create_file_response(
        ...
        For two-step uploads, the handler stores the initial response in derouter_params.
        ...
        """
        try:
            # For two-step uploads, get the initial response from derouter_params
            initial_response_data: Final = derouter_params.get("initial_file_response")
