...
class HuggingFaceEmbeddingConfig(BaseConfig):
    ...
    hf_task: hf_tasks | None = (
        None  # derouter-specific param, used to know the api spec to use when calling huggingface api
    )
    ...
    def transform_request(
        ...
        task: Final = derouter_params.get("task", None)
        ## VALIDATE API FORMAT
        ...
        ## Load Config
        config: Final = derouter.HuggingFaceEmbeddingConfig.get_config()
        ...
        if task == "conversational":
            ...
            if model in derouter.custom_prompt_dict:
                ...
                model_prompt_details = derouter.custom_prompt_dict[model]
