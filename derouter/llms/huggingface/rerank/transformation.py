...
class HuggingFaceRerankConfig(BaseRerankConfig):
    ...
    def transform_rerank_response(
        ...
        # Use standard derouter token counter for proper token estimation
    ...
    def get_api_credentials(
        ...
        final_api_key: Final = api_key or derouter.huggingface_key or get_secret_str("HUGGINGFACE_API_KEY")

        # Get API base from multiple sources
        final_api_base: Final = (
            api_base or derouter.api_base or get_secret_str("HF_API_BASE") or get_secret_str("HUGGINGFACE_API_BASE")
        )
