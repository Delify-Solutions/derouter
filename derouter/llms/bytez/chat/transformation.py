...
from derouter.derouter_core_utils.url_utils import encode_url_path_segments
...
# derouter/types/llms/openai.py is a good reference for what is supported
