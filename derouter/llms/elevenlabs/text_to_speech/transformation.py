...
class ElevenLabsTextToSpeechConfig(BaseTextToSpeechConfig):
    ...
    def _resolve_voice_id(
        ...
        if mapped_voice is None:
            raise ValueError("ElevenLabs voice_id is required. Pass `voice` when calling `derouter.speech()`.")
    ...
    def validate_environment(
        ...
        """
        api_key = api_key or derouter.api_key or derouter.openai_key or get_secret_str("ELEVENLABS_API_KEY")
    ...
    def _add_elevenlabs_specific_params(
        ...
        reserved_kwarg_keys: Final = set(all_derouter_params) | {
    ...
    def get_complete_url(
        ...
        voice_id: Final = derouter_params.get(self.ELEVENLABS_VOICE_ID_KEY)
        ...
        query_params: Final = derouter_params.get(self.ELEVENLABS_QUERY_PARAMS_KEY, {})
        if query_params:
