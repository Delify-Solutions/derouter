...
class AWSPollyTextToSpeechConfig(BaseTextToSpeechConfig, BaseAWSLLM):
    ...
    def dispatch_text_to_speech(
        ...
        **kwargs: object,
        ...
        # Update derouter_params with resolved values
        # Note: AWS credentials (aws_access_key_id, aws_secret_access_key, etc.)
        # are already in derouter_params_dict via get_derouter_params() in main.py
        derouter_params_dict["aws_region_name"] = aws_region_name
    ...
    def get_complete_url(
        ...
        aws_region_name: Final = derouter_params.get("aws_region_name", self.DEFAULT_REGION)
    ...
    def _sign_polly_request(
        ...
        credentials: Final = self.get_credentials(
            aws_access_key_id=derouter_params.get("aws_access_key_id"),
            aws_secret_access_key=derouter_params.get("aws_secret_access_key"),
            aws_session_token=derouter_params.get("aws_session_token"),
            aws_region_name=aws_region_name,
            aws_session_name=derouter_params.get("aws_session_name"),
            aws_profile_name=derouter_params.get("aws_profile_name"),
            aws_role_name=derouter_params.get("aws_role_name"),
            aws_web_identity_token=derouter_params.get("aws_web_identity_token"),
            aws_sts_endpoint=derouter_params.get("aws_sts_endpoint"),
            aws_external_id=derouter_params.get("aws_external_id"),
        )
