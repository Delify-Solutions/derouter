...
from derouter.llms.gigachat.chat.streaming import GigaChatModelResponseIterator
...
class GigaChatPassthroughConfig(BasePassthroughConfig):
    ...
    def validate_environment(
        ...
        """
        access_token: Final = get_access_token(credentials=api_key, derouter_params=derouter_params)
    ...
    def logging_non_streaming_response(
        ...
        if "completions" in endpoint:
            ...
            derouter_model_response: Final = provider_chat_config.transform_response(
                model=model,
                ...
                derouter_params={},  # mutable-ok: empty dict kwarg for transform_response
                api_key="",
        ...
        if "embeddings" in endpoint:
            ...
            derouter_embedding_response: Final[EmbeddingResponse] = (
                provider_embedding_config.transform_embedding_response(
                    ...
                    derouter_params={},  # mutable-ok: empty dict kwarg for transform_embedding_response
                )
            )

            return derouter_embedding_response
