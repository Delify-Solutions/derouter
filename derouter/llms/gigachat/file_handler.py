...
from derouter.llms.gigachat.utils import get_api_base
...
async def upload_file_async(
    ...
    try:
        ...
        # Get access token
        access_token: Final = await get_access_token_async(credentials=credentials, derouter_params=derouter_params)
