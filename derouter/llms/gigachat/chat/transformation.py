...
from derouter.llms.gigachat.utils import convert_usage, get_api_base
...
class GigaChatConfig(BaseConfig):
    ...
    def validate_environment(
        ...
        access_token: Final = get_access_token(credentials=credentials, derouter_params=derouter_params)
