...
from derouter.llms.gemini.image_usage_transformation import (
    transform_gemini_image_usage,
)
from derouter.secret_managers.main import get_secret_str
from derouter.types.llms.gemini import GeminiImageGenerationRequest
...
class GoogleImageGenConfig(BaseImageGenerationConfig):
    ...
    def transform_image_generation_response(
        ...
        """
        Transform Google AI Imagen response to derouter ImageResponse format
        """
        try:
