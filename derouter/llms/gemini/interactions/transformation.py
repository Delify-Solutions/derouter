...
- Legacy (Api-Revision: 2026-05-07): old `outputs` schema, controlled via
  derouter.use_legacy_interactions_schema = True. Remove flag after June 8, 2026.
"""
...
class GoogleAIStudioInteractionsConfig(BaseInteractionsAPIConfig):
    ...
    def validate_environment(
        ...
        if derouter_params:
            api_key: Final = GeminiModelInfo.get_api_key(derouter_params.get("api_key"))
            if api_key:
        ...
        if derouter.use_legacy_interactions_schema:
    ...
    def transform_request(
        ...
        """
        use_legacy: Final[bool] = derouter.use_legacy_interactions_schema
    ...
    def transform_get_interaction_request(
        ...
        if not GeminiModelInfo.get_api_key(derouter_params.api_key):
