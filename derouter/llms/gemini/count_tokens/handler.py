...
if TYPE_CHECKING:
    from derouter.types.google_genai.main import GenerateContentContentListUnionDict
else:
    ...
    async def acount_tokens(
        ...
        **kwargs,
        ...
        Raises:
            ...
            derouter.APIError: If the API call fails
            derouter.APIConnectionError: If the connection fails
        ...
        try:
            ...
            raise derouter.APIConnectionError(message=error_msg, llm_provider="gemini", model=model) from e
