...
def supports_gemini_image_size(model: str) -> bool:
    try:
        model_info: Final = derouter.get_model_info(model=model)
...
class GeminiModelInfo(BaseLLMModelInfo):
    ...
    def process_model_name(self, models: list[dict[str, str]]) -> list[str]:
        ...
        for model in models:
            ...
            derouter_model_name = "gemini/" + stripped_model_name
    ...
    def get_models(self, api_key: str | None = None, api_base: str | None = None) -> list[str]:
        ...
        derouter_model_names: Final = self.process_model_name(models)
        return derouter_model_names
