...
class GoogleGenAIConfig(BaseGoogleGenAIGenerateContentConfig, VertexLLM):
    ...
    def validate_environment(
        ...
        headers: dict | None,
        model: str,
        derouter_params: GenericDeRouterParams | dict | None,
    ) -> dict:
        default_headers: Final = {
            "Content-Type": "application/json",
        }
        # Use the passed api_key first, then fall back to derouter_params and environment
        gemini_api_key: Final = api_key or self._get_google_ai_studio_api_key(dict(derouter_params or {}))
    ...
    def _get_google_ai_studio_api_key(self, derouter_params: dict) -> str | None:
        return (
            derouter_params.pop("api_key", None)
            or derouter_params.pop("gemini_api_key", None)
    ...
    def _get_common_auth_components(
        ...
        """
        vertex_credentials: Final = self.get_vertex_ai_credentials(derouter_params)
    ...
    def _build_final_headers_and_url(
        ...
        """
        gemini_api_key: Final = self._get_google_ai_studio_api_key(derouter_params)
    ...
    def sync_get_auth_token_and_url(
        ...
        (
            ...
            vertex_project,
            vertex_location,
        ) = self._get_common_auth_components(derouter_params)
    ...
    def transform_generate_content_response(
        ...
        """
        from derouter.types.google_genai.main import GenerateContentResponse
