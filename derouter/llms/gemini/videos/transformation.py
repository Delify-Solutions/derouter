...
from derouter.types.llms.gemini import (
...
class GeminiVideoConfig(BaseVideoConfig):
    ...
    def validate_environment(
        ...
        if derouter_params and derouter_params.api_key:
            api_key = api_key or derouter_params.api_key

        api_key = api_key or derouter.api_key or get_secret_str("GOOGLE_API_KEY") or get_secret_str("GEMINI_API_KEY")
