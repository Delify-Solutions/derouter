...
class GithubCopilotConfig(OpenAIConfig):
    ...
    def _transform_messages(
        ...
        if derouter.disable_copilot_system_to_assistant:
    ...
    def validate_environment(
        ...
        validated_headers = super().validate_environment(
            headers, model, messages, optional_params, derouter_params, api_key, api_base
        )
    ...
    def transform_parsed_response_dict(self, parsed_response: dict) -> dict:
        ...
        transform_response. See: https://github.com/Delify-Solutions/derouter/issues/30927
        """
