...
from derouter.llms.openai.image_edit.transformation import ImageEditRequestUtils
from derouter.secret_managers.main import get_secret_str
from derouter.types.llms.openai import CreateVideoRequest
...
class OpenAIVideoConfig(BaseVideoConfig):
    ...
    def _decode_character_ids_in_create_video_request(self, request_dict: dict) -> dict:
        """
        Decode DeRouter-managed encoded character ids for provider requests.
