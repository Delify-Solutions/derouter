...
class OpenAIEmbeddingsHandler(BaseTranslation):
    ...
    async def process_input_messages(
        ...
        if isinstance(input_data, str):
            data = await self._process_string_input(data, input_data, guardrail_to_apply, derouter_logging_obj)
        elif isinstance(input_data, list):
            data = await self._process_list_input(data, input_data, guardrail_to_apply, derouter_logging_obj)
        else:
