...
from derouter.types.llms.openai import AllMessageValues, OpenAITextCompletionUserMessage
from derouter.types.utils import Choices, Message, ModelResponse, TextCompletionResponse
    ...
    def convert_to_chat_model_response_object(
        ...
        try:
            ...
            model_response_object._hidden_params["original_response"] = (
                response_object  # track original response, if users make a derouter.text_completion() request, we can return the original response
            )
