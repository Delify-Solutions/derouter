...
# because DeRouterFineTuningJob schema has no intermediate cancellation state.
...
def _derouter_fine_tuning_job_from_response(response: FineTuningJob, is_azure: bool = False) -> DeRouterFineTuningJob:
    return DeRouterFineTuningJob(**_normalize_fine_tuning_job_dict(response.model_dump(), is_azure=is_azure))
...
class OpenAIFineTuningAPI:
    ...
    async def acreate_fine_tuning_job(
        ...
        return _derouter_fine_tuning_job_from_response(response)
