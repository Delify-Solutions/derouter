...
class OpenAIRealtimeHTTPConfig(BaseRealtimeHTTPConfig):
    def get_api_base(self, api_base: str | None, **kwargs) -> str:
        return api_base or derouter.api_base or get_secret_str("OPENAI_API_BASE") or "https://api.openai.com"

    def get_api_key(self, api_key: str | None, **kwargs) -> str:
        return api_key or derouter.api_key or derouter.openai_key or get_secret_str("OPENAI_API_KEY") or ""
