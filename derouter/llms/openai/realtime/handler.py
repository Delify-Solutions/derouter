...
This requires websockets, and is currently only supported on DeRouter Proxy.
"""
...
from ....derouter_core_utils.realtime_streaming import (
        ...
        try:
            ...
            if not openai_beta_realtime:
                verbose_logger.debug(
                    ...
                    "to the WebSocket headers sent to the DeRouter proxy."
                )
            ...
            async with websockets.connect(
                ...
                realtime_streaming: Final = RealTimeStreaming(
                    ...
                    request_data={"derouter_metadata": derouter_metadata or {}},
