...
import derouter
from derouter.secret_managers.main import get_secret_str, normalize_nonempty_secret_str
...
OPENAI_WIF_CLIENT_ID: Final = "derouter"
...
def resolve_openai_workload_identity_config(
    ...
    effective_api_base: Final = (
        api_base or derouter.api_base or get_secret_str("OPENAI_BASE_URL") or get_secret_str("OPENAI_API_BASE")
    )
