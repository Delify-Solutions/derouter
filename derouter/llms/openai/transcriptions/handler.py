...
from derouter.derouter_core_utils.audio_utils.utils import get_audio_file_name
...
class OpenAIAudioTranscription(OpenAIChatCompletion):
    ...
    async def make_openai_audio_transcriptions_request(
        ...
        """
        Helper to:
        - call openai_aclient.audio.transcriptions.with_raw_response when derouter.return_response_headers is True
    ...
    def make_sync_openai_audio_transcriptions_request(
        ...
        """
        try:
            if derouter.return_response_headers is True:
