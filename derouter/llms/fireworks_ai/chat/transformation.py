...
from derouter.derouter_core_utils.prompt_templates.common_utils import unpack_legacy_defs
...
class FireworksAIConfig(FireworksAIMixin, OpenAIGPTConfig):
    ...
    def validate_environment(
        ...
        return self._add_session_affinity_header(validated_headers, derouter_params)
    ...
    def map_openai_params(
        ...
        for param, value in non_default_params.items():
            if param == "tool_choice":
                if value == "required":
                    # relevant issue: https://github.com/Delify-Solutions/derouter/issues/4416
    ...
    def _transform_messages_helper(
        self, messages: list[AllMessageValues], model: str, derouter_params: dict
    ...
    # Cached index of fireworks_ai/* entries from derouter.model_cost. Building
    ...
    def _get_fireworks_index(cls) -> list[tuple[str, dict]]:
        model_cost: Final = derouter.model_cost
    ...
    def _get_model_cost_capability_exact(self, model: str, capability: str) -> bool | None:
        ...
        for candidate_key in candidate_keys:
            model_info = derouter.model_cost.get(candidate_key)
    ...
    def transform_request(
        ...
        messages = self._transform_messages_helper(
            messages=messages, model=resolved_model, derouter_params=derouter_params
        )
    ...
    def _handle_message_content_with_tool_calls(
        ...
        Relevant Issue: https://github.com/Delify-Solutions/derouter/issues/7209#issuecomment-2813208780
        """
