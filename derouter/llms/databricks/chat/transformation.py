...
from derouter.derouter_core_utils.prompt_templates.common_utils import (
    strip_derouter_internal_message_fields,
    strip_name_from_message,
)
from derouter.llms.base_llm.base_model_iterator import BaseModelResponseIterator
from derouter.types.llms.anthropic import AllAnthropicToolsValues
from derouter.types.llms.databricks import (
...
class DatabricksConfig(DatabricksBase, OpenAILikeChatConfig, AnthropicConfig):
    ...
    def validate_environment(
        ...
        # This allows partners building on DeRouter to set their own telemetry
        ...
        custom_user_agent: Final = (
            ...
            or derouter_params.get("user_agent")
            or os.getenv("DEROUTER_USER_AGENT")
    ...
    def _transform_messages(
        ...
        - derouter's internal `thinking_blocks` / `reasoning_content` on assistant messages.
        """
        new_messages = []
        for idx, message in enumerate(messages):
            ...
            _message = strip_derouter_internal_message_fields(_message)
    ...
    def transform_response(
        ...
        _custom_llm_provider: Final = derouter_params.get("custom_llm_provider") or "databricks"
