...
class BaseResponsesAPIConfig(ABC):
    ...
    def supports_native_file_search(self) -> bool:
        ...
        DeRouter emulation (e.g. OpenAI, Azure OpenAI).
        """
        return False
    ...
    def should_fake_stream(
        ...
        """Returns True if derouter should fake a stream for the given model and stream value"""
        return False
    ...
    def get_websocket_url(
        ...
        """
        http_url: Final = self.get_complete_url(api_base=api_base, derouter_params=derouter_params)
