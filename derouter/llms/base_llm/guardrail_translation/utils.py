...
from derouter.types.llms.openai import AllMessageValues, ResponseAPIUsage
...
def effective_skip_system_message_for_guardrail(guardrail_to_apply: object) -> bool:
    ...
    return bool(getattr(derouter, "skip_system_message_in_guardrail", False))
...
def effective_skip_tool_message_for_guardrail(guardrail_to_apply: object) -> bool:
    ...
    return bool(getattr(derouter, "skip_tool_message_in_guardrail", False))
