...
class BaseBatchesConfig(ABC):
    ...
    must implement to work with DeRouter's unified batch processing system.
    """
    ...
    def transform_create_batch_response(
        ...
        """
        Transform provider-specific batch response to DeRouter format.
    ...
    def transform_retrieve_batch_response(
        ...
        """
        Transform provider-specific batch retrieval response to DeRouter format.
