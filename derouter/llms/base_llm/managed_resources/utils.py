...
def extract_target_model_names_from_unified_id(
    ...
    Example:
        unified_id = "derouter_proxy:vector_store;unified_id,uuid;target_model_names,gpt-4,gemini-2.0"
...
def extract_resource_type_from_unified_id(
    ...
    Example:
        unified_id = "derouter_proxy:vector_store;unified_id,uuid;..."
    ...
    try:
        ...
        match: Final = re.search(r"derouter_proxy:([^;]+)", unified_id)
        if match:
...
def extract_unified_uuid_from_unified_id(
    ...
    Example:
        unified_id = "derouter_proxy:vector_store;unified_id,abc-123;..."
        returns: "abc-123"
    """
    try:
        # Ensure unified_id is a string
...
def extract_model_id_from_unified_id(
    ...
    Example:
        unified_id = "derouter_proxy:vector_store;...;model_id,gpt-4-model-id;..."
...
def extract_provider_resource_id_from_unified_id(
    ...
    Example:
        unified_id = "derouter_proxy:vector_store;...;resource_id,vs_abc123;..."
        returns: "vs_abc123"
    """
    try:
        # Ensure unified_id is a string
...
def generate_unified_id_string(
    ...
    Example:
        ...
        returns: "derouter_proxy:vector_store;unified_id,abc-123;target_model_names,gpt-4,gemini;resource_id,vs_xyz;model_id,model-id-123"
    """
    # Build the unified ID string
    parts: Final = [
        f"derouter_proxy:{resource_type}",
...
def decode_unified_id(encoded_unified_id: str) -> str | None:
    ...
    try:
        ...
        if decoded.startswith("derouter_proxy:"):
            return decoded
...
def parse_unified_id(
    ...
    try:
        ...
        if not decoded_id:
            ...
            if unified_id.startswith("derouter_proxy:"):
