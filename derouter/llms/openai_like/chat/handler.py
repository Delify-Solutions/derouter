...
from derouter.llms.databricks.streaming_utils import ModelResponseIterator
...
from derouter.types.utils import CustomStreamingDecoder, ModelResponse
from derouter.utils import CustomStreamWrapper, ProviderConfigManager
...
def make_sync_call(
    ...
    if client is None:
        client = derouter.module_level_client  # Create a new client if none provided
