...
def create_config_class(provider: SimpleProviderConfig):
    ...
    class JSONProviderConfig(base_class):
        ...
        def get_supported_openai_params(self, model: str) -> list:
            ...
            from derouter.utils import supports_function_calling, supports_reasoning
...
def create_responses_config_class(provider: SimpleProviderConfig):
    ...
    from derouter.llms.openai_like.responses.transformation import (
    ...
    class JSONProviderResponsesConfig(OpenAILikeResponsesConfig):
        ...
        def validate_environment(
            ...
            api_key: Final = derouter_params.api_key or get_secret_str(provider.api_key_env)
            if api_key:
