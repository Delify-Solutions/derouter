"""
Prompt Injection Handler for DeRouter Skills
...
from derouter.proxy._types import DeRouter_SkillsTable
...
class SkillPromptInjectionHandler:
    ...
    def extract_skill_content(self, skill: DeRouter_SkillsTable) -> str | None:
        """
        ...
        Args:
            skill: The skill from DeRouter database
    ...
    def extract_all_files(self, skill: DeRouter_SkillsTable) -> dict[str, bytes]:
        """
    ...
    def convert_skill_to_tool(self, skill: DeRouter_SkillsTable) -> dict[str, Any]:
        """
        Convert a DeRouter skill to an OpenAI-style tool.
    ...
    def convert_skill_to_anthropic_tool(self, skill: DeRouter_SkillsTable) -> dict[str, Any]:
        """
        Convert a DeRouter skill to an Anthropic-style tool (messages API format).
