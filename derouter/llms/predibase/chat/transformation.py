...
class PredibaseConfig(BaseConfig):
    ...
    def transform_response(
        ...
        prompt_tokens = 0
        try:
            prompt_tokens = derouter.token_counter(messages=messages)
        except Exception:
    ...
    def transform_request(
        ...
        custom_prompt_dict: Final = derouter_params.get("custom_prompt_dict", {})
    ...
    def output_parser(generated_text: str) -> str:
        ...
        Initial issue that prompted this - https://github.com/Delify-Solutions/derouter/issues/763
        """
    ...
    def get_complete_url(
        ...
        tenant_id: Final = derouter_params.get("predibase_tenant_id") or derouter_params.get("tenant_id")
