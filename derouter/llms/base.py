...
if TYPE_CHECKING:
    ...
    from derouter.types.utils import ModelResponse, TextCompletionResponse
...
class BaseLLM:
    ...
    def create_client_session(self):
        if derouter.client_session:
            _client_session = derouter.client_session
        else:
    ...
    def create_aclient_session(self):
        if derouter.aclient_session:
            _aclient_session = derouter.aclient_session
        else:
