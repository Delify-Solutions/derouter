...
from derouter.llms.xai.cost_calculator import (
...
class XAIChatConfig(OpenAIGPTConfig):
    ...
    def validate_environment(
        ...
        dynamic_api_key: Final = XAIModelInfo.get_api_key(api_key)
        if should_use_xai_oauth(derouter_params) and not dynamic_api_key:
            try:
    ...
    def transform_request(
        ...
        """
        Handle https://github.com/Delify-Solutions/derouter/issues/9720
