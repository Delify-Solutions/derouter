...
from derouter.derouter_core_utils.url_utils import SSRFError, assert_same_origin, encode_url_path_segment
...
class AzureDocumentIntelligenceOCRConfig(BaseOCRConfig):
    ...
    def get_supported_ocr_params(self, model: str) -> list:
        ...
        `req_format` selects the response shape: "derouter" (default) returns
    ...
    async def _poll_operation_async(
        ...
        client: Final = get_async_httpx_client(llm_provider=derouter.LlmProviders.AZURE_AI)
        start_time: Final = time.time()
