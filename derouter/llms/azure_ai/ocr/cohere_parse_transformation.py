...
from derouter.llms.cohere.ocr.transformation import COHERE_PARSE_PATH, CohereParseConfig
    ...
    def validate_environment(
        ...
        **kwargs: object,  # kwargs-ok: BaseOCRConfig.validate_environment signature
        ...
        return {  # mutable-ok: BaseOCRConfig signature
            **get_azure_ai_auth_headers(api_key=resolved_key, derouter_params=derouter_params),
