...
class AzureAIAgentsConfig(BaseConfig):
    ...
    def transform_response(
        ...
        """
        Transform the Azure Agents response to DeRouter ModelResponse format.
        """
    ...
    def completion(
        ...
        from derouter.llms.azure_ai.agents.handler import azure_ai_agents_handler
        ...
        if api_key is None:
            ...
            # Create a GenericDeRouterParams with the scope override for Azure Foundry Agents
            azure_auth_params: Final = dict(derouter_params) if derouter_params else {}
            azure_auth_params["azure_scope"] = "https://ai.azure.com/.default"
            api_key = get_azure_ad_token(GenericDeRouterParams(**azure_auth_params))
