...
from derouter.llms.azure_ai.agents.transformation import (
    AzureAIAgentsConfig,
    AzureAIAgentsError,
)
...
class AzureAIAgentsHandler:
    ...
    def completion(
        ...
        if client is None:
            client = _get_httpx_client(params={"ssl_verify": derouter_params.get("ssl_verify", None)})
    ...
    async def acompletion(
        ...
        if client is None:
            client = get_async_httpx_client(
                llm_provider=derouter.LlmProviders.AZURE_AI,
    ...
    async def acompletion_stream(
        ...
        # Use DeRouter's async HTTP client for streaming
