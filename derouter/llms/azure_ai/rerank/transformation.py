...
from derouter.llms.cohere.rerank.transformation import CohereRerankConfig
...
class AzureAIRerankConfig(CohereRerankConfig):
    ...
    def validate_environment(
        ...
        if api_key is None:
            api_key = get_secret_str("AZURE_AI_API_KEY") or derouter.azure_key

        default_headers: Final = {
            **get_azure_ai_auth_headers(api_key=api_key, derouter_params=derouter_params),
