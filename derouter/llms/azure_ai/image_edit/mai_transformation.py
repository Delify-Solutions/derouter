...
from derouter.llms.azure_ai.image_generation.mai_transformation import (
...
if TYPE_CHECKING:
    from derouter.derouter_core_utils.logging import Logging as DeRouterLoggingObj
...
class AzureFoundryMAIImageEditConfig(OpenAIImageEditConfig):
    ...
    def get_complete_url(
        ...
        api_version: Final = derouter_params.get("api_version") or get_secret_str("AZURE_AI_API_VERSION") or "preview"
