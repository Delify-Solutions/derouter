...
class AzureFoundryFluxImageEditConfig(OpenAIImageEditConfig):
    ...
    def get_complete_url(
        ...
        - derouter_params: Additional parameters including api_version
        ...
        api_version = derouter_params.get("api_version") or derouter.api_version or get_secret_str("AZURE_AI_API_VERSION")
