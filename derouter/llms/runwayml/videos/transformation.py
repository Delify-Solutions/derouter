...
import derouter
from derouter.constants import RUNWAYML_DEFAULT_API_VERSION
...
class RunwayMLVideoConfig(BaseVideoConfig):
    ...
    def validate_environment(
        ...
        api_key = (
            api_key or derouter.api_key or get_secret_str("RUNWAYML_API_SECRET") or get_secret_str("RUNWAYML_API_KEY")
        )
    ...
    async def async_transform_video_content_response(
        ...
        async_httpx_client: Final[AsyncHTTPHandler] = get_async_httpx_client(
            llm_provider=derouter.LlmProviders.RUNWAYML,
        )
