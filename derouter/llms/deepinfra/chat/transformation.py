...
import derouter
from derouter.constants import MIN_NON_ZERO_TEMPERATURE
...
class DeepInfraConfig(OpenAIGPTConfig):
    ...
    def get_supported_openai_params(self, model: str):
        ...
        if derouter.supports_reasoning(
            model=model,
                ...
                if value != "auto" and value != "none":  # https://deepinfra.com/docs/advanced/function_calling
                    ...
                    if derouter.drop_params is True or drop_params is True:
                        ...
                        raise derouter.utils.UnsupportedParamsError(
                            message=f"Deepinfra doesn't support tool_choice={value}. To drop unsupported openai params from the call, set `derouter.drop_params = True`",
                            status_code=400,
                        )
