...
from derouter.llms.nvidia_riva.common_utils import NvidiaRivaException
...
_INSTALL_HINT = "Install Riva STT extras to enable automatic audio resampling: `pip install 'derouter[stt-nvidia-riva]'`"
    ...
    try:
        ...
        raise NvidiaRivaException(
            ...
            message=(
                ...
                f"(`pip install 'derouter[stt-nvidia-riva]'`) or convert your "
