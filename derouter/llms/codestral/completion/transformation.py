...
import derouter
from derouter.llms.openai.completion.transformation import OpenAITextCompletionConfig
from derouter.types.llms.databricks import GenericStreamingChunk
...
class CodestralTextCompletionConfig(OpenAITextCompletionConfig):
    ...
    def _chunk_parser(self, chunk_data: str) -> GenericStreamingChunk:
        ...
        chunk_data = derouter.CustomStreamWrapper._strip_sse_data_from_chunk(chunk_data) or ""
        ...
        original_chunk: Final = derouter.ModelResponseStream(**chunk_data_dict)
