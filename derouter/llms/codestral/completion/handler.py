...
from derouter.types.utils import TextChoices
from derouter.utils import CustomStreamWrapper, TextCompletionResponse
...
class CodestralTextCompletion:
    ...
    def process_text_completion_response(
        ...
        for choice in _original_choices:
            ...
            _choice = derouter.utils.TextChoices(
        ...
        _response: Final = derouter.TextCompletionResponse(
    ...
    def completion(
        ...
        ## Load Config
        config: Final = derouter.CodestralTextCompletionConfig.get_config()
    ...
    async def async_completion(
        ...
        async_handler: Final = get_async_httpx_client(
            llm_provider=derouter.LlmProviders.TEXT_COMPLETION_CODESTRAL,
