...
DeRouter Docs: https://router.delify.vn/docs/providers/aws_sagemaker#sagemaker-messages-api
...
class SagemakerChatConfig(OpenAIGPTConfig, BaseAWSLLM):
    ...
    def transform_request(
        ...
        derouter_params: dict,  # mutable-ok: matches the base chat transform signature
        ...
        served_model_name: Final = derouter_params.get("hf_model_name")
