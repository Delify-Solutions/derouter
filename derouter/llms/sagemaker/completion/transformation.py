...
class SagemakerConfig(BaseConfig):
    ...
    def transform_request(
        ...
        custom_prompt_dict: Final = derouter_params.get("custom_prompt_dict", None) or derouter.custom_prompt_dict
    ...
    async def async_transform_request(
        ...
        return await asyncify(self.transform_request)(model, messages, optional_params, derouter_params, headers)
    ...
    def transform_response(
        ...
        try:
            ...
            raise SagemakerError(
                message=f"DeRouter Error: Unable to parse sagemaker RAW RESPONSE {json.dumps(completion_response)}",
                status_code=500,
            )
