...
from derouter.types.utils import StreamingChatCompletionChunk
...
def _load_sagemaker_response_stream_shape():
    try:
        ...
        verbose_logger.warning(
            "derouter: could not load sagemaker-runtime response stream shape "
        ...
        for chunk in iterator:
            ...
            for event in event_stream_buffer:
                ...
                if message:
                    ...
                    message = derouter.CustomStreamWrapper._strip_sse_data_from_chunk(message) or ""
