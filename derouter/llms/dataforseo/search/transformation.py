...
from derouter.constants import DEFAULT_DATAFORSEO_LOCATION_CODE
...
class DataForSEOSearchConfig(BaseSearchConfig):
    ...
    def transform_search_response(
        ...
        **kwargs,
        ...
        """
        Transform DataForSEO SERP API response to DeRouter unified SearchResponse format.

        DataForSEO → DeRouter mappings:
