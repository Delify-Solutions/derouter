...
DeRouter supports the re rank API format, no paramter transformation occurs
"""

from typing import Any, Final

import derouter
from derouter.llms.base import BaseLLM
from derouter.llms.custom_httpx.http_handler import (
    _get_httpx_client,
    get_async_httpx_client,
)
from derouter.llms.together_ai.rerank.transformation import TogetherAIRerankConfig
from derouter.types.rerank import RerankRequest, RerankResponse
...
class TogetherAIRerank(BaseLLM):
    ...
    async def async_rerank(  # New async method
        ...
        client: Final = get_async_httpx_client(llm_provider=derouter.LlmProviders.TOGETHER_AI)  # Use async client
