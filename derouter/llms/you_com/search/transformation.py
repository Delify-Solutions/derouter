...
class YouComSearchConfig(BaseSearchConfig):
    ...
    def validate_environment(
        ...
        **kwargs,
        ...
        # decoder rejects, which surfaces as httpx.DecodingError through derouter's
    ...
    def transform_search_response(
        ...
        **kwargs,
        ...
        """
        Transform You.com API response to DeRouter unified SearchResponse format.

        You.com → DeRouter mappings (for both `results.web[]` and `results.news[]`):
