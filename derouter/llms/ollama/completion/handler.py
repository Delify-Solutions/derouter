...
def _process_ollama_embedding_response(
    ...
    model_response.usage = derouter.Usage(
...
async def ollama_aembeddings(
    ...
    response: Final = await derouter.module_level_aclient.post(url=api_base, json=data)
...
def ollama_embeddings(
    ...
    response: Final = derouter.module_level_client.post(url=api_base, json=data)
    response_json: Final[OllamaEmbeddingResponse] = response.json()
