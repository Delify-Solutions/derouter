...
from derouter.types.llms.ollama import (
...
class OllamaChatConfig(BaseConfig):
    ...
    def map_openai_params(
        ...
        for param, value in non_default_params.items():
            ...
            # Fixes: https://github.com/Delify-Solutions/derouter/issues/18922
            if param == "tools":
    ...
    def transform_request(
        ...
        derouter_params["function_name"] = function_name
        ...
        for m in messages:
            if isinstance(
                m, BaseModel
            ):  # avoid message serialization issues - https://github.com/Delify-Solutions/derouter/issues/5319
    ...
    def transform_response(
        ...
        if (
            ...
            and derouter_params.get("function_name") is not None
            and response_json_message is not None
        ):
            function_call: Final = json.loads(response_json_message["content"])
            message: Final = derouter.Message(
                content=None,
                tool_calls=[
                    {
                        "id": f"call_{uuid.uuid4()}",
                        "function": {
                            "name": function_call.get("name", derouter_params.get("function_name")),
            ...
            _message: Final = derouter.Message(**response_json_message)
        ...
        prompt_tokens = response_json.get("prompt_eval_count", derouter.token_counter(messages=messages))
        completion_tokens: Final = response_json.get(
            "eval_count",
            derouter.token_counter(text=response_json["message"]["content"]),
        )
        setattr(
            model_response,
            "usage",
    ...
    def chunk_parser(self, chunk: dict) -> ModelResponseStream:
        try:
            ...
            if chunk["done"] is True:
                ...
                # Fixes: https://github.com/Delify-Solutions/derouter/issues/18922
                # Fixes: https://github.com/Delify-Solutions/derouter/issues/34692
