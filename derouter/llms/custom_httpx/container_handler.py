"""
Generic container file handler for DeRouter.
...
class EndpointConfig(TypedDict):
    """One endpoint entry of ``derouter/containers/endpoints.json``."""
...
class EndpointsConfig(TypedDict):
    """The parsed ``derouter/containers/endpoints.json`` document."""
...
def _sync_http_client(
    ...
    if client is None or not isinstance(client, HTTPHandler):
        return _get_httpx_client(params={"ssl_verify": derouter_params.get("ssl_verify", None)})
    return client
...
class GenericContainerHandler:
    ...
    def handle(
        ...
        **kwargs: object,
        ...
        Args:
            ...
            derouter_params: DeRouter parameters including api_key, api_base
    ...
    def _sync_handle(
        ...
        **kwargs: object,
        ...
        # Get HTTP client
        http_client: Final = _sync_http_client(client, derouter_params)

        # Build request
        headers = _request_headers(container_provider_config, extra_headers, derouter_params)
        if extra_headers:
            headers.update(extra_headers)

        api_base: Final = _request_api_base(container_provider_config, derouter_params)
    ...
    async def _async_handle(
        ...
        **kwargs: object,
        ...
        # Get HTTP client
        http_client: Final = _async_http_client(client, derouter_params)
