...
from derouter.types.utils import HttpHandlerRequestFields, ImageResponse, LlmProviders
from derouter.utils import CustomStreamWrapper, ModelResponse, ProviderConfigManager
...
class BaseLLMAIOHTTPHandler:
    def __init__(
        ...
        transport: DeRouterAiohttpTransport | None = None,
    ...
    def _get_or_create_transport(self) -> DeRouterAiohttpTransport | None:
    ...
    def image_variations(
        ...
        if derouter_params.get("async_call", False):
