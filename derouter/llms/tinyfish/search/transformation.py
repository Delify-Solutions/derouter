...
class TinyfishSearchConfig(BaseSearchConfig):
    ...
    def transform_search_request(
        ...
        **kwargs: object,
        ...
        """
        Transform a DeRouter search request to TinyFish's querystring format.

        Maps DeRouter's unified-spec params (see
    ...
    def transform_search_response(
        ...
        **kwargs: object,
        ...
        """
        Transform a TinyFish response to DeRouter's unified ``SearchResponse``.
        ...
        try:
            ...
            raise self._wrap_error(
                error_message=(f"Response shape does not match DeRouter's SearchResponse schema: {e}"),
                status_code=raw_response.status_code,
                headers=dict(raw_response.headers),
            )
    ...
    def _wrap_error(
        ...
        left to inherit from the base so it auto-picks-up any future DeRouter
        improvements. Trade-off: network failures (routed through DeRouter
