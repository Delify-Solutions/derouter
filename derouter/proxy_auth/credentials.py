...
class ProxyAuthHandler:
    ...
    Set this as derouter.proxy_auth to automatically inject auth headers
    into all requests to your DeRouter Proxy.
    ...
    Example:
        ...
        derouter.proxy_auth = ProxyAuthHandler(
            ...
            scope="api://my-derouter-proxy/.default"
        )
        derouter.api_base = "https://my-proxy.example.com"

        # Auth headers are now automatically injected
        response = derouter.completion(model="gpt-4", messages=[...])
    """
