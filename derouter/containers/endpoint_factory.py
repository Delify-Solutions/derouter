...
from derouter.containers.utils import decode_managed_container_id_for_request
    ...
    def endpoint_func(
        ...
        **kwargs,
        ...
        try:
            ...
            # Get provider config
            derouter_params = GenericDeRouterParams(**kwargs)
            # Strip DeRouter-managed container IDs before calling the provider API
