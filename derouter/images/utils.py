...
from derouter.types.files import FILE_MIME_TYPES, FileType
...
class ImageEditRequestUtils:
    ...
    def get_optional_params_image_edit(
        ...
        should_drop: Final = derouter.drop_params is True or drop_params is True
    ...
    def get_image_content_type(image_data: Any) -> str:
        """
        Detect the content type of image data using existing DeRouter utils.
