...
from derouter.constants import DEFAULT_MAX_REDIS_BATCH_CACHE_SIZE
...
class DualCache(BaseCache):
    ...
    def __init__(
        ...
        self.redis_batch_cache_expiry = (
            default_redis_batch_cache_expiry or derouter.default_redis_batch_cache_expiry or 10
        )
        self.default_in_memory_ttl = default_in_memory_ttl or derouter.default_in_memory_ttl
        self.default_redis_ttl = default_redis_ttl or derouter.default_redis_ttl
    ...
    def increment_cache(self, key, value: int, local_only: bool = False, **kwargs) -> int:
        ...
        try:
            ...
            verbose_logger.error("DeRouter Cache: Excepton async add_cache: %s", e)
            raise e
    ...
    async def async_set_cache(self, key, value, local_only: bool = False, **kwargs):
        ...
        try:
            ...
            verbose_logger.exception("DeRouter Cache: Excepton async add_cache: %s", e)
