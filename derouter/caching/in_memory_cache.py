...
from derouter.constants import MAX_SIZE_PER_ITEM_IN_MEMORY_CACHE_IN_KB
...
class InMemoryCache(BaseCache):
    def __init__(
        ...
        default_ttl: int
        | None = 600,  # default ttl is 10 minutes. At maximum derouter rate limiting logic requires objects to be in memory for 1 minute
