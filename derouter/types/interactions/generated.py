...
# ============================================================
# DeRouter-specific types (added manually after generation)
# ============================================================
#
...
class InteractionsAPIResponse(BaseDeRouterOpenAIResponseObject):
    """
    Response from the Interactions API.

    Wraps the API response with DeRouter-specific hidden params.
...
class InteractionsAPIStreamingResponse(BaseDeRouterOpenAIResponseObject):
    """
...
class DeleteInteractionResult(BaseDeRouterOpenAIResponseObject):
...
class CancelInteractionResult(BaseDeRouterOpenAIResponseObject):
