...
DEROUTER_PASS_THROUGH_CUSTOM_BODY_STATE_KEY: Final = "derouter_pass_through_custom_body"
...
DEROUTER_PASS_THROUGH_RAW_BODY_STATE_KEY: Final = "derouter_pass_through_raw_body"
...
# DeRouter-managed one. Keying off the resolved endpoint (not the request path) means a
...
DEROUTER_PASS_THROUGH_ENDPOINT_MARKER: Final = "__derouter_pass_through_endpoint__"
