...
class WebSearchInterceptionConfig(TypedDict, total=False):
    ...
    Used in proxy_config.yaml under derouter_settings:
        derouter_settings:
    ...
    """How many follow-up model calls one intercepted request may chain. If None, DeRouter's default of 3 applies."""
