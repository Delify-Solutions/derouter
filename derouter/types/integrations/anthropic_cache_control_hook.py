...
from derouter.types.llms.openai import ChatCompletionCachedContent

GATEWAY_INJECTED_CACHE_METADATA_KEY: Final = "derouter_gateway_injected_cache"
...
class CacheControlMessageInjectionPoint(TypedDict):
    ...
    _derouter_judged: NotRequired[bool]  # Internal: written back by derouter once the client cache_control judgment ran
    _derouter_openai_dialect: NotRequired[ReadOnly[bool]]
