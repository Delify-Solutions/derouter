...
from derouter.types.integrations.custom_logger import StandardCustomLoggerInitParams


class NewRelicInitParams(StandardCustomLoggerInitParams):
    """
    Params for initializing a New Relic logger on derouter
    """
...
NEWRELIC_METRIC_REQUESTS: Final = "derouter.requests"
NEWRELIC_METRIC_COST_USD: Final = "derouter.cost.usd"
NEWRELIC_METRIC_PROMPT_TOKENS: Final = "derouter.tokens.prompt"
NEWRELIC_METRIC_COMPLETION_TOKENS: Final = "derouter.tokens.completion"
NEWRELIC_METRIC_TOTAL_TOKENS: Final = "derouter.tokens.total"
NEWRELIC_METRIC_REQUEST_DURATION_MS: Final = "derouter.request.duration_ms"
