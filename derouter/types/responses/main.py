...
class GenericResponseOutputItemContentAnnotation(BaseDeRouterOpenAIResponseObject):
...
class OutputText(BaseDeRouterOpenAIResponseObject):
...
class OutputFunctionToolCall(BaseDeRouterOpenAIResponseObject):
...
class OutputImageGenerationCall(BaseDeRouterOpenAIResponseObject):
...
class OutputCodeInterpreterCallLog(BaseDeRouterOpenAIResponseObject):
...
class OutputCodeInterpreterCall(BaseDeRouterOpenAIResponseObject):
...
class CustomToolCallOutputItem(BaseDeRouterOpenAIResponseObject):
...
class GenericResponseOutputItem(BaseDeRouterOpenAIResponseObject):
    """
...
class DeleteResponseResult(BaseDeRouterOpenAIResponseObject):
    """
