...
class TeamListItem(DeRouter_TeamTable):
...
class TeamListResponse(BaseModel):
    ...
    teams: list[TeamListItem | DeRouter_TeamTable | DeRouter_DeletedTeamTable]
    total: int
    page: int
    page_size: int
    total_pages: int
...
class TeamMemberInfoResponse(DeRouter_TeamMembership):
