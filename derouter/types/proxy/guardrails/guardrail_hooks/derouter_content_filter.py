...
class ContentFilterCategoryConfig(BaseDeRouterOpenAIResponseObject):
    """
...
class LitellmContentFilterGuardrailConfigModel(GuardrailConfigModel):
    """
    Configuration model for DeRouter Content Filter guardrail.
    ...
    def ui_friendly_name() -> str:
        return "DeRouter Content Filter"
