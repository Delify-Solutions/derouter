...
class GenericGuardrailAPIOptionalParams(BaseModel):
    ...
    streaming_end_of_stream_only: bool | None = Field(
        ...
        description=(
            ...
            "unset optional_params does not shadow top-level derouter_params."
        ),
    )
    ...
    streaming_sampling_rate: int | None = Field(
        ...
        description=(
            ...
            "when None so unset optional_params does not shadow top-level derouter_params."
        ),
    )
...
class GenericGuardrailAPIRequest(BaseModel):
    ...
    derouter_call_id: str | None = None  # the call id of the individual LLM call
    derouter_trace_id: str | None = (
    ...
    derouter_version: str | None = Field(
        default=None,
        description="DeRouter library version running this proxy.",
    )
