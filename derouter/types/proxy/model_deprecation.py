...
class ModelDeprecationInfo(BaseModel):
    ...
    derouter_model: str | None = Field(
        default=None,
        description="The underlying derouter model string the deprecation date is sourced from.",
    )
    ...
    derouter_provider: str | None = Field(default=None, description="The provider this model belongs to.")
