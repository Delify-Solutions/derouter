...
from derouter.types.llms.openai import BaseDeRouterOpenAIResponseObject
...
if TYPE_CHECKING:
    ...
    class GenerateContentResponse(GoogleGenAIGenerateContentResponse, BaseDeRouterOpenAIResponseObject):
        _hidden_params: dict = {}
    ...
    class GenerateContentResponse(BaseDeRouterOpenAIResponseObject):
        def __init__(self, **kwargs) -> None:
            super().__init__(**kwargs)
