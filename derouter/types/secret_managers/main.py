...
class KeyManagementSettings(DeRouterPydanticObjectBase):
    hosted_keys: list | None = None
    store_virtual_keys: bool | None = False
    """
    If True, virtual keys created by derouter will be stored in the secret manager
    """
    prefix_for_stored_virtual_keys: str = "derouter/"
    """
