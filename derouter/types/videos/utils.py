...
from derouter.types.videos.main import DecodedVideoId

VIDEO_ID_PREFIX: Final = "video_"
CHARACTER_ID_PREFIX: Final = "character_"
CHARACTER_ID_TEMPLATE: Final = "derouter:custom_llm_provider:{};model_id:{};character_id:{}"
...
def encode_video_id_with_provider(video_id: str, provider: str, model_id: str | None = None) -> str:
    ...
    assembled_id = str(SpecialEnums.DEROUTER_MANAGED_VIDEO_COMPLETE_STR.value).format(provider, model_id or "", video_id)
