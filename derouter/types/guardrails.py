...
from derouter.types.proxy.guardrails.guardrail_hooks.akto import (
    AktoConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.block_code_execution import (
    BlockCodeExecutionGuardrailConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.cisco_ai_defense import (
    CiscoAIDefenseGuardrailConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.compresr import (
    CompresrGuardrailConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.enkryptai import (
    EnkryptAIGuardrailConfigs,
)
from derouter.types.proxy.guardrails.guardrail_hooks.grayswan import (
    GraySwanGuardrailConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.headroom import (
    HeadroomGuardrailConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.hiddenlayer import (
    HiddenlayerGuardrailConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.ibm import (
    IBMGuardrailsBaseConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.derouter_content_filter import (
    ContentFilterCategoryConfig,
)
from derouter.types.proxy.guardrails.guardrail_hooks.ovalix import (
    OvalixGuardrailConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.promptguard import (
    PromptGuardConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.qohash import (
    QostodianNexusConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.qualifire import (
    QualifireGuardrailConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.repelloai import (
    RepelloAIGuardrailConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.singulr import (
    SingulrGuardrailConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.tool_permission import (
    ToolPermissionGuardrailConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.vigil_guard import (
    VigilGuardGuardrailConfigModel,
)
from derouter.types.proxy.guardrails.guardrail_hooks.xecguard import (
    XecGuardConfigModel,
)

"""
Pydantic object defining how to set guardrails on derouter proxy
...
class SupportedGuardrailIntegrations(Enum):
    ...
    DEROUTER_CONTENT_FILTER = "derouter_content_filter"
...
class PresidioPresidioConfigModelUserInterface(BaseModel):
    """Configuration parameters for the Presidio PII masking guardrail on DeRouter UI"""
    ...
    output_parse_pii: bool | None = Field(
        default=None,
        description="When True, DeRouter will replace the masked text with the original text in the response",
...
class NomaGuardrailConfigModel(BaseModel):
    ...
    application_id: str | None = Field(
        default=None,
        description="Application ID for Noma Security. Defaults to 'derouter' if not provided",
    )
...
class BaseLitellmParams(ContentFilterConfigModel):  # works for new and patch update guardrails
    ...
    only_scan_new_messages: bool | None = Field(
        ...
        description=(
            ...
            "earlier in the same session (identified by derouter_session_id / session_id). "
    ...
    skip_system_message_in_guardrail: bool | None = Field(
        ...
        description=(
            ...
            "messages are included even if derouter_settings sets a global skip. When "
            "None, use the global derouter.skip_system_message_in_guardrail setting. "
    ...
    skip_tool_message_in_guardrail: bool | None = Field(
        ...
        description=(
            ...
            "messages are included even if derouter_settings sets a global skip. When "
            "None, use the global derouter.skip_tool_message_in_guardrail setting."
        ),
    )
...
class Guardrail(TypedDict, total=False):
    ...
    derouter_params: Required[LitellmParams]
...
class GuardrailInfoResponse(BaseModel):
    ...
    guardrail_name: str
    derouter_params: BaseLitellmParams | None = None
