...
BATCH_GUARDRAIL_RESPONSE_FIELD: Final = "derouter_batch_guardrail"
...
class OpenAIFileObject(BaseModel):
    ...
    derouter_batch_guardrail: BatchGuardrailReport | None = None
    ...
    def _omit_absent_batch_guardrail(  # noqa: ANN202  # annotating it replaces the model's serialization schema
        ...
        if self.derouter_batch_guardrail is not None:
            return serialized
...
class DeRouterBatchCreateRequest(CreateBatchRequest, total=False):
    model: str
...
):  # derouter wrapper on top of openai object for handling cached content
...
class ChatCompletionRequest(TypedDict, total=False):
    ...
    functions: list
    user: str
    metadata: dict  # derouter specific param
...
class DeRouterFineTuningJobCreate(FineTuningJobCreate):
...
class OutputTokensDetails(BaseDeRouterOpenAIResponseObject):
...
class InputTokensDetails(BaseDeRouterOpenAIResponseObject):
    audio_tokens: int | None = None
    cached_tokens: int = 0
    text_tokens: int | None = None
...
class ResponseAPIUsage(BaseDeRouterOpenAIResponseObject):
    input_tokens: int
...
class ResponsesAPIResponse(BaseDeRouterOpenAIResponseObject):
    id: str
    created_at: int
    ...
    def _serialize_output_filter_reasoning_nulls(cls, value, handler, _info):
        ...
        Issue: https://github.com/Delify-Solutions/derouter/issues/16824
        """
...
class ResponseCreatedEvent(BaseDeRouterOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_CREATED]
    response: ResponsesAPIResponse


class ResponseInProgressEvent(BaseDeRouterOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_IN_PROGRESS]
    response: ResponsesAPIResponse


class ResponseCompletedEvent(BaseDeRouterOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_COMPLETED]
    response: ResponsesAPIResponse
    _hidden_params: dict = PrivateAttr(default_factory=dict)


class ResponseFailedEvent(BaseDeRouterOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_FAILED]
    response: ResponsesAPIResponse


class ResponseIncompleteEvent(BaseDeRouterOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.RESPONSE_INCOMPLETE]
    response: ResponsesAPIResponse


class ResponsePartAddedEvent(BaseDeRouterOpenAIResponseObject):
...
class ReasoningSummaryTextDeltaEvent(BaseDeRouterOpenAIResponseObject):
...
class ReasoningSummaryTextDoneEvent(BaseDeRouterOpenAIResponseObject):
...
class ReasoningSummaryPartDoneEvent(BaseDeRouterOpenAIResponseObject):
...
class OutputItemAddedEvent(BaseDeRouterOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.OUTPUT_ITEM_ADDED]
    output_index: int
    item: BaseDeRouterOpenAIResponseObject | None


class OutputItemDoneEvent(BaseDeRouterOpenAIResponseObject):
...
class ContentPartAddedEvent(BaseDeRouterOpenAIResponseObject):
...
class ContentPartDonePartOutputText(BaseDeRouterOpenAIResponseObject):
    type: Literal["output_text"]
    text: str
    annotations: list[BaseDeRouterOpenAIResponseObject]
    logprobs: list[OpenAIChatCompletionLogprobsContent] | None


class ContentPartDonePartRefusal(BaseDeRouterOpenAIResponseObject):
    type: Literal["refusal"]
    refusal: str


class ContentPartDonePartReasoningText(BaseDeRouterOpenAIResponseObject):
...
class ContentPartDoneEvent(BaseDeRouterOpenAIResponseObject):
...
class OutputTextDeltaEvent(BaseDeRouterOpenAIResponseObject):
...
class OutputTextAnnotationAddedEvent(BaseDeRouterOpenAIResponseObject):
...
class OutputTextDoneEvent(BaseDeRouterOpenAIResponseObject):
...
class RefusalDeltaEvent(BaseDeRouterOpenAIResponseObject):
...
class RefusalDoneEvent(BaseDeRouterOpenAIResponseObject):
...
class FunctionCallArgumentsDeltaEvent(BaseDeRouterOpenAIResponseObject):
...
class FunctionCallArgumentsDoneEvent(BaseDeRouterOpenAIResponseObject):
...
class FileSearchCallInProgressEvent(BaseDeRouterOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_IN_PROGRESS]
    output_index: int
    item_id: str


class FileSearchCallSearchingEvent(BaseDeRouterOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_SEARCHING]
    output_index: int
    item_id: str


class FileSearchCallCompletedEvent(BaseDeRouterOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.FILE_SEARCH_CALL_COMPLETED]
    output_index: int
    item_id: str


class WebSearchCallInProgressEvent(BaseDeRouterOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.WEB_SEARCH_CALL_IN_PROGRESS]
    output_index: int
    item_id: str


class WebSearchCallSearchingEvent(BaseDeRouterOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.WEB_SEARCH_CALL_SEARCHING]
    output_index: int
    item_id: str


class WebSearchCallCompletedEvent(BaseDeRouterOpenAIResponseObject):
...
class MCPListToolsInProgressEvent(BaseDeRouterOpenAIResponseObject):
...
class MCPListToolsCompletedEvent(BaseDeRouterOpenAIResponseObject):
...
class MCPListToolsFailedEvent(BaseDeRouterOpenAIResponseObject):
...
# MCP Call Events
class MCPCallInProgressEvent(BaseDeRouterOpenAIResponseObject):
...
class MCPCallArgumentsDeltaEvent(BaseDeRouterOpenAIResponseObject):
...
class MCPCallArgumentsDoneEvent(BaseDeRouterOpenAIResponseObject):
...
class MCPCallCompletedEvent(BaseDeRouterOpenAIResponseObject):
...
class MCPCallFailedEvent(BaseDeRouterOpenAIResponseObject):
...
class ImageGenerationPartialImageEvent(BaseDeRouterOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.IMAGE_GENERATION_PARTIAL_IMAGE]
    partial_image_index: int
    b64_json: str


class ErrorEventError(BaseDeRouterOpenAIResponseObject):
...
class ErrorEvent(BaseDeRouterOpenAIResponseObject):
    type: Literal[ResponsesAPIStreamEvents.ERROR]
    sequence_number: int
    error: ErrorEventError


class GenericEvent(BaseDeRouterOpenAIResponseObject):
    type: str
...
class OpenAIModerationResult(BaseDeRouterOpenAIResponseObject):
...
class OpenAIModerationResponse(BaseDeRouterOpenAIResponseObject):
    """
