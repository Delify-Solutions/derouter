...
def get_assistants(
    ...
    **kwargs,
    ...
    optional_params: Final = GenericDeRouterParams(api_key=api_key, api_base=api_base, api_version=api_version, **kwargs)
    ...
    if custom_llm_provider == "openai":
        ...
        api_base = optional_params.api_base or derouter.api_base or get_secret("AZURE_API_BASE")

        api_version = optional_params.api_version or derouter.api_version or get_secret("AZURE_API_VERSION")
        ...
        raise derouter.exceptions.BadRequestError(
            message=f"DeRouter doesn't support {custom_llm_provider} for 'get_assistants'. Only 'openai' is supported.",
            model="n/a",
...
def create_assistants(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise derouter.exceptions.BadRequestError(
            message=f"DeRouter doesn't support {custom_llm_provider} for 'create_assistants'. Only 'openai' is supported.",
            model="n/a",
            llm_provider=custom_llm_provider,
            response=httpx.Response(
                status_code=400,
    ...
    if response is None:
        raise derouter.exceptions.InternalServerError(
...
def delete_assistant(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise derouter.exceptions.BadRequestError(
            message=f"DeRouter doesn't support {custom_llm_provider} for 'delete_assistant'. Only 'openai' is supported.",
            model="n/a",
            llm_provider=custom_llm_provider,
            response=httpx.Response(
                status_code=400,
                content="Unsupported provider",
                request=httpx.Request(method="delete_assistant", url="https://github.com/Delify-Solutions/derouter"),
            ),
        )
    if response is None:
        raise derouter.exceptions.InternalServerError(
...
def create_thread(
    ...
    **kwargs,
    ...
    ```
    from derouter import create_thread
    ...
    if custom_llm_provider == "openai":
        ...
        api_version: str | None = optional_params.api_version or derouter.api_version or get_secret("AZURE_API_VERSION")
        ...
        raise derouter.exceptions.BadRequestError(
            message=f"DeRouter doesn't support {custom_llm_provider} for 'create_thread'. Only 'openai' is supported.",
            model="n/a",
            llm_provider=custom_llm_provider,
            response=httpx.Response(
                status_code=400,
...
def get_thread(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise derouter.exceptions.BadRequestError(
            message=f"DeRouter doesn't support {custom_llm_provider} for 'get_thread'. Only 'openai' is supported.",
            model="n/a",
            llm_provider=custom_llm_provider,
            response=httpx.Response(
                status_code=400,
...
def get_messages(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise derouter.exceptions.BadRequestError(
            message=f"DeRouter doesn't support {custom_llm_provider} for 'get_messages'. Only 'openai' is supported.",
            model="n/a",
            llm_provider=custom_llm_provider,
            response=httpx.Response(
                status_code=400,
...
def run_thread(
    ...
    **kwargs,
    ...
    if custom_llm_provider == "openai":
        ...
        raise derouter.exceptions.BadRequestError(
            message=f"DeRouter doesn't support {custom_llm_provider} for 'run_thread'. Only 'openai' is supported.",
            model="n/a",
            llm_provider=custom_llm_provider,
            response=httpx.Response(
                status_code=400,
