/**
 * `derouter xai video` — generate a Grok Imagine video through the local
 * derouter gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: derouter xai video --prompt "..." [options]

Generate a Grok Imagine video via your local derouter gateway
...
Options:
  ...
  --api-key <key>         derouter API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-derouter-connection-id"] || null;
