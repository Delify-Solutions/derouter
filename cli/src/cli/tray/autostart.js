...
const APP_LABEL = "com.derouter.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when derouter is currently
 ...
 * SIGTERM to the running process. When the running derouter cli.js was itself
...
<dict>
    ...
    <string>/tmp/derouter.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/derouter.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `derouter.cmd` lookup that depended on the npm prefix path.
