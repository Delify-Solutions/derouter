...
## VARIABLES
DATABASE_URL = "postgresql://postgres:postgres@localhost:5432/derouter"
        ...
        with open(csv_file_path, "r", encoding="utf-8") as file:
            ...
            for row in csv_reader:
                try:
                    ...
                    existing_token = await prisma.derouter_verificationtoken.find_unique(
                    ...
                    # Insert the record
                    await prisma.derouter_verificationtoken.create(
