-- Converts an existing DeRouter_SpendLogs table into a native Postgres
...
--
-- This is an opt-in, manual operation. The default DeRouter schema is NOT
...
--     PK becomes composite ("request_id", "startTime"). DeRouter's write path uses
...
ALTER TABLE "DeRouter_SpendLogs" RENAME TO "DeRouter_SpendLogs_legacy";
...
ALTER INDEX IF EXISTS "DeRouter_SpendLogs_pkey"
    RENAME TO "DeRouter_SpendLogs_legacy_pkey";
ALTER INDEX IF EXISTS "DeRouter_SpendLogs_startTime_idx"
    RENAME TO "DeRouter_SpendLogs_legacy_startTime_idx";
ALTER INDEX IF EXISTS "DeRouter_SpendLogs_startTime_request_id_idx"
    RENAME TO "DeRouter_SpendLogs_legacy_startTime_request_id_idx";
ALTER INDEX IF EXISTS "DeRouter_SpendLogs_end_user_idx"
    RENAME TO "DeRouter_SpendLogs_legacy_end_user_idx";
ALTER INDEX IF EXISTS "DeRouter_SpendLogs_session_id_idx"
    RENAME TO "DeRouter_SpendLogs_legacy_session_id_idx";

CREATE TABLE "DeRouter_SpendLogs" (
    LIKE "DeRouter_SpendLogs_legacy" INCLUDING DEFAULTS INCLUDING GENERATED
...
CREATE TABLE IF NOT EXISTS "DeRouter_SpendLogs_pdefault"
    PARTITION OF "DeRouter_SpendLogs" DEFAULT;
...
-- window instead of one statement, or simply keep "DeRouter_SpendLogs_legacy"
...
--   SELECT * FROM "DeRouter_SpendLogs_legacy"
