          ...
          <DialogContent className="top-8 max-h-[calc(100dvh-4rem)] translate-y-0 overflow-y-auto sm:max-w-[1000px]">
            ...
            <div className="mt-6">
              <Alert variant="info" className="mb-6">
                ...
                <AlertDescription>
                  Route requests from your DeRouter proxy to any external API. Perfect for custom models, image
                  generation APIs, or any service you want to proxy through DeRouter.
                </AlertDescription>
              </Alert>
