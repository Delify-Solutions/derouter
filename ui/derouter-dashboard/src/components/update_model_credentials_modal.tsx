  ...
  const handleSubmit = async (values: UpdateCredentialsValues) => {
    ...
    try {
      await modelPatchUpdateCall(
        accessToken,
        { derouter_params: { api_key: apiKey }, model_info: { id: modelId } },
        modelId,
      );
      ...
      <DialogContent className="max-h-[calc(100dvh-2rem)] overflow-y-auto sm:max-w-[520px]">
        ...
        <Alert variant="warning" className="mb-4">
          ...
          <AlertTitle>
            ...
            Vertex service-account JSON aren&apos;t supported yet; update those from the model&apos;s DeRouter Params for
            now.
          </AlertTitle>
        </Alert>
