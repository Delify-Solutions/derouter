                ...
                {keyOwner === "agent" && (
                  <div className="mt-4 p-4 bg-purple-50 border border-purple-200 rounded-md dark:bg-purple-950 dark:border-purple-800">
                    ...
                    <div className="text-xs text-muted-foreground mt-2">
                      This key will be used by the selected agent to make requests to DeRouter
                    </div>
                  </div>
                )}
                <MountedFormField
                      ...
                      <MountedFormField
                        ...
                        label={
                          <span>
                            ...
                            <SimpleTooltip content="When this key exceeds its max budget, throttle its TPM/RPM to the globally configured percentage instead of blocking access entirely. Requires budget_exceeded_throttle_percentage in derouter_settings and a TPM/RPM limit on the key.">
                              <Info className="ml-1 inline size-3.5 align-text-bottom" />
                            </SimpleTooltip>
                          </span>
                        }
                          ...
                          label={
                            <span>
                              ...
                              <SimpleTooltip content="Apply policies to this key to control guardrails and other settings">
                                <a
                                  href="https://router.delify.vn/docs/proxy/guardrails/guardrail_policies"
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  onClick={(e) => e.stopPropagation()} // Prevent accordion from collapsing when clicking link
                                >
                          ...
                          label={
                            <span>
                              ...
                              <SimpleTooltip content="Allow this key to use specific prompt templates">
                                <a
                                  href="https://router.delify.vn/docs/proxy/prompt_management"
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  onClick={(e) => e.stopPropagation()} // Prevent accordion from collapsing when clicking link
                                >
                        ...
                        label={
                          <span>
                            ...
                            <SimpleTooltip content="Allow this key to use specific pass through routes">
                              <a
                                href="https://router.delify.vn/docs/proxy/pass_through"
                                target="_blank"
                                rel="noopener noreferrer"
                                onClick={(e) => e.stopPropagation()} // Prevent accordion from collapsing when clicking link
                              >
                        ...
                        <SimpleTooltip
                          ...
                          content={
                            <span>
                              ...
                              <a href="https://www.router.delify.vn/enterprise" target="_blank">
                                https://www.router.delify.vn/enterprise
                              </a>
                            </span>
                          }
                          side="top"
