  ...
  return (
    <Card className="block p-6">
      ...
      <p className="mb-4 text-sm text-muted-foreground">
        When enabled, requests to this endpoint will require a valid DeRouter Virtual Key
      </p>
      {premiumUser ? (
        ...
        <div>
          ...
          <div className="rounded-lg border border-warning/20 bg-warning/10 p-3">
            <p className="text-sm text-warning">
              Setting authentication for pass-through endpoints is a DeRouter Enterprise feature. Get a trial key{" "}
              <a href="https://www.router.delify.vn/#pricing" target="_blank" rel="noopener noreferrer" className="underline">
                here
              </a>
              .
            </p>
