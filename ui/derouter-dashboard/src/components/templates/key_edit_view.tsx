...
export function KeyEditView({
  ...
  const [disabledCallbacks, setDisabledCallbacks] = useState<string[]>(
    Array.isArray(keyData.metadata?.derouter_disabled_callbacks)
      ? mapInternalToDisplayNames(keyData.metadata.derouter_disabled_callbacks)
      : [],
  );
        ...
        <FieldGroup>
          ...
          <FormField
            ...
            label={labelWithHint(
              ...
              "When this key exceeds its max budget, throttle its TPM/RPM to the globally configured percentage instead of blocking access entirely. Requires budget_exceeded_throttle_percentage in derouter_settings and a TPM/RPM limit on the key.",
            )}
          >
