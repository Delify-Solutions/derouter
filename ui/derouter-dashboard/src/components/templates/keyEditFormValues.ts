...
export const toKeyEditFormValues = (keyData: KeyResponse): KeyEditFormValues => ({
  ...
  soft_budget:
    (keyData.derouter_budget_table as { soft_budget?: number | null } | null | undefined)?.soft_budget ?? null,
  ...
  disabled_callbacks: Array.isArray(readMetadata(keyData, "derouter_disabled_callbacks"))
    ? mapInternalToDisplayNames(readMetadata(keyData, "derouter_disabled_callbacks") as string[])
    : [],
