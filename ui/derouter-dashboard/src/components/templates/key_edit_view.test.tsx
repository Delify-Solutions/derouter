  ...
  describe("policy and prompt fields", () => {
    ...
    it("lists a prompt existing in several environments once in the dropdown", async () => {
      vi.mocked(getPromptsList).mockResolvedValueOnce({
        prompts: [
          { prompt_id: "envgreet", derouter_params: {}, prompt_info: { prompt_type: "db" }, environment: "development" },
          { prompt_id: "envgreet", derouter_params: {}, prompt_info: { prompt_type: "db" }, environment: "production" },
        ],
      });
