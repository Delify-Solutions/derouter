...
const makeOrganization = (overrides: Partial<Organization>): Organization =>
  ({
    ...
    updated_at: "2026-01-01T00:00:00Z",
    updated_by: "admin",
    derouter_budget_table: { max_budget: null, budget_duration: null },
    teams: null,
    users: null,
    members: null,
    ...overrides,
...
describe("KeyInfoView overview budget display (LIT-2845)", () => {
  ...
  it("lists the organization budget in the hint when the team's org has one", async () => {
    ...
    mockOrganizations([makeOrganization({ derouter_budget_table: { max_budget: 5000, budget_duration: null } })]);
    renderWithProviders(
      <KeyInfoView
