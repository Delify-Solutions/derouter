...
export const AUDIT_TABLE_NAME_DISPLAY: Record<string, string> = {
  DeRouter_VerificationToken: "Keys",
  DeRouter_TeamTable: "Teams",
  DeRouter_UserTable: "Users",
  DeRouter_OrganizationTable: "Organizations",
  DeRouter_ProxyModelTable: "Models",
};
