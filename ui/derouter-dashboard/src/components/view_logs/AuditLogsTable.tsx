...
const TABLE_OPTIONS = [
  { label: "Keys", value: "DeRouter_VerificationToken" },
  { label: "Teams", value: "DeRouter_TeamTable" },
  { label: "Users", value: "DeRouter_UserTable" },
  { label: "Organizations", value: "DeRouter_OrganizationTable" },
  { label: "Models", value: "DeRouter_ProxyModelTable" },
] as const;
