...
const DISMISS_KEY_PREFIX = "derouter:licenseExpiryBannerDismissed:";
...
export const LicenseExpiryBannerView: React.FC<LicenseExpiryBannerViewProps> = ({ licenseInfo }) => {
  ...
  const message =
    tier === "expired"
      ? `Your DeRouter Enterprise license expired on ${formattedDate}`
      : `Your DeRouter Enterprise license ${describeCountdown(days)} (${formattedDate})`;
