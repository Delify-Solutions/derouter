...
const REDIS_DOCS_URL = "https://router.delify.vn/docs/proxy/redis_requirements";
    ...
    >
      ...
      <div>
        ...
        <p>
          ...
          . Set <code className="font-mono">DEROUTER_DISABLE_NO_REDIS_WARNING=true</code> to hide this banner anyway.
        </p>
      </div>
    </div>
  );
