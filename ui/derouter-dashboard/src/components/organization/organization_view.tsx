          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              <CardContent>
                ...
                <div className="mt-2 text-sm text-foreground">
                  ...
                  <p>
                    of{" "}
                    {orgData.derouter_budget_table.max_budget === null
                      ? "Unlimited"
                      : `$${formatNumberWithCommas(orgData.derouter_budget_table.max_budget, 4)}`}
                  </p>
                  {orgData.derouter_budget_table.budget_duration && (
                    <p className="text-muted-foreground">Reset: {orgData.derouter_budget_table.budget_duration}</p>
                  )}
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent>
                ...
                <div className="mt-2 text-sm text-foreground">
                  <p>TPM: {orgData.derouter_budget_table.tpm_limit ?? "Unlimited"}</p>
                  <p>RPM: {orgData.derouter_budget_table.rpm_limit ?? "Unlimited"}</p>
                  {orgData.derouter_budget_table.max_parallel_requests && (
                    <p>Max Parallel Requests: {orgData.derouter_budget_table.max_parallel_requests}</p>
                  )}
                </div>
              </CardContent>
            </Card>
              ...
              {isEditing ? (
                ...
                <div className="space-y-4 text-sm">
                  ...
                  <div>
                    ...
                    <div>TPM: {orgData.derouter_budget_table.tpm_limit ?? "Unlimited"}</div>
                    <div>RPM: {orgData.derouter_budget_table.rpm_limit ?? "Unlimited"}</div>
                  </div>
                  <div>
                    ...
                    <div>Reset: {orgData.derouter_budget_table.budget_duration || "Never"}</div>
                  </div>
