 ...
 * <HelpLink href="https://router.delify.vn/docs/proxy/custom_pricing">
 *   Learn more about custom pricing
 * </HelpLink>
 *
 * @example
 * // Subtle link (just icon + text, minimal styling)
 * <HelpLink href="https://router.delify.vn/docs/proxy/cost_tracking" variant="subtle">
 *   View docs
 * </HelpLink>
 *
 * @example
 * // Button style (more prominent)
 * <HelpLink href="https://router.delify.vn/docs/proxy/custom_pricing" variant="button">
 ...
 * @example
 * <DocsMenu items={[
 *   { label: "Custom pricing for models", href: "https://router.delify.vn/docs/proxy/custom_pricing" },
 *   { label: "Spend tracking", href: "https://router.delify.vn/docs/proxy/cost_tracking" }
 * ]}>
 *   Docs
 * </DocsMenu>
 */
