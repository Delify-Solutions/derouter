...
const organization = {
  ...
  derouter_budget_table: { max_budget: 5000, budget_duration: null },
};
...
describe("inheritedBudgetGates", () => {
  ...
  it("skips a team or org whose max_budget is null", () => {
    ...
    expect(inheritedBudgetGates(team, { ...organization, derouter_budget_table: { max_budget: null } })).toEqual([
      { scope: "Team", alias: "Platform", maxBudget: 1200, budgetDuration: "30d" },
    ]);
  });
  ...
  it("returns nothing when team and org are missing or budgetless", () => {
    ...
    expect(
      inheritedBudgetGates({ ...team, max_budget: null }, { ...organization, derouter_budget_table: null }),
    ).toEqual([]);
  });
