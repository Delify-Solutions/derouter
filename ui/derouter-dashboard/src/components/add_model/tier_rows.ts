...
// Mirrors TierDefinition in derouter/router_strategy/complexity_router/config.py
...
// Mirrors init_complexity_router_deployment (derouter/router.py): a pin wins, then the fallback
