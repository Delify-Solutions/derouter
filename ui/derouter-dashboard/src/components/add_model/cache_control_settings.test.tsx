...
const ROLE_HINT = "DeRouter will mark all messages of this role as cacheable";
const INDEX_HINT = "(Optional) If set derouter will mark the message at this index as cacheable";
