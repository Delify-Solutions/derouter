...
describe("ConditionalPublicModelName", () => {
  it("should render", () => {
    ...
    expect(screen.getByText("DeRouter Model Name")).toBeInTheDocument();
  });
  ...
  it("keeps the public name input focused across keystrokes", async () => {
    ...
    render(
      <MountedFormHost
        defaultValues={{
          model: ["gpt-4"],
          model_mappings: [{ public_name: "gpt-4", derouter_model: "gpt-4" }],
        }}
      >
        <ConditionalPublicModelName />
      </MountedFormHost>,
