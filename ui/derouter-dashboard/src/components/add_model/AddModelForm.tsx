...
const AddModelForm: React.FC<AddModelFormProps> = ({
  ...
  const selectedCredentialName = useWatch({ control: form.control, name: "derouter_credential_name" });
                      ...
                      <div className="grid grid-cols-12">
                        ...
                        <div className="col-span-5">
                          <p className="text-sm mb-5 mt-1">
                            <strong>Optional</strong> - DeRouter endpoint to use when health checking this model{" "}
                            <a
                              href="https://router.delify.vn/docs/proxy/health#health"
                              target="_blank"
                              rel="noreferrer"
