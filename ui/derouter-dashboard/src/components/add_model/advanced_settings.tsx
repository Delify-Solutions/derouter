      ...
      <Collapsible className="mt-2 mb-4 overflow-hidden rounded-lg border">
        ...
        <CollapsibleContent className="px-4 pb-3">
          <div className="rounded-lg">
            ...
            <MountedFormField
              ...
              label={labelWithHint(
                ...
                <span>
                  ...
                  <a
                    href="https://router.delify.vn/docs/pass_through/vertex_ai"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <MountedFormField
              name="derouter_extra_params"
              label={labelWithHint(
                "DeRouter Params",
                "Optional derouter params used for making a derouter.completion() call.",
              )}
              className="mb-4 mt-4"
            ...
            <div className="grid grid-cols-24 mb-4">
              <p className="col-start-11 col-span-10 text-muted-foreground text-sm">
                Pass JSON of derouter supported params{" "}
                <a
