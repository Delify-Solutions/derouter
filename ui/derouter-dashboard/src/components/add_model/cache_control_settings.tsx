...
export const CACHE_CONTROL_TOOLTIP =
  "Tell derouter where to inject cache control checkpoints. You can specify either by role (to apply to all messages of that role) or by specific message index.";

export const CACHE_CONTROL_DESCRIPTION =
  "Providers like Anthropic, Bedrock API require users to specify where to inject cache control checkpoints, derouter can automatically add them for you as a cost saving feature.";

export const CACHE_CONTROL_ROLE_HINT = "DeRouter will mark all messages of this role as cacheable";

export const CACHE_CONTROL_INDEX_HINT = "(Optional) If set derouter will mark the message at this index as cacheable";
