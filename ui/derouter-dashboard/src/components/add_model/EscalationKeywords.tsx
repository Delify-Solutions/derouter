...
export const DEFAULT_ESCALATION_KEYWORDS = ["DEROUTER ESCALATE"];
  ...
  return (
    <div className="w-full max-w-none">
      ...
      <span className="mb-2 block text-xs text-muted-foreground">
        ...
        otherwise route to. Matching is case-sensitive, so &quot;DEROUTER ESCALATE&quot; only fires on the exact, shouted
      ...
      <MultiSelect
        ...
        placeholder="e.g., DEROUTER ESCALATE"
