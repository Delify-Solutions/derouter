          ...
          {step === 1 ? (
            <div className="text-center">
              ...
              <p className="text-muted-foreground mb-6">
                DeRouter needs access to {serverDisplayName} to complete your request.
              </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      DeRouter acts as a secure bridge. Your requests are routed through our MCP client directly to{" "}
