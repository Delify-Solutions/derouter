/** A single MCP tool event emitted by the DeRouter proxy during a Responses API turn. */
...
export const AUTH_TYPE_ITEMS = [
  ...
  { value: AUTH_TYPE.TRUE_PASSTHROUGH, label: "True Passthrough (no DeRouter auth)" },
...
// verbatim for true_passthrough, alongside DeRouter admission for oauth_delegate). The dashboard holds
