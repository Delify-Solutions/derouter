...
describe("ByokCredentialModal", () => {
  it("saves the credential with the session's configured derouter key header, not a hardcoded Authorization", async () => {
    registerAuthHeaderNameGetter(() => "x-derouter-api-key");
    ...
    expect(request.headers.get("x-derouter-api-key")).toBe("Bearer sk-session");
