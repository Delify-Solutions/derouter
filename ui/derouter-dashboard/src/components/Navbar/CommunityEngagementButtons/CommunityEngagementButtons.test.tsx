...
describe("CommunityEngagementButtons", () => {
  ...
  it("should render Join Slack button with correct link", () => {
    ...
    expect(joinSlackLink).toHaveAttribute("href", "https://www.router.delify.vn/support");
  ...
  it("should render GitHub link with correct href", () => {
    ...
    const githubLink = screen.getByRole("link", { name: /derouter on github/i });
    expect(githubLink).toBeInTheDocument();
    expect(githubLink).toHaveAttribute("href", "https://github.com/Delify-Solutions/derouter");
  ...
  it("should not render buttons when prompts are disabled", () => {
    ...
    expect(screen.queryByRole("link", { name: /derouter on github/i })).not.toBeInTheDocument();
  });
});
