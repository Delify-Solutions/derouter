...
const COMMUNITY_LINKS = [
  {
    href: "https://www.router.delify.vn/support",
    label: "Join Slack",
    tooltip: "DeRouter Slack community",
    Icon: Slack,
  },
  {
    href: "https://github.com/Delify-Solutions/derouter",
    label: "DeRouter on GitHub",
    tooltip: "DeRouter on GitHub",
    Icon: Github,
  },
] as const;
