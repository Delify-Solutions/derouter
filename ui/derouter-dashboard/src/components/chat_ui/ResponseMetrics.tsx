...
const RESPONSE_CACHE_TOOLTIP =
  "This response was replayed from DeRouter's response cache. The request never reached the provider, so it did not read from or write to the provider's own prompt cache.";
