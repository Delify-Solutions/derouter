...
const Navbar: React.FC<NavbarProps> = ({
  ...
  const handleLogout = () => {
    clearTokenCookies();
    localStorage.removeItem("derouter_selected_worker_id");
    localStorage.removeItem("derouter_worker_url");
              ...
              <Link href={uiHref("")} className="flex items-center">
                <div className="relative">
                  <div className="flex h-10 max-w-48 items-center justify-center overflow-hidden">
                    <img src={imageUrl} alt="DeRouter Brand" className={cn(NAV_LOGO_CLASS_NAME, "dark:hidden")} />
                    <img
                      src={darkImageUrl}
                      alt=""
                      aria-hidden
                ...
                <div className="relative">
                  {!disableBouncingIcon && (
                    <span
                      ...
                      title="Thanks for using DeRouter!"
                    >
                      🌑
                    </span>
                  )}
                  <Badge variant="outline" className="relative z-raised cursor-pointer text-xs font-medium">
                    <a
                      href="https://router.delify.vn/release_notes"
                      target="_blank"
