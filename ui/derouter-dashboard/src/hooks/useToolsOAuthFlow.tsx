 ...
 * - uses "derouter-tools-mcp-oauth-result" as its result key to avoid
...
const FLOW_STATE_KEY = "derouter-tools-mcp-oauth-flow-state";
const RESULT_KEY = "derouter-tools-mcp-oauth-result";
const RETURN_URL_KEY = "derouter-mcp-oauth-return-url";
