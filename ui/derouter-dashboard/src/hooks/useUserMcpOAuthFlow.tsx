...
const FLOW_STATE_KEY = "derouter-user-mcp-oauth-flow-state";
// Use a user-flow-specific key to avoid collisions with the admin OAuth flow
// (useMcpOAuthFlow) which uses "derouter-mcp-oauth-result".
const RESULT_KEY = "derouter-user-mcp-oauth-result";
