  ...
  return (
    <div className="p-2">
      ...
      <p className="text-sm text-muted-foreground">
        See how DeRouter transforms your request for the specified provider.
      </p>
      <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>The request you would send to DeRouter /chat/completions endpoint.</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>How DeRouter transforms your request for the specified provider.</CardDescription>
      ...
      <div className="mt-4 text-right">
        <p className="text-sm text-muted-foreground">
          ...
          <a
            ...
            href="https://github.com/Delify-Solutions/derouter/issues"
            target="_blank"
