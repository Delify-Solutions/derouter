...
describe("ChatUI", () => {
  ...
  it("should show Fill button and populate customProxyBaseUrl when proxySettings.DEROUTER_UI_API_DOC_BASE_URL is provided", async () => {
    ...
    render(
      <ChatUI
        ...
        disabledPersonalKeyCreation={false}
        proxySettings={{
          DEROUTER_UI_API_DOC_BASE_URL: testProxyUrl,
        }}
      />,
    );
