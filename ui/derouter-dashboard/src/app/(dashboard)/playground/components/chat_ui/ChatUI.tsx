        ...
        if (endpointType === EndpointType.CHAT) {
          ...
          const requestProxyBaseUrl =
            simplified && proxySettings
              ? proxySettings.DEROUTER_UI_API_DOC_BASE_URL ?? proxySettings.PROXY_BASE_URL ?? undefined
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    {proxySettings?.DEROUTER_UI_API_DOC_BASE_URL && !customProxyBaseUrl && (
                      <Button
                        type="button"
                        variant="link"
                        size="xs"
                        ...
                        onClick={() => {
                          setCustomProxyBaseUrl(proxySettings.DEROUTER_UI_API_DOC_BASE_URL || "");
                          sessionStorage.setItem("customProxyBaseUrl", proxySettings.DEROUTER_UI_API_DOC_BASE_URL || "");
                        }}
                      >
                      ...
                      {!isLoading && (
                        <div className="flex flex-wrap gap-2">
                          {[
                            ...
                            "Create a PNG bar chart comparing AI gateway providers including DeRouter",
