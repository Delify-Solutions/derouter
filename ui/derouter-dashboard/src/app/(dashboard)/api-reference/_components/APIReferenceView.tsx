    ...
    <div className="grid grid-cols-1 gap-2 p-8 h-[80vh] w-full mt-2">
      <div className="mb-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <DocLink className="ml-3 shrink-0" href="https://router.delify.vn/docs/proxy/user_keys" />
        </div>

        <p className="mt-2 mb-2 text-sm text-muted-foreground">
          DeRouter is OpenAI Compatible. This means your API Key works with the OpenAI SDK. Just replace the base_url to
          point to your derouter proxy. Example Below{" "}
        </p>
...
client = openai.OpenAI(
    ...
    base_url="${base_url}" # DeRouter Proxy is OpenAI compatible, Read More: https://router.delify.vn/docs/proxy/user_keys
)
...
llm = AzureOpenAI(
    engine="azure-gpt-3.5",               # model_name on derouter proxy
    temperature=0.0,
    azure_endpoint="${base_url}", # derouter proxy endpoint
    api_key="sk-1234",                    # derouter proxy API Key
...
messages = [
    ...
    HumanMessage(
        content="test from derouter. tell me why it's amazing in 1 sentence"
    ),
]
