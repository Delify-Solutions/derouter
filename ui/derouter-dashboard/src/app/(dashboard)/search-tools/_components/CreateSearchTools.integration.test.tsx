...
describe("CreateSearchTools submit payload", () => {
  ...
  it("sends every filled field under derouter_params and search_tool_info", async () => {
    ...
    expect(JSON.stringify(payload)).toBe(
      '{"search_tool_name":"my-search","derouter_params":{"search_provider":"perplexity","api_key":"sk-secret"},"search_tool_info":{"description":"finds things"}}',
    );
  });
  ...
  it("omits untouched optional fields from the wire body instead of sending empty strings", async () => {
    ...
    expect(JSON.stringify(payload)).toBe(
      '{"search_tool_name":"minimal","derouter_params":{"search_provider":"tavily"}}',
    );
  });
