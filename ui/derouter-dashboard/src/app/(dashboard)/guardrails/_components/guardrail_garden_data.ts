...
const derouterContentFilterLogo = guardrailLogoMap["DeRouter Content Filter"];

export const DEROUTER_CONTENT_FILTER_CARDS: GuardrailCardInfo[] = [
  {
    ...
    logo: derouterContentFilterLogo,
...
export const ALL_CARDS = [...DEROUTER_CONTENT_FILTER_CARDS, ...PARTNER_GUARDRAIL_CARDS];
