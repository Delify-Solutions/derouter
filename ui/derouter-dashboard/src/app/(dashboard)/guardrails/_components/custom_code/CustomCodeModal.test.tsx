...
describe("CustomCodeModal", () => {
  ...
  it("should render the edit heading and existing values in edit mode", async () => {
    renderModal({
      editData: {
        ...
        derouter_params: { mode: "post_call", default_on: true, custom_code: "def apply_guardrail(): pass" },
      },
    });
  ...
  it("should create the guardrail with the entered name, mode and code", async () => {
    ...
    expect(payload).toMatchObject({
      ...
      derouter_params: { guardrail: "custom_code", mode: ["pre_call"], default_on: false },
    });
    await waitFor(() => {
