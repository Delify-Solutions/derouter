...
const GuardrailDetailView: React.FC<GuardrailDetailViewProps> = ({ card, onBack, accessToken, onGuardrailCreated }) => {
  ...
  const detailRows = [
    { property: "Provider", value: card.category === "derouter" ? "DeRouter Content Filter" : "Partner Guardrail" },
    ...(card.subcategory ? [{ property: "Subcategory", value: card.subcategory }] : []),
    ...(card.category === "derouter" ? [{ property: "Cost", value: "$0 / request" }] : []),
    ...(card.category === "derouter" ? [{ property: "External Dependencies", value: "None" }] : []),
    ...(card.category === "derouter" ? [{ property: "Latency", value: card.eval?.latency || "<1ms" }] : []),
  ];
        ...
        <div className="flex gap-16">
          ...
          <div className="w-60 shrink-0">
            ...
            <div className="mb-7">
              ...
              <div className="break-all text-[13px] text-foreground">derouter/{card.id}</div>
            </div>
            ...
            <div className="mb-7">
              ...
              <div className="text-[13px] text-foreground">
                {card.category === "derouter" ? "Content Filter" : "Partner"}
              </div>
            </div>
