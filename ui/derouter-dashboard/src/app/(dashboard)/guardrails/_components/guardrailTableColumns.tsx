...
export const getGuardrailTableColumns = ({
  ...
  },
  {
    ...
    size: 180,
    enableSorting: false,
    cell: ({ row }) => <GuardrailProviderCell provider={row.original.derouter_params.guardrail} />,
  },
  {
    id: "mode",
    meta: { title: "Mode" },
    ...
    enableSorting: false,
    cell: ({ row }) => {
      const mode = formatGuardrailMode(row.original.derouter_params.mode);
      return (
  ...
  },
  {
    ...
    enableSorting: false,
    cell: ({ row }) => {
      const isDefaultOn = !!row.original.derouter_params?.default_on;
      return (
