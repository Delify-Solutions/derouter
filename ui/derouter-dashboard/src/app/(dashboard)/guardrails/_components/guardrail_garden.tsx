...
const GuardrailGarden: React.FC<GuardrailGardenProps> = ({ accessToken, onGuardrailCreated }) => {
  ...
  const derouterCards = filteredCards.filter((c) => c.category === "derouter");
    ...
    <div>
      ...
      <div className="mb-10">
        <div className="mb-1 flex items-center justify-between">
          <h2 className="m-0 text-xl font-semibold text-foreground">DeRouter Content Filter</h2>
          <span
        ...
        <div className="grid grid-cols-[repeat(auto-fill,minmax(220px,1fr))] gap-4">
          {(showAllLitellm ? derouterCards : derouterCards.slice(0, CARDS_PER_ROW * VISIBLE_ROWS)).map((card) => (
