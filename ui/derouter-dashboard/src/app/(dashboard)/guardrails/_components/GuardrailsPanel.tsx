...
const GuardrailsPanel: React.FC<GuardrailsPanelProps> = ({ accessToken, userRole }) => {
  ...
  const providerDisplayName =
    guardrailToDelete && guardrailToDelete.derouter_params
      ? getGuardrailLogoAndName(guardrailToDelete.derouter_params.guardrail).displayName
      : undefined;
            ...
            <TabsContent value="guardrails" keepMounted>
              ...
              <DeleteResourceModal
                ...
                resourceInformation={[
                  ...
                  { label: "Mode", value: formatGuardrailMode(guardrailToDelete?.derouter_params.mode) },
                  {
                    label: "Default On",
                    value: guardrailToDelete?.derouter_params.default_on ? "Yes" : "No",
                  },
                ]}
