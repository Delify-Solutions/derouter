...
describe("MCPServerEdit (true passthrough warning)", () => {
  ...
  it("warns that DeRouter auth is disabled for a true_passthrough server", async () => {
    renderWithAuthType("true_passthrough");

    await waitFor(() => {
      expect(screen.getByText("True Passthrough disables DeRouter authentication for this server")).toBeInTheDocument();
    });
  });
