                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex gap-2 mt-2">
                      <Badge variant="outline">{guardrail.definition?.derouter_params?.guardrail || "unknown"}</Badge>
                      <Badge variant="secondary">
                        {formatGuardrailMode(guardrail.definition?.derouter_params?.mode) || "unknown"}
                      </Badge>
                      {guardrail.definition?.derouter_params?.patterns && (
                        <Badge variant="secondary">
                          {guardrail.definition.derouter_params.patterns.length} pattern(s)
                        </Badge>
                      )}
                      {guardrail.definition?.derouter_params?.categories && (
                        <Badge variant="secondary">
                          {guardrail.definition.derouter_params.categories.length} category/categories
                        </Badge>
                      )}
                    </div>
                  </div>
