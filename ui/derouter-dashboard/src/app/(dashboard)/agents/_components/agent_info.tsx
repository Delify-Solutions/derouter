        ...
        <div>
          ...
          <TabsContent value="overview" keepMounted>
            <DetailList>
              ...
              {agent.derouter_params?.model && <DetailItem label="Model">{agent.derouter_params.model}</DetailItem>}
              {agent.derouter_params?.make_public !== undefined && (
                <DetailItem label="Make Public">{agent.derouter_params.make_public ? "Yes" : "No"}</DetailItem>
              )}
