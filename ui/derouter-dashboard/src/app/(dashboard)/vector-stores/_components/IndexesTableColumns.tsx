...
export const getIndexesTableColumns = ({
  ...
  },
  {
    ...
    accessorFn: (row) => row.derouter_params.vector_store_name,
    meta: { title: "Vector Store" },
    header: ({ column }) => <DataTableSortHeader column={column} title="Vector Store" />,
    size: 200,
    enableSorting: true,
    cell: ({ row }) => {
      const name = row.original.derouter_params.vector_store_name;
  ...
  },
  {
    ...
    accessorFn: (row) => row.derouter_params.vector_store_index,
    ...
    cell: ({ row }) => (
      <span
        ...
        title={row.original.derouter_params.vector_store_index}
      >
        {row.original.derouter_params.vector_store_index || "-"}
      </span>
    ),
  },
  {
