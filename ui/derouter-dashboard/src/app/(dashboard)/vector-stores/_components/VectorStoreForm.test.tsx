...
describe("buildVectorStoreLitellmParams", () => {
  it("renames embedding_model to derouter_embedding_model for valkey", () => {
    ...
    const expectedParams = {
      ...
      valkey_password: "secret",
      valkey_ssl: "true",
      derouter_embedding_model: "text-embedding-3-small",
      valkey_text_field: "text",
      valkey_embedding_field: "vector",
    };
  ...
  it("renames embedding_model to derouter_embedding_model for milvus", () => {
  ...
  it("renames embedding_model to derouter_embedding_model for mongodb", () => {
    const formValues = {
  ...
  it("omits a blank mongodb_num_candidates so derouter picks its own candidate count", () => {
  ...
  it("keeps embedding_model as-is for providers outside the rename set", () => {
    ...
    expect(params).not.toHaveProperty("derouter_embedding_model");
  });
});
