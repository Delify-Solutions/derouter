...
const vectorStoreShape = {
  ...
  derouter_credential_name: z.string().nullable().optional(),
...
const VERTEX_SEARCH_API_WITH_ENGINE_PLACEHOLDER = "Any identifier you'll use to reference this in DeRouter";
  ...
  const handleCreate = async (formValues: VectorStoreFormValues) => {
    ...
    try {
      ...
      await vectorStoreCreateCall(accessToken, {
        ...
        derouter_credential_name: formValues.derouter_credential_name,
        derouter_params: buildVectorStoreLitellmParams(formValues.custom_llm_provider, formValues),
      });
            ...
            <FieldGroup>
              ...
              {selectedProvider === "pg_vector" && (
                <Alert variant="info">
                  ...
                  <AlertDescription>
                    <p>DeRouter provides a server to connect to PG Vector. To use this provider:</p>
                    <ol style={{ marginLeft: "16px", marginTop: "8px", listStyleType: "decimal" }}>
                      <li>
                        Deploy the derouter-pgvector server from:{" "}
                        <a href="https://github.com/Delify-Solutions/derouter-pgvector" target="_blank" rel="noopener noreferrer">
                          https://github.com/Delify-Solutions/derouter-pgvector
                        </a>
                      </li>
              ...
              {selectedProvider === "valkey" && (
                <Alert variant="info">
                  ...
                  <AlertDescription>
                    <p>
                      DeRouter searches documents you have already stored in Valkey. It does not create the index or
                    ...
                    <p style={{ marginTop: "8px" }}>
                      When a query comes in, DeRouter converts it to an embedding with the model below and returns the
                  ...
                  <AlertDescription>
                    ...
                    <ol style={{ marginLeft: "16px", marginTop: "8px", listStyleType: "decimal" }}>
                      ...
                      <li>
                        ...
                        the Engine ID field. The Vector Store ID is still required as the DeRouter-side name for this
              ...
              <FormField
                ...
                label={labelWithHint(
                  "Vector Store Name",
                  "Custom name you want to give to the vector store, this name will be rendered on the DeRouter UI",
                )}
              >
