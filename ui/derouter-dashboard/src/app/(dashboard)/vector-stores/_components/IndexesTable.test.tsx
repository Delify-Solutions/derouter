...
const newerIndex: VectorStoreIndex = {
  ...
  derouter_params: { vector_store_index: "provider-newer", vector_store_name: "newer-store" },
...
const olderIndex: VectorStoreIndex = {
  ...
  derouter_params: { vector_store_index: "provider-older", vector_store_name: "older-store" },
  created_by: "admin@example.com",
...
const undatedIndex: VectorStoreIndex = {
  ...
  derouter_params: { vector_store_index: "provider-undated", vector_store_name: "undated-store" },
  created_by: null,
  created_at: null,
};
