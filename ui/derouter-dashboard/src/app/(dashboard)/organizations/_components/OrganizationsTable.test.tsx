...
describe("OrganizationsTable", () => {
  ...
  it("renders budget, limits, members, and models for a fully-populated organization", () => {
    render(
      <OrganizationsTable
        ...
        organizations={[
          makeOrganization({
            derouter_budget_table: { max_budget: 100, tpm_limit: 1000, rpm_limit: 60 },
  ...
  it("shows Unlimited budget and All Proxy Models when unset", () => {
    render(
      <OrganizationsTable
        {...baseProps}
        organizations={[makeOrganization({ organization_id: "org-empty", derouter_budget_table: {}, models: [] })]}
      />,
    );
  ...
  it("renders a tpm/rpm limit of 0 as 0, never as Unlimited", () => {
    render(
      <OrganizationsTable
        {...baseProps}
        organizations={[makeOrganization({ derouter_budget_table: { max_budget: null, tpm_limit: 0, rpm_limit: 0 } })]}
      />,
    );
