      ...
      <div className="w-full p-8">
        <Card>
          ...
          <CardContent className="flex flex-col items-start gap-4">
            ...
            <Button
              render={
                <a href="https://router.delify.vn/docs/proxy/cost_tracking" target="_blank" rel="noreferrer">
                  View Usage Guide
                </a>
              }
            />
        ...
        <TabsContent value="customer-usage" keepMounted>
          <p className="mb-2 text-[12px] text-muted-foreground italic">
            ...
            <a
              ...
              href="https://router.delify.vn/docs/proxy/users"
              target="_blank"
              rel="noreferrer"
            >
              docs here
              ...
              <Card>
                ...
                <CardContent className="flex flex-col gap-2">
                  <p className="text-sm text-muted-foreground">
                    ...
                    <a
                      className="text-primary"
                      href="https://router.delify.vn/docs/proxy/cost_tracking"
                      target="_blank"
                      rel="noreferrer"
                    >
                      here
