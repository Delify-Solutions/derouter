...
vi.mock("@/app/(dashboard)/hooks/models/useModels", () => ({
  useAutoRouters: vi.fn(() => ({
    data: [
      { model_name: "claude-auto", derouter_params: { model: "auto_router/claude-auto" } },
      { model_name: "gpt-auto", derouter_params: { model: "auto_router/gpt-auto" } },
    ],
  })),
...
vi.mock("@/app/(dashboard)/hooks/models/useModelCostMap", () => ({
  useModelCostMap: vi.fn(() => ({
    data: {
      "claude-sonnet-5": { derouter_provider: "anthropic", mode: "chat" },
      "gpt-4o": { derouter_provider: "openai", mode: "chat" },
      "gemini/gemini-2.5-pro": { derouter_provider: "gemini", mode: "chat" },
      "text-embedding-3-large": { derouter_provider: "openai", mode: "embedding" },
    },
  })),
}));
