...
const CONFIG_KEY_BY_ROUTER_TYPE: Record<string, keyof NonNullable<AutoRouterDeployment["derouter_params"]>> = {
...
const deploymentFor = (
  ...
  return autoRouters.find((d) => d.model_name === routerName && d.derouter_params?.[configKey]);
};
...
const tierLabelsFor = (
  ...
  const config = asRecord(deployment.derouter_params?.complexity_router_config);
