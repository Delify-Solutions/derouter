      ...
      guardrails: [
        {
          ...
          derouter_params: { guardrail: "headroom", api_base: "https://a.example.com", default_on: true },
        },
        {
          guardrail_id: "g-2",
          guardrail_name: "opt-in-one",
          derouter_params: { guardrail: "headroom", api_base: "https://b.example.com", default_on: false },
        },
      ],
    });
    render(<PromptCompressionTab accessToken="test-token" />);
