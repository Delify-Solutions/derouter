...
describe("compressionGuardrailsOf", () => {
  it("keeps only headroom-provider guardrails and drops others", () => {
    const filtered = compressionGuardrailsOf({
      guardrails: [
        { guardrail_id: "1", guardrail_name: "headroom-compression", derouter_params: { guardrail: "headroom" } },
        { guardrail_id: "2", guardrail_name: "pii-masker", derouter_params: { guardrail: "presidio" } },
        { guardrail_id: "3", guardrail_name: "no-params", derouter_params: null },
      ],
    });
