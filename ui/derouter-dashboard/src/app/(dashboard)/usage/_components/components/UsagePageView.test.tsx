...
describe("UsagePage", () => {
  ...
  describe("model view toggle", () => {
    ...
    it("should switch to Litellm Model Name view on toggle click", async () => {
      ...
      const derouterToggle = screen.getAllByText("Litellm Model Name")[0];
      act(() => {
        fireEvent.click(derouterToggle);
      });
    ...
    it("should switch the Model Activity tab to the derouter models breakdown on toggle click", async () => {
      renderWithProviders(<UsagePage {...defaultProps} />);
