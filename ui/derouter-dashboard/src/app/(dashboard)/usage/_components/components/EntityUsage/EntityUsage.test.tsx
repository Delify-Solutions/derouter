...
describe("EntityUsage", () => {
  ...
  it("feeds the per-user spend card every visible team except the dashboard team, only for teams", async () => {
    ...
    mockUseTeams.mockReturnValue(
      teamsResult([{ team_id: "team-alpha" }, { team_id: "derouter-dashboard" }, { team_id: "team-beta" }]),
    );
  ...
  it("defaults Model Activity to public model names and toggles to derouter models", async () => {
