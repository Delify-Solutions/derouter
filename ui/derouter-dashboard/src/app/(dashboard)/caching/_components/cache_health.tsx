    ...
    if (response?.error) {
      try {
        ...
        errorDetails = {
          ...
          derouter_params: errorMessage?.derouter_cache_params || {},
          health_check_cache_params: errorMessage?.health_check_cache_params || {},
        };

        parsedLitellmParams = deepParse(errorDetails.derouter_params) || {};
      ...
      parsedLitellmParams = deepParse(response?.derouter_cache_params) || {};
            ...
            <table className="w-full border-collapse">
              <tbody>
                ...
                <TableClickableErrorField
                  label="derouter_settings.cache_params"
            ...
            <pre className="whitespace-pre-wrap wrap-break-word overflow-auto max-h-[500px]">
              {(() => {
                try {
                  const data = {
                    ...response,
                    derouter_cache_params: parsedLitellmParams,
