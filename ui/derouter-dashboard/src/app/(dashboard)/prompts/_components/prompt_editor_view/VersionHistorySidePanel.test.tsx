...
describe("VersionHistorySidePanel", () => {
  ...
  it.each([
    ["dot suffix", "welcome.v7", { prompt_id: "welcome.v7", derouter_params: {}, prompt_info: { prompt_type: "db" } }],
    [
      "underscore suffix",
      "welcome_v8",
      { prompt_id: "welcome_v8", derouter_params: {}, prompt_info: { prompt_type: "db" } },
    ],
    ["no suffix", "welcome", { prompt_id: "welcome", derouter_params: {}, prompt_info: { prompt_type: "db" } }],
  ...
  it("should show a placeholder when a creation date is unavailable", async () => {
    vi.mocked(getPromptVersions).mockResolvedValue({
      prompts: [{ prompt_id: "welcome.v1", version: 1, derouter_params: {}, prompt_info: { prompt_type: "db" } }],
    });
