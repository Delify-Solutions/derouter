...
const pluginModeValue = {
  mode: "derouter-platform-plugin" as string,
  setMode: vi.fn(),
  plugins: [{ name: "derouter-platform-plugin", display_name: "Chat UI", url: "http://localhost:3300" }],
  activePlugin: { name: "derouter-platform-plugin", display_name: "Chat UI", url: "http://localhost:3300" } as {
    name: string;
    display_name: string;
    url: string;
  } | null,
