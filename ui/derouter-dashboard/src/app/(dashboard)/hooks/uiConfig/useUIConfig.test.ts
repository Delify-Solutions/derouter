...
import { getUiConfig, DeRouterWellKnownUiConfig } from "@/components/networking";
...
// Mock data
const mockUIConfig: DeRouterWellKnownUiConfig = {
  sso_configured: true,
...
describe("useUIConfig", () => {
  ...
  it("should return different UI config data correctly", async () => {
    const alternativeUIConfig: DeRouterWellKnownUiConfig = {
      server_root_path: "/v1",
      proxy_base_url: null,
