...
describe("useGuardrails", () => {
  ...
  it("should partition guardrails into global and optional sets based on default_on", async () => {
    const mockMixedResponse = {
      guardrails: [
        { guardrail_name: "global-guard-a", derouter_params: { default_on: true } },
        { guardrail_name: "global-guard-b", derouter_params: { default_on: true } },
        { guardrail_name: "optional-guard-a", derouter_params: { default_on: false } },
