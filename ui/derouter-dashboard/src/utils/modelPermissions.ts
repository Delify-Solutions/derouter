 ...
 * route RBAC (`_check_proxy_admin_viewer_access` in derouter/proxy/auth/route_checks.py),
 ...
 * derouter/proxy/management_endpoints/model_management_endpoints.py behind it.
 *
