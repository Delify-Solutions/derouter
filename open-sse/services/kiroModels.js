 ...
 * API. They are derouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic derouter variant set for a single upstream Kiro model.
 *
 ...
 * into derouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
