 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what derouter needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a derouter
 ...
 * The suffix is a derouter request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a derouter synthetic agentic variant.
...
/**
 * Detect whether a model id is a derouter synthetic thinking variant
...
/**
 * Resolve a derouter model id to the real upstream Kiro model id, plus flags
