...
#   DEROUTER_BASE_URL=http://localhost:4000 DEROUTER_KEY=sk-1234 bash qa_sticky_session.sh

set -euo pipefail

BASE="${DEROUTER_BASE_URL:-http://localhost:4000}"
KEY="${DEROUTER_KEY:-sk-1234}"
MODEL="${DEROUTER_MODEL:-gpt-4o-mini}"
