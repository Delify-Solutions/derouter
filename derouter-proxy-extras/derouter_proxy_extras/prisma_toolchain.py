...
release: ``DEROUTER_PRISMA_BOOTSTRAP_TIMEOUT`` for the toolchain install,
``DEROUTER_PRISMA_MIGRATE_DEPLOY_TIMEOUT`` for ``prisma migrate deploy`` and
``DEROUTER_PRISMA_COMMAND_TIMEOUT`` for every other Prisma command. The
...
PRISMA_COMMAND_TIMEOUT_ENV_VAR = "DEROUTER_PRISMA_COMMAND_TIMEOUT"
PRISMA_BOOTSTRAP_TIMEOUT_ENV_VAR = "DEROUTER_PRISMA_BOOTSTRAP_TIMEOUT"
PRISMA_MIGRATE_DEPLOY_TIMEOUT_ENV_VAR = "DEROUTER_PRISMA_MIGRATE_DEPLOY_TIMEOUT"
