CREATE TABLE IF NOT EXISTS "DeRouter_AutoRouterSession" (
    ...
    CONSTRAINT "DeRouter_AutoRouterSession_pkey" PRIMARY KEY ("api_key", "session_id", "router_name")
);

CREATE INDEX IF NOT EXISTS "idx_autorouter_session_last_turn" ON "DeRouter_AutoRouterSession"("last_turn_at");
