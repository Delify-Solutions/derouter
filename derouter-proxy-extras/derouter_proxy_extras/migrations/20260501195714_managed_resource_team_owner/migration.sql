...
ALTER TABLE "DeRouter_ManagedFileTable" ADD COLUMN IF NOT EXISTS "team_id" TEXT;
ALTER TABLE "DeRouter_ManagedObjectTable" ADD COLUMN IF NOT EXISTS "team_id" TEXT;
ALTER TABLE "DeRouter_ManagedVectorStoreTable" ADD COLUMN IF NOT EXISTS "team_id" TEXT;

-- Index names follow Prisma's auto-generated convention so `prisma migrate diff`
-- against the schema is clean.
CREATE INDEX IF NOT EXISTS "DeRouter_ManagedFileTable_team_id_created_at_idx" ON "DeRouter_ManagedFileTable" ("team_id", "created_at" DESC);
CREATE INDEX IF NOT EXISTS "DeRouter_ManagedObjectTable_team_id_created_at_idx" ON "DeRouter_ManagedObjectTable" ("team_id", "created_at" DESC);
CREATE INDEX IF NOT EXISTS "DeRouter_ManagedVectorStoreTable_team_id_created_at_idx" ON "DeRouter_ManagedVectorStoreTable" ("team_id", "created_at" DESC);
