...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "DeRouter_HealthCheckTable_model_id_model_name_checked_at_idx" ON "DeRouter_HealthCheckTable"("model_id", "model_name", "checked_at" DESC);
