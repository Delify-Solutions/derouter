...
public_exceptions = derouter.DEROUTER_EXCEPTION_TYPES
...
if undocumented_keys:
    raise Exception(
        f"\nKeys not documented in 'DeRouter Exceptions': {undocumented_keys}"
    )
else:
    print("\nAll keys are documented in 'DeRouter Exceptions'. - {}".format(error_names))
