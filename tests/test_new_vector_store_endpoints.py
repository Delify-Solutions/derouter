...
async def test_vector_store_retrieve_basic():
    ...
    with patch(
        "derouter.vector_stores.main.aretrieve",
...
async def test_vector_store_list_basic():
    ...
    with patch(
        "derouter.vector_stores.main.alist",
        new=AsyncMock(return_value=mock_response),
    ) as mock_list:
        router = derouter.Router(model_list=[])
...
async def test_vector_store_update_basic():
    ...
    with patch(
        "derouter.vector_stores.main.aupdate",
        new=AsyncMock(return_value=mock_response),
    ) as mock_update:
        router = derouter.Router(model_list=[])
...
async def test_vector_store_delete_basic():
    ...
    with patch(
        "derouter.vector_stores.main.adelete",
        new=AsyncMock(return_value=mock_response),
    ) as mock_delete:
        router = derouter.Router(model_list=[])
...
async def test_vector_store_list_with_pagination():
    ...
    with patch(
        "derouter.vector_stores.main.list",
...
async def test_vector_store_update_with_expires_after():
    ...
    with patch(
        "derouter.vector_stores.main.update",
        return_value=mock_response,
    ) as mock_update:
        router = derouter.Router(model_list=[])
