"""Tests for the /public/derouter_blog_posts endpoint."""
...
SAMPLE_POSTS = [
    {
        ...
        "date": "2026-01-01",
        "url": "https://www.router.delify.vn/blog/test",
    }
]
...
def client():
    ...
    from derouter.proxy.public_endpoints.public_endpoints import router
...
def test_get_blog_posts_returns_response_shape(client):
    with patch(
        "derouter.proxy.public_endpoints.public_endpoints.get_blog_posts",
        return_value=SAMPLE_POSTS,
    ):
        response = client.get("/public/derouter_blog_posts")
    ...
    assert post["url"] == "https://www.router.delify.vn/blog/test"
    ...
    many_posts = [
        {
            ...
            "description": "desc",
            "date": "2026-01-01",
            "url": f"https://www.router.delify.vn/blog/{i}",
        }
        for i in range(10)
    ]
