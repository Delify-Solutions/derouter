...
async def test_get_favicon_default():
    ...
    os.environ.pop("DEROUTER_FAVICON_URL", None)
...
async def test_get_favicon_with_custom_url(monkeypatch):
    ...
    monkeypatch.setenv("DEROUTER_FAVICON_URL", "https://example.com/favicon.ico")
...
async def test_get_favicon_remote_url_is_not_server_fetched(monkeypatch):
    ...
    monkeypatch.setenv("DEROUTER_FAVICON_URL", "https://invalid.com/favicon.ico")
