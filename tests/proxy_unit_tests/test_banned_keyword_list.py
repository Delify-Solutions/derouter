...
import pytest
import derouter
from derouter.proxy.enterprise.enterprise_hooks.banned_keywords import (
...
async def test_banned_keywords_check():
    """
    - Set some banned keywords as a derouter module value
    ...
    """
    derouter.banned_keywords_list = ["hello"]
