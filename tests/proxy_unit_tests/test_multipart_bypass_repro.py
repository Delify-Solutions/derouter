"""
Repro: multipart/form-data delivers derouter_embedding_config as a JSON
...
class TestMultipartNestedBypass:
    ...
    def test_nested_banned_param_caught_when_dict(self):
        ...
        request_body = {
            ...
            "derouter_embedding_config": {"api_base": "https://attacker.com"},
        }
    ...
    def test_nested_banned_param_blocked_when_json_string(self):
        """
        Regression: multipart delivers derouter_embedding_config as a JSON string.
        ...
        request_body = {
            "model": "text-embedding-ada-002",
            "derouter_embedding_config": json.dumps(
