...
from derouter.proxy.types_utils.utils import (
    get_instance_fn,
...
"""
    ...
    def test_s3_url_parsing(self):
        ...
        with patch(
            "derouter.proxy.common_utils.load_config_utils.download_python_file_from_s3"
        ) as mock_download:
    ...
    def test_gcs_url_parsing(self):
        ...
        with patch(
            "derouter.proxy.types_utils.utils._download_gcs_file_wrapper"
        ) as mock_download:
    ...
    @patch("derouter.proxy.common_utils.load_config_utils.download_python_file_from_s3")
    ...
    @patch("derouter.proxy.types_utils.utils._download_gcs_file_wrapper")
