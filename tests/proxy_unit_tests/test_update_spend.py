...
from derouter.proxy.utils import _get_redoc_url, _get_docs_url
...
import httpx
import math
from derouter.constants import SPEND_LOG_WRITE_BATCH_MAX_ROWS
from derouter.proxy.utils import update_spend
...
class MockPrismaClient:
    def __init__(self):
        ...
        self.db = AsyncMock()
        self.db.derouter_spendlogs = AsyncMock()
        self.db.derouter_spendlogs.create_many = AsyncMock()
...
async def test_update_spend_logs_connection_errors(error_type):
    ...
    prisma_client.db.derouter_spendlogs.create_many = create_many_mock
