...
def test_routes_on_derouter_proxy():
    """
    ...
    print("ALL ROUTES on DeRouter Proxy:", _all_routes)
    print("\n\n")
    print("ALL OPENAI ROUTES:", DeRouterRoutes.openai_routes.value)

    for route in DeRouterRoutes.openai_routes.value:
