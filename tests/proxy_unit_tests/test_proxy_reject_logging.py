...
def _register_proxy_test_logger(callback_logger: testLogger) -> None:
    ...
    only ``derouter.callbacks``.
    """
    derouter.callbacks = [callback_logger]
    derouter.success_callback = [callback_logger]
    derouter.failure_callback = [callback_logger]
    derouter._async_success_callback = [callback_logger]
    derouter._async_failure_callback = [callback_logger]
...
async def test_chat_completion_request_with_redaction(route, body):
    ...
    Makes a /chat/completions request on DeRouter Proxy
