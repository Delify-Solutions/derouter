...
@patch("derouter.proxy.proxy_server.get_complete_model_list")
@patch("derouter.proxy.proxy_server.get_key_models")
@patch("derouter.proxy.proxy_server.get_team_models")
@patch("derouter.proxy.proxy_server.get_all_fallbacks")
def test_model_list_with_fallback_metadata(
    ...
    try:
        from derouter.proxy.proxy_server import DEFAULT_MODEL_CREATED_AT_TIME
    except ImportError:
