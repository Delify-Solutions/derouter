...
def mock_env_vars(monkeypatch):
    ...
    monkeypatch.setenv("DEROUTER_MASTER_KEY", "mock_master_key")
...
async def test_auth_callback_new_user(mock_google_sso, mock_env_vars, prisma_client):
    ...
    try:
        ...
        derouter.proxy.proxy_server.master_key = "mock_master_key"
        ...
        user = await prisma_client.db.derouter_usertable.find_first(
...
async def test_auth_callback_new_user_with_sso_default(
    ...
    """
    When derouter_settings.default_internal_user_params.user_role = 'INTERNAL_USER'
