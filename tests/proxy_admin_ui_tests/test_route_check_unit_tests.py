...
from derouter.proxy._types import DeRouter_UserTable, LitellmUserRoles, UserAPIKeyAuth
...
import derouter.proxy.auth.route_checks
...
derouter.proxy.auth.route_checks.hash_token = mock_hash_token
