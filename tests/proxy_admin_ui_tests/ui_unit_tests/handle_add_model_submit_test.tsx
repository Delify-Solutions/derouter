import { handleAddModelSubmit } from '../../../ui/derouter-dashboard/src/components/add_model/handle_add_model_submit';
import { modelCreateCall } from '../../../ui/derouter-dashboard/src/components/networking';

// Mock the dependencies
const mockModelCreateCall = jest.fn().mockResolvedValue({ data: 'success' });
jest.mock('../../../ui/derouter-dashboard/src/components/networking', () => ({
  modelCreateCall: async (accessToken: string, formValues: any) => mockModelCreateCall(formValues)
}));

// Also need to mock provider_map
jest.mock('../../../ui/derouter-dashboard/src/components/provider_info_helpers', () => ({
  provider_map: {
    'openai': 'openai'
  }
}));
