...
from derouter.types.guardrails import ApplyGuardrailRequest, ApplyGuardrailResponse
...
async def test_bedrock_apply_guardrail_endpoint_integration(mock_proxy_logging_ctx):
    ...
    from derouter.proxy.guardrails.guardrail_endpoints import apply_guardrail
