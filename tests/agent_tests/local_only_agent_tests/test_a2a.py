...
async def test_asend_message_with_client_decorator():
    ...
    This tests the DeRouter logging integration.
    """
...
async def test_a2a_logging_payload():
    ...
    Validates the @client decorator integration with DeRouter logging.
    """
...
async def test_pydantic_ai_non_streaming():
    ...
    response = await asend_message(
        ...
        derouter_params={"custom_llm_provider": "pydantic_ai_agents"},
    )
