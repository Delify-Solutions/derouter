...
edits:
    ...
    DEROUTER_COMPAT_RATE_ANTHROPIC          (req/s, default 5.0)
    DEROUTER_COMPAT_RATE_AZURE              (req/s, default 5.0)
    DEROUTER_COMPAT_RATE_VERTEX_AI          (req/s, default 5.0)
    DEROUTER_COMPAT_RATE_BEDROCK_CONVERSE   (req/s, default 5.0)
    DEROUTER_COMPAT_RATE_BEDROCK_INVOKE     (req/s, default 5.0)
    DEROUTER_COMPAT_RATE_OPENAI             (req/s, default 5.0)
    DEROUTER_COMPAT_RATE_AZURE_OPENAI       (req/s, default 5.0)
    DEROUTER_COMPAT_RATE_BEDROCK_MANTLE     (req/s, default 5.0)
    DEROUTER_COMPAT_RATE_BURST              (per-bucket burst override;
                                            default = rate)
    DEROUTER_COMPAT_RATE_STATE_DIR          (state file directory;
                                            default = $TMPDIR/derouter-claude-compat-ratelimit)
...
RATE_ENV_PREFIX = "DEROUTER_COMPAT_RATE_"
BURST_ENV = "DEROUTER_COMPAT_RATE_BURST"
STATE_DIR_ENV = "DEROUTER_COMPAT_RATE_STATE_DIR"
DEFAULT_STATE_DIR_NAME = "derouter-claude-compat-ratelimit"
...
def load_config(
    ...
    crashing the test session — a typo in `DEROUTER_COMPAT_RATE_AZURE`
...
def _state_dir(env: Optional[Mapping[str, str]] = None) -> Path:
    ...
    A user-supplied `DEROUTER_COMPAT_RATE_STATE_DIR` wins for tests and
