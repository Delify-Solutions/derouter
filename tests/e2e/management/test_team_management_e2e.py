...
class TeamMembership(BaseModel):
    user_id: str
    derouter_budget_table: MemberBudgetTable | None = None
...
def _member_max_budget(info: TeamInfoRead, user_id: str) -> float | None:
    ...
    if membership is None or membership.derouter_budget_table is None:
        return None
    return membership.derouter_budget_table.max_budget
