...
from models import KeyGenerateBody, DeRouterParamsBody, ModelInfoBody, ModelNewBody
...
def _create_db_model(client: ManagementClient, resources: ResourceManager, model_name: str) -> str:
    model_id = client.proxy.create_model(
        model_name, DeRouterParamsBody(model=_DUMMY_MODEL, api_key=_DUMMY_API_KEY)
    )
    ...
    def test_non_admin_key_cannot_add_global_model(
        ...
        outcome = client.proxy.transport.send(
            ...
            json=ModelNewBody(
                ...
                derouter_params=DeRouterParamsBody(model=_DUMMY_MODEL, api_key=_DUMMY_API_KEY),
