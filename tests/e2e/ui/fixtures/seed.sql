...
DELETE FROM "DeRouter_TeamMembership" WHERE "user_id" LIKE 'e2e-%';
DELETE FROM "DeRouter_VerificationToken" WHERE token LIKE 'e2e-%';
DELETE FROM "DeRouter_TeamTable" WHERE "team_id" LIKE 'e2e-%';
DELETE FROM "DeRouter_OrganizationTable" WHERE "organization_id" LIKE 'e2e-%';
DELETE FROM "DeRouter_UserTable" WHERE "user_id" LIKE 'e2e-%';
DELETE FROM "DeRouter_BudgetTable" WHERE "budget_id" LIKE 'e2e-%';

-- 2. Budget (created_by and updated_by are NOT NULL)
INSERT INTO "DeRouter_BudgetTable" ("budget_id", "max_budget", "created_by", "updated_by")
VALUES ('e2e-budget-org', 1000, 'e2e-proxy-admin', 'e2e-proxy-admin');

-- 3. Organization (created_by and updated_by are NOT NULL)
INSERT INTO "DeRouter_OrganizationTable" (
...
INSERT INTO "DeRouter_UserTable" ("user_id", "user_email", "user_role", "teams", "password")
VALUES
...
INSERT INTO "DeRouter_TeamTable" (
...
INSERT INTO "DeRouter_TeamMembership" ("user_id", "team_id", "spend")
VALUES
...
INSERT INTO "DeRouter_VerificationToken" (
