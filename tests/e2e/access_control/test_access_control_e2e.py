...
derouter-regression-tests/tests/test_access_control.py: the source asserted 401 for
...
from models import ChatBody, ChatMessage, ChatResponse, EmbedBody, DeRouterParamsBody
...
class TestVirtualKeyAuth:
    ...
    def test_valid_key_allows_and_invalid_key_denied(
        ...
        model_id = proxy.create_model(
            model,
            DeRouterParamsBody(model=VIRTUAL_KEY_BACKEND, api_key="os.environ/ANTHROPIC_API_KEY"),
        )
