...
class ContentFilterParamsBody(GuardrailParamsBase):
    guardrail: Literal["derouter_content_filter"] = "derouter_content_filter"
...
class GuardrailSpecBody(BaseModel):
    guardrail_name: str
    derouter_params: GuardrailParamsBody
...
class GuardrailsClient:
    ...
    def create_backend_model(
        ...
        *,
        ...
        model_id = self.proxy.create_model(
            model_name,
            DeRouterParamsBody(model=backend, api_key=api_key),
        )
    ...
    def register(self, name: str, params: GuardrailParamsBody) -> str:
        ...
        guardrail_id = unwrap(
            self.proxy.transport.post(
                ...
                json=GuardrailCreateBody(guardrail=GuardrailSpecBody(guardrail_name=name, derouter_params=params)),
    ...
    def chat_raw(
        ...
        *,
        ...
        assertions a typed body cannot carry: the `x-derouter-applied-guardrails`
