...
by hand, drive the proxy through the shared DeRouterRealtimeLLMService (pipecat's
...
test passing points at pipecat, not derouter.
"""
...
from pipecat_service import DeRouterRealtimeLLMService  # noqa: E402
...
async def _run_pipeline(key: str, model: str) -> tuple[bool, bool]:
    ...
    llm = DeRouterRealtimeLLMService(
