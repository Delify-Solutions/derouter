...
from models import ChatBody, ChatMessage, ChatTool, ChatToolFunction, DeRouterParamsBody
...
class TestResponsesBridgeChatCompletionsStreaming:
    ...
    def bridged_model(self, client: PassthroughClient, resources: ResourceManager) -> str:
        ...
        model_id = client.proxy.create_model(
            model,
            DeRouterParamsBody(model=RESPONSES_ONLY_BACKEND, api_key="os.environ/OPENAI_API_KEY"),
        )
