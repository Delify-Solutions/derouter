...
param mapper (``derouter/llms/deepseek/chat/transformation.py``
...
from models import ChatBody, ChatMessage, ChatResponse, DeRouterParamsBody, ThinkingParam
...
def _register_reasoner(client: PassthroughClient, resources: ResourceManager) -> str:
    ...
    model_id = client.proxy.create_model(
        model,
        DeRouterParamsBody(model=REASONER, api_key="os.environ/DEEPSEEK_API_KEY"),
    )
