...
def test_cell_claimed_only_by_a_skipped_test_is_uncovered() -> None:
    ...
    assert "derouter_e2e_coverage_skipped_markers 1" in render_prometheus(report)
...
def test_prometheus_render_exposes_module_coverage_timeseries() -> None:
    ...
    assert 'derouter_e2e_coverage_cells{module="Core LLMs",state="covered"} 1' in metrics
    assert 'derouter_e2e_coverage_percent{module="Core LLMs"} 100.000000' in metrics
    assert 'derouter_e2e_coverage_percent{module="Non-Core LLMs"} 0.000000' in metrics
    assert "derouter_e2e_coverage_orphan_markers 0" in metrics
