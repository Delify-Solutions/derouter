...
components. In the response headers, `x-derouter-response-cost-input` is net of
...
from models import DeRouterParamsBody, SpendLogsParams
...
def register_priced_model(
    ...
    model_id = proxy.create_model(model_name, derouter_params)
