...
from derouter.proxy.guardrails.guardrail_helpers import should_proceed_based_on_metadata
from derouter.types.guardrails import GuardrailEventHooks
from derouter.proxy.guardrails.guardrail_endpoints import _get_guardrails_list_response
from derouter.types.guardrails import GuardrailInfoResponse, ListGuardrailsResponse
    ...
    minimal_config = [
        {
            ...
            "derouter_params": {"guardrail": "minimal-guard", "mode": "pre_call"},
        }
    ]
