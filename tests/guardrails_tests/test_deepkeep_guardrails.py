...
async def test_callback_blocked():
    ...
    deepkeep_guardrails = derouter.logging_callback_manager.get_custom_loggers_for_type(
        DeepKeepGuardrail
    )
    ...
    mock_response = Response(
        ...
        request=Request(
            method="POST",
            url="https://test.deepkeep.ai/v3/openai/beta/derouter_basic_guardrail_api",
        ),
    )
