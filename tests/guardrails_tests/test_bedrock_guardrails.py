...
async def test_bedrock_guardrails_with_streaming():
    ...
    async def _stream_through_guardrail():
        ...
        derouter.callbacks.append(guardrail)
        ...
        chunks = [
            ModelResponseStream(
                ...
                choices=[
                    derouter.utils.StreamingChoices(
                        index=0,
                        delta=derouter.utils.Delta(content="Sure! My email is "),
                        finish_reason=None,
                    )
                ],
                created=1234567890,
            ...
            ModelResponseStream(
                ...
                choices=[
                    derouter.utils.StreamingChoices(
                        index=0,
                        delta=derouter.utils.Delta(content="123-45-6789"),
                        finish_reason="stop",
                    )
                ],
                created=1234567890,
        ...
        chunks = [
            ModelResponseStream(
                ...
                choices=[
                    derouter.utils.StreamingChoices(
                        index=0,
                        delta=derouter.utils.Delta(content="My email is "),
                        finish_reason=None,
                    )
                ],
                created=1234567890,
            ...
            ModelResponseStream(
                ...
                choices=[
                    derouter.utils.StreamingChoices(
                        index=0,
                        delta=derouter.utils.Delta(content="john@example.com"),
                        finish_reason="stop",
                    )
                ],
                created=1234567890,
...
async def test_bedrock_guardrail_blocked_action_shows_output_text():
    ...
    mock_bedrock_response.json.return_value = {
        "action": "GUARDRAIL_INTERVENED",
        "outputs": [{"text": "this violates derouter corporate guardrail policy"}],
        "assessments": [
            {
                "topicPolicy": {
                    "topics": [
    ...
    with patch.object(
        ...
        expected_output_text = "this violates derouter corporate guardrail policy"
        ...
        chunks = [
            ...
            ModelResponseStream(
                ...
                choices=[
                    derouter.utils.StreamingChoices(
                        index=0,
                        delta=derouter.utils.Delta(content="step 1, step 2..."),
                        finish_reason="stop",
                    )
                ],
                created=1234567890,
        ...
        choices=[
            derouter.Choices(
                ...
                message=derouter.Message(
                    ...
                    tool_calls=[
                        derouter.utils.ChatCompletionMessageToolCall(
                            id="tooluse_kZJMlvQmRJ6eAyJE5GIl7Q",
                            function=derouter.utils.Function(
