...
class TestRouteLoader:
    ...
    def test_load_builtin_prompt_injection_template(self):
        from derouter.proxy.guardrails.guardrail_hooks.semantic_guard.route_loader import (
...
class TestContentFilterSqlInjectionTemplate:
    """Tests for the keyword-based SQL injection policy template (derouter-content-filter)."""
    ...
    def sql_injection_guardrail(self):
        ...
        content_filter_dir = os.path.join(
            ...
            "../../derouter/proxy/guardrails/guardrail_hooks/derouter_content_filter",
        )
        ...
        return ContentFilterGuardrail(
            ...
            event_hook=derouter.types.guardrails.GuardrailEventHooks.pre_call,
        )
...
class TestContentFilterPromptInjectionTemplate:
    """Tests for the keyword-based prompt injection policy template (derouter-content-filter)."""
