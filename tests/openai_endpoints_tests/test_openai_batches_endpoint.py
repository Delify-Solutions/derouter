...
async def test_list_batches_with_target_model_names():
    ...
    with (
        ...
        from derouter.proxy.batches_endpoints.endpoints import list_batches
...
async def test_batch_status_sync_from_provider_to_database():
    ...
    unified_batch_id = "derouter_proxy:test_unified_batch"
    ...
    mock_prisma_client.db.derouter_managedobjecttable.find_first.assert_called_once_with(
    ...
    updated_batch_response = DeRouterBatch(
        id=batch_id,
        object="batch",
    ...
    mock_prisma_client.db.derouter_managedobjecttable.update.assert_called_once()
    update_call_args = mock_prisma_client.db.derouter_managedobjecttable.update.call_args
...
async def test_batch_cancel_updates_database():
    ...
    unified_batch_id = "derouter_proxy:cancel_test"

    # Mock cancelled batch response from provider
    cancelled_batch_response = DeRouterBatch(
        id=batch_id,
        object="batch",
        status="cancelled",
        endpoint="/v1/chat/completions",
...
async def test_batch_terminal_state_skip_provider_call():
    ...
    unified_batch_id = "derouter_proxy:completed_test"
...
async def test_batch_no_status_change_skip_update():
    ...
    unified_batch_id = "derouter_proxy:no_change_test"
    ...
    mock_prisma_client.db.derouter_managedobjecttable.update.assert_not_called()
