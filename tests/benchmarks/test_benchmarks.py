"""
Performance benchmarks for derouter core operations.

These benchmarks measure the performance of frequently called functions
in the derouter hot path: token counting, model info lookup, provider
...
def test_get_model_cost_key_exact_match():
    ...
    derouter.utils._get_model_cost_key("gpt-4o")
