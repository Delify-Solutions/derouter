...
class TestServiceLoggerOTEL(unittest.IsolatedAsyncioTestCase):
    ...
    @patch("derouter.integrations.opentelemetry.OpenTelemetry._init_tracing")
    @patch("derouter.integrations.opentelemetry.OpenTelemetry._init_metrics")
    @patch("derouter.integrations.opentelemetry.OpenTelemetry._init_logs")
    ...
    async def test_langfuse_otel_does_not_create_proxy_request_span(
        ...
        """
        Test that LangfuseOtelLogger returns None for create_derouter_proxy_request_started_span.
        ...
        self.assertEqual(
            logger.create_derouter_proxy_request_started_span.__qualname__,
            "LangfuseOtelLogger.create_derouter_proxy_request_started_span",
        )

        # Verify it returns None
        result = logger.create_derouter_proxy_request_started_span(
    ...
    async def test_service_logging_shadowing_fix(
        ...
        derouter.service_callback = [langfuse_logger, otel_logger]
