...
# Add parent directory to path to import derouter (same pattern as other tests)
...
def mock_server():
    ...
    # Ensure api_base has trailing slash (DeRouter appends /v1/chat/completions)
    ...
    for attempt in range(max_attempts):
        ...
        try:
            # Test the actual endpoint we'll use (DeRouter appends /v1/chat/completions to api_base)
            response = httpx.post(
