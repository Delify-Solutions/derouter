...
ALLOWED_FILES = [
    # local files
    "../../derouter/__init__.py",
    "../../derouter/llms/custom_httpx/http_handler.py",
    "../../derouter/router_utils/client_initalization_utils.py",
    "../../derouter/llms/custom_httpx/http_handler.py",
    "../../derouter/llms/huggingface_restapi.py",
    "../../derouter/llms/base.py",
    "../../derouter/llms/custom_httpx/httpx_handler.py",
    "../../derouter/llms/openai/common_utils.py",
    "../../derouter/experimental_mcp_client/client.py",
