...
IGNORE_FUNCTIONS = [
    ...
    "__getattr__",  # lazy loading pattern in derouter/__init__.py with proper caching to prevent infinite recursion.
    ...
    "dict",  # max depth set. _DeRouterParamsDictView.dict() calls builtin dict(), not itself.
    ...
    "_redact_sensitive_derouter_params",  # max depth set (default 10).
    ...
    "_redact_agent_params_tree",  # max depth set (default 10), same shape as _redact_sensitive_derouter_params.
