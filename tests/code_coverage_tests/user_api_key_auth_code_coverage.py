...
def main():
    # router_file = [
    #     "./derouter/user_api_key_auth.py",
    # ]
    router_file = [
        "../../derouter/proxy/auth/user_api_key_auth.py",
    ]
    # router_file = [
    #     "../../derouter/router.py",
    #     "../../derouter/router_utils/pattern_match_deployments.py",
    #     "../../derouter/router_utils/batch_utils.py",
    # ]  ## LOCAL TESTING
    # tests_dir = (
