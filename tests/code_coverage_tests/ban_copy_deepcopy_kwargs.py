...
if __name__ == "__main__":
    # Check for copy.deepcopy(kwargs) usage in the derouter directory
    ...
    if violations:
        ...
        print("   - from derouter.proxy.utils import safe_deep_copy")
        print("   - from derouter.derouter_core_utils.core_helpers import safe_deep_copy")
        print("=" * 80)
