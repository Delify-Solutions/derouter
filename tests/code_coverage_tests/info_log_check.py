...
def check_sensitive_logging(base_dir: str) -> List[Dict[str, Any]]:
    ...
    Args:
        base_dir: Base directory to scan (typically the derouter root)
    ...
    # Directories to scan - only main derouter codebase
    scan_dirs = ["derouter", "enterprise"]  # Include enterprise directory if it exists
