...
def image_url():
    ...
    # and the non-square aspect ratio of the old DeRouter logo URL
    ...
    image_file.name = "derouter_logo.png"
...
# @pytest.mark.asyncio
# async def test_openai_image_variation_derouter_sdk(image_url, sync_mode):
#     from derouter import image_variation, aimage_variation
#
#     if sync_mode:
