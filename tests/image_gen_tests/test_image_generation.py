# What this tests?
## This tests the derouter support for the openai /generations endpoint
...
class TestVertexAIGeminiImageGeneration(BaseImageGenTest):
    ...
    def get_base_image_generation_call_args(self) -> dict:
        ...
        derouter.in_memory_llm_clients_cache = InMemoryCache()
        return {
            "model": "vertex_ai/gemini-2.5-flash-image",
            "vertex_ai_project": "derouter-ci-cd",
...
async def test_aiml_openai_gpt_image_2_request_uses_openai_param_shape():
    ...
    with patch("derouter.llms.custom_httpx.http_handler.HTTPHandler.post") as mock_post:
        ...
        await derouter.aimage_generation(
...
async def test_azure_image_generation_request_body():
    ...
    from derouter import aimage_generation
