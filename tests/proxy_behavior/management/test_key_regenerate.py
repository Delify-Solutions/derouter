...
async def test_key_regenerate_enforces_upperbound_key_params(
    ...
    derouter.upperbound_key_generate_params is rejected 400, a value within the
    ...
    derouter.* state, so monkeypatch save/restores it."""
    ...
    monkeypatch.setattr(
        ...
        DeRouter_UpperboundKeyGenerateParams(max_budget=100.0),
    )
