...
from derouter import create_fine_tuning_job
from derouter.llms.vertex_ai.fine_tuning.handler import (
    FineTuningJobCreate,
    VertexFineTuningAPI,
)
from derouter.types.llms.openai import Hyperparameters
...
async def test_create_vertex_fine_tune_jobs_mocked():
    ...
    original_success_callback = derouter.success_callback
    original_async_success_callback = derouter._async_success_callback
    ...
    try:
        with (
            ...
            create_fine_tuning_response = await derouter.acreate_fine_tuning_job(
                model=base_model,
        ...
        derouter.success_callback = original_success_callback
        derouter._async_success_callback = original_async_success_callback
...
async def test_mock_openai_create_fine_tune_job():
    ...
    previous_callbacks = derouter.callbacks
    ...
    with patch.object(client.fine_tuning.jobs, "create") as mock_create:
        ...
        response = await derouter.acreate_fine_tuning_job(
            model="gpt-4o-mini-2024-07-18",
            training_file="file-123",
    ...
    try:
        ...
        derouter.callbacks = previous_callbacks
...
async def test_mock_openai_list_fine_tune_jobs():
    ...
    with patch.object(
        ...
        await derouter.alist_fine_tuning_jobs(limit=2, after="ft-000", client=client)
...
async def test_mock_openai_cancel_fine_tune_job():
    ...
    with patch.object(client.fine_tuning.jobs, "cancel") as mock_cancel:
        try:
            await derouter.acancel_fine_tuning_job(
...
async def test_mock_azure_create_fine_tune_job_with_azure_specific_params():
    ...
    mock_response = DeRouterFineTuningJob(
        id="ft-azure-123",
    ...
    with patch(
        "derouter.llms.azure.fine_tuning.handler.AzureOpenAIFineTuningAPI.create_fine_tuning_job"
    ) as mock_create:
