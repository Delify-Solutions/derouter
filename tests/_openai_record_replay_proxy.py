...
Several E2E tests run the derouter proxy in its own container and curl it over
...
RECORD_KEY_PREFIX = "derouter:openai:record:"
...
# model's ``api_base``. This rides ``api_base`` (which every derouter provider
