...
class BaseAnthropicMessagesTest:
    ...
    async def test_non_streaming_base(self):
        ...
        # Call the handler
        response = await derouter.anthropic.messages.acreate(**call_args)
    ...
    async def test_response_format_consistency(self):
        ...
        Issue: https://github.com/Delify-Solutions/derouter/issues/20342
        """
        derouter._turn_on_debug()
            ...
            model_list=[
                {
                    ...
                    "derouter_params": {**self.model_config},
                }
            ]
        )
