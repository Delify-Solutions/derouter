"""
E2E Test suite for Bedrock Converse API structured outputs via derouter.anthropic.messages.
...
class TestBedrockConverseStructuredOutput(BaseAnthropicMessagesStructuredOutputTest):
    ...
    Uses the bedrock/converse/ prefix which routes through derouter.completion()
