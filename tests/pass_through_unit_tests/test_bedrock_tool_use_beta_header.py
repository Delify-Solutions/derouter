...
Tests that DeRouter correctly filters out the advanced-tool-use-2025-11-20 beta header
...
async def test_bedrock_sonnet_4_5_with_advanced_tool_use_beta_header():
    ...
    This should work without throwing "invalid beta flag" error because DeRouter
...
#     This should work because the beta header is filtered out by DeRouter before
