...
from derouter.proxy.pass_through_endpoints.llm_provider_handlers.vertex_ai_live_passthrough_logging_handler import (
...
class TestVertexAILivePassthroughLoggingHandler:
    ...
    def mock_logging_obj(self):
        ...
        mock = MagicMock(spec=DeRouterLoggingObj)
    ...
    @patch(
        "derouter.proxy.pass_through_endpoints.llm_provider_handlers.vertex_ai_live_passthrough_logging_handler.get_model_info"
    )
...
class TestVertexAILivePassthroughIntegration:
    ...
    @patch(
        "derouter.proxy.pass_through_endpoints.llm_passthrough_endpoints.websocket_passthrough_request"
    )
    @patch(
    ...
    @patch(
        "derouter.proxy.pass_through_endpoints.llm_provider_handlers.vertex_ai_live_passthrough_logging_handler.VertexAILivePassthroughLoggingHandler"
    )
    @pytest.mark.asyncio
