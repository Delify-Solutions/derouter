...
Gated on DEROUTER_IMAGE so it is skipped in the normal unit-test run and
...
UI_PORT = os.getenv("DEROUTER_UI_PORT", "3000")
ARBITRARY_UID = "1001200000:0"
STARTUP_TIMEOUT_SECONDS = int(os.getenv("DEROUTER_UI_STARTUP_TIMEOUT", "60"))
