...
class TestRAGS3Vectors(BaseRAGTest):
    ...
    def get_base_ingest_options(self) -> RAGIngestOptions:
        ...
        Embeddings are generated using DeRouter's embedding API.
        """
        vector_bucket_name = os.environ.get(
            "S3_VECTOR_BUCKET_NAME", "test-derouter-vectors"
        )
        ...
        return {
            ...
            "embedding": {
                "model": "text-embedding-3-small"  # Can use any DeRouter-supported model
            },
            "vector_store": {
    ...
    async def query_vector_store(
        ...
        try:
            ...
            from derouter.rag.ingestion.s3_vectors_ingestion import (
