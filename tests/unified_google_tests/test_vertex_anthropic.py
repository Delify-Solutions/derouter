...
import derouter
from derouter.google_genai import agenerate_content, agenerate_content_stream
...
async def test_vertex_anthropic_mocked():
    ...
    expected_url = "https://us-east5-aiplatform.googleapis.com/v1/projects/internal-derouter-local-dev/locations/us-east5/publishers/anthropic/models/claude-sonnet-4:rawPredict"
    ...
    with patch(
        "derouter.llms.custom_httpx.llm_http_handler.AsyncHTTPHandler.post",
        ...
        response = await agenerate_content(
            ...
            vertex_project="internal-derouter-local-dev",
...
async def test_vertex_anthropic_streaming_mocked():
    ...
    expected_url = "https://us-east5-aiplatform.googleapis.com/v1/projects/internal-derouter-local-dev/locations/us-east5/publishers/anthropic/models/claude-sonnet-4:streamRawPredict"
    expected_body_keys = {"messages", "anthropic_version", "max_tokens"}
    expected_message_content = "Hello, can you tell me a short joke?"
