...
from derouter.llms.replicate.chat.handler import (
    async_completion,
...
class TestReplicateStartingStatus:
    ...
    @pytest.mark.asyncio
    @patch("derouter.llms.replicate.chat.handler.get_async_httpx_client")
    async def test_async_completion_handles_starting_status(self, mock_get_client):
        ...
        model_response.choices = [derouter.Choices()]
        model_response.choices[0].message = derouter.Message(content="")
    ...
    @patch("derouter.llms.replicate.chat.handler._get_httpx_client")
...
class TestReplicateOutputFormats:
    ...
    def test_transform_response_list_output(self):
        ...
        from derouter.llms.replicate.chat.transformation import ReplicateConfig
