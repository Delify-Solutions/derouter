...
class TestBedrockMoonshotInvoke(BaseLLMChatTest):
    ...
    def _invoke_with_mocked_post(
        ...
        *,
        ...
        """Run a sync derouter.completion() with HTTPHandler.post patched to
    ...
    def test_developer_role_translation(self):
        """Verify DeRouter maps the ``developer`` role to ``system`` on the
    ...
    def test_streaming(self):
        ...
        with patch(
            "derouter.llms.bedrock.chat.invoke_transformations."
    ...
    async def test_completion_cost(self):
        """Verify DeRouter computes a positive cost from a mocked Bedrock
