...
from derouter.types.utils import Usage, ModelResponse
...
def _usage_format_tests(usage: derouter.Usage):
    """
...
class BaseLLMChatTest(ABC):
    ...
    def test_streaming(self):
        """Check if derouter handles streaming correctly"""
        ...
        resp = derouter.stream_chunk_builder(chunks=chunks)
        print(resp)
    ...
    def test_pydantic_model_input(self):
        ...
        from derouter import completion, Message
    ...
    def test_web_search(self):
        from derouter.utils import supports_web_search
    ...
    def test_url_context(self):
        from derouter.utils import supports_url_context
    ...
    async def test_async_pdf_handling_with_file_id(self):
        ...
        image_content = [
            {"type": "text", "text": "What's this file about?"},
            {
                "type": "file",
                "file": {
                    "file_id": "https://cdn.jsdelivr.net/gh/Delify-Solutions/derouter@d769e81c90d453240c61fc572cdb27fae06a89d0/tests/llm_translation/fixtures/dummy.pdf"
                },
            },
        ]
    ...
    def test_file_data_unit_test(self, pdf_messages):
        from derouter.utils import supports_pdf_input, return_raw_request
    ...
    def test_response_format_type_text(self):
        ...
        _, provider, _, _ = derouter.get_llm_provider(
    ...
    def test_audio_input(self):
        ...
        """
        from derouter.utils import supports_audio_input
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "https://cdn.jsdelivr.net/gh/Delify-Solutions/derouter@d769e81c90d453240c61fc572cdb27fae06a89d0/ui/derouter-dashboard/public/assets/logos/derouter_logo.jpg",
                    ...
                    "content": [
                        {"type": "text", "text": "What's in this image?"},
                        {
                            ...
                            "image_url": {
                                ...
                                "url": "https://cdn.jsdelivr.net/gh/Delify-Solutions/derouter@d769e81c90d453240c61fc572cdb27fae06a89d0/ui/derouter-dashboard/public/assets/logos/derouter_logo.jpg",
                                "detail": detail,
                            },
                        },
                    ],
    ...
    def test_empty_tools(self):
        """
        Related Issue: https://github.com/Delify-Solutions/derouter/issues/9080
        """
        try:
            from derouter import completion, ModelResponse
    ...
    def test_supports_audio_input(self, input_type, format_specified):
        from derouter.utils import return_raw_request, supports_audio_input
        from derouter.types.utils import CallTypes
    ...
    def test_reasoning_effort(self):
        ...
        from derouter.utils import supports_reasoning
        from derouter import completion
