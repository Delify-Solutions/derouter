...
def test_dynamic_aws_params_propagation(model, param_name, param_value):
    """
    When passed to derouter.completion, each dynamic AWS authentication parameter
    ...
    with patch("botocore.auth.SigV4Auth", autospec=True) as mock_sigv4:
        ...
        with patch.object(
            ...
            with patch.object(client, "post") as mock_post:
                ...
                # Call derouter.completion with our base & dynamic parameters.
                derouter.completion(**base_params)
