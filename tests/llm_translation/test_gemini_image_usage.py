...
from derouter.types.utils import ImageResponse, ImageObject, ImageUsage
...
def test_gemini_image_generation_accumulates_multiple_image_prompt_token_details():
    ...
    """
    previous_local_model_cost_map = os.environ.get("DEROUTER_LOCAL_MODEL_COST_MAP")
    previous_model_cost = derouter.model_cost
    try:
        ...
        observed_cost = derouter.completion_cost(
        ...
        if previous_local_model_cost_map is None:
            ...
            os.environ["DEROUTER_LOCAL_MODEL_COST_MAP"] = previous_local_model_cost_map
        derouter.model_cost = previous_model_cost
