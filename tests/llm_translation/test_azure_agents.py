...
Example environment variables:
  AZURE_AGENTS_API_BASE=https://derouter-ci-cd-prod.services.ai.azure.com/api/projects/derouter-ci-cd
...
def test_azure_ai_agents_is_agents_route():
    ...
    """
    from derouter.llms.azure_ai.agents.transformation import AzureAIAgentsConfig
...
def test_azure_ai_agents_handler_url_builders():
    ...
    See: https://learn.microsoft.com/en-us/azure/ai-foundry/agents/quickstart
    """
    from derouter.llms.azure_ai.agents.handler import AzureAIAgentsHandler
...
def test_azure_ai_agents_extract_content_with_annotations():
    ...
    Ref: https://github.com/Delify-Solutions/derouter/issues/19126
    """
    from derouter.llms.azure_ai.agents.handler import AzureAIAgentsHandler
