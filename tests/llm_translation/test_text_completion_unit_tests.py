...
async def test_acompletion_uses_optimized_http_client():
    ...
    instead of derouter.aclient_session directly.

    Related issue: https://github.com/Delify-Solutions/derouter/issues/17676
    """
    from derouter.llms.openai.completion.handler import OpenAITextCompletion
    ...
    with patch.object(
        ...
        with patch(
            "derouter.llms.openai.completion.handler.AsyncOpenAI",
