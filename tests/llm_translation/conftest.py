...
#   - Function-scoped fixture resets derouter globals to true defaults
...
_VCR_INCOMPATIBLE_NODEID_SUFFIXES: tuple[str, ...] = (
    ...
    "test_derouter_proxy_provider.py::test_derouter_gateway_from_sdk_embedding[False]",
    "test_derouter_proxy_provider.py::test_derouter_gateway_from_sdk_embedding[True]",
)
...
_SCALAR_DEFAULTS = {
    ...
    "cohere_key": getattr(derouter, "cohere_key", None),
}
