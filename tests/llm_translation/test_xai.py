...
import derouter
from derouter import Choices, Message, ModelResponse, EmbeddingResponse, Usage
from derouter import completion
from unittest.mock import patch
from derouter.llms.xai.chat.transformation import XAIChatConfig, XAI_API_BASE
...
def test_xai_grok_4_stop_not_supported(model):
    ...
    Issue: https://github.com/Delify-Solutions/derouter/issues/12635
    """
