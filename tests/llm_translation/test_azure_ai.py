...
def test_map_azure_model_group(model_group_header, expected_model):
    from derouter.llms.azure_ai.embed.cohere_transformation import AzureAICohereConfig
                ...
                messages=[
                    {
                        ...
                        "content": [
                            ...
                            },
                            {
                                "type": "image_url",
                                "image_url": {
                                    "url": "https://derouter-listing.s3.amazonaws.com/derouter_logo.png"
                                },
                            },
                        ],
                    },
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "https://derouter8397336933.services.ai.azure.com/models/chat/completions",
            "https://derouter8397336933.services.ai.azure.com/models/chat/completions",
        ),
        (
            "https://derouter8397336933.services.ai.azure.com/models",
            "https://derouter8397336933.services.ai.azure.com/models/chat/completions",
        ),
        (
    ...
    with patch.object(client, "post") as mock_client:
        try:
            response = derouter.completion(
                ...
                api_base="https://derouter8397336933.services.ai.azure.com/models",
                client=client,
            )
        except Exception as e:
            print(f"Error: {e}")
...
def test_azure_deepseek_reasoning_content():
    ...
    with patch.object(client, "post") as mock_post:
        ...
        response = derouter.completion(
            ...
            api_base="https://derouter8397336933.services.ai.azure.com/models/chat/completions",
            api_key="my-fake-api-key",
            client=client,
        )
...
#         return derouter.LlmProviders.AZURE_AI
...
class AzureModelRouterStreamingCallback(
    derouter.integrations.custom_logger.CustomLogger
):
    """
...
async def test_azure_ai_model_router_streaming_cost_with_stream_options():
    ...
    derouter.callbacks = [test_callback]
