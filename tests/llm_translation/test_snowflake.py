...
from derouter import completion, acompletion, responses
from derouter.exceptions import APIConnectionError
...
def test_snowflake_tool_calling_responses_api():
    ...
    derouter.drop_params = False  # We now support tools!
