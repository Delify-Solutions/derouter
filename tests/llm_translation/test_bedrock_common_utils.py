"""
Unit tests for derouter/llms/bedrock/common_utils.py
...
class TestBedrockModelInfoWrappers:
    ...
    def test_get_non_derouter_routing_model_name_matches_standalone(self):
        model = "bedrock/converse/claude-3"
        assert BedrockModelInfo.get_non_derouter_routing_model_name(
            model
