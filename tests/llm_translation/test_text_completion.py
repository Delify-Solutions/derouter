...
def test_convert_chat_to_text_completion():
    ...
    result = DeRouterResponseObjectHandler.convert_chat_to_text_completion(
...
def test_convert_provider_response_logprobs_non_huggingface():
    ...
    result = DeRouterResponseObjectHandler._convert_provider_response_logprobs_to_text_completion_logprobs(
