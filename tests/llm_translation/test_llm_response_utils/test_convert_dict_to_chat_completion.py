...
def test_convert_to_model_response_object_preserves_provider_specific_fields_from_proxy():
    ...
    Regression test for https://github.com/Delify-Solutions/derouter/issues/21153
    """
    citations = [
        [
            {
...
def test_convert_to_model_response_object_no_provider_specific_fields_still_works():
    ...
    Ensures the fix for https://github.com/Delify-Solutions/derouter/issues/21153
...
def test_convert_to_model_response_object_default_usage_overwritten():
    ...
    (i.e. no extra derouter.Usage() set via setattr beforehand).

    This validates the optimization of removing the redundant
    `setattr(model_response, "usage", derouter.Usage())` in completion().
    """
    mr = ModelResponse()
...
def test_convert_to_model_response_object_with_null_top_logprobs():
    ...
    an array, so derouter should normalize null to [].

    Regression test for https://github.com/Delify-Solutions/derouter/issues/21932
    """
    response_object = {
...
class TestMissingChoicesGuard:
    ...
    See: https://github.com/Delify-Solutions/derouter/issues/29391
    """
    ...
    def test_convert_to_model_response_object_no_choices_raises_api_error(self):
        ...
        from derouter.exceptions import APIError
...
class TestConvertToModelResponseObjectAudioTranscription:
    def test_basic_transcription(self):
        from derouter.types.utils import TranscriptionResponse
