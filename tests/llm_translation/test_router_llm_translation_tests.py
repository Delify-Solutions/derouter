"""
Uses derouter.Router, ensures router.completion and router.acompletion pass BaseLLMChatTest
"""
...
class TestRouterLLMTranslation(BaseLLMChatTest):
    ...
    def completion_function(self):
        return self.derouter_router.completion

    @property
    def async_completion_function(self):
        return self.derouter_router.acompletion
