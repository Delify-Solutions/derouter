...
class TestMinimaxTextToSpeechConfig:
    ...
    def test_validate_environment_missing_api_key(self):
        ...
        # Mock both derouter.api_key and get_secret_str to return None
        import derouter
        ...
        try:
            ...
            with patch(
                "derouter.llms.minimax.text_to_speech.transformation.get_secret_str",
                return_value=None,
            ):
...
class TestMinimaxSpeechIntegration:
    """Integration tests for MiniMax TTS via derouter.speech()"""
    ...
    def test_speech_mock_response(self):
        ...
        with patch(
            "derouter.llms.custom_httpx.llm_http_handler.BaseLLMHTTPHandler.text_to_speech_handler"
        ) as mock_tts:
...
class TestMinimaxProviderRegistration:
    ...
    def test_minimax_in_provider_list(self):
        ...
        assert derouter.LlmProviders.MINIMAX in derouter.provider_list
    ...
    def test_get_provider_text_to_speech_config(self):
        ...
        config = ProviderConfigManager.get_provider_text_to_speech_config(
            model="speech-2.6-hd",
            provider=derouter.LlmProviders.MINIMAX,
        )
