...
import derouter
from derouter.llms.v0.chat.transformation import V0ChatConfig
...
def test_v0_in_provider_lists():
    ...
    assert "v0" in derouter.openai_compatible_providers
    assert "v0" in derouter.provider_list
    assert "https://api.v0.dev/v1" in derouter.openai_compatible_endpoints
