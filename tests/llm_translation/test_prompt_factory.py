...
def test_bedrock_parallel_tool_calling_pt(provider):
    """
    Make sure parallel tool call blocks are merged correctly - https://github.com/Delify-Solutions/derouter/issues/5277
    """
    from derouter.derouter_core_utils.prompt_templates.factory import (
...
def test_convert_url(monkeypatch):
    ...
    monkeypatch.setattr(derouter, "module_level_client", mock_client, raising=False)
...
def test_azure_tool_call_invoke_helper():
    ...
    transformed_messages = derouter.AzureOpenAIConfig().transform_request(
        model="gpt-4o",
        messages=messages,
        optional_params={},
        derouter_params={},
...
def test_ollama_pt():
    from derouter.derouter_core_utils.prompt_templates.factory import ollama_pt
...
def test_convert_to_anthropic_tool_invoke_server_tool():
    ...
    Context: https://github.com/Delify-Solutions/derouter/issues/17737 (original
...
def test_anthropic_messages_pt_with_bash_tool_result_in_provider_specific_fields():
    ...
    from provider_specific_fields["tool_results"] when replaying DeRouter response objects.
...
def test_convert_to_anthropic_tool_invoke_malformed_json():
    ...
    Fixes: https://github.com/Delify-Solutions/derouter/issues/18920
    """
    tool_calls = [
        {
            "id": "toolu_01_invalid",
