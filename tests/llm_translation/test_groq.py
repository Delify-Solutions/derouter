...
from derouter.llms.groq.chat.transformation import (
    GroqChatConfig,
...
class TestGroqStructuredOutputs:
    ...
    Related issues:
    - https://github.com/Delify-Solutions/derouter/issues/11001
...
class TestGroqReasoning:
    ...
    Groq returns 'reasoning' field in delta, but DeRouter expects 'reasoning_content'.
    """
    ...
    def test_reasoning_field_mapping_in_streaming_chunks(self):
        ...
        to DeRouter's 'reasoning_content' field.
        """
