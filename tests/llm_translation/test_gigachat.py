"""
Tests for GigaChat DeRouter Provider
...
class TestGigaChatMessageTransformation:
    ...
    @pytest.fixture
    def config(self):
        from derouter.llms.gigachat.chat.transformation import GigaChatConfig
...
class TestGigaChatProviderRegistration:
    """Tests for provider registration in DeRouter"""
    ...
    def test_gigachat_in_chat_providers(self):
        """GigaChat should be in DEROUTER_CHAT_PROVIDERS"""
        from derouter.constants import DEROUTER_CHAT_PROVIDERS

        assert "gigachat" in DEROUTER_CHAT_PROVIDERS

    def test_gigachat_key_exists(self):
        """gigachat_key should be available"""
        import derouter

        assert hasattr(derouter, "gigachat_key")

    def test_gigachat_config_exists(self):
        """GigaChatConfig should be available"""
        import derouter

        assert hasattr(derouter, "GigaChatConfig")
