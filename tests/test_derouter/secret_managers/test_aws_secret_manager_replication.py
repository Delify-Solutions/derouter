...
_CREATE_RESPONSE = {
    "ARN": "arn:aws:secretsmanager:us-east-1:123456789012:secret:derouter/test-key",
    "Name": "derouter/test-key",
...
async def test_write_secret_replicates_when_configured():
    ...
    with patch.object(
        ...
        return_value=(
            ...
            b'{"Name":"derouter/test-key"}',
        ),
    ):
        with patch(
            "derouter.secret_managers.aws_secret_manager_v2.get_async_httpx_client",
...
async def test_async_replicate_secret_correct_payload():
    ...
    assert captured["SecretId"] == "derouter/test-key"
...
async def test_replication_fires_on_create(caplog):
    ...
    with patch.object(
        ...
        with patch(
            ...
            with caplog.at_level(logging.INFO, logger="DeRouter"):
...
def test_load_aws_secret_manager_passes_replica_regions():
    ...
    original = derouter.secret_manager_client
    settings = MagicMock()
    ...
    try:
        ...
        assert derouter.secret_manager_client.replica_regions == [
            "us-west-2",
            "eu-west-1",
        ]
    finally:
        derouter.secret_manager_client = original
