...
def test_an_ancestor_directory_covers_a_file_but_does_not_name_it():
    ...
    assert coverage._token_covers("tests/test_derouter", "tests/test_derouter/caching") is True
    assert coverage._token_names("tests/test_derouter", "tests/test_derouter/caching") is False


def test_an_exact_token_both_covers_and_names():
    assert coverage._token_covers("tests/test_derouter/caching", "tests/test_derouter/caching") is True
    assert coverage._token_names("tests/test_derouter/caching", "tests/test_derouter/caching") is True


def test_a_glob_names_only_what_it_matches_not_what_sits_below_it():
    glob = "tests/test_derouter/test_*.py"
    assert coverage._token_names(glob, "tests/test_derouter/test_router.py") is True
    assert coverage._token_names(glob, "tests/test_derouter/test_router.py/nested.py") is False
    assert coverage._token_names(glob, "tests/test_derouter/proxy/test_router.py") is False
