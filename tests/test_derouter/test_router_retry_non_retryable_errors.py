...
Regression tests for https://github.com/Delify-Solutions/derouter/issues/21343
"""
...
def _make_context_window_error(message="prompt is too long: 1205821 tokens > 200000"):
    ...
    return derouter.ContextWindowExceededError(
        message=message,
...
def _make_bad_request_error(message="Invalid request"):
    ...
    return derouter.BadRequestError(
        message=message,
        llm_provider="openai",
        model="gpt-4",
    )
