...
DeRouter could not infer its provider — the model was simply missing from the
...
``derouter.anthropic_models`` at import time, which is what the bare-name lookup
