...
from derouter.endpoints.speech.speech_to_completion_bridge.transformation import (
    SpeechToCompletionBridgeTransformationHandler,
)
from derouter.types.utils import ChatCompletionAudioResponse, Choices, Message, ModelResponse
...
def test_gemini_tts_request_keeps_speech_response_format_out_of_chat_params(response_format: str | None) -> None:
    ...
    gemini_params: Final = derouter.get_optional_params(
        model=GEMINI_TTS_MODEL,
        custom_llm_provider="gemini",
