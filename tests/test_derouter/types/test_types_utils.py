...
from derouter.types.utils import HiddenParams, all_derouter_params, text_tokens_without_nested_reasoning


def test_rust_is_a_known_derouter_param():
    assert "rust" in all_derouter_params
...
def test_chat_completion_token_logprob_null_top_logprobs():
    ...
    """
    from derouter.types.utils import ChatCompletionTokenLogprob
...
def test_chat_completion_token_logprob_valid_top_logprobs():
    ...
    """
    from derouter.types.utils import ChatCompletionTokenLogprob, TopLogprob
...
def test_choice_logprobs_with_null_top_logprobs():
    ...
    Regression test for https://github.com/Delify-Solutions/derouter/issues/21932
    """
    from derouter.types.utils import ChoiceLogprobs
...
def test_delta_maps_reasoning_to_reasoning_content():
    ...
    but DeRouter expects delta.reasoning_content.
    """
...
def test_delattr_fast_path_matches_pydantic_exactly():
    ...
    """
    from derouter.types.utils import Message, SafeAttributeModel
...
def test_delattr_fast_path_missing_attribute_is_noop():
    ...
    """
    from derouter.types.utils import SafeAttributeModel
...
def test_chat_completion_tool_call_from_dict_custom_strips_null_function():
    from derouter.types.utils import chat_completion_tool_call_from_dict
...
def test_chat_completion_tool_call_from_dict_typeless_custom_payload():
    ...
    accepts as custom."""
    from derouter.types.utils import ChatCompletionMessageCustomToolCall, chat_completion_tool_call_from_dict
...
def test_delta_custom_tool_call_first_and_continuation_chunks():
    from derouter.types.utils import ChatCompletionDeltaCustomToolCall, Delta
...
def test_delta_function_tool_call_unchanged_by_custom_support():
    from derouter.types.utils import ChatCompletionDeltaToolCall, Delta
