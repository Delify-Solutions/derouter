...
class TestEnterpriseCallbackControls:
    ...
    def mock_request_headers(self):
        ...
        with patch(
            "derouter_enterprise.enterprise_callbacks.callback_controls.get_proxy_server_request_headers"
        ) as mock_headers:
            yield mock_headers
    ...
    def test_callback_disabled_langfuse_string(
        ...
        mock_request_headers.return_value = {X_DEROUTER_DISABLE_CALLBACKS: "langfuse"}
        derouter_params = {"proxy_server_request": {"url": "test"}}
        standard_callback_dynamic_params = StandardCallbackDynamicParams()

        result = EnterpriseCallbackControls.is_callback_disabled_dynamically(
            "langfuse", derouter_params, standard_callback_dynamic_params
        )
    ...
    def test_callback_disabled_langfuse_customlogger(
        ...
        result = EnterpriseCallbackControls.is_callback_disabled_dynamically(
            langfuse_logger, derouter_params, standard_callback_dynamic_params
        )
        assert result is True
    ...
    def test_callback_disabled_s3_v2_string(
        ...
        mock_request_headers.return_value = {X_DEROUTER_DISABLE_CALLBACKS: "s3_v2"}
        derouter_params = {"proxy_server_request": {"url": "test"}}
        standard_callback_dynamic_params = StandardCallbackDynamicParams()

        result = EnterpriseCallbackControls.is_callback_disabled_dynamically(
            "s3_v2", derouter_params, standard_callback_dynamic_params
        )
        assert result is True
    ...
    def test_callback_disabled_s3_v2_customlogger(
        ...
        with patch("derouter.integrations.s3_v2.S3Logger.__init__", return_value=None):
            s3_logger = S3Logger()
            result = EnterpriseCallbackControls.is_callback_disabled_dynamically(
                s3_logger, derouter_params, standard_callback_dynamic_params
            )
            assert result is True
    ...
    def test_callback_disabled_datadog_string(
        ...
        mock_request_headers.return_value = {X_DEROUTER_DISABLE_CALLBACKS: "datadog"}
        derouter_params = {"proxy_server_request": {"url": "test"}}
        standard_callback_dynamic_params = StandardCallbackDynamicParams()

        result = EnterpriseCallbackControls.is_callback_disabled_dynamically(
            "datadog", derouter_params, standard_callback_dynamic_params
        )
        assert result is True
    ...
    def test_callback_disabled_datadog_customlogger(
        ...
        with patch(
            "derouter.integrations.datadog.datadog.DataDogLogger.__init__",
            return_value=None,
        ):
            datadog_logger = DataDogLogger()
            result = EnterpriseCallbackControls.is_callback_disabled_dynamically(
                datadog_logger, derouter_params, standard_callback_dynamic_params
            )
            assert result is True
    ...
    def test_multiple_callbacks_disabled(self, mock_premium_user, mock_request_headers):
        ...
        mock_request_headers.return_value = {
            X_DEROUTER_DISABLE_CALLBACKS: "langfuse,datadog,s3_v2"
        }
        derouter_params = {"proxy_server_request": {"url": "test"}}
        standard_callback_dynamic_params = StandardCallbackDynamicParams()
        ...
        assert (
            EnterpriseCallbackControls.is_callback_disabled_dynamically(
                "prometheus", derouter_params, standard_callback_dynamic_params
            )
            is False
        )
    ...
    def test_callback_not_disabled_when_header_none(
        ...
        mock_request_headers.return_value = {X_DEROUTER_DISABLE_CALLBACKS: None}
        derouter_params = {"proxy_server_request": {"url": "test"}}
        standard_callback_dynamic_params = StandardCallbackDynamicParams()
    ...
    def test_case_insensitive_callback_matching(
        ...
        mock_request_headers.return_value = {
            X_DEROUTER_DISABLE_CALLBACKS: "LANGFUSE,DataDog"
        }
        derouter_params = {"proxy_server_request": {"url": "test"}}
        standard_callback_dynamic_params = StandardCallbackDynamicParams()
    ...
    def test_custom_logger_not_in_registry(
        ...
        mock_request_headers.return_value = {
            X_DEROUTER_DISABLE_CALLBACKS: "unknown_logger"
        }
        derouter_params = {"proxy_server_request": {"url": "test"}}
        standard_callback_dynamic_params = StandardCallbackDynamicParams()
        ...
        result = EnterpriseCallbackControls.is_callback_disabled_dynamically(
            unknown_logger, derouter_params, standard_callback_dynamic_params
        )
        assert result is False
    ...
    def test_callback_disabled_via_request_body_langfuse(
        ...
        """Test that callbacks can be disabled via request body derouter_disabled_callbacks"""
    ...
    def test_callback_disabled_via_request_body_multiple(
        ...
        derouter_params = {"proxy_server_request": {"url": "test"}}
        standard_callback_dynamic_params = StandardCallbackDynamicParams(
            derouter_disabled_callbacks=["langfuse", "datadog", "s3_v2"]
        )
    ...
    def test_admin_can_disable_dynamic_callback_disabling(self, mock_request_headers):
        ...
        # Mock derouter.allow_dynamic_callback_disabling set to False
        with patch("derouter.allow_dynamic_callback_disabling", False):
    ...
    def test_admin_can_enable_dynamic_callback_disabling(self, mock_request_headers):
        ...
        # Mock derouter.allow_dynamic_callback_disabling set to True
        with patch("derouter.allow_dynamic_callback_disabling", True):
            with patch("derouter.proxy.proxy_server.premium_user", True):
                result = EnterpriseCallbackControls.is_callback_disabled_dynamically(
                    "langfuse", derouter_params, standard_callback_dynamic_params
                )
    ...
    def test_default_admin_setting_allows_dynamic_callback_disabling(
        ...
        # derouter.allow_dynamic_callback_disabling should default to True
        with patch("derouter.proxy.proxy_server.premium_user", True):
            result = EnterpriseCallbackControls.is_callback_disabled_dynamically(
                "langfuse", derouter_params, standard_callback_dynamic_params
            )
