...
UNIFIED_BATCH_ID = "derouter_proxy;model_id:my-model;llm_batch_id:batch-raw-123"
...
async def test_get_batch_from_database_registers_missing_output_file_id():
    ...
    prisma = MagicMock()
    prisma.db.derouter_managedobjecttable.find_first = AsyncMock(
...
async def test_registered_output_file_row_denies_cross_user_access():
    ...
    prisma = MagicMock()
    prisma.db.derouter_managedfiletable.upsert = AsyncMock()
    prisma.db.derouter_managedfiletable.find_first = AsyncMock(return_value=None)
    ...
    registered_row = prisma.db.derouter_managedfiletable.upsert.call_args.kwargs[
        "data"
    ]["create"]
    ...
    prisma.db.derouter_managedfiletable.find_first = AsyncMock(
