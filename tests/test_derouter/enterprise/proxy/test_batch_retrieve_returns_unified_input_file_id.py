...
async def test_should_resolve_raw_input_file_id_to_unified_id():
    ...
    prisma.db.derouter_managedfiletable.find_first.assert_any_call(
...
async def test_should_preserve_already_managed_input_file_id():
    ...
    unified_batch_id = "bGl0ZWxsbV9wcm94eTpiYXRjaF9pZA"
    decoded_unified = "derouter_proxy:application/octet-stream;unified_id,test-123"
    ...
    prisma.db.derouter_managedfiletable.find_first.assert_not_called()
