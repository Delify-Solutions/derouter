...
def _make_unified_file_id() -> str:
    raw = "derouter_proxy:application/octet-stream;unified_id,test-deleted-file;target_model_names,azure-gpt-4"
    return base64.b64encode(raw.encode()).decode()


def _make_managed_files_with_no_db_record():
    """Create a _PROXY_DeRouterManagedFiles where the DB returns None (file was deleted)."""
    ...
    return _PROXY_DeRouterManagedFiles(
