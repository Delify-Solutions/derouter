...
from derouter.derouter_core_utils.get_model_cost_map import _expand_model_aliases
...
class TestExpandModelAliases:
    ...
    def test_basic_expansion(self):
        ...
        assert result["my-model-20250101"]["derouter_provider"] == "test"
