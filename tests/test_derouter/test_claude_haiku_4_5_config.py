...
https://github.com/Delify-Solutions/derouter/issues/15818
"""
...
def test_bedrock_haiku_4_5_matches_sonnet_capabilities():
    ...
    assert haiku_info["derouter_provider"] == "bedrock_converse"
    assert sonnet_info["derouter_provider"] == "bedrock_converse"
