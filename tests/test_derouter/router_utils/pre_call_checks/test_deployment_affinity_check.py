    ...
    healthy_deployments = [
        {
            ...
            "derouter_params": {"model": f"vertex_ai/{stable_model_map_key}"},
...
async def test_model_group_affinity_config_overrides_global():
    ...
    healthy_deployments = [
        {
            "model_name": stable_model_map_key,
            "derouter_params": {"model": "anthropic/claude-3-opus"},
            "model_info": {"id": "deployment-1"},
        },
        {
            "model_name": stable_model_map_key,
    ...
    return [
        {
            ...
            "derouter_params": {"model": "openai/gpt-5.4-mini"},
...
async def test_async_jwt_user_affinity_routes_to_same_deployment():
    ...
    router = derouter.Router(
        model_list=[
            {
                "model_name": model_group,
                "derouter_params": {"model": "openai/gpt-5.4-mini", "api_key": "mock-api-key-a"},
                "model_info": {"id": "openai-deployment-a"},
            },
            {
                "model_name": model_group,
                "derouter_params": {"model": "openai/gpt-5.4-mini", "api_key": "mock-api-key-b"},
                "model_info": {"id": "openai-deployment-b"},
            },
        ],
        optional_pre_call_checks=["deployment_affinity"],
