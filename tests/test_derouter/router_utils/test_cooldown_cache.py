...
class TestCooldownCacheExceptionMasking:
    ...
    def test_long_exception_string_masked(self, cooldown_cache):
        ...
        long_exception = (
            "derouter.proxy.proxy_server._handle_llm_api_exception(): Exception occurred - "
            ...
            "'derouter.RateLimitError: RateLimitError: Azure_aiException - "
        ...
        assert masked_exception.startswith("derouter.proxy.proxy_server._handle_llm_api_excepti")
