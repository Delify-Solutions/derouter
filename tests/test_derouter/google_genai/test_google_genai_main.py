...
async def test_agenerate_content_stream():
    ...
    from derouter.google_genai.main import (
...
def test_native_top_level_field_forwarded_to_request_body(field_name, field_value):
    """
    Regression for https://github.com/Delify-Solutions/derouter/issues/12671
    ...
    from derouter.google_genai.main import generate_content
...
def test_native_fields_and_system_instruction_forwarded_on_sync_stream():
    ...
    from derouter.google_genai.main import generate_content_stream
    from derouter.llms.custom_httpx.http_handler import HTTPHandler
...
async def test_native_fields_forwarded_on_async_stream():
    ...
    from derouter.google_genai.main import agenerate_content_stream
    from derouter.llms.custom_httpx.http_handler import AsyncHTTPHandler
