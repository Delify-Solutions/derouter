...
@patch("derouter._redis.get_redis_connection_pool")
@patch("derouter._redis.get_redis_client")
@patch.object(import_module("derouter.caching.redis_cache").RedisCache, "_setup_health_pings")
def test_cache_init_creates_cluster_cache_from_env_var(
    ...
    Regression test for https://github.com/Delify-Solutions/derouter/issues/22748
    """
