...
def test_url_config_uses_passed_pool():
    ...
    with patch("derouter._redis._get_redis_client_logic") as mock_logic:
...
def _make_redis_cache():
    ...
    patches = [
        patch("derouter._redis.get_redis_client", return_value=mock_sync_client),
        patch("derouter._redis.get_redis_connection_pool", return_value=mock_async_pool),
