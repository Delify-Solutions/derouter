...
from derouter.caching.valkey_semantic_cache import ValkeySemanticCache
...
_FT_INFO_ATTRS_DIM_1536 = [
    [b"identifier", b"derouter_cache_key", b"type", b"TAG"],
    [
        b"identifier",
        b"embedding",
        b"type",
...
def test_importing_caching_does_not_require_redis():
    ...
    # importing derouter.caching.caching must not, or `import derouter` breaks for
    ...
    code = textwrap.dedent("""
        ...
        import derouter.caching.caching  # must not import redis at module top
        from derouter.types.caching import DeRouterCacheType
        assert DeRouterCacheType.VALKEY_SEMANTIC == "valkey-semantic"
        print("ok")
        """)
