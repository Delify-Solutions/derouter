...
def test_is_chat_completion_cached_dict():
    from derouter.caching.caching_handler import _is_chat_completion_cached_dict
...
def test_request_kwargs_does_not_retain_logging_obj():
    ...
    derouter_logging_obj inside request_kwargs closes a reference cycle
    ...
    assert "derouter_logging_obj" not in handler.request_kwargs
