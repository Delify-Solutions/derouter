"""Unit tests for derouter.setup_wizard — pure functions only, no network calls."""

from derouter.setup_wizard import SetupWizard, _yaml_escape
...
def test_build_config_does_not_mutate_env_vars():
    ...
    env_vars = {
        ...
        "_DEROUTER_AZURE_AI_API_BASE_AZURE": "https://my.azure.com",
        "_DEROUTER_AZURE_DEPLOYMENT_AZURE": "my-deployment",
    }
...
def test_build_config_azure_uses_deployment_name():
    env_vars = {
        "AZURE_AI_API_KEY": "az-key",
        "_DEROUTER_AZURE_AI_API_BASE_AZURE": "https://my.azure.com",
        "_DEROUTER_AZURE_DEPLOYMENT_AZURE": "my-gpt4o",
    }
...
def test_build_config_no_display_name_collision_openai_and_azure():
    ...
    env_vars = {
        ...
        "AZURE_AI_API_KEY": "az-key",
        "_DEROUTER_AZURE_DEPLOYMENT_AZURE": "gpt-4o",
    }
...
def test_build_config_internal_sentinel_keys_excluded():
    """_DEROUTER_ prefixed sentinel keys must not appear in environment_variables."""
    env_vars = {
        "OPENAI_API_KEY": "sk-real",
        "_DEROUTER_AZURE_AI_API_BASE_AZURE": "https://x.azure.com",
    }
    config = SetupWizard._build_config([_OPENAI], env_vars, "sk-master")
    assert "_DEROUTER_" not in config
