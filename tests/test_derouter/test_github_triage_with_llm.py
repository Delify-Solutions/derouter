...
class TestHasLinkedIssue:
    @pytest.mark.parametrize(
        ...
        [
            ...
            "Closes https://github.com/Delify-Solutions/derouter/issues/27000",
            "Resolved https://github.com/Delify-Solutions/derouter/issues/27001",
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "ref #1234",
            "Refs https://github.com/Delify-Solutions/derouter/issues/27000",
            "this addresses #1234",
        ],
    )
...
class TestCloseCommentText:
    ...
    def test_pr_close_comment_should_link_blog_explainer(self, triage_module):
        ...
        assert "https://router.delify.vn/blog/agent-shin-triage" in body
    ...
    def test_all_agent_shin_comments_should_use_bullet_train_emoji(self, triage_module):
        # The bullet train (🚅) is Agent Shin's symbol, matching the DeRouter
