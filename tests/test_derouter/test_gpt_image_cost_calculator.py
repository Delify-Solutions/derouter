...
https://github.com/Delify-Solutions/derouter/issues/13847
...
class TestGPTImageCostCalculator:
    ...
    def test_gpt_image_1_cost_with_text_only(self):
        ...
        from derouter.llms.openai.image_generation.cost_calculator import cost_calculator
...
class TestGPTImageCostRouting:
    ...
    def test_openai_gpt_image_routes_to_token_calculator(self):
        ...
        from derouter.derouter_core_utils.llm_cost_calc.utils import CostCalculatorUtils
...
class TestGPTImage2OutputImageTokensNoBreakdown:
    ...
    /v1/images/edits) return usage with NO output token breakdown — derouter's
