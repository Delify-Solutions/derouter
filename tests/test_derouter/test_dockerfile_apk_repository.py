...
Anyone pulling the published derouter image and running `apk add` inside it
hits SSL/auth failures with no fallback repo configured, so nothing can be
installed. See https://github.com/Delify-Solutions/derouter/issues/33518
"""
...
def test_runtime_stage_adds_public_wolfi_repo():
    ...
    assert re.search(
        ...
        "See https://github.com/Delify-Solutions/derouter/issues/33518"
    )
