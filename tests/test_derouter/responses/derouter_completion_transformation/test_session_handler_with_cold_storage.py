...
from derouter.proxy.spend_tracking.spend_tracking_utils import _get_spend_logs_metadata
from derouter.responses.derouter_completion_transformation.session_handler import (
    ResponsesSessionHandler,
)
from derouter.types.utils import StandardLoggingMetadata, StandardLoggingPayload
...
class TestColdStorageObjectKeyIntegration:
    ...
    async def test_cold_storage_handler_supports_object_key_retrieval(self):
        ...
        with (
            ...
            patch(
                "derouter.logging_callback_manager.get_active_custom_logger_for_callback_name",
