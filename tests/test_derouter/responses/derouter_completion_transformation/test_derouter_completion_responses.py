...
class TestDeRouterCompletionResponsesConfig:
    def test_transform_input_file_item_to_file_item_with_file_id(self):
        ...
        # Execute
        result = (
            DeRouterCompletionResponsesConfig._transform_input_file_item_to_file_item(
                input_item
            )
        )
    ...
    def test_transform_input_image_item_to_image_item_with_image_url(self):
        ...
        # Execute
        result = (
            DeRouterCompletionResponsesConfig._transform_input_image_item_to_image_item(
                input_item
            )
        )
    ...
    def test_transform_chat_completion_response_with_reasoning_content(self):
        ...
        # Execute
        responses_api_response = DeRouterCompletionResponsesConfig.transform_chat_completion_response_to_responses_api_response(
    ...
    def test_transform_top_level_function_collision_stays_unnamespaced(self):
        ...
        try:
            response = DeRouterCompletionResponsesConfig.transform_chat_completion_response_to_responses_api_response(
...
class TestFunctionCallTransformation:
    ...
    def test_function_call_detection(self):
        ...
        assert DeRouterCompletionResponsesConfig._is_input_item_function_call(
            function_call_item
        )
        assert not DeRouterCompletionResponsesConfig._is_input_item_function_call(
            function_call_output_item
        )
        assert not DeRouterCompletionResponsesConfig._is_input_item_function_call(
            regular_message
        ...
        assert DeRouterCompletionResponsesConfig._is_input_item_tool_call_output(
            function_call_output_item
        )
        assert not DeRouterCompletionResponsesConfig._is_input_item_tool_call_output(
            function_call_item
        )
        assert not DeRouterCompletionResponsesConfig._is_input_item_tool_call_output(
            regular_message
    ...
    def test_function_call_transformation(self):
        ...
        result = DeRouterCompletionResponsesConfig._transform_responses_api_function_call_to_chat_completion_message(
    ...
    def test_function_call_transformation_normalizes_redacted_arguments(self):
        ...
        result = DeRouterCompletionResponsesConfig._transform_responses_api_function_call_to_chat_completion_message(
            function_call={
                "type": "function_call",
                "name": "get_weather",
                "arguments": "redacted-by-derouter",
                "call_id": "call_123",
            }
        )
    ...
    def test_create_tool_call_chunk_json_encodes_object_arguments(self):
        ...
        chunk = DeRouterCompletionResponsesConfig._create_tool_call_chunk(
            tool_use_definition={
                "id": "call_456",
                "type": "function",
    ...
    def test_complete_input_transformation_with_function_calls(self):
        ...
        messages = DeRouterCompletionResponsesConfig._transform_response_input_param_to_chat_completion_message(
            input=test_input
        )
    ...
    def test_complete_request_transformation_with_function_calls(self):
        ...
        result = DeRouterCompletionResponsesConfig.transform_responses_api_request_to_chat_completion_request(
    ...
    def test_ensure_tool_results_preserves_cached_openai_object_tool_call(self):
        ...
        try:
            fixed_messages = DeRouterCompletionResponsesConfig._ensure_tool_results_have_corresponding_tool_calls(
...
class TestToolChoiceTransformation:
    ...
    def test_transform_tool_choice_cursor_bug_fix(self):
        ...
        """
        result = DeRouterCompletionResponsesConfig._transform_tool_choice(
            {"type": "tool"}
        )
    ...
    def test_transform_tool_choice_preserves_function_with_name(self):
        ...
        result = DeRouterCompletionResponsesConfig._transform_tool_choice(tool_choice)
    ...
    def test_transform_tool_choice_custom_follows_function_downgrade(self):
        ...
        """
        flat = DeRouterCompletionResponsesConfig._transform_tool_choice(
            {"type": "custom", "name": "ApplyPatch"}
        )
        assert flat == {"type": "function", "function": {"name": "ApplyPatch"}}

        nested = DeRouterCompletionResponsesConfig._transform_tool_choice(
    ...
    def test_transform_tool_choice_custom_without_name_falls_back_to_required(self):
        result = DeRouterCompletionResponsesConfig._transform_tool_choice({"type": "custom"})
        assert result == "required"
...
class TestContentTypeTransformation:
    ...
    def test_tool_result_content_type_transformed_to_text(self):
        ...
        """
        result = (
            DeRouterCompletionResponsesConfig._get_chat_completion_request_content_type(
                "tool_result"
            )
        )
        assert result == "text"
    ...
    def test_none_text_blocks_filtered_out(self):
        ...
        result = DeRouterCompletionResponsesConfig._transform_responses_api_content_to_chat_completion_content(
            content
        )
        assert len(result) == 2
...
class TestToolTransformation:
    ...
    def test_transform_vertex_ai_tools(self):
        ...
        from derouter.types.llms.vertex_ai import VertexToolName
    ...
    def test_transform_function_tools_parameters_keep_client_key_order(self):
        ...
        result_tools, _ = DeRouterCompletionResponsesConfig.transform_responses_api_tools_to_chat_completion_tools(
            tools=tools
        )
    ...
    def test_bedrock_anthropic_drops_derived_web_search_options(self):
        ...
        chat-completion bridge it must be dropped (so derouter doesn't raise
    ...
    def test_function_call_echo_requalifies_namespace_tool_name(self):
        ...
        messages = DeRouterCompletionResponsesConfig._transform_responses_api_function_call_to_chat_completion_message(
            function_call={
                "type": "function_call",
                "name": "get_sum",
    ...
    def test_namespace_tool_name_map_accepts_unique_unqualified_tool_names(self):
        ...
        result = DeRouterCompletionResponsesConfig.namespace_tool_name_map(
            [namespace_tool]
        )
    ...
    def test_namespace_tool_name_map_drops_top_level_function_collision(self):
        ...
        result = DeRouterCompletionResponsesConfig.namespace_tool_name_map(tools)
    ...
    def test_transform_tools_rejects_flattened_name_collision(self):
        ...
        with pytest.raises(
            ...
            DeRouterCompletionResponsesConfig.transform_responses_api_tools_to_chat_completion_tools(tools=tools)


    def test_restore_namespace_tool_name_leaves_unknown_tool_unchanged(self):
        tool_name, namespace = DeRouterCompletionResponsesConfig._restore_namespace_tool_name(
            "mcp__node_repl",
            {},
        )
    ...
    def test_bedrock_anthropic_responses_tools_yield_only_function_toolspec(self):
        ...
        assert names == ["noop"]
        assert not any(name.startswith("derouter_unnamed_tool_") for name in names)
...
class TestUsageTransformation:
    ...
    def test_transform_usage_with_cached_tokens_anthropic(self):
        ...
        # Execute
        response_usage = DeRouterCompletionResponsesConfig._transform_chat_completion_usage_to_responses_usage(
            chat_completion_response=chat_completion_response
        )
...
class TestStreamingIDConsistency:
    ...
    def test_streaming_iterator_uses_consistent_item_ids(self):
        ...
        Reproduces: https://github.com/Delify-Solutions/derouter/issues/14962
        """
        ...
        mock_stream_wrapper = Mock(spec=derouter.CustomStreamWrapper)
        mock_logging_obj = Mock()
        mock_stream_wrapper.logging_obj = mock_logging_obj

        # Create the streaming iterator
        iterator = DeRouterCompletionStreamingIterator(
            model="gemini/gemini-2.5-flash-lite",
            derouter_custom_stream_wrapper=mock_stream_wrapper,
    ...
    def test_streaming_iterator_done_events_use_cached_id(self):
        ...
        iterator.derouter_model_response = complete_response
...
class TestCompletedResponseLatchedOnStreamEnd:
    """Regression: DeRouterCompletionStreamingIterator (the Chat Completions
    ...
    def _make_iterator_with_stop(self, model_response):
        """Build a DeRouterCompletionStreamingIterator whose underlying
        ...
        mock_wrapper = Mock(spec=derouter.CustomStreamWrapper)
        ...
        iterator = DeRouterCompletionStreamingIterator(
            ...
            derouter_custom_stream_wrapper=mock_wrapper,
            request_input="test",
            responses_api_request={},
        )
        iterator.derouter_model_response = model_response
        return iterator
    ...
    def test_completed_response_set_after_common_done_event_logic(self):
        ...
        assert iterator.completed_response is not None, (
            "DeRouterCompletionStreamingIterator.completed_response is still None "
                ...
                model_list=[
                    {
                        ...
                        "derouter_params": {"model": "deepseek/deepseek-chat", "api_key": "sk-test"},
                    }
                ]
            )
...
class TestEnsureOutputItemContentPartAdded:
    ...
    def _make_iterator(self):
        """Create a minimal DeRouterCompletionStreamingIterator for testing."""
        from derouter.responses.derouter_completion_transformation.streaming_iterator import (
            DeRouterCompletionStreamingIterator,
        )

        iterator = DeRouterCompletionStreamingIterator.__new__(
            DeRouterCompletionStreamingIterator
        )
        ...
        iterator._namespace_tool_names = DeRouterCompletionResponsesConfig.namespace_tool_name_map(None)
        return iterator
    ...
    def test_streaming_namespace_tool_calls_restore_responses_namespace(self):
        ...
        iterator._namespace_tool_names = DeRouterCompletionResponsesConfig.namespace_tool_name_map(
    ...
    def test_streaming_namespace_map_is_built_once(self):
        ...
        with patch.object(
            ...
            wraps=DeRouterCompletionResponsesConfig.namespace_tool_name_map,
        ) as namespace_map:
            iterator = DeRouterCompletionStreamingIterator(
                model="test-model",
                derouter_custom_stream_wrapper=mock_stream_wrapper,
    ...
    def test_reasoning_item_does_not_emit_content_part_added(self):
        ...
        from derouter.types.llms.openai import OutputItemAddedEvent
...
class TestCacheControlPreservation:
    ...
    def test_cache_control_preserved_in_input_item_transformation(self):
        ...
        messages = DeRouterCompletionResponsesConfig._transform_responses_api_input_item_to_chat_completion_message(
            input_item
        )
...
def test_function_call_tool_id_falls_back_to_unique_id_for_degenerate_call_id():
    ...
    convert = (
        DeRouterCompletionResponsesConfig.convert_response_function_tool_call_to_chat_completion_tool_call
    )
...
class TestBridgedOutputItemIdPrefixes:
    ...
    def _transform(self, chat_completion_response):
        return DeRouterCompletionResponsesConfig.transform_chat_completion_response_to_responses_api_response(
    ...
    def _reasoning_items(self):
        ...
        return DeRouterCompletionResponsesConfig._extract_reasoning_output_items(
