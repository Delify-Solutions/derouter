...
from derouter.types.responses.main import CustomToolCallOutputItem
...
class TestTransformationCustomTools:
    ...
    def test_transform_apply_patch_function_call_to_custom_tool_call(self):
        ...
        from derouter.types.utils import ModelResponse, Choices, Message, ChatCompletionMessageToolCall, Function
        ...
        result = DeRouterCompletionResponsesConfig.transform_chat_completion_tools_to_responses_tools(
    ...
    def test_custom_tool_call_input_item_recovers_payload_from_input(self):
        ...
        for arguments in (None, ""):
            ...
            messages = (
                DeRouterCompletionResponsesConfig._transform_responses_api_function_call_to_chat_completion_message(
                    function_call=item
                )
            )
