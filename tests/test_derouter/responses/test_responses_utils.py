...
from derouter.types.llms.openai import ResponseAPIUsage, ResponsesAPIOptionalRequestParams
...
class TestResponsesAPIRequestUtils:
    ...
    def test_decode_previous_response_id_to_original_previous_response_id(self):
        """Test decoding a DeRouter encoded previous_response_id to the original previous_response_id"""
        # Setup
    ...
    def test_update_responses_api_response_id_with_model_id_handles_dict(self):
        ...
        derouter_metadata = {"model_info": {"id": "gpt-4o"}}
    ...
    def test_update_responses_api_response_id_with_model_id_is_idempotent_for_derouter_ids(self):
        raw = "resp_" + "a" * 48
    ...
    def test_decode_container_id_legacy_literal_none_model_id(self):
        ...
        legacy_inner = "derouter:custom_llm_provider:azure;model_id:None;container_id:cntr_x"
...
def test_responses_extra_body_forwarded_to_completion_transformation_handler():
    ...
    not passed to derouter_completion_transformation_handler.response_api_handler(),
    ...
    with (
        ...
        patch.object(
            import_module("derouter.responses.main").derouter_completion_transformation_handler, "response_api_handler",
        ) as mock_handler,
    ):
...
def test_responses_maps_reasoning_effort_from_derouter_params_to_reasoning():
    """
    Test that when reasoning_effort is passed in kwargs (e.g. from proxy derouter_params)
