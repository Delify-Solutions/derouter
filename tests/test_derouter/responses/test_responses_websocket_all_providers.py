...
from derouter.llms.chatgpt.responses.transformation import ChatGPTResponsesAPIConfig
from derouter.llms.databricks.responses.transformation import (
    DatabricksResponsesAPIConfig,
)
from derouter.llms.fireworks_ai.responses.transformation import (
    FireworksAIResponsesAPIConfig,
)
from derouter.llms.github_copilot.responses.transformation import (
    GithubCopilotResponsesAPIConfig,
)
from derouter.llms.hosted_vllm.responses.transformation import (
    HostedVLLMResponsesAPIConfig,
)
from derouter.llms.derouter_proxy.responses.transformation import (
    DeRouterProxyResponsesAPIConfig,
)
from derouter.llms.manus.responses.transformation import ManusResponsesAPIConfig
from derouter.llms.openai.responses.transformation import OpenAIResponsesAPIConfig
from derouter.llms.openrouter.responses.transformation import (
    OpenRouterResponsesAPIConfig,
)
from derouter.llms.perplexity.responses.transformation import PerplexityResponsesConfig
from derouter.llms.volcengine.responses.transformation import (
    VolcEngineResponsesAPIConfig,
)
from derouter.llms.xai.responses.transformation import XAIResponsesAPIConfig
...
class TestResponsesAPIWebSocketSupport:
    ...
    def test_azure_websocket_url_uses_v1_path(self):
        ...
        url = config.get_websocket_url(
            ...
            derouter_params={"api_version": "2025-04-01-preview"},
        )
    ...
    def test_azure_websocket_url_requires_api_base(self):
        ...
        with pytest.raises(ValueError, match='api_base is required for Azure WebSocket'):
            config.get_websocket_url(api_base=None, derouter_params={})
    ...
    def test_openai_default_websocket_url_converts_scheme(self):
        ...
        config = OpenAIResponsesAPIConfig()
        url = config.get_websocket_url(
            api_base="https://api.openai.com/v1", derouter_params={}
        )
    ...
    def test_derouter_proxy_uses_managed_websocket(self):
        """DeRouter Proxy should use managed websocket handler"""
...
class TestManagedWebSocketHandlerIntegration:
    ...
    async def test_frame_alias_resolves_to_connection_model(self, monkeypatch):
        ...
        derouter.aresponses with the router-resolved deployment model, not the
        ...
        monkeypatch.setattr(derouter, "aresponses", fake_aresponses)
        ...
        handler = ManagedResponsesWebSocketHandler(
            ...
            derouter_metadata={"model_group": "gpt-5.5-mantle"},
        )
    ...
    async def test_warmup_frame_skips_provider_and_sends_synthetic_ack(
        ...
        monkeypatch.setattr(derouter, "aresponses", fail_aresponses)
...
class TestNativeWebSocketUrlConstruction:
    ...
    @pytest.mark.asyncio
    async def test_ws_passes_derouter_params_to_get_websocket_url(self):
        ...
        assert call_kwargs["derouter_params"]["api_version"] == "2025-04-01-preview"
