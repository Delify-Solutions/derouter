...
This test verifies that DeRouter properly handles streaming responses where
text content is None, preventing TypeErrors in downstream OpenAI-compatible SDKs.

Related issue: When using DeRouter as an OpenAI-compatible proxy for self-hosted
