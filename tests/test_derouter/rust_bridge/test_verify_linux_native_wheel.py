...
_NATIVE_MEMBER: Final = "derouter/rust_bridge/_native.abi3.so"
_DIST_INFO: Final = "derouter-1.100.0.dist-info"
...
def _write_wheel(
    ...
    *,
    ...
    wheel: Final = tmp_path / f"derouter-1.100.0-{filename_tag}.whl"
...
def _run_verifier(
    ...
    *,
    ...
    native_module: Final = (
        _NativeModuleWithPanicHook("derouter.rust_bridge._native")
        if exposes_panic
        else ModuleType("derouter.rust_bridge._native")
    )
