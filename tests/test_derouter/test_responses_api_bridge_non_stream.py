...
def create_mock_completion_response(
    ...
    if reasoning_tokens is not None or text_tokens is not None:
        from derouter.types.utils import CompletionTokensDetails
...
def test_transform_usage_no_token_details():
    ...
    responses_usage = DeRouterCompletionResponsesConfig._transform_chat_completion_usage_to_responses_usage(
        completion_response
    )
...
def test_transform_usage_maps_nested_cache_creation_input_tokens():
    ...
    responses_usage: Final = DeRouterCompletionResponsesConfig._transform_chat_completion_usage_to_responses_usage(
        usage
    )
...
def test_transform_usage_unknown_reasoning_split_keeps_output_tokens_details():
    ...
    responses_usage = DeRouterCompletionResponsesConfig._transform_chat_completion_usage_to_responses_usage(usage)
