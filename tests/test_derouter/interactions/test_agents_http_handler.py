"""
Unit tests for derouter/interactions/agents/http_handler.py
...
from derouter.interactions.agents.http_handler import (
    AgentsHTTPHandler,
    agents_http_handler,
)
...
from derouter.llms.gemini.common_utils import GeminiError
...
@pytest.fixture
def derouter_params() -> GenericDeRouterParams:
    return GenericDeRouterParams(api_key="AIza-test")
...
class TestCreateAgent:
    def test_sync_returns_parsed_create_response(self, handler, config, derouter_params):
    ...
    def test_sync_dispatches_to_async_when_is_async(
        self, handler, config, derouter_params
    ):
        client = _make_sync_client()
    ...
    def test_sync_maps_http_error_via_config(self, handler, config, derouter_params):
        client = _make_sync_client()
...
class TestListAgents:
    def test_sync_returns_list_response(self, handler, config, derouter_params):
        client = _make_sync_client()
    ...
    @pytest.mark.asyncio
    async def test_async_returns_list_response(self, handler, config, derouter_params):
        client = _make_async_client()
        client.get.return_value = _make_response(
...
class TestGetAgent:
    def test_sync_returns_get_response(self, handler, config, derouter_params):
        client = _make_sync_client()
    ...
    @pytest.mark.asyncio
    async def test_async_returns_get_response(self, handler, config, derouter_params):
        client = _make_async_client()
...
class TestDeleteAgent:
    def test_sync_returns_delete_result(self, handler, config, derouter_params):
        client = _make_sync_client()
    ...
    @pytest.mark.asyncio
    async def test_async_returns_delete_result(self, handler, config, derouter_params):
        client = _make_async_client()
        client.delete.return_value = _make_response(200, json_data={})
...
class TestListAgentVersions:
    def test_sync_returns_versions_response(self, handler, config, derouter_params):
        client = _make_sync_client()
        client.get.return_value = _make_response(
            200,
            json_data={
