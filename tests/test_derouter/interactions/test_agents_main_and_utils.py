"""
Unit tests for derouter/interactions/agents/utils.py and main.py
...
import derouter
from derouter.interactions.agents import (
    acreate,
    adelete,
    aget,
    alist,
...
from derouter.interactions.agents.utils import get_provider_agents_api_config
...
_HANDLER_PATH = "derouter.interactions.agents.main.agents_http_handler"
...
class TestMakeLoggingObj:
    def test_calls_update_from_kwargs_and_returns_same_obj(self):
        ...
        kwargs = {"derouter_logging_obj": logging_obj, "derouter_call_id": "abc-123"}
        ...
        assert kwargs_call["derouter_params"]["derouter_call_id"] == "abc-123"
...
class TestAsyncErrorWrapping:
    ...
    derouter.exception_type so users get a normalised provider error."""
