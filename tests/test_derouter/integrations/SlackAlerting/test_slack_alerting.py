...
from derouter.types.integrations.slack_alerting import AlertType, SlackAlertingCacheKeys
...
class TestSlackAlerting(unittest.TestCase):
    ...
    @patch("derouter.integrations.SlackAlerting.slack_alerting.datetime")
