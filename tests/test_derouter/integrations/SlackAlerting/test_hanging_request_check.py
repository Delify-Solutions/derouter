...
from derouter.types.integrations.slack_alerting import HangingRequestData
...
class TestAlertingHangingRequestCheck:
    ...
    async def test_add_request_to_hanging_request_check_success(
        ...
        """
        request_data = {
            "derouter_call_id": "test_request_123",
            "model": "gpt-4",
            "deployment": {"derouter_params": {"api_base": "https://api.openai.com/v1"}},
            "metadata": {
        ...
        with patch("derouter.get_api_base", return_value="https://api.openai.com/v1"):
    ...
    async def test_add_request_to_hanging_request_check_minimal_data(
        ...
        """
        request_data = {
            "derouter_call_id": "minimal_request_456",
            "model": "gpt-3.5-turbo",
        }
    ...
    async def test_send_alerts_for_hanging_requests_no_proxy_logging(
        ...
        """
        with patch("derouter.proxy.proxy_server.proxy_logging_obj") as mock_proxy:
