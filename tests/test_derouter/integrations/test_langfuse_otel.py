...
class TestLangfuseOtelIntegration:
    ...
    def test_set_langfuse_otel_attributes(self):
        ...
        from derouter.integrations.langfuse.langfuse_otel_attributes import (
        ...
        with patch(
            "derouter.integrations.arize._utils.set_attributes"
    ...
    def test_set_langfuse_environment_attribute(self):
        ...
        with patch.dict(os.environ, {"LANGFUSE_TRACING_ENVIRONMENT": test_env}):
            with patch(
                "derouter.integrations.arize._utils.safe_set_attribute"
    ...
    def test_extract_langfuse_metadata_basic(self):
        """Ensure metadata is correctly pulled from derouter_params."""
        metadata_in = {"generation_name": "my-gen", "custom": "data"}
        kwargs = {"derouter_params": {"metadata": metadata_in}}
    ...
    def test_extract_langfuse_metadata_with_header_enrichment(self, monkeypatch):
        ...
        stub_module = types.ModuleType("derouter.integrations.langfuse.langfuse")

        class StubLFLogger:
            @staticmethod
            def add_metadata_from_header(derouter_params, metadata):
        ...
        monkeypatch.setitem(sys.modules, "derouter.integrations.langfuse.langfuse", stub_module)  # type: ignore

        kwargs = {"derouter_params": {"metadata": {"foo": "bar"}}}
        extracted = LangfuseOtelLogger._extract_langfuse_metadata(kwargs)
    ...
    def test_set_langfuse_specific_attributes_metadata(self):
        ...
        kwargs = {"derouter_params": {"metadata": metadata}}
        ...
        with patch(
            ...
            from derouter.types.integrations.langfuse_otel import LangfuseSpanAttributes
    ...
    def test_version_emitted_on_langfuse_v4_key(self, metadata, expected_version):
        kwargs = {"derouter_params": {"metadata": {"trace_release": "rel-9", **metadata}}}
...
class TestLangfuseOtelResponsesAPI:
    ...
    def test_langfuse_otel_with_responses_api(self):
        ...
        kwargs = {
            ...
            "model": "gpt-4o",
            "optional_params": {},
            "derouter_params": {"metadata": test_metadata},
        }
    ...
    def test_responses_api_metadata_extraction(self):
        ...
        if "derouter.integrations.langfuse.langfuse" in sys.modules:
            sys.modules["derouter.integrations.langfuse.langfuse"]
    ...
    def test_responses_api_langfuse_specific_attributes(self):
        ...
        kwargs = {"call_type": "responses", "derouter_params": {"metadata": metadata}}
