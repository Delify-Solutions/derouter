...
from derouter.integrations.levo.levo import LevoConfig, LevoLogger
...
class TestLevoIntegration(unittest.TestCase):
    ...
    @patch(
        "derouter.integrations.opentelemetry.OpenTelemetry._init_otel_logger_on_derouter_proxy"
    )
    @pytest.mark.asyncio
