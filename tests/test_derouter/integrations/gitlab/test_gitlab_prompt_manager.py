...
from derouter.integrations.gitlab.gitlab_client import GitLabClient
...
@patch("derouter.integrations.gitlab.gitlab_client.HTTPHandler.get")
...
@patch("derouter.integrations.gitlab.gitlab_prompt_manager.GitLabClient")
...
def test_gitlab_prompt_manager_pre_call_hook_no_prompt_id():
    ...
    msgs, params = mgr.pre_call_hook(
        user_id="u", messages=original, derouter_params={}, prompt_id=None
    )
...
@patch("derouter.integrations.gitlab.gitlab_prompt_manager.GitLabPromptManager")
