...
from derouter.integrations.gitlab.gitlab_prompt_manager import GitLabPromptManager
...
def test_gitlab_prompt_manager_config_validation_via_client_ctor():
    ...
    """
    with patch(
        "derouter.integrations.gitlab.gitlab_prompt_manager.GitLabClient",
...
User: {{user_message}}"""
    ...
    derouter_params = {"api_key": "keep-me"}
