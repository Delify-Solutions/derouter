...
from derouter.integrations.focus.destinations.mavvrik_destination import (
...
def test_factory_creates_mavvrik_destination(monkeypatch):
    ...
    from derouter.integrations.focus.destinations.factory import FocusDestinationFactory
...
def test_only_daily_frequency_is_supported():
    ...
    for freq in ("hourly", "interval"):
        ...
        def _make(f=freq, monkeypatch=None):
            ...
            try:
                from derouter.integrations.mavvrik_focus import mavvrik_focus_logger
