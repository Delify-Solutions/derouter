...
from derouter.integrations.focus.destinations.vantage_destination import (
...
MOCK_TARGET = (
    "derouter.integrations.focus.destinations.vantage_destination.get_async_httpx_client"
)
