...
from derouter.integrations.otel.model.config import ExporterSpec
from derouter.integrations.otel.presets import agentops as agentops_mod
from derouter.integrations.otel.presets.agentops import (
    _AGENTOPS_ENDPOINT,
...
def test_dynamic_cred_presets_tag_exporter_with_matching_owner(monkeypatch):
    ...
    from derouter.integrations.otel.model.config import ExporterOwner
...
def test_newrelic_preset_reads_env_license_key(monkeypatch):
    ...
    from derouter.integrations.otel.model.config import ExporterOwner
    from derouter.integrations.otel.presets.newrelic import newrelic_preset
