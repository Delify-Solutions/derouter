...
import derouter  # noqa: E402
from derouter.caching.dual_cache import DualCache  # noqa: E402
from derouter.integrations.otel.logger import build_otel_v2_logger  # noqa: E402
from derouter.integrations.otel.model.config import OpenTelemetryV2Config, is_otel_v2_enabled  # noqa: E402
from derouter.integrations.otel.model.spans import DEROUTER_PROXY_REQUEST_SPAN_NAME, SpanRole  # noqa: E402
from derouter.integrations.otel.plumbing import context as otel_context  # noqa: E402
from derouter.integrations.otel.plumbing import providers  # noqa: E402
from derouter.integrations.otel.plumbing.context import set_request_root_span  # noqa: E402
from derouter.derouter_core_utils.derouter_logging import _maybe_construct_otel_v2  # noqa: E402
from derouter.proxy._types import UserAPIKeyAuth  # noqa: E402
from derouter.proxy.utils import ProxyLogging  # noqa: E402
from derouter.types.llms.openai import (  # noqa: E402
    ResponseCompletedEvent,
    ResponsesAPIResponse,
    ResponsesAPIStreamEvents,
)
from derouter.types.utils import (  # noqa: E402
    Choices,
    Delta,
    Embedding,
    EmbeddingResponse,
...
def _start_root(logger):
    root = logger._emitter.start_span(SpanRole.PROXY_REQUEST, DEROUTER_PROXY_REQUEST_SPAN_NAME)
...
def _root_attrs(exporter):
    ...
    return dict(by_name[DEROUTER_PROXY_REQUEST_SPAN_NAME].attributes or {})
...
def test_root_observation_io_survives_the_root_ending_before_the_success_callback():
    ...
    logger.log_pre_api_call(
        model="gpt-5.4-mini",
        messages=[],
        kwargs={"derouter_call_id": "call_1", "derouter_params": {"metadata": {}}},
    )
    asyncio.run(
    ...
    asyncio.run(
        logger.async_log_success_event(
            {"standard_logging_object": payload, "derouter_params": {"metadata": {}}}, response, None, None
        )
    )

    attrs = _root_attrs(exporter)
    assert INPUT_ATTR in attrs and OUTPUT_ATTR in attrs
    generation = next(span for span in exporter.get_finished_spans() if span.name != DEROUTER_PROXY_REQUEST_SPAN_NAME)
