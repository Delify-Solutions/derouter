...
from derouter.integrations.deepeval.api import Endpoints, HttpMethods
from derouter.integrations.deepeval.deepeval import DeepEvalLogger
from derouter.integrations.deepeval.types import SpanApiType, TraceSpanApiStatus
...
class TestDeepEvalLogger(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.api_patcher = patch("derouter.integrations.deepeval.deepeval.Api")
    ...
    def _common_assertions(
        ...
        expected_name = (
            "derouter_success_callback"
            if expected_status == TraceSpanApiStatus.SUCCESS
            else "derouter_failure_callback"
        )
