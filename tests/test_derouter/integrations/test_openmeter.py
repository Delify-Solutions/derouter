...
class TestOpenMeterIntegration:
    ...
    @patch("derouter.integrations.openmeter.HTTPHandler")
    ...
    @patch("derouter.integrations.openmeter.get_async_httpx_client")
    @pytest.mark.asyncio
    async def test_async_log_success_event(self, mock_get_client):
        ...
        kwargs = {
            ...
            "model": "gpt-4",
            "response_cost": 0.002,
            "derouter_call_id": "async-test-call-id",
        }
    ...
    def test_cloudevents_structure(self):
        ...
        kwargs = {
            ...
            "model": "gpt-3.5-turbo",
            "response_cost": 0.001,
            "derouter_call_id": "cloudevents-test-call-id",
        }
        ...
        response_obj = derouter.ModelResponse(**response_data)

        result = logger._common_logic(kwargs, response_obj)

        # Verify CloudEvents required fields
        assert result["specversion"] == "1.0"
        assert result["type"] == "derouter_tokens"  # default value
        assert result["id"] == "cloudevents-test-response-id"
        assert result["source"] == "derouter-proxy"
    ...
    def test_custom_event_type(self, monkeypatch):
        ...
        kwargs = {
            ...
            "model": "gpt-4",
            "response_cost": 0.003,
            "derouter_call_id": "custom-event-call-id",
        }
    ...
    def test_common_logic_user_from_token_user_id(self):
        ...
        kwargs = {
            ...
            "response_cost": 0.001,
            "derouter_call_id": "test-call-id",
            "derouter_params": {"metadata": {"user_api_key_user_id": "token-user-123"}},
    ...
    def test_integration_token_user_id_scenario(self, mock_http_handler):
        ...
        kwargs = {
            ...
            "response_cost": 0.001,
            "derouter_call_id": "test-integration-call-id",
            "derouter_params": {
                "metadata": {
