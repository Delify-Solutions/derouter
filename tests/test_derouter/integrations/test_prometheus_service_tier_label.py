...
Run with:
    uv run pytest tests/test_derouter/integrations/test_prometheus_service_tier_label.py -v
"""
...
async def test_success_event_emits_service_tier_on_latency_and_spend_metrics():
    ...
    try:
        ...
        for metric_name in (
            ...
            "derouter_llm_api_time_to_first_token_metric_bucket",
