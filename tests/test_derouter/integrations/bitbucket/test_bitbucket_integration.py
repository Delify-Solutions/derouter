...
from derouter.integrations.bitbucket.bitbucket_client import _sanitize_file_path


@patch("derouter.integrations.bitbucket.bitbucket_prompt_manager.BitBucketClient")
def test_bitbucket_prompt_integration_with_derouter(mock_client_class):
    """Test BitBucket prompt integration with DeRouter completion."""
...
User: {{user_message}}"""
    ...
    derouter.set_global_bitbucket_config(bitbucket_config)

    # Test that the configuration was set
    assert derouter.global_bitbucket_config == bitbucket_config
...
User: {{user_message}}"""
    ...
    # Should have updated derouter_params
...
def test_bitbucket_client_rejects_traversal_in_get_file_content():
    from derouter.integrations.bitbucket.bitbucket_client import BitBucketClient
