...
class TestPrometheusQueueTimeMetric:
    ...
    def test_queue_time_metric_recorded_in_set_latency_metrics(self):
        ...
        prometheus_logger.derouter_request_queue_time_metric = mock_metric

        # Create mock kwargs with queue_time_seconds in metadata
        queue_time_seconds = 0.5

        kwargs = {
            "derouter_params": {"metadata": {"queue_time_seconds": queue_time_seconds}},
            "model": "gpt-3.5-turbo",
...
class TestPrometheusTotalLatencyMetric:
    """derouter_request_total_latency_metric must be true end-to-end latency: start_time
    ...
    def test_total_latency_includes_queue_time_when_present(self):
        ...
        mock_labeled_metric = MagicMock()
        mock_metric.labels.return_value = mock_labeled_metric
        prometheus_logger.derouter_request_total_latency_metric = mock_metric
    ...
    def test_total_latency_ignores_negative_queue_time(self):
        ...
        kwargs = {
            "derouter_params": {"metadata": {"queue_time_seconds": -0.1}},
            "model": "gpt-3.5-turbo",
            "start_time": start_time,
            "end_time": end_time,
        }
...
class TestPrometheusGuardrailMetrics:
    ...
    def test_record_guardrail_metrics_success(self):
        ...
        prometheus_logger.derouter_guardrail_latency_metric = mock_latency_metric
        prometheus_logger.derouter_guardrail_requests_total = mock_requests_metric
        prometheus_logger.derouter_guardrail_errors_total = mock_errors_metric
    ...
    def test_record_guardrail_metrics_handles_exception(self):
        ...
        prometheus_logger.derouter_guardrail_latency_metric = mock_metric
        prometheus_logger.derouter_guardrail_requests_total = MagicMock()
