...
from derouter.integrations.arize.arize_phoenix_prompt_manager import (
    ArizePhoenixTemplateManager,
)
from derouter.integrations.bitbucket.bitbucket_prompt_manager import (
    BitBucketTemplateManager,
)
from derouter.integrations.gitlab.gitlab_prompt_manager import GitLabTemplateManager
...
def _build_bitbucket_manager(monkeypatch) -> BitBucketTemplateManager:
    ...
    from derouter.integrations.bitbucket import bitbucket_prompt_manager
...
def _build_arize_manager(monkeypatch) -> ArizePhoenixTemplateManager:
    from derouter.integrations.arize import arize_phoenix_prompt_manager
