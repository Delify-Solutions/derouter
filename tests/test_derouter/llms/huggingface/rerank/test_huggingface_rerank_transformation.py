...
@patch("derouter.llms.custom_httpx.http_handler.AsyncHTTPHandler.post")
...
def test_huggingface_rerank_config():
    ...
    from derouter.llms.huggingface.rerank.transformation import HuggingFaceRerankConfig
...
def test_request_transformation():
    ...
    from derouter.llms.huggingface.rerank.transformation import HuggingFaceRerankConfig
    from derouter.types.rerank import OptionalRerankParams
