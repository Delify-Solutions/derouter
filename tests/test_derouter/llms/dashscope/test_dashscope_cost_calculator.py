...
class TestDashscopeCostCalculator:
    ...
    def test_dashscope_flat_pricing_fallback(self):
        ...
        model_info = derouter.get_model_info("dashscope/qwen-max")
    ...
    def test_dashscope_tiered_pricing_within_first_tier(self):
        ...
        model_info = derouter.get_model_info("dashscope/qwen-flash")
    ...
    def test_dashscope_tiered_pricing_boundary_stays_in_lower_tier(self):
        ...
        tier_1 = derouter.get_model_info("dashscope/qwen-flash")["tiered_pricing"][0]
    ...
    def test_dashscope_tiered_pricing_with_caching(self):
        ...
        tier_2 = derouter.get_model_info("dashscope/qwen3-coder-plus")["tiered_pricing"][1]
    ...
    def test_dashscope_tiered_pricing_exceeding_highest_tier(self):
        ...
        tier_2 = derouter.get_model_info("dashscope/qwen-flash")["tiered_pricing"][1]
    ...
    def _register_tiered_model(self, model_key: str, tiered_pricing: list[dict]) -> None:
        derouter.model_cost[model_key] = {
            "derouter_provider": "dashscope",
            "mode": "chat",
    ...
    def test_dashscope_flat_cache_creation_tokens_use_flat_rate(self):
        ...
        derouter.model_cost["dashscope/qwen-flat-cache-write-test"] = {
            "derouter_provider": "dashscope",
            "mode": "chat",
            "input_cost_per_token": 3.25e-07,
            "output_cost_per_token": 1.95e-06,
    ...
    def test_dashscope_tier_without_an_output_rate_bills_the_model_rate(self):
        ...
        """
        derouter.model_cost["dashscope/qwen-input-only-tier-test"] = {
            "derouter_provider": "dashscope",
            "mode": "chat",
            "output_cost_per_token": 1.6e-06,
    ...
    def test_dashscope_tier_without_an_output_rate_bills_the_model_reasoning_rate(self):
        ...
        """
        derouter.model_cost["dashscope/qwen-input-only-reasoning-test"] = {
            "derouter_provider": "dashscope",
            "mode": "chat",
            "output_cost_per_token": 1.6e-06,
    ...
    def test_dashscope_tier_output_rate_wins_over_the_model_reasoning_rate(self):
        ...
        """
        derouter.model_cost["dashscope/qwen-tier-output-reasoning-test"] = {
            "derouter_provider": "dashscope",
            "mode": "chat",
            "output_cost_per_reasoning_token": 4e-06,
            "tiered_pricing": [
    ...
    def test_dashscope_model_zero_reasoning_rate_bills_reasoning_free(self):
        ...
        """
        derouter.model_cost["dashscope/qwen-zero-reasoning-test"] = {
            "derouter_provider": "dashscope",
            "mode": "chat",
            "input_cost_per_token": 4e-07,
            "output_cost_per_token": 1.6e-06,
    ...
    def test_dashscope_tier_zero_reasoning_rate_bills_reasoning_free(self):
        ...
        """
        derouter.model_cost["dashscope/qwen-tier-zero-reasoning-test"] = {
            "derouter_provider": "dashscope",
            "mode": "chat",
            "tiered_pricing": [
                {
    ...
    def test_dashscope_tiered_pricing_zero_input_falls_back_to_flat_rates(self):
        ...
        """
        derouter.model_cost["dashscope/qwen-zero-input-test"] = {
            "derouter_provider": "dashscope",
            "mode": "chat",
            "input_cost_per_token": 4e-07,
            "output_cost_per_token": 1.6e-06,
    ...
    def test_dashscope_off_peak_window_overrides_the_selected_tier(self):
        ...
        derouter.model_cost["dashscope/qwen-tiered-off-peak-test"]["off_peak_pricing"] = {
            "hours_utc": self.OFF_PEAK_WINDOW,
    ...
    def test_dashscope_off_peak_rates_left_unset_keep_the_standard_rates(self):
        ...
        derouter.model_cost["dashscope/qwen-partial-off-peak-test"]["output_cost_per_reasoning_token"] = 9e-06
        usage = Usage(
            prompt_tokens=1000,
            completion_tokens=200,
    ...
    def test_dashscope_off_peak_reasoning_rate_replaces_the_dedicated_reasoning_rate(self):
        ...
        derouter.model_cost["dashscope/qwen-reasoning-rate-off-peak-test"]["output_cost_per_reasoning_token"] = 9e-06
        usage = Usage(
            prompt_tokens=100,
            completion_tokens=200,
            completion_tokens_details=CompletionTokensDetailsWrapper(reasoning_tokens=50),
    ...
    def test_dashscope_off_peak_reasoning_and_cache_creation_rates_override_the_selected_tier(self):
        ...
        derouter.model_cost["dashscope/qwen-tiered-reasoning-off-peak-test"]["off_peak_pricing"] = {
            "hours_utc": self.OFF_PEAK_WINDOW,
