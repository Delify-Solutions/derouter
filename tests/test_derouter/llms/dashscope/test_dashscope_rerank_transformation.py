...
from derouter.llms.dashscope.common_utils import DashScopeError
from derouter.llms.dashscope.rerank.transformation import (
    DEFAULT_RERANK_URL,
...
class TestProviderConfigManagerDispatch:
    def test_dashscope_returns_rerank_config(self):
        ...
        cfg = ProviderConfigManager.get_provider_rerank_config(
            model="qwen3-rerank",
            provider=derouter.LlmProviders.DASHSCOPE,
            api_base=None,
