...
Issue: https://github.com/Delify-Solutions/derouter/issues/18430
Vertex AI Anthropic models don't support URL sources for images.
DeRouter should convert image URLs to base64 when using Vertex AI Anthropic.
"""
...
class TestVertexAIAnthropicImageURLHandling:
    ...
    @patch("derouter.derouter_core_utils.prompt_templates.factory.convert_url_to_base64")
...
class TestToolMessageImageURLHandling:
    ...
    Issue: https://github.com/Delify-Solutions/derouter/issues/19891
    """
...
async def test_vertex_ai_anthropic_async_completion_inlines_https_images_off_the_event_loop(async_only_image_fetch):
    ...
    with (
        ...
        patch.object(  # test-quality-ok: derouter.acompletion has no seam for Vertex token minting
            derouter.main.vertex_partner_models_chat_completion,
