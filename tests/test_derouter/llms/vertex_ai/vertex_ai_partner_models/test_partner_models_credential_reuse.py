...
from derouter.llms.vertex_ai.vertex_gemma_models.main import VertexAIGemmaModels
from derouter.llms.vertex_ai.vertex_model_garden.main import VertexAIModelGardenModels
...
class TestPartnerModelsCredentialReuse:
    def test_completion_uses_self_ensure_access_token(self):
        ...
        with (
            ...
            patch(
                "derouter.llms.vertex_ai.vertex_ai_partner_models.main.base_llm_http_handler"
            ) as mock_handler,
        ):
...
class TestGemmaModelsCredentialReuse:
    def test_completion_uses_self_ensure_access_token(self):
        ...
        with (
            ...
            patch(
                "derouter.llms.vertex_ai.vertex_gemma_models.transformation.VertexGemmaConfig",
                mock_gemma_config,
            ),
        ):
            gemma.completion(
...
class TestModelGardenCredentialReuse:
    def test_completion_uses_self_ensure_access_token(self):
        ...
        with (
            ...
            patch(
                "derouter.llms.openai_like.chat.handler.OpenAILikeChatHandler",
                mock_handler,
            ),
        ):
            garden.completion(
