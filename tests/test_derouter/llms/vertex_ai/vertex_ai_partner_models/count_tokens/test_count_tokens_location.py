...
Ref: https://github.com/Delify-Solutions/derouter/issues/23872
"""
...
class TestCountTokensLocationResolution:
    ...
    async def test_count_tokens_location_overrides_vertex_location(
        ...
        import derouter.llms.vertex_ai.vertex_ai_partner_models.count_tokens.handler as handler_mod

        monkeypatch.setattr(
            handler_mod, "get_async_httpx_client", lambda **kwargs: FakeClient()
        )

        derouter_params = self._build_derouter_params(
    ...
    async def test_claude_without_count_tokens_location_defaults_to_us_east5(
        ...
        derouter_params = self._build_derouter_params()  # no location at all
    ...
    async def test_claude_with_vertex_location_uses_it(self, counter, monkeypatch):
        ...
        derouter_params = self._build_derouter_params(vertex_location="asia-southeast1")
...
class TestCountTokensVersionSuffixStripping:
    ...
    async def test_handle_count_tokens_strips_version_from_request_data(
        ...
        await counter.handle_count_tokens_request(
            ...
            derouter_params={"vertex_location": "us-east5"},
        )
