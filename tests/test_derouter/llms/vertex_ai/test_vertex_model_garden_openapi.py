...
import derouter
from derouter.llms.vertex_ai.vertex_model_garden.main import (
...
async def _invoke_model_garden_completion(
    *,
    ...
    """Drive derouter.acompletion through the Vertex Model Garden route and return
    ...
    with (
        ...
        patch(
            "derouter.llms.vertex_ai.vertex_model_garden.main.VertexAIModelGardenModels._ensure_access_token",
        ...
        await derouter.acompletion(**kwargs)
...
async def test_user_supplied_api_base_passes_through_unchanged(
    clean_vertex_env, _reset_derouter_http_client_cache
):
