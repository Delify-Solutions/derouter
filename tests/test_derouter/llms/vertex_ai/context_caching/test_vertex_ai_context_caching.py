...
from derouter.llms.vertex_ai.context_caching.vertex_ai_context_caching import (
...
class TestContextCachingEndpoints:
    ...
    def setup_method(self):
        ...
        self._token_check_patcher = patch(
            "derouter.llms.vertex_ai.context_caching.vertex_ai_context_caching.is_prompt_caching_valid_prompt",
            return_value=True,
        )
    ...
    @patch(
        "derouter.llms.vertex_ai.context_caching.vertex_ai_context_caching.separate_cached_messages"
    )
    @patch(
        "derouter.llms.vertex_ai.context_caching.vertex_ai_context_caching.local_cache_obj"
    )
    ...
    @patch(
        "derouter.llms.vertex_ai.context_caching.vertex_ai_context_caching.transform_openai_messages_to_gemini_context_caching"
    )
    @patch.object(ContextCachingEndpoints, "check_cache")
    ...
    @patch.object(ContextCachingEndpoints, "_get_token_and_url_context_caching")
    @patch(
        "derouter.llms.vertex_ai.context_caching.vertex_ai_context_caching.get_async_httpx_client"
    )
    ...
    def test_check_and_create_cache_tool_choice_typed_constructor(
        ...
        ToolConfig / FunctionCallingConfig are TypedDicts (derouter/types/llms/vertex_ai.py:158, 277)
...
class TestVertexAIGlobalLocation:
    ...
    def test_gemini_context_caching_with_custom_api_base_passes_model(self):
        ...
        Regression test for https://github.com/Delify-Solutions/derouter/issues/23846
