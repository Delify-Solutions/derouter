...
import derouter
from derouter.llms.vertex_ai.vertex_ai_aws_wif import VertexAIAwsWifAuth
...
class TestVertexBase:
    ...
    def test_credentials_from_aws_with_explicit_auth(self):
        ...
        with (
            patch("derouter.llms.bedrock.base_aws_llm.BaseAWSLLM") as MockBaseAWSLLM,
            patch(
    ...
    async def test_aws_wif_routes_to_explicit_auth_when_aws_params_present(
        ...
        with (
            patch(
                "derouter.llms.vertex_ai.vertex_ai_aws_wif.VertexAIAwsWifAuth.credentials_from_explicit_aws",
                return_value=mock_creds,
    ...
    def test_aws_credentials_supplier(self):
        ...
        from derouter.llms.vertex_ai.aws_credentials_supplier import (
