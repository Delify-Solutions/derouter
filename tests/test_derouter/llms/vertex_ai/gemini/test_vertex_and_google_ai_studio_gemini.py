...
import derouter
from derouter import ModelResponse, completion
...
from derouter.types.llms.vertex_ai import UsageMetadata
from derouter.types.utils import ChoiceLogprobs, Usage
...
def test_vertex_ai_get_json_schema_preserves_refs_for_nested_pydantic():
    ...
    This is the root cause fix for https://github.com/Delify-Solutions/derouter/issues/21014
    """
...
def test_vertex_ai_thinking_output_part():
    ...
    from derouter.types.llms.vertex_ai import HttpxPartType
...
def test_vertex_ai_grounded_usage_surfaces_tool_use_tokens():
    ...
    Regression for https://github.com/Delify-Solutions/derouter/issues/33530: it must be folded into
...
def test_vertex_ai_maps_grounding_tool_use_tokens_excluded_from_prompt_tokens():
    ...
    Regression for https://github.com/Delify-Solutions/derouter/issues/35906
    """
    v = VertexGeminiConfig()
    completion_response = {
        "candidates": [
...
def test_streaming_chunk_includes_reasoning_tokens():
    ...
    iterator = ModelResponseIterator(
        streaming_response=[], sync_stream=True, logging_obj=derouter_logging
    )
...
def test_vertex_ai_map_tool_with_anyof():
    """
    Related issue: https://github.com/Delify-Solutions/derouter/issues/11164

    Ensure if anyof is present, only the anyof field and its contents are kept - otherwise VertexAI will throw an error - https://github.com/Delify-Solutions/derouter/issues/11164
    """
    v = VertexGeminiConfig()
    optional_params = {}
    value = [
...
def test_vertex_ai_annotation_streaming_events():
    ...
    from derouter.types.llms.openai import ChatCompletionAnnotation
...
async def test_vertex_ai_streaming_bad_request_is_not_wrapped():
    class DummyLogging:
        def __init__(self):
            self.model_call_details = {"derouter_params": {}}
...
def test_reasoning_effort_dict_format_gemini_3():
    ...
    Related issue: https://github.com/Delify-Solutions/derouter/issues/19411
    """
    from derouter.llms.vertex_ai.gemini.vertex_and_google_ai_studio_gemini import (
        VertexGeminiConfig,
    )
...
def test_gemini_3_image_models_no_thinking_config():
    ...
    Related issue: https://github.com/Delify-Solutions/derouter/issues/17013
...
def test_partial_json_chunk_after_first_chunk():
    ...
    - https://github.com/Delify-Solutions/derouter/issues/16562
    - https://github.com/Delify-Solutions/derouter/issues/16037
    - https://github.com/Delify-Solutions/derouter/issues/14747
    - https://github.com/Delify-Solutions/derouter/issues/10410
    - https://github.com/Delify-Solutions/derouter/issues/5650
...
def test_accumulated_json_does_not_reparse_every_fragment():
    """
    Regression test for https://github.com/Delify-Solutions/derouter/issues/26181
...
def test_google_ai_studio_presence_penalty_supported():
    ...
    Regression test for https://github.com/Delify-Solutions/derouter/issues/14753
    """
...
def test_vertex_ai_usage_metadata_with_document_tokens_in_prompt():
    ...
    Fixes: https://github.com/Delify-Solutions/derouter/issues/24375
...
def test_async_streaming_uses_custom_client():
    ...
    Fixes: https://github.com/Delify-Solutions/derouter/issues/17148
    """
...
def test_transform_response_does_not_leak_body_on_parse_failure():
    ...
    with patch(
        "derouter.llms.vertex_ai.gemini.vertex_and_google_ai_studio_gemini.GenerateContentResponseBody",
