...
Ref: https://github.com/Delify-Solutions/derouter/issues/21041
"""
...
def test_streaming_tool_call_finish_reason_with_empty_content_in_final_chunk():
    ...
    Ref: https://github.com/Delify-Solutions/derouter/issues/22900
    """
    logging_obj = _make_logging_obj()
    iterator = ModelResponseIterator(
        streaming_response=iter([]),
...
def test_streaming_metadata_only_chunk_does_not_yield_empty_choices():
    ...
    Ref: https://github.com/Delify-Solutions/derouter/issues/28884
    """
    logging_obj = _make_logging_obj()
    iterator = ModelResponseIterator(
        streaming_response=iter([]),
