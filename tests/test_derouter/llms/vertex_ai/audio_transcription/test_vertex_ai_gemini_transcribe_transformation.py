...
from derouter.types.utils import LlmProviders, TranscriptionUsageTokensObject
...
class TestGetCompleteUrl:
    ...
    def test_explicit_location_is_honored(self, config):
        url = config.get_complete_url(
            ...
            model="gemini-3.5-transcribe-preview",
            optional_params={},
            derouter_params={"vertex_project": "test-project", "vertex_location": "us-central1"},
        )
        assert url == (
    ...
    def test_malicious_project_is_rejected(self, config, malicious_project):
        with pytest.raises(VertexAIError):
            config.get_complete_url(
                ...
                model="gemini-3.5-transcribe-preview",
                optional_params={},
                derouter_params={"vertex_project": malicious_project},
            )
