...
Validates that derouter.transcription transforms requests correctly for WatsonX.
"""
...
class TestWatsonXAudioTranscription:
    """Tests for WatsonX audio transcription via derouter.transcription."""

    @pytest.mark.asyncio
    async def test_watsonx_transcription_url_and_headers(self):
        """
        Test that derouter.transcription sends request to correct WatsonX URL with proper headers.
        """
        captured_request = {}
    ...
    async def test_watsonx_transcription_request_body(self):
        """
        Test that derouter.transcription sends correct request body for WatsonX.
    ...
    async def test_watsonx_transcription_only_user_params_sent_with_project_id(self):
        ...
        DeRouter should NOT add extra params like response_format if user didn't specify them.
        """
        captured_request = {}
