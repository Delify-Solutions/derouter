...
from derouter.llms.watsonx.common_utils import generate_iam_token


class TestGenerateIAMToken:
    """Tests for the generate_iam_token function, specifically testing API key fallback logic."""

    @patch("derouter.llms.watsonx.common_utils.iam_token_cache")
    @patch("derouter.llms.watsonx.common_utils.derouter.module_level_client")
    @patch("derouter.llms.watsonx.common_utils.get_secret_str")
