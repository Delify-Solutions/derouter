...
Source: derouter/llms/chatgpt/responses/transformation.py
"""
...
class TestChatGPTResponsesAPITransformation:
    ...
    @patch("derouter.llms.chatgpt.responses.transformation.Authenticator")
    def test_chatgpt_responses_endpoint_url(self, mock_authenticator_class):
        ...
        custom_url = config.get_complete_url(
            api_base="https://custom.chatgpt.com", derouter_params={}
        )
        assert custom_url == "https://custom.chatgpt.com/responses"

        url_with_slash = config.get_complete_url(
            api_base="https://chatgpt.example.com/", derouter_params={}
        )
    ...
    def test_validate_environment_headers(self, mock_authenticator_class):
        ...
        config = ChatGPTResponsesAPIConfig()
        derouter_params = GenericDeRouterParams(derouter_session_id="session-123")
