...
from derouter.llms.snowflake.chat.transformation import SnowflakeConfig, SnowflakeStreamingHandler
...
class TestSnowflakeToolTransformation:
    ...
    def test_transform_response_with_tool_calls(self):
        ...
        model_response = ModelResponse(choices=[derouter.Choices(index=0, message=derouter.Message())])
