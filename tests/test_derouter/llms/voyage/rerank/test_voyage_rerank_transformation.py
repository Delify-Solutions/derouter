...
from derouter.llms.voyage.rerank.transformation import VoyageRerankConfig
...
class TestVoyageRerankTransform:
    ...
    @patch("derouter.llms.voyage.rerank.transformation.get_secret_str")
    ...
    def test_calculate_rerank_cost(self):
        ...
        from derouter.types.rerank import RerankBilledUnits
