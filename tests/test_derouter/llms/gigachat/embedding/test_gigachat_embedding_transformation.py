...
from derouter.llms.gigachat.embedding.transformation import (
    GigaChatEmbeddingConfig,
    GigaChatEmbeddingError,
)
from derouter.types.utils import EmbeddingResponse

TRANSFORM_MODULE = "derouter.llms.gigachat.embedding.transformation"
...
class TestValidateEnvironment:
    ...
    def test_sets_oauth_headers(self, mock_get_token):
        ...
        mock_get_token.assert_called_once_with(credentials="creds", derouter_params={})
