...
from derouter.llms.gigachat.chat.transformation import (
    GigaChatConfig,
    GigaChatError,
    is_valid_json,
)
...
TRANSFORM_MODULE = "derouter.llms.gigachat.chat.transformation"
...
class TestGetModelResponseIterator:
    ...
    def test_returns_gigachat_iterator_sync(self):
        from derouter.llms.gigachat.chat.streaming import (
