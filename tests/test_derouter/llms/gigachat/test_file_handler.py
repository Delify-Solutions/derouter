...
from derouter.llms.gigachat import file_handler
from derouter.llms.gigachat.file_handler import (
    _file_cache,
    _get_url_hash,
    _parse_data_url,
    upload_file_async,
...
FILE_MODULE = "derouter.llms.gigachat.file_handler"
...
class TestUploadFileSync:
    ...
    def test_uploads_without_optional_args(
        ...
        """Verify that credentials, api_base, and derouter_params are optional."""
        mock_client = MagicMock()
        mock_response = MagicMock()
        ...
        mock_get_token.assert_called_once_with(credentials=None, derouter_params=None)
