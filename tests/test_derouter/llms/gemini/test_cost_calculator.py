...
import derouter
from derouter.llms.gemini.cost_calculator import (
...
def test_map_traffic_type_to_service_tier(
    ...
    """
    Gemini/Vertex usageMetadata.trafficType maps to the DeRouter service_tier
    ...
    """
    from derouter.cost_calculator import _map_traffic_type_to_service_tier
...
def test_flash_latest_alias_spellings_price_identically(monkeypatch, prefixed, bare):
    ...
    prefixed_entry = derouter.model_cost[prefixed]
    bare_entry = derouter.model_cost[bare]
