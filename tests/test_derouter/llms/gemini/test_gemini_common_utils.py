...
from derouter.llms.gemini.common_utils import GeminiModelInfo, GoogleAIStudioTokenCounter
...
class TestGoogleAIStudioTokenCounter:
    ...
    async def test_count_tokens(self):
        ...
        with patch(
            "derouter.llms.gemini.count_tokens.handler.GoogleAIStudioTokenCounter.acount_tokens",
