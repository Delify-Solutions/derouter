...
from derouter.llms.gemini.files.transformation import GoogleAIStudioFilesHandler
...
class TestGoogleAIStudioFilesTransformation:
    ...
    def test_transform_retrieve_file_request_with_full_uri(self):
        ...
        Regression test for: https://github.com/Delify-Solutions/derouter/issues/XXX
    ...
    @patch("derouter.llms.gemini.common_utils.get_secret_str", return_value=None)
