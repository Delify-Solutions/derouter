...
test_derouter tree so the AgentCoreSearchConfig transformation is exercised by
...
import derouter
from derouter.llms.bedrock.search.transformation import (
...
class TestAgentCoreSearchEdgeCases:
    ...
    def test_search_cost_lookup_is_mapped(self, monkeypatch):
        """Assert against the map in this checkout: the remote cost map derouter loads by
