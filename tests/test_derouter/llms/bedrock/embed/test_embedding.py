...
from derouter.types.utils import Embedding
from derouter.main import bedrock_embedding, embedding, EmbeddingResponse, Usage
...
def test_bedrock_embedding_cohere_app_profile(model: str):
    with patch(
        "derouter.llms.bedrock.embed.embedding.cohere_embedding"
