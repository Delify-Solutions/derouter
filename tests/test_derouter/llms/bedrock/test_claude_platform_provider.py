...
def test_claude_platform_requires_workspace_header():
    from derouter import AuthenticationError
    from derouter.llms.bedrock.claude_platform.transformation import (
        BedrockClaudePlatformConfig,
    )
...
def test_bedrock_claude_platform_messages_config_round_trips_native_body():
    ...
    config = derouter.ProviderConfigManager.get_provider_anthropic_messages_config(
    ...
    headers, _ = config.validate_anthropic_messages_environment(
        ...
        derouter_params={"workspace_id": "wrkspc_test"},
    )
