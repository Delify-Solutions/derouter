...
when constructing DeRouterBatch. This test suite verifies the sanitization
layer prevents that.
"""
...
class TestGetOpenaiCompatibleBatchMetadata:
    ...
    def test_result_compatible_with_derouter_batch(self):
        """Verify sanitized metadata can construct a DeRouterBatch without error."""
        import time
