...
class TestBedrockSSLVerify:
    ...
    def test_base_aws_llm_get_ssl_verify_default(self):
        ...
        # Reset derouter.ssl_verify to default
        derouter.ssl_verify = True
    ...
    def test_base_aws_llm_get_ssl_verify_derouter_config(self):
        """Test that _get_ssl_verify uses derouter.ssl_verify when set."""
        base_aws = BaseAWSLLM()
        ...
        try:
            # Set derouter.ssl_verify to custom CA bundle
            derouter.ssl_verify = ca_bundle_path
    ...
    @patch("derouter.llms.bedrock.base_aws_llm.get_secret")
    @patch("boto3.client")
    ...
    def test_ssl_verify_priority_env_over_derouter_config(self, monkeypatch):
        """Test that SSL_VERIFY environment variable takes priority over derouter.ssl_verify."""
        base_aws = BaseAWSLLM()

        # Set derouter.ssl_verify to True
        derouter.ssl_verify = True
