...
class TestBedrockImageGeneration:
    def test_image_generation_with_api_key_bearer_token(self):
        ...
        with patch(
            "derouter.llms.bedrock.image_generation.image_handler.BedrockImageGeneration.image_generation"
        ) as mock_bedrock_image_gen:
            # Setup mock response
            mock_image_response_obj = derouter.ImageResponse()
    ...
    async def test_async_image_generation_with_bearer_token(self):
        ...
        with patch(
            "derouter.llms.bedrock.image_generation.image_handler.BedrockImageGeneration.async_image_generation"
...
def test_image_generation_bearer_token_never_runs_the_sigv4_credential_chain(monkeypatch):
    ...
    bearer token alone."""
    from derouter.llms.bedrock.image_generation.image_handler import BedrockImageGeneration
