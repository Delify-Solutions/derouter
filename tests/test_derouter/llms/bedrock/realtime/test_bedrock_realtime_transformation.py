...
from derouter.llms.bedrock.realtime.transformation import (
    TRIGGER_LEADING_SILENCE,
    TRIGGER_TRAILING_SILENCE,
    BedrockRealtimeConfig,
)
from derouter.llms.bedrock.realtime.trigger_audio import ready_trigger_pcm
...
class TestBedrockRealtimeSessionEvents:
    ...
    def _logging():
        ...
        return SimpleNamespace(derouter_trace_id="trace_123")
