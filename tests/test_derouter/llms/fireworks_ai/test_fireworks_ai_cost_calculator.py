...
import derouter
from derouter.llms.fireworks_ai.cost_calculator import cost_per_token
from derouter.types.utils import OffPeakPricing, PromptTokensDetailsWrapper, Usage
...
CACHE_READ_COST = derouter.get_model_info(model=MODEL, custom_llm_provider="fireworks_ai")["cache_read_input_token_cost"]
OUTPUT_COST = 4.4e-06
...
def _register_off_peak_model(off_peak_pricing: OffPeakPricing, cache_read_cost: float | None = STANDARD_CACHE_READ_COST) -> None:
    derouter.model_cost[f"fireworks_ai/{OFF_PEAK_MODEL}"] = {
        "derouter_provider": "fireworks_ai",
        "mode": "chat",
