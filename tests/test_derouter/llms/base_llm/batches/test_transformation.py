"""
Unit tests for derouter/llms/base_llm/batches/transformation.py
...
class _ConcreteBatchesConfig(BaseBatchesConfig):
    ...
    def get_complete_batch_url(
        self, api_base, api_key, model, optional_params, derouter_params, data
    ) -> str:
        return "https://example.com/batch"

    def transform_create_batch_request(
        self, model, create_batch_data, optional_params, derouter_params
    ):
        return {"created": True}

    def transform_create_batch_response(
        self, model, raw_response, logging_obj, derouter_params
    ):
        return raw_response

    def transform_retrieve_batch_request(
        self, batch_id, optional_params, derouter_params
    ):
...
def test_concrete_instance_methods_run():
    ...
    assert instance.transform_retrieve_batch_request(
        batch_id="b-1", optional_params={}, derouter_params={}
    ) == {"batch_id": "b-1"}
