...
class TestMessageSanitization:
    ...
    def setup_method(self):
        ...
        self.original_modify_params = derouter.modify_params
        derouter.modify_params = True

    def teardown_method(self):
        """Cleanup after each test"""
        # Restore original modify_params value
        derouter.modify_params = self.original_modify_params
    ...
    def test_empty_string_content_sanitized_without_modify_params(self):
        ...
        even when derouter.modify_params is False. Otherwise Anthropic returns:
