...
async def test_async_streaming_hands_the_logging_object_the_message_id_the_caller_is_streamed():
    ...
    sse = await DeRouterMessagesToCompletionTransformationHandler.async_anthropic_messages_handler(
        max_tokens=1024,
        messages=MESSAGES,
        model="groq/kimi-k2",
        stream=True,
...
def test_sync_streaming_hands_the_logging_object_the_message_id_the_caller_is_streamed():
    ...
    sse = DeRouterMessagesToCompletionTransformationHandler.anthropic_messages_handler(
        max_tokens=1024,
        messages=MESSAGES,
        model="groq/kimi-k2",
        stream=True,
