...
(derouter/llms/anthropic/experimental_pass_through/responses_adapters/streaming_iterator.py)
"""
...
class TestToolUseBlockClosedExactlyOnce:
    """Regression for https://github.com/Delify-Solutions/derouter/issues/37273.

    With ``custom_llm_provider: openai`` + ``use_chat_completions_api: true``,
    ``/v1/messages`` streams through ``DeRouterCompletionStreamingIterator``,
