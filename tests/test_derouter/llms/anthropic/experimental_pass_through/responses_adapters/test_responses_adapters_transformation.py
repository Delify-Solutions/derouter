"""
Tests for DeRouterAnthropicToResponsesAPIAdapter
(derouter/llms/anthropic/experimental_pass_through/responses_adapters/transformation.py)
"""
...
from derouter.types.llms.openai import ResponseAPIUsage
...
_ADAPTER = DeRouterAnthropicToResponsesAPIAdapter()
...
class TestTranslateThinkingToReasoning:
    ...
    def test_summary_added_when_env_var_set(self, monkeypatch):
        """When DEROUTER_REASONING_AUTO_SUMMARY env var is true, summary is included."""
        import derouter
...
class TestTranslateResponse:
    ...
    def test_missing_usage_maps_to_zero_tokens(self):
        ...
        assert DeRouterAnthropicToResponsesAPIAdapter.translate_responses_api_usage_to_anthropic_usage(None) == {
            "input_tokens": 0,
            "output_tokens": 0,
        }
