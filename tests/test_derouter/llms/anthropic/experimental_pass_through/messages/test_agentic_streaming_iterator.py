...
def _build_hold_back_iterator(
    ...
    server_fulfilled_tool_names: frozenset = frozenset({"derouter_content_retrieve"}),
) -> AgenticAnthropicStreamingIterator:
...
class TestRebuildAnthropicResponse:
    ...
    def test_should_rebuild_tool_use_response(self):
        ...
        assert tool["name"] == "derouter_content_retrieve"
...
class TestAgenticStreamingIteratorPhase1:
    ...
    async def test_should_pass_rebuilt_response_to_hooks(self):
        ...
        assert captured_response["content"][1]["name"] == "derouter_content_retrieve"
...
class TestAgenticStreamingIteratorErrorHandling:
    ...
    async def test_should_swallow_hook_errors(self):
        ...
        mock_logging.derouter_call_id = "test_call_123"
...
class TestAgenticStreamingIteratorHoldBack:
    ...
    async def test_should_not_leak_intercepted_message_when_follow_up_fires(self):
        ...
        assert b"derouter_content_retrieve" not in b"".join(collected)
