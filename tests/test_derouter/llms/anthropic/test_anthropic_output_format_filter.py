...
Mirrors tests/derouter/llms/anthropic/test_anthropic_schema_filter.py, but lives
under tests/test_derouter/ so the coverage-uploading CI job exercises the stripped
