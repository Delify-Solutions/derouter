...
from derouter.llms.anthropic.files.transformation import (
...
class TestAnthropicFilesConfig:
    ...
    def test_transform_retrieve_file_request_custom_base(self):
        url, params = self.config.transform_retrieve_file_request(
            file_id="file-abc123",
            optional_params={},
            derouter_params={"api_base": "https://custom.api.com"},
        )
    ...
    def test_transform_file_content_request_message_batch_id_custom_api_base(self):
        url, _ = self.config.transform_file_content_request(
            ...
            optional_params={},
            derouter_params={"api_base": "https://custom.example.com/"},
        )
