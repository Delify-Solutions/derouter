...
from derouter.llms.azure.image_generation import get_azure_image_generation_config
...
class TestAzureMAIImageGeneration:
    ...
    def test_mai_image_cost_calculator_token_based(self, monkeypatch):
        ...
        model_info = derouter.get_model_info(model=model, custom_llm_provider="azure_ai")
