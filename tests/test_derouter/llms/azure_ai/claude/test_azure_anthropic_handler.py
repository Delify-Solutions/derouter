...
from derouter.llms.azure_ai.anthropic.handler import AzureAnthropicChatCompletion
...
class TestAzureAnthropicChatCompletion:
    ...
    @patch("derouter.utils.ProviderConfigManager")
    @patch("derouter.llms.azure_ai.anthropic.handler.AzureAnthropicConfig")
    ...
    @patch("derouter.llms.anthropic.chat.handler.make_sync_call")
    @patch("derouter.utils.ProviderConfigManager")
    @patch("derouter.llms.azure_ai.anthropic.handler.AzureAnthropicConfig")
    ...
    @patch("derouter.llms.custom_httpx.http_handler._get_httpx_client")
    @patch("derouter.utils.ProviderConfigManager")
    @patch("derouter.llms.azure_ai.anthropic.handler.AzureAnthropicConfig")
