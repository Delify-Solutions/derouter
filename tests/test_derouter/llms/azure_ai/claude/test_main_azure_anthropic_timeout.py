"""
Ensure derouter.completion() forwards timeout to Azure Anthropic handler (main.py dispatch).
"""
...
def test_main_azure_ai_claude_completion_passes_timeout_to_azure_anthropic_handler():
    ...
    with patch("derouter.main.azure_anthropic_chat_completions") as mock_azure_anthropic:
