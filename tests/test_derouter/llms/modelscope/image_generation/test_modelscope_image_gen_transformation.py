...
from derouter.llms.modelscope.image_generation.transformation import (
...
class TestModelScopeImageGenerationTransformation:
    ...
    @patch("derouter.llms.modelscope.image_generation.transformation.get_secret_str")
    ...
    def test_transform_image_generation_response_error_handling(self):
        ...
        with pytest.raises(Exception, match='derouter\\.BadRequestError: ModelScope error: Invalid prompt') as exc_info:
    ...
    def test_transform_image_generation_response_json_error(self):
        ...
        with pytest.raises(Exception, match='derouter\\.InternalServerError: Error parsing ModelScope') as exc_info:
            self.config.transform_image_generation_response(
                model=self.model,
                raw_response=mock_response,
                model_response=model_response,
    ...
    def test_get_error_class_internal_server_error(self):
        ...
        from derouter.exceptions import InternalServerError
