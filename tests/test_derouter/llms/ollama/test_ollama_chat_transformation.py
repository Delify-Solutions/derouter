...
from derouter.llms.ollama.chat.transformation import (
    OllamaChatConfig,
...
class TestOllamaChatConfigResponseFormat:
    ...
    def test_transform_request_loads_config_parameters(self):
        ...
        derouter.OllamaChatConfig(num_ctx=8000, temperature=0.0)
        ...
        try:
            ...
            delattr(derouter.OllamaChatConfig, "num_ctx")
            delattr(derouter.OllamaChatConfig, "temperature")
...
class TestOllamaToolCalling:
    ...
    Issue: https://github.com/Delify-Solutions/derouter/issues/18922
    """
    ...
    def test_tools_passed_directly_without_capability_check(self):
        ...
        Previously, the code called derouter.get_model_info() which could fail
...
class TestOllamaFinishReasonLength:
    ...
    def test_finish_reason_tool_calls_streamed_before_done_chunk(self):
        ...
        Regression test for https://github.com/Delify-Solutions/derouter/issues/34692:
...
class TestOllamaToolCallTransformation:
    def test_transform_request_preserves_tool_calls(self):
        ...
        Regression: https://github.com/Delify-Solutions/derouter/issues/26094
        """
        config = OllamaChatConfig()
        messages = cast(
            list[AllMessageValues],
