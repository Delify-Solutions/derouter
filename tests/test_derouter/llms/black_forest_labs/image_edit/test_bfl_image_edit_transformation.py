...
from derouter.llms.black_forest_labs.image_edit import (
...
from derouter.llms.black_forest_labs.common_utils import BlackForestLabsError
...
class TestBlackForestLabsImageEditTransformation:
    ...
    def test_validate_environment_missing_api_key(self):
        ...
        with patch(
            "derouter.llms.black_forest_labs.image_edit.transformation.get_secret_str"
        ) as mock_get_secret:
