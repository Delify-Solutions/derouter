...
from derouter.llms.black_forest_labs.image_generation.transformation import (
...
class TestBlackForestLabsImageGenerationTransformation:
    ...
    def test_validate_environment_missing_api_key(self):
        ...
        with patch(
            "derouter.llms.black_forest_labs.image_generation.transformation.get_secret_str",
            return_value=None,
        ):
