...
from derouter.llms.sap.embed.transformation import GenAIHubEmbeddingConfig
...
def test_basic_config_transform(fake_token_creator, fake_deployment_url):
    ...
    with (
        patch(
            "derouter.llms.sap.embed.transformation.GenAIHubEmbeddingConfig.deployment_url",
            new_callable=PropertyMock,
            return_value=fake_deployment_url,
        ),
        patch(
            "derouter.llms.sap.embed.transformation.get_token_creator",
