...
from derouter.llms.sap.chat.transformation import GenAIHubOrchestrationConfig
...
class TestStreamIterators:
    ...
    def test_sync_stream_iterator_basic(self):
        ...
        from derouter.llms.sap.chat.handler import SAPStreamIterator
    ...
    def test_async_stream_iterator_basic(self):
        ...
        from derouter.llms.sap.chat.handler import AsyncSAPStreamIterator
