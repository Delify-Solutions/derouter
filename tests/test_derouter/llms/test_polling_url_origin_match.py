...
# ``tests/test_derouter/derouter_core_utils/test_url_utils.py``; the
...
def test_bfl_image_generation_sync_rejects_cross_origin_polling():
    from derouter.llms.black_forest_labs.image_generation.handler import (
...
def test_bfl_image_edit_sync_rejects_cross_origin_polling():
    from derouter.llms.black_forest_labs.image_edit.handler import (
