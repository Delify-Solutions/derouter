...
class TestDeepSeekVisionMultimodalContent:
    ...
    def teardown_method(self):
        if self._prior_registry_entry is None:
            derouter.model_cost.pop(self.VISION_MODEL, None)
        else:
            derouter.model_cost[self.VISION_MODEL] = self._prior_registry_entry
