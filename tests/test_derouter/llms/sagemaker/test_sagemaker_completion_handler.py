...
from derouter.llms.sagemaker.completion.handler import SagemakerLLM
...
def test_load_credentials_assumes_role_with_external_id(monkeypatch):
    ...
    optional_params = {
        ...
        "aws_role_name": "arn:aws:iam::999999999999:role/derouter-sm-completion-role",
        "aws_session_name": "derouter-sm-completion-session",
