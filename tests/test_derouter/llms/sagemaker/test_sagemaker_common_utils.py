...
from derouter.llms.sagemaker.common_utils import AWSEventStreamDecoder
from derouter.llms.sagemaker.completion.transformation import SagemakerConfig
...
def _reset_sagemaker_response_stream_shape_cache():
    ...
    import derouter.llms.sagemaker.common_utils as mod
...
def test_sagemaker_response_stream_shape_loaded_on_first_access():
    ...
    from derouter.llms.sagemaker.common_utils import get_sagemaker_response_stream_shape
...
def test_sagemaker_parse_message_from_event_raises_on_none_shape():
    ...
    import derouter.llms.sagemaker.common_utils as mod
    from derouter.llms.sagemaker.common_utils import SagemakerError
...
async def test_aiter_bytes_unicode_decode_error():
    ...
    Relevant issue: https://github.com/Delify-Solutions/derouter/issues/9165
    """
