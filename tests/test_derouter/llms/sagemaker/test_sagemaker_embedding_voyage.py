...
from derouter.llms.sagemaker.embedding.cohere_transformation import (
    SagemakerCohereEmbeddingConfig,
)
from derouter.llms.sagemaker.embedding.transformation import SagemakerEmbeddingConfig
from derouter.llms.voyage.embedding.transformation import VoyageEmbeddingConfig
...
class TestSagemakerCohereEmbeddingConfig:
    ...
    def test_get_optional_params_embeddings_preserves_input_type(self):
        ...
        from derouter.utils import get_optional_params_embeddings
...
class TestSagemakerEmbeddingIntegration:
    ...
    def test_voyage_embedding_request_format(self):
        ...
        with patch(
            "derouter.llms.sagemaker.completion.handler.SagemakerLLM.embedding"
        ) as mock_embedding:
