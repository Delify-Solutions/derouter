...
from derouter.llms.sagemaker.chat.handler import SagemakerChatHandler
...
def test_load_credentials_assumes_role_with_external_id(monkeypatch):
    ...
    optional_params = {
        ...
        "aws_role_name": "arn:aws:iam::999999999999:role/derouter-sm-chat-role",
        "aws_session_name": "derouter-sm-chat-session",
