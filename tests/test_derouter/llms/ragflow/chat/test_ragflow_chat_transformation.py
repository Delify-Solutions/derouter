...
import derouter
from derouter.llms.ragflow.chat.transformation import RAGFlowConfig
...
class TestRAGFlowChatTransformation:
    ...
    def test_get_complete_url_from_derouter_params(self):
        """Test URL construction with api_base from derouter_params."""
        config = RAGFlowConfig()

        model = "ragflow/chat/my-chat-id/gpt-4o-mini"

        # Create a simple dict-like object for derouter_params
        class DeRouterParams:
            def __init__(self):
    ...
    def test_validate_environment_stores_actual_model(self):
        ...
        assert derouter_params["_ragflow_actual_model"] == "gpt-4o-mini"
    ...
    def test_validate_environment_from_derouter_params(self):
        """Test that validate_environment gets api_key from derouter_params."""
        config = RAGFlowConfig()
        ...
        # Create a simple object for derouter_params with api_key attribute
        class DeRouterParams:
            def __init__(self):
                self.api_key = "derouter-params-key"
        ...
        assert result_headers["Authorization"] == "Bearer derouter-params-key"
    ...
    def test_transform_request_uses_actual_model(self):
        ...
        model = "ragflow/chat/my-chat-id/gpt-4o-mini"
        messages = [{"role": "user", "content": "Hello"}]
        derouter_params = {"_ragflow_actual_model": "gpt-4o-mini"}
    ...
    def test_transform_request_fallback_parsing(self):
        ...
        model = "ragflow/agent/my-agent-id/gpt-4o-mini"
        messages = [{"role": "user", "content": "Hello"}]
        derouter_params = {}  # Missing _ragflow_actual_model
