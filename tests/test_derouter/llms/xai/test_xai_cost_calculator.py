...
class TestXAICostCalculator:
    ...
    def test_tiered_pricing_model_without_tiered_pricing(self):
        derouter.model_cost["xai/flat-rate-fixture"] = {
            "input_cost_per_token": 3e-7,
            "output_cost_per_token": 5e-7,
            "derouter_provider": "xai",
            "mode": "chat",
        }
    ...
    def test_custom_pricing_beats_the_reported_cost(self):
        ...
        billed = derouter.completion_cost(
    ...
    def test_deployment_custom_pricing_beats_the_reported_cost(self, monkeypatch):
        ...
        monkeypatch.setitem(
            derouter.model_cost,
            deployment_id,
            {"input_cost_per_token": 0.001, "output_cost_per_token": 0.001, "derouter_provider": "xai", "mode": "chat"},
        )
        response = ModelResponse(
            id="chatcmpl-xai",
            model="grok-4-latest",
