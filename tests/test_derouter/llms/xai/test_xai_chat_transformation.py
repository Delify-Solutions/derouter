...
import derouter
from derouter.llms.xai.chat.transformation import (
...
class TestXAIReportedCost:
    ...
    ``cost`` is the field derouter already carries a provider stated cost in, so restating
    ...
    def test_streamed_reported_cost_survives_chunk_aggregation(self):
        ...
        assembled = derouter.stream_chunk_builder(chunks=[parsed])
