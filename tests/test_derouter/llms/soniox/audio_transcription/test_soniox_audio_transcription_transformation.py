...
from derouter.llms.soniox.common_utils import SonioxException
...
class TestRenderSonioxTokens:
    def test_should_return_empty_string_for_no_tokens(self):
        from derouter.llms.soniox.common_utils import render_soniox_tokens
...
class TestRenderSonioxTokensAsSrt:
    def test_should_render_basic_srt(self):
        from derouter.llms.soniox.common_utils import render_soniox_tokens_as_srt
...
class TestMultilingualCueGrouping:
    def test_should_split_spaceless_chinese_on_width_budget(self):
        from derouter.derouter_core_utils.audio_utils.subtitle_utils import _text_width
        from derouter.llms.soniox.common_utils import render_soniox_tokens_as_srt
...
class TestRenderSonioxTokensAsVtt:
    def test_should_render_basic_vtt_with_header(self):
        from derouter.llms.soniox.common_utils import render_soniox_tokens_as_vtt
