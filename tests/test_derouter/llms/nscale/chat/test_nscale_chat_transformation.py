...
from derouter.llms.nscale.chat.transformation import NscaleConfig
...
class TestNscaleConfig:
    ...
    def test_get_api_key(self):
        ...
        with patch(
            "derouter.llms.nscale.chat.transformation.get_secret_str",
    ...
    def test_get_api_base(self):
        ...
        with patch(
            "derouter.llms.nscale.chat.transformation.get_secret_str", return_value=None
        ):
