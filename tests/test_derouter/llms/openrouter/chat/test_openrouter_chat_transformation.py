...
from derouter.llms.openrouter.chat.transformation import (
...
def test_openrouter_extra_body_transformation():
    ...
    # https://github.com/Delify-Solutions/derouter/issues/8425, validate its not contained in extra_body still
