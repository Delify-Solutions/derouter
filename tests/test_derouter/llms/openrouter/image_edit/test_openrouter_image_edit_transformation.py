...
from derouter.llms.openrouter.common_utils import OpenRouterException
from derouter.llms.openrouter.image_edit.transformation import (
...
class TestOpenRouterImageEditTransformation:
    ...
    @patch("derouter.llms.openrouter.image_edit.transformation.get_secret_str")
    ...
    @patch("derouter.llms.openrouter.image_edit.transformation.derouter")
    @patch("derouter.llms.openrouter.image_edit.transformation.get_secret_str")
    def test_validate_environment_missing_api_key_raises(
        self, mock_get_secret, mock_derouter
    ):
