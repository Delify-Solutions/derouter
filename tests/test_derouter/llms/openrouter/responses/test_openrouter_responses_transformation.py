...
Related issue: https://github.com/Delify-Solutions/derouter/issues/22189
"""
...
class TestOpenRouterResponsesAPIConfig:
    ...
    def test_validate_environment_sets_auth_header(self):
        ...
        params = GenericDeRouterParams(api_key="sk-or-test-key")
        headers = config.validate_environment(
            headers={}, model="openai/o4-mini", derouter_params=params
        )
