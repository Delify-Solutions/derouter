...
from derouter.llms.oci.embed.transformation import OCI_EMBED_BATCH_LIMIT, OCIEmbedConfig
...
class TestOCIEmbedConfig:
    ...
    def test_validate_environment_sets_headers(self):
        ...
        assert "derouter/" in headers["user-agent"]
    ...
    def test_map_openai_params_encoding_format_not_supported(self):
        ...
        The derouter framework handles unsupported-param rejection above this layer,
