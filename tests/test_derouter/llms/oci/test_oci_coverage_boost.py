...
Covers:
  - derouter/llms/oci/common_utils.py  (sign_with_manual_credentials, routing)
  - derouter/llms/oci/chat/generic.py  (message adaptation, tool conversion, streaming)
  - derouter/llms/oci/chat/cohere.py   (message adaptation, response parsing, streaming)
  - derouter/llms/oci/chat/transformation.py  (OCIChatConfig methods, stream wrappers)
...
if TYPE_CHECKING:
    from derouter.llms.oci.chat.transformation import OCIStreamWrapper
...
from derouter.llms.oci.chat.transformation import OCIChatConfig, get_vendor_from_model
...
from derouter.types.llms.oci import OCIVendors, OCIToolCall
...
@patch("derouter.llms.oci.common_utils._CRYPTOGRAPHY_AVAILABLE", True)
@patch("derouter.llms.oci.common_utils.load_private_key_from_str")
@patch("derouter.llms.oci.common_utils.padding")
@patch("derouter.llms.oci.common_utils.hashes")
...
@patch("derouter.llms.oci.common_utils._CRYPTOGRAPHY_AVAILABLE", True)
@patch("derouter.llms.oci.common_utils.load_private_key_from_file")
@patch("derouter.llms.oci.common_utils.padding")
@patch("derouter.llms.oci.common_utils.hashes")
...
def test_require_cryptography_available_does_not_raise():
    ...
    from derouter.llms.oci.common_utils import _require_cryptography

    with patch("derouter.llms.oci.common_utils._CRYPTOGRAPHY_AVAILABLE", True):
