...
class TestJSONProviderLoader:
    ...
    def test_tool_params_excluded_when_function_calling_not_supported(self):
        ...
        function calling. Regression test for https://github.com/Delify-Solutions/derouter/issues/21125
        """
        from derouter.llms.openai_like.dynamic_config import create_config_class
        from derouter.llms.openai_like.json_loader import JSONProviderRegistry
        ...
        with patch("derouter.utils.supports_function_calling", return_value=False):
    ...
    def test_tool_params_included_when_function_calling_supported(self):
        ...
        with patch("derouter.utils.supports_function_calling", return_value=True):
