...
from derouter.llms.azure.image_generation.gpt_transformation import AzureGPTImageGenerationConfig
from derouter.llms.openai.image_generation.gpt_transformation import GPTImageGenerationConfig
