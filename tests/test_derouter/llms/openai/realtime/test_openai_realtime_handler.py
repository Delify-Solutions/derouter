...
def test_openai_realtime_handler_url_construction(api_base):
    from derouter.llms.openai.realtime.handler import OpenAIRealtime
...
async def test_async_realtime_success():
    ...
    with (
        ...
        patch(
            "derouter.llms.openai.realtime.handler.RealTimeStreaming"
...
async def test_async_realtime_ws_url_has_no_ssl():
    ...
    This verifies the fix for: https://github.com/Delify-Solutions/derouter/issues/19222
    """
    from derouter.llms.openai.realtime.handler import OpenAIRealtime
    from derouter.types.realtime import RealtimeQueryParams
