...
class TestOpenAIResponsesHandlerToolInjection:
    ...
    def test_merge_keeps_guardrail_appended_tool(self):
        ...
        groups = [form.chat_tools for form in DeRouterCompletionResponsesConfig.responses_tools_to_chat_forms(original)]
        guardrailed = [
            *groups[0],
...
class TestProvenancePatching:
    ...
    def test_provenance_bails_on_non_mapping_item(self):
        from derouter.llms.openai.responses.guardrail_translation.handler import _input_item_provenance
    ...
    def test_provenance_bails_on_unpredicted_merge(self):
        ...
        expected = DeRouterCompletionResponsesConfig.transform_responses_api_input_to_messages(
...
class TestPatchEdgeBranches:
    ...
    def test_item_rewrite_field_ignores_non_string_type(self):
        from derouter.llms.openai.responses.guardrail_translation.handler import _item_rewrite_field
    ...
    def test_continuation_closes_open_item_given_pydantic_events_with_enum_types(self):
        ...
        yielded = [
            ...
            ContentPartAddedEvent(
                ...
                output_index=0,
                content_index=0,
                part=BaseDeRouterOpenAIResponseObject.model_validate(
