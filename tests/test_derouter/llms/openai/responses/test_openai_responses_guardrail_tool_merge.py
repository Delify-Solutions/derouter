...
from derouter.types.proxy.guardrails.guardrail_hooks.generic_guardrail_api import GuardrailToolParam


def _groups(tools):
    return [form.chat_tools for form in DeRouterCompletionResponsesConfig.responses_tools_to_chat_forms(tools)]
