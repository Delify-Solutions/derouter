...
Tests the fix for https://github.com/Delify-Solutions/derouter/issues/17118
"""
...
import derouter
from derouter import text_completion
...
class TestTextCompletionTokenIds:
    ...
    def test_completion_prompt_token_ids(self, text_completion_response, monkeypatch):
        ...
        This tests the fix for https://github.com/Delify-Solutions/derouter/issues/17118
        """
