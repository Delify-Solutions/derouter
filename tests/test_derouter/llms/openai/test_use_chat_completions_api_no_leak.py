...
`use_chat_completions_api` is a DeRouter-internal control flag (it forces the
...
def test_use_chat_completions_api_is_a_known_derouter_param():
    assert "use_chat_completions_api" in all_derouter_params
