...
from derouter.files import main as files_main
...
from derouter.llms.openai.openai import OpenAIFilesAPI
...
async def test_afile_content_streaming_populates_hidden_params_before_iteration(
    ...
    assert stream_iterator._hidden_params["derouter_model_name"] is None
