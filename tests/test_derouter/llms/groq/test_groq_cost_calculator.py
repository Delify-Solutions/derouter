...
from derouter.llms.groq.cost_calculator import cost_per_web_search_request
from derouter.types.utils import ModelInfo, ServerToolUse, Usage

PRICED_MODEL_INFO = ModelInfo(
    key="groq/openai/gpt-oss-20b",
    derouter_provider="groq",
    mode="chat",
...
def test_missing_pricing_costs_nothing():
    unpriced = ModelInfo(key="groq/openai/gpt-oss-20b", derouter_provider="groq", mode="chat")
