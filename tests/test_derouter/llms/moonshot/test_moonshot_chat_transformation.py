...
from derouter.llms.moonshot.chat.transformation import MoonshotChatConfig
...
class TestMoonshotConfig:
    ...
    def test_temperature_dropped_for_reasoning_models(self):
        ...
        with patch(
            "derouter.llms.moonshot.chat.transformation.supports_reasoning",
            return_value=True,
        ):
    ...
    def test_reasoning_content_preserved_on_pydantic_message_object(self):
        ...
        Regression test for: https://github.com/Delify-Solutions/derouter/issues/23765
    ...
    def test_reasoning_content_preserved_in_multi_turn_flow(self):
        ...
        """
        from derouter.types.utils import Message
        from derouter.utils import convert_to_dict
        ...
        # Convert to Message object (as DeRouter does)
...
class TestMoonshotResponseSchemaSupport:
    ...
    response_format, which gates discovery via derouter.responses(). The flag
    ...
    def test_supports_response_schema_utility_reports_true(self, model_cost_map, monkeypatch):
        monkeypatch.setattr(derouter, "model_cost", model_cost_map)
        assert derouter.utils.supports_response_schema(model="moonshot/kimi-k2.5") is True
