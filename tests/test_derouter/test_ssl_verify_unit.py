"""
Unit tests for per-service SSL support in DeRouter.
...
# Add derouter to path
sys.path.insert(0, str(Path(__file__).parent))

import derouter.proxy.guardrails.guardrail_hooks.aim.aim as _aim_module
import derouter.proxy.guardrails.guardrail_hooks.cato_networks.cato_networks as _cato_networks_module
from derouter.llms.bedrock.base_aws_llm import BaseAWSLLM
from derouter.proxy.guardrails.guardrail_hooks.aim.aim import AimGuardrail
from derouter.proxy.guardrails.guardrail_hooks.cato_networks.cato_networks import CatoNetworksGuardrail
...
class TestBaseAWSLLMSSLVerify:
    ...
    def test_get_ssl_verify_without_parameter(self):
        ...
        # Should fall back to environment or global derouter.ssl_verify
