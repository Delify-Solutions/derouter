...
from derouter.a2a_protocol.providers.pydantic_ai_agents.transformation import (
...
async def test_send_non_streaming_request_forwards_agent_extra_headers():
    ...
    with patch(
        "derouter.a2a_protocol.providers.pydantic_ai_agents.transformation.get_async_httpx_client",
