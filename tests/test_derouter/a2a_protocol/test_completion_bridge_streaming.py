...
async def test_handle_streaming_emits_proper_events():
    ...
    # Mock derouter.acompletion to return a streaming response
...
async def test_handle_streaming_forwards_api_key():
    """Test that handle_streaming forwards api_key from derouter_params to acompletion."""
    from derouter.a2a_protocol.derouter_completion_bridge.handler import (
        A2ACompletionBridgeHandler,
    )
...
async def test_handle_non_streaming_forwards_api_key():
    """Test that handle_non_streaming forwards api_key from derouter_params to acompletion."""
    from derouter.a2a_protocol.derouter_completion_bridge.handler import (
        A2ACompletionBridgeHandler,
    )
