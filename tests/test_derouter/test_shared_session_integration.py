...
# Add the derouter directory to the path
...
class TestSharedSessionIntegration:
    ...
    def test_acompletion_shared_session_parameter(self):
        ...
        sig = inspect.signature(derouter.acompletion)
    ...
    def test_completion_shared_session_parameter(self):
        ...
        # Get the function signature
        sig = inspect.signature(derouter.completion)
        params = list(sig.parameters.keys())
    ...
    def test_type_annotations_consistency(self):
        ...
        acompletion_sig = inspect.signature(derouter.acompletion)
        completion_sig = inspect.signature(derouter.completion)
