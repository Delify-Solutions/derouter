...
Regression guard for https://github.com/Delify-Solutions/derouter/issues/33772: OpenAI
...
def test_tiered_cache_creation_rates_are_registered_and_billed(
    ...
    model_info = derouter.get_model_info(model=MODEL, custom_llm_provider="openai")
    tiered_rate = derouter.model_cost[MODEL][rate_key]
    ...
    input_rate = derouter.model_cost[MODEL][input_rate_key]
