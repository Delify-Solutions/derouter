...
def test_completion_cost_with_tool_reference_records_spend():
    ...
    """
    cost = derouter.completion_cost(model=ANTHROPIC_MODEL, messages=TOOL_SEARCH_MESSAGES)
...
def test_completion_cost_with_empty_tool_name_records_spend():
    ...
    cost = derouter.completion_cost(model=ANTHROPIC_MODEL, messages=messages)
