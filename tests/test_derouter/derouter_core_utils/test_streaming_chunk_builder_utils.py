...
from derouter import ChatCompletionUsageBlock, stream_chunk_builder
from derouter.types.utils import GenericStreamingChunk
from derouter.derouter_core_utils.streaming_chunk_builder_utils import ChunkProcessor
...
def test_stream_chunk_builder_derouter_usage_chunks():
    """
...
def test_stream_chunk_builder_tolerates_trailing_chunk_without_choices():
    """Regression for https://github.com/Delify-Solutions/derouter/issues/32051
    ...
    trailing_chunk = BaseDeRouterOpenAIResponseObject()
...
def test_get_combined_tool_content_custom_tool_call():
    from derouter.derouter_core_utils.streaming_chunk_builder_utils import ChunkProcessor
    from derouter.types.utils import ChatCompletionMessageCustomToolCall
