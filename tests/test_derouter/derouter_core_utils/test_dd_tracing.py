...
from derouter.derouter_core_utils.dd_tracing import tracer as dd_tracer


def test_dd_tracer_when_package_exists():
    with patch("derouter.derouter_core_utils.dd_tracing.should_use_dd_tracer", True):
        """
        ...
        with patch("derouter.derouter_core_utils.dd_tracing.tracer", mock_tracer):
...
def test_dd_tracer_when_package_not_exists():
    ...
    """
    with patch("derouter.derouter_core_utils.dd_tracing.should_use_dd_tracer", False):
...
def test_should_use_dd_tracer():
    ...
    """
    with patch(
        "derouter.derouter_core_utils.dd_tracing.get_secret_bool"
    ) as mock_get_secret:
