"""
Test the audio utils functionality in derouter_core_utils/audio_utils/utils.py
"""
...
class TestSpeechMediaTypeFromAudioBytes:
    ...
    def test_sniffing(self, audio, expected):
        from derouter.derouter_core_utils.audio_utils.utils import speech_media_type_from_audio_bytes
