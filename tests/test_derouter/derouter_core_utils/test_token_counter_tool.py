#### What this tests ####
#    This tests derouter.token_counter() function

import pytest


# Use the same token_counter as the main test.
from tests.test_derouter.derouter_core_utils.test_token_counter import token_counter
from tests.test_derouter.derouter_core_utils.test_token_counter_tool_data import *
