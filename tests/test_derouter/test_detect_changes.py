...
UI_FILE = "ui/derouter-dashboard/src/components/Teams.tsx"
BACKEND_FILE = "derouter/proxy/proxy_server.py"
...
def _run(
    ...
    *,
    ...
    env["REPO"] = "Delify-Solutions/derouter"
...
def test_ui_category_runs_when_the_ui_workflows_themselves_change(tmp_path: Path) -> None:
    ...
    decision, _ = _run(tmp_path, files=[".github/workflows/test-derouter-ui-unit.yml"], category="ui")
    assert decision == "decision=run"
