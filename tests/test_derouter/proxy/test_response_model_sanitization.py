...
def _make_minimal_chat_completion_response(model: str) -> derouter.ModelResponse:
...
def _make_model_response_stream_chunk(model: str) -> derouter.ModelResponseStream:
    """
    ...
    return derouter.ModelResponseStream(**chunk_dict)
...
def test_restamp_streaming_chunk_skips_matching_model():
    from derouter.proxy.proxy_server import _restamp_streaming_chunk_model
...
def test_fast_serialize_simple_streaming_chunk_matches_model_dump_json():
    from derouter.proxy.proxy_server import _serialize_streaming_chunk
            ...
            "model_list": [
                {
                    ...
                    "derouter_params": {"model": internal_model},
                }
            ],
        },
        tmp_path=tmp_path,
...
async def test_proxy_streaming_chunks_use_client_requested_model_before_alias_mapping(
    ...
    gen = proxy_server.async_data_generator(
        ...
        request_data={
            ...
            "_derouter_client_requested_model": client_model_alias,
        },
    )
...
async def test_proxy_streaming_azure_model_router_preserves_actual_model(monkeypatch):
    ...
    gen = proxy_server.async_data_generator(
        ...
        request_data={
            "model": router_model,
            "_derouter_client_requested_model": router_model,
        },
    )
...
async def test_proxy_streaming_fastest_response_preserves_winning_model(monkeypatch):
    ...
    gen = proxy_server.async_data_generator(
        ...
        request_data={
            ...
            "_derouter_client_requested_model": comma_separated_models,
