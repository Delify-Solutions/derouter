...
def test_build_logging_obj_seeds_model_call_details():
    ...
    md = details["derouter_params"]["metadata"]
...
async def test_success_record_invokes_success_handler(monkeypatch):
    ...
    monkeypatch.setattr(DeRouterLogging, "async_success_handler", fake_success)
...
async def test_failure_record_invokes_failure_handler(monkeypatch):
    ...
    monkeypatch.setattr(DeRouterLogging, "async_failure_handler", fake_failure)
...
async def test_one_bad_record_does_not_sink_the_batch(monkeypatch):
    ...
    monkeypatch.setattr(DeRouterLogging, "async_success_handler", flaky_success)
...
def test_batch_over_limit_is_rejected():
    from derouter.constants import MAX_CALLBACK_LOG_RECORDS
