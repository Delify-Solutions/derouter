...
class TestFastAPIOfflineRoutes:
    ...
    def test_routes_endpoint_with_fastapi_offline(self):
        ...
        """
        from derouter.proxy.proxy_server import router
        ...
        # Include the derouter proxy router which contains the /routes endpoint
    ...
    def test_routes_endpoint_with_auth_token_fastapi_offline(self):
        ...
        with patch(
            "derouter.proxy.auth.user_api_key_auth.user_api_key_auth"
        ) as mock_auth:
