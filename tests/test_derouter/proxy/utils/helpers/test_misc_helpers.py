...
def test_construct_database_url_from_env_vars_happy_path_full(monkeypatch):
    ...
    assert summary == {
        "result": "postgresql://user:pass@db.example.com/derouter",
        "host": "db.example.com",
        "scheme": "postgresql",
        "has_password": True,
    }
...
def test_construct_database_url_from_env_vars_happy_path_no_password(monkeypatch):
    ...
    assert summary == {
        "result": "postgresql://user@db.example.com/derouter",
...
def test_construct_database_url_from_env_vars_with_schema(monkeypatch):
    ...
    assert summary == {
        "result": "postgresql://user:pass@db.example.com/derouter?schema=public",
