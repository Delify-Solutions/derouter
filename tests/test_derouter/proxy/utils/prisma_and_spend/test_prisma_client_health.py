...
async def test_save_health_check_result_creates_record(
    ...
    prisma_client.db.derouter_healthchecktable.create = AsyncMock(return_value=expected)
    ...
    data = prisma_client.db.derouter_healthchecktable.create.await_args.kwargs["data"]
    pinned = {
        "returned": result,
...
async def test_save_health_check_result_db_failure_returns_none(
    ...
    prisma_client.db.derouter_healthchecktable.create = AsyncMock(
...
async def test_get_health_check_history_filters_by_model_and_status(
    ...
    prisma_client.db.derouter_healthchecktable.find_many = AsyncMock(return_value=rows)
    result = await prisma_client.get_health_check_history(
        model_name="gpt-4o", limit=5, offset=10, status_filter="healthy"
    )
    kwargs = prisma_client.db.derouter_healthchecktable.find_many.await_args.kwargs
    actual = {
...
async def test_get_health_check_history_db_error_returns_empty_list(
    ...
    prisma_client.db.derouter_healthchecktable.find_many = AsyncMock(
...
async def test_get_latest_health_checks_for_models_bounds_the_query_to_those_models(
    ...
    prisma_client.db.derouter_healthchecktable.find_many = AsyncMock(return_value=[])
...
async def test_get_latest_health_checks_for_models_does_not_query_for_an_empty_page(
    ...
    assert prisma_client.db.derouter_healthchecktable.find_many.await_count == 0
...
async def test_get_latest_health_checks_for_models_db_error_returns_empty_list(
    ...
    prisma_client.db.derouter_healthchecktable.find_many = AsyncMock(side_effect=RuntimeError("oops"))
