...
_MCP_MANAGER = "derouter.proxy._experimental.mcp_server.mcp_server_manager.global_mcp_server_manager"
_HANDLE_HTTP = (
    "derouter.proxy._experimental.mcp_server.server.handle_streamable_http_mcp"
)
_STREAM_ASGI = "derouter.proxy.proxy_server._stream_mcp_asgi_response"
_PRISMA = "derouter.proxy.proxy_server.prisma_client"
_IS_ACCESS_GROUP = "derouter.proxy.proxy_server._is_mcp_access_group_cached"
_USER_API_KEY_CACHE = "derouter.proxy.proxy_server.user_api_key_cache"
_GET_ACCESS_GROUP_SERVERS = (
    "derouter.proxy._experimental.mcp_server.auth.user_api_key_auth_mcp."
    "MCPRequestHandler._get_mcp_servers_from_access_groups"
)
_FORWARD = "derouter.proxy.proxy_server._mcp_forward_as_path"
_RESOLVE_CSV = "derouter.proxy.proxy_server._resolve_mcp_csv_tokens"
...
async def test_dynamic_mcp_route_resolves_registered_server():
    ...
    from derouter.proxy.proxy_server import dynamic_mcp_route
...
async def test_resolve_mcp_csv_tokens_dedupes_and_caps():
    ...
    from derouter.proxy.proxy_server import _resolve_mcp_csv_tokens
...
async def test_is_mcp_access_group_cached_caches_positive_result():
    ...
    from derouter.proxy.proxy_server import _is_mcp_access_group_cached
...
async def test_toolset_mcp_route_unexpected_exception_returns_500_without_traceback():
    ...
    from derouter.proxy.proxy_server import toolset_mcp_route
...
_IS_MCP_AVAILABLE = "derouter.proxy._experimental.mcp_server.utils.is_mcp_available"
