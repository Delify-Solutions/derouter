...
def test_create_prometheus_admission_metrics_registers_named_metrics() -> None:
    ...
    if metrics is not None:
        ...
        assert REGISTRY.get_sample_value("derouter_admission_admitted_requests") == 1.0
        assert REGISTRY.get_sample_value("derouter_admission_queued_requests") == 1.0
    assert REGISTRY.get_sample_value("derouter_admission_rejected_requests_total", {"reason": "queue_full"}) is not None
