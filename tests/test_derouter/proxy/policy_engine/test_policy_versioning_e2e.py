...
from derouter.proxy.policy_engine.policy_registry import PolicyRegistry
from derouter.types.proxy.policy_engine import PolicyCreateRequest, PolicyUpdateRequest
...
async def test_full_lifecycle_create_draft_edit_publish_promote():
    ...
    prisma.db.derouter_policytable.create = AsyncMock(side_effect=create_impl)
    ...
    prisma.db.derouter_policytable.find_first = AsyncMock(return_value=created_v1)
    prisma.db.derouter_policytable.update_many = AsyncMock()
    prisma.db.derouter_policytable.create = AsyncMock(return_value=v2_row)
    ...
    prisma.db.derouter_policytable.find_unique = AsyncMock(return_value=v2_row)
    prisma.db.derouter_policytable.update = AsyncMock(return_value=v2_updated_row)
    ...
    prisma.db.derouter_policytable.find_unique = AsyncMock(return_value=v2_updated_row)
    prisma.db.derouter_policytable.update = AsyncMock(return_value=v2_published)
    ...
    prisma.db.derouter_policytable.find_unique = AsyncMock(return_value=v2_published)
    prisma.db.derouter_policytable.update_many = AsyncMock()
    ...
    prisma.db.derouter_policytable.update = AsyncMock(return_value=v2_production)
