...
def mock_existing_customer():
    ...
    return MagicMock(spec=DeRouter_EndUserTable)


@pytest.fixture
def mock_budget_table():
    """Mock budget table data."""
    return MagicMock(spec=DeRouter_BudgetTable)
...
async def test_update_customer_with_budget_id(
    ...
    mock_prisma_client.db.derouter_endusertable.update = AsyncMock(
    ...
    mock_prisma_client.db.derouter_endusertable.update.assert_called_once()
    call_args = mock_prisma_client.db.derouter_endusertable.update.call_args
    ...
    assert not mock_prisma_client.db.derouter_budgettable.create.called
...
async def test_update_customer_creates_budget_with_proper_relations(
    ...
    call_args = mock_prisma_client.db.derouter_budgettable.create.call_args
...
async def test_update_customer_budget_creation_with_fallback_admin(
    ...
    creation_data = call_args[1]["data"]  # kwargs['data']
    assert creation_data["created_by"] == "admin"  # derouter_proxy_admin_name
