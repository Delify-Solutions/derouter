...
def _make_tx(event_return=None, run_return=None, msg_return=None) -> MagicMock:
    ...
    tx = MagicMock()
    tx.derouter_workflowevent = MagicMock()
    tx.derouter_workflowevent.create = AsyncMock(
        return_value=event_return or _make_event()
    )
    tx.derouter_workflowrun = MagicMock()
    tx.derouter_workflowrun.update = AsyncMock(return_value=run_return or _make_run())
    tx.derouter_workflowmessage = MagicMock()
    tx.derouter_workflowmessage.create = AsyncMock(
...
def _make_prisma_client() -> MagicMock:
    client = MagicMock()
    client.db = MagicMock()
    client.db.derouter_workflowrun = MagicMock()
    client.db.derouter_workflowevent = MagicMock()
    client.db.derouter_workflowmessage = MagicMock()
...
class TestCreateWorkflowRun:
    ...
    def test_create_returns_run(self, mock_pc):
        ...
        self._prisma.db.derouter_workflowrun.create = AsyncMock(return_value=_make_run())
        ...
        self._prisma.db.derouter_workflowrun.create.assert_awaited_once()
...
class TestListWorkflowRuns:
    ...
    def test_list_returns_runs(self, mock_pc):
        mock_pc.db = self._prisma.db
        self._prisma.db.derouter_workflowrun.find_many = AsyncMock(
    ...
    def test_list_filters_by_status(self, mock_pc):
        mock_pc.db = self._prisma.db
        self._prisma.db.derouter_workflowrun.find_many = AsyncMock(return_value=[])

        resp = self.client.get("/v1/workflows/runs?status=running")
        assert resp.status_code == 200
        call_kwargs = self._prisma.db.derouter_workflowrun.find_many.call_args[1]
...
class TestGetWorkflowRun:
    ...
    def test_get_existing_run(self, mock_pc):
        mock_pc.db = self._prisma.db
        self._prisma.db.derouter_workflowrun.find_unique = AsyncMock(
            return_value=_make_run()
        )
    ...
    def test_get_missing_run_returns_404(self, mock_pc):
        mock_pc.db = self._prisma.db
        self._prisma.db.derouter_workflowrun.find_unique = AsyncMock(return_value=None)
...
class TestUpdateWorkflowRun:
    ...
    def test_update_status(self, mock_pc):
        ...
        self._prisma.db.derouter_workflowrun.update = AsyncMock(return_value=updated)

        resp = self.client.patch(
            "/v1/workflows/runs/run-1", json={"status": "completed"}
        )
        assert resp.status_code == 200
        self._prisma.db.derouter_workflowrun.update.assert_awaited_once()
...
class TestAppendWorkflowEvent:
    ...
    def test_append_event_updates_run_status(self, mock_pc):
        ...
        self._prisma.db.derouter_workflowevent.find_many = AsyncMock(return_value=[])
        tx = _make_tx(
        ...
        tx.derouter_workflowrun.update.assert_awaited_once()
        update_call = tx.derouter_workflowrun.update.call_args[1]
    ...
    def test_append_event_no_status_update_for_unknown_type(self, mock_pc):
        ...
        tx.derouter_workflowrun.update.assert_not_awaited()
    ...
    def test_sequence_number_increments(self, mock_pc):
        ...
        self._prisma.db.derouter_workflowevent.find_many = AsyncMock(
        ...
        create_call = tx.derouter_workflowevent.create.call_args[1]
    ...
    def test_sequence_collision_retries_and_succeeds(self, mock_pc):
        ...
        tx_fail.derouter_workflowevent.create = AsyncMock(
...
class TestWorkflowMessages:
    ...
    def test_append_message(self, mock_pc):
        ...
        self._prisma.db.derouter_workflowmessage.find_many = AsyncMock(return_value=[])
        self._prisma.db.derouter_workflowmessage.create = AsyncMock(
    ...
    def test_list_messages_ordered(self, mock_pc):
        ...
        self._prisma.db.derouter_workflowmessage.find_many = AsyncMock(
            return_value=[
        ...
        data = resp.json()
        assert data["count"] == 2
        call_kwargs = self._prisma.db.derouter_workflowmessage.find_many.call_args[1]
...
class TestListWorkflowEvents:
    ...
    def test_list_events_ordered(self, mock_pc):
        ...
        data = resp.json()
        assert data["count"] == 2
        call_kwargs = self._prisma.db.derouter_workflowevent.find_many.call_args[1]
        assert call_kwargs["order"] == {"sequence_number": "asc"}
...
class TestTenantIsolation:
    ...
    def test_create_stores_caller_token(self, mock_pc):
        ...
        mock_pc.db = self._prisma.db
        self._prisma.db.derouter_workflowrun.create = AsyncMock(
            return_value=_make_run(created_by=token)
        )

        resp = client.post("/v1/workflows/runs", json={"workflow_type": "test"})
        assert resp.status_code == 200
        create_call = self._prisma.db.derouter_workflowrun.create.call_args[1]
    ...
    def test_non_admin_update_null_owner_run_returns_404(self, mock_pc):
        ...
        self._prisma.db.derouter_workflowrun.update = AsyncMock(
            return_value=_make_run(status="completed")
        )

        resp = client.patch("/v1/workflows/runs/run-1", json={"status": "completed"})
        assert resp.status_code == 404
        self._prisma.db.derouter_workflowrun.update.assert_not_awaited()
...
class TestAdminViewerReadParity:
    ...
    def test_require_run_still_scopes_when_handed_a_viewer(self):
        ...
        prisma.db.derouter_workflowrun.find_unique = AsyncMock(
            return_value=_make_run(created_by="tok-other-owner")
        )
