...
from derouter.proxy.management_endpoints import (
...
def setup_mock_prisma_client(
    ...
    mcp_servers: List[DeRouter_MCPServerTable],
):
    """Helper to set up a mock prisma client with proper async behavior"""
    mock_prisma_client.db = MagicMock()
    mock_prisma_client.db.derouter_teamtable = AsyncMock()
    mock_prisma_client.db.derouter_teamtable.find_many = AsyncMock(return_value=team_records)
    mock_prisma_client.db.derouter_mcpservertable = AsyncMock()
    mock_prisma_client.db.derouter_mcpservertable.find_many = AsyncMock(return_value=mcp_servers)
    return mock_prisma_client


def create_mcp_router_test_client() -> TestClient:
    from derouter.proxy.management_endpoints.mcp_management_endpoints import router
...
def patch_proxy_general_settings(settings: dict):
    ...
    return patch.dict(
        sys.modules,
        {"derouter.proxy.proxy_server": fake_proxy_server_module},
    )
...
class TestListMCPServers:
    ...
    async def test_list_mcp_servers_config_yaml_only(self):
        ...
        with (
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager",
                mock_manager,
            ),
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints._user_has_admin_view",
                return_value=True,
            ),
            patch(
            ...
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.build_effective_auth_contexts",
                AsyncMock(return_value=[mock_user_auth]),
            ),
        ):
            # Import and call the function
            from derouter.proxy.management_endpoints.mcp_management_endpoints import (
    ...
    async def test_list_mcp_servers_view_all_mode(self):
        ...
        with (
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints._get_user_mcp_management_mode",
    ...
    async def test_fetch_single_mcp_server_redacts_credentials(self):
        ...
        # Mock health check result as DeRouter_MCPServerTable
        ...
        with (
            ...
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.get_mcp_server",
                AsyncMock(return_value=mock_server),
            ),
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager.health_check_server",
    ...
    async def test_fetch_single_mcp_server_drops_env_vars_for_non_admin(self):
        ...
        dicts; it is wrapped in ``DeRouter_MCPServerTable`` (parsing the dicts
        ...
        raw_prisma_model = DeRouter_MCPServerTable.model_construct(
        ...
        mock_prisma_client = MagicMock()
        mock_prisma_client.db.derouter_mcpservertable.find_unique = AsyncMock(return_value=raw_prisma_model)
        ...
        with (
            ...
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.get_all_mcp_servers_for_user",
    ...
    async def test_fetch_single_mcp_server_sanitizes_for_view_only_admin(self):
        ...
        mock_server = DeRouter_MCPServerTable.model_construct(
...
class TestTeamScopedMCPServerAccess:
    ...
    async def test_team_member_can_query_own_team(self):
        ...
        with (
            ...
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints._get_team_scoped_mcp_server_list",
...
class TestTemporaryMCPSessionEndpoints:
    ...
    def test_cache_temporary_mcp_server_stores_entry_with_ttl(self):
        ...
        with patch(
            "derouter.proxy.management_endpoints.mcp_management_endpoints._temporary_mcp_servers",
            {},
        ) as cache:
    ...
    async def test_get_cached_temporary_mcp_server_prunes_expired_entries(self):
        ...
        with (
            ...
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints._get_prisma_client_or_none",
                return_value=None,
            ),
        ):
    ...
    async def test_get_cached_temporary_mcp_server_resolves_draft_written_by_another_worker(self):
        ...
        with (
            ...
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.get_draft_mcp_server",
                get_draft,
            ),
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager",
    ...
    async def test_create_draft_mcp_server_never_overwrites_a_real_server(self):
        ...
        from derouter.proxy._experimental.mcp_server.db import create_draft_mcp_server
        ...
        with (
            patch(
                "derouter.proxy._experimental.mcp_server.db._db_find_mcp_server_row",
                AsyncMock(return_value=real_row),
            ),
            patch(
                "derouter.proxy._experimental.mcp_server.db._db_find_mcp_server_rows",
                AsyncMock(return_value=[]),
            ),
            patch("derouter.proxy._experimental.mcp_server.db.create_mcp_server", create_call),
            patch("derouter.proxy._experimental.mcp_server.db.delete_mcp_server", delete_call),
        ):
    ...
    async def test_create_draft_mcp_server_adopts_the_winner_when_it_loses_a_create_race(self):
        ...
        with (
            patch("derouter.proxy._experimental.mcp_server.db._db_find_mcp_server_row", lookups),
            patch(
                "derouter.proxy._experimental.mcp_server.db._db_find_mcp_server_rows",
                AsyncMock(return_value=[]),
            ),
            patch(
                "derouter.proxy._experimental.mcp_server.db.create_mcp_server",
    ...
    async def test_create_draft_mcp_server_prunes_drafts_past_their_lifetime(self):
        ...
        with (
            patch("derouter.proxy._experimental.mcp_server.db._db_find_mcp_server_rows", find_rows),
            patch(
                "derouter.proxy._experimental.mcp_server.db._db_find_mcp_server_row",
                AsyncMock(return_value=None),
            ),
    ...
    async def test_get_all_mcp_servers_hides_drafts_without_hiding_legacy_null_rows(self):
        ...
        NULL != 'draft' as NULL."""
        from derouter.proxy._experimental.mcp_server.db import get_all_mcp_servers
    ...
    async def test_get_cached_temporary_mcp_server_or_404(self):
        ...
        with patch(
            "derouter.proxy.management_endpoints.mcp_management_endpoints.get_cached_temporary_mcp_server",
            return_value=server,
        ) as get_cached:
    ...
    async def test_add_session_mcp_server_caches_and_redacts_credentials(self):
        ...
        with (
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.validate_and_normalize_mcp_server_payload",
                MagicMock(),
            ) as validate_mock,
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager",
            ...
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints._cache_temporary_mcp_server",
                MagicMock(),
            ) as cache_mock,
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints._cache_temporary_mcp_server_in_redis",
                AsyncMock(),
            ) as redis_cache_mock,
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints._get_prisma_client_or_none",
    ...
    async def test_mcp_oauth_user_api_key_auth_falls_back_to_token_cookie(self):
        ...
        with (
            patch.dict(sys.modules, {"derouter.proxy.proxy_server": fake_proxy_server}),
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints._user_api_key_auth_builder",
                AsyncMock(return_value=expected_auth),
            ) as auth_builder_mock,
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints._read_request_body",
                AsyncMock(return_value={}),
            ),
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.populate_request_with_path_params",
    ...
    async def test_mcp_authorize_proxies_to_discoverable_endpoint(self):
        ...
        with (
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints._get_cached_temporary_mcp_server_or_404",
                return_value=server,
            ) as get_server,
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.authorize_with_server",
    ...
    async def test_mcp_authorize_rejects_untrusted_redirect_before_minting(self):
        ...
        admin_auth = generate_mock_user_api_key_auth(user_role=LitellmUserRoles.PROXY_ADMIN)
        request = MagicMock()
        request.base_url = "https://derouter.example.com/"
        request.headers = {}
    ...
    async def test_mcp_token_opens_sealed_passthrough_code_and_exchanges_with_minted_client(self):
        ...
        with (
            patch("derouter.proxy.proxy_server.master_key", "sk-lit4581-test-master-key"),
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints._get_cached_temporary_mcp_server_or_404",
                return_value=server,
            ),
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.exchange_token_with_server",
        ...
        assert exchange_mock.await_args.kwargs["redirect_uri"] == "https://derouter.example.com/callback"
    ...
    async def test_mcp_register_proxies_request_body(self):
        ...
        with (
            ...
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.register_client_with_server",
    ...
    async def test_mcp_register_forwards_validated_redirect_uris(self, raw_redirect_uris, forwarded):
        ...
        server = generate_mock_mcp_server_config_record(server_id="server-1")
        server.auth_type = MCPAuth.oauth2
        request_body = {"client_name": "DeRouter", "redirect_uris": raw_redirect_uris}
        admin_auth = generate_mock_user_api_key_auth(user_role=LitellmUserRoles.PROXY_ADMIN)
    ...
    async def test_get_cached_temporary_mcp_server_falls_back_to_redis(self):
        ...
        original_cache = mgmt_endpoints.derouter.cache
        mgmt_endpoints.derouter.cache = SimpleNamespace(cache=mock_cache_backend)
        try:
            with (
                patch(
                    "derouter.proxy.management_endpoints.mcp_management_endpoints._temporary_mcp_servers",
                ...
                patch(
                    "derouter.proxy.management_endpoints.mcp_management_endpoints.decrypt_value_helper",
            ...
            mgmt_endpoints.derouter.cache = original_cache

        assert result is not None
        assert result.server_id == "from-redis"
        mock_cache_backend.async_get_cache.assert_awaited_once_with(key="derouter:mcp:temporary_server:from-redis")
    ...
    async def test_cache_temporary_mcp_server_in_redis_uses_ttl_and_key(self):
        ...
        try:
            with patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.encrypt_value_helper",
        ...
        assert call_kwargs["key"] == "derouter:mcp:temporary_server:to-redis"
...
class TestUpdateMCPServer:
    ...
    async def test_update_mcp_server_respects_extra_headers(self):
        ...
        mock_prisma_client.db = MagicMock()
        mock_prisma_client.db.derouter_mcpservertable = AsyncMock()
        mock_prisma_client.db.derouter_mcpservertable.find_unique = AsyncMock(return_value=existing_server)
        mock_prisma_client.db.derouter_mcpservertable.update = AsyncMock(return_value=updated_server)
        ...
        with (
            ...
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.update_mcp_server",
                AsyncMock(return_value=updated_server),
            ) as update_mock,
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager.add_server",
                AsyncMock(),
            ),
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager.reload_servers_from_database",
                AsyncMock(),
            ),
        ):
            # Import and call the function
...
class TestAddMCPServerAtomicity:
    ...
    async def test_create_succeeds_when_registry_refresh_fails(self):
        ...
        with (
            ...
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.create_mcp_server",
...
class TestIdJagRegistrationWarnsAboutTheSSOGap:
    ...
    @staticmethod
    def _server_record(auth_type) -> DeRouter_MCPServerTable:
    ...
    async def test_update_to_id_jag_warns(self, monkeypatch, caplog):
        ...
        with (
            ...
            patch(  # test-quality-ok: endpoint test stubs credential cleanup
                "derouter.proxy.management_endpoints.mcp_management_endpoints.purge_user_oauth_credentials_for_server",
...
class TestMCPRegistryEndpoint:
    ...
    def test_registry_returns_entries_when_enabled(self):
        ...
        assert builtin_entry["name"] == "derouter-mcp-server"
...
class TestMCPApprovalWorkflow:
    ...
    async def test_get_submissions_admin_returns_summary(self):
        from derouter.proxy._types import MCPSubmissionsSummary
        from derouter.proxy.management_endpoints.mcp_management_endpoints import (
            get_mcp_server_submissions,
        )
        ...
        with (
            ...
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.get_mcp_submissions",
    ...
    async def test_approve_pending_server_loads_into_registry(self):
        ...
        with (
            ...
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.approve_mcp_server",
    ...
    async def test_reject_already_rejected_raises_400(self):
        from derouter.proxy._types import MCPApprovalStatus, RejectMCPServerRequest
        from derouter.proxy.management_endpoints.mcp_management_endpoints import (
    ...
    async def test_reject_active_server_allowed(self):
        ...
        with (
            ...
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.reject_mcp_server",
...
async def test_store_mcp_oauth_user_credential_returns_status():
    ...
    with (
        ...
        patch(
            "derouter.proxy.management_endpoints.mcp_management_endpoints.store_user_oauth_credential",
            new=AsyncMock(return_value=None),
        ),
        patch(
            "derouter.proxy.management_endpoints.mcp_management_endpoints.get_user_oauth_credential",
...
async def test_delete_mcp_oauth_user_credential_only_deletes_oauth():
    ...
    from derouter.proxy._types import MCPOAuthUserCredentialStatus
    ...
    with (
        ...
        patch(
            "derouter.proxy.management_endpoints.mcp_management_endpoints.delete_user_credential",
            new=delete_mock,
        ),
    ):
...
async def test_store_mcp_oauth_user_credential_invalidates_cached_token():
    ...
    from derouter.proxy._types import MCPOAuthUserCredentialRequest
...
async def test_list_mcp_user_credentials_batch_server_fetch():
    ...
    from derouter.proxy._types import MCPUserCredentialListItem
    ...
    with (
        ...
        patch(
            "derouter.proxy.management_endpoints.mcp_management_endpoints.list_user_oauth_credentials",
            new=AsyncMock(return_value=stored_creds),
        ),
        patch(
            "derouter.proxy.management_endpoints.mcp_management_endpoints.get_mcp_servers",
            new=batch_mock,
        ),
        patch(
            "derouter.proxy.management_endpoints.mcp_management_endpoints.get_mcp_server",
...
def test_sanitize_non_admin_drops_all_env_vars():
    ...
    import derouter.proxy.management_endpoints.mcp_management_endpoints as mgmt
...
async def test_fetch_all_mcp_servers_env_vars_full_admin_vs_view_only():
    ...
    async def _fetch_all(user_role):
        with (
            ...
            patch(
                "derouter.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager.get_all_mcp_servers_unfiltered",
                AsyncMock(return_value=[server]),
            ),
            patch(
...
def _leaky_list_server() -> "DeRouter_MCPServerTable":
    ...
    return DeRouter_MCPServerTable.model_construct(
...
def test_oauth2_flow_accepted_on_create_request():
    ...
    from derouter.proxy._experimental.mcp_server.db import _prepare_mcp_server_data
...
def test_oauth2_flow_round_trips_on_update_and_response_models():
    """oauth2_flow survives UpdateMCPServerRequest and the DeRouter_MCPServerTable
...
def test_oauth2_flow_defaults_to_none_when_omitted():
    ...
    assert DeRouter_MCPServerTable(server_id="srv-1", transport="http").oauth2_flow is None


def test_dcr_bridge_rejected_on_create_for_gateway_managed_auth_type():
    from pydantic import ValidationError

    from derouter.proxy._types import NewMCPServerRequest
...
def test_dcr_bridge_update_rejected_when_payload_auth_type_not_client_forwarded():
    ...
    from derouter.proxy._types import UpdateMCPServerRequest
...
def test_dcr_bridge_round_trips_on_response_model():
    from derouter.proxy._types import DeRouter_MCPServerTable

    row = DeRouter_MCPServerTable(server_id="srv-1", transport="http", dcr_bridge=True)
    assert row.dcr_bridge is True
    assert DeRouter_MCPServerTable(server_id="srv-1", transport="http").dcr_bridge is None


def _edit_endpoint_patches(old_record, update_mock):
    return (
        patch("derouter.proxy.management_endpoints.mcp_management_endpoints.MCP_AVAILABLE", True),
        patch(
            "derouter.proxy.management_endpoints.mcp_management_endpoints.get_prisma_client_or_throw",
            return_value=MagicMock(),
        ),
...
async def test_edit_mcp_server_rejects_dcr_bridge_when_stored_auth_type_not_client_forwarded(stored_auth_type):
    from derouter.proxy._types import UpdateMCPServerRequest
    from derouter.proxy.management_endpoints.mcp_management_endpoints import edit_mcp_server
...
async def _run_edit(old_record, updated_record, purge_mock=None):
    ...
    with (
        ...
        patch("derouter.proxy.management_endpoints.mcp_management_endpoints.global_mcp_server_manager") as mock_manager,
        patch(
            "derouter.proxy.management_endpoints.mcp_management_endpoints.purge_user_oauth_credentials_for_server",
...
class TestConnectedAppViewAnnotation:
    ...
    async def test_connected_app_view_lists_user_granted_servers_via_admitted_context(self):
        ...
        with (
            ...
            patch(
                "derouter.proxy._experimental.mcp_server.ui_session_utils.resolve_ui_session_team_ids",
                AsyncMock(return_value=[]),
            ),
            patch(
                "derouter.proxy._experimental.mcp_server.auth.user_api_key_auth_mcp.MCPRequestHandler.reload_admitted_user",
...
class TestImportMCPServers:
    ...
    def _import_patches(existing_servers, create_mock, mock_manager):
        return (
            ...
            patch(  # test-quality-ok: endpoint takes collaborators from module scope, matching the suite's pattern
                "derouter.proxy.management_endpoints.mcp_management_endpoints.get_all_mcp_servers",
