...
from derouter.proxy.management_endpoints.scim.scim_v2 import _apply_patch_ops, patch_user
...
async def test_patch_user_updates_fields():
    ...
    mock_db.derouter_usertable.update = AsyncMock(side_effect=mock_update)
    ...
    mock_db.derouter_verificationtoken.find_many = AsyncMock(return_value=[])
    ...
    mock_db.derouter_usertable.update.assert_called_once()
...
async def test_patch_user_manages_group_memberships():
    ...
    call_args = mock_db.derouter_usertable.update.call_args
