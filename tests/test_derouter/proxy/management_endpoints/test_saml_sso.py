...
from derouter.proxy.management_endpoints.sso.saml_sso import (
...
class TestSAMLAuthnCookieSecureFlag:
    """Regression tests for the derouter_saml_authn cookie's Secure attribute.
    derouter only sees a plain-HTTP hop whenever TLS terminates at a reverse
