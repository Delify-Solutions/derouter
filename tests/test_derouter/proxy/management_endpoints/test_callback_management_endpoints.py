...
from derouter.proxy.management_endpoints.callback_management_endpoints import router
...
class TestCallbackManagementEndpoints:
    ...
    def test_alist_callbacks_with_langfuse_logger(self):
        ...
        with patch("derouter.integrations.langfuse.langfuse.Langfuse") as mock_langfuse:
            ...
            derouter.success_callback.append("langfuse")
            derouter._async_success_callback.append("langfuse")
    ...
    def test_alist_callbacks_with_datadog_logger(self):
        ...
        derouter.success_callback.append("datadog")
        derouter.failure_callback.append("datadog")
        derouter.callbacks.append("datadog")
    ...
    def test_alist_callbacks_mixed_callback_types(self):
        ...
        derouter.success_callback.append("langfuse")
        derouter.failure_callback.append("datadog")
        derouter.callbacks.append("prometheus")
...
class TestNewRelicTeamCallbackValidation:
    ...
    def test_rejects_when_otel_v2_off(self, monkeypatch):
        ...
        from derouter.proxy.management_endpoints.team_callback_endpoints import _validate_team_callback
        ...
        try:
            ...
            assert "DEROUTER_OTEL_V2" in str(exc.value.detail)
        finally:
            is_otel_v2_enabled.cache_clear()
