...
Regression tests for https://github.com/Delify-Solutions/derouter/issues/22594
...
class TestTeamModelAddAtomicAppend:
    ...
    async def test_uses_atomic_array_append_with_dedup(self):
        ...
        from derouter.proxy.management_endpoints.team_endpoints import team_model_add
