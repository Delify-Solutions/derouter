...
def test_onboarding_get_token_happy(client, monkeypatch, mock_prisma):
    ...
    mock_prisma.db.derouter_invitationlink.find_unique.return_value = invite
    mock_prisma.db.derouter_usertable.find_unique.return_value = user_obj
...
def test_onboarding_get_token_expired_invite_401(client, monkeypatch, mock_prisma):
    ...
    mock_prisma.db.derouter_invitationlink.find_unique.return_value = expired_invite
...
def test_claim_onboarding_link_happy(client, monkeypatch, mock_prisma):
    ...
    user_obj = _make_user_obj()
    mock_prisma.db.derouter_invitationlink.find_unique.return_value = invite
    mock_prisma.db.derouter_invitationlink.update_many.return_value = 1
    mock_prisma.db.derouter_invitationlink.update.return_value = invite
    mock_prisma.db.derouter_usertable.update.return_value = user_obj
