...
class TestQualifireGuardrailInit:
    ...
    def test_init_with_default_prompt_injections(self):
        ...
        from derouter.proxy.guardrails.guardrail_hooks.qualifire.qualifire import (
            QualifireGuardrail,
        )
    ...
    def test_on_flagged_inject_system_message_raises_at_construction(self):
        """
        Maintainer finding on Delify-Solutions/derouter#34940: on_flagged is defined on
    ...
    def test_in_memory_update_reintroducing_inject_system_message_raises(self):
        """
        Bugbot finding on Delify-Solutions/derouter#34940: on_flagged is validated only in
        __init__. The base CustomGuardrail.update_in_memory_derouter_params is a
        ...
        Mirrors LakeraAIGuardrail's own update_in_memory_derouter_params override.
        """
        from derouter.proxy.guardrails.guardrail_hooks.qualifire.qualifire import (
            QualifireGuardrail,
        )
...
class TestQualifireGuardrailRegistry:
    ...
    def test_initialize_guardrail_function_exists(self):
        ...
        from derouter.proxy.guardrails.guardrail_hooks.qualifire import (
