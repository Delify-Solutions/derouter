...
"""
    ...
    async def test_streaming_hook_logs_guardrail_information_clean(self):
        ...
        assert entry["guardrail_provider"] == "derouter_content_filter"
    ...
    async def test_apply_guardrail_masks_all_different_blocked_keywords(self):
        ...
        https://github.com/Delify-Solutions/derouter/issues/17517
    ...
    async def test_apply_guardrail_masks_all_regex_pattern_matches(self):
        ...
        https://github.com/Delify-Solutions/derouter/issues/17687
    ...
    async def test_apply_guardrail_logs_guardrail_information(self):
        ...
        assert guardrail_info["guardrail_provider"] == "derouter_content_filter"
    ...
    async def test_html_tags_in_messages_not_blocked(self):
        ...
        https://github.com/Delify-Solutions/derouter/issues/20441
