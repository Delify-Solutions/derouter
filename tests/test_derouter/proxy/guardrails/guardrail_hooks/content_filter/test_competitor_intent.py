...
from derouter.proxy.guardrails.guardrail_hooks.derouter_content_filter.competitor_intent import (
...
# Exact config from derouter/proxy/_new_secret_config.yaml (lines 27-53).
...
# Dataset from ui/derouter-dashboard/src/data/compliancePrompts.ts airlineCompliancePrompts
