...
from derouter.proxy.guardrails.guardrail_hooks.repelloai.repelloai import (
...
class TestRepelloAIInitialization:
    ...
    def test_asset_id_optional_on_shared_derouter_params(self):
        ...
        derouter_params validation and break them."""
