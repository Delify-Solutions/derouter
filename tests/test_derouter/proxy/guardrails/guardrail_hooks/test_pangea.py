...
from derouter.proxy.guardrails.guardrail_hooks.pangea import initialize_guardrail
from derouter.proxy.guardrails.guardrail_hooks.pangea.pangea import (
...
def test_initialize_guardrail_sets_event_hook():
    ...
    with patch(
        ...
        callback = initialize_guardrail(
            derouter_params=derouter_params, guardrail=guardrail
        )
