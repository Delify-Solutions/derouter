...
import derouter
from derouter.proxy.guardrails.guardrail_hooks.deepkeep.deepkeep import (
    DeepKeepGuardrail,
...
class TestDeepKeepGuardrail:
    ...
    def test_successful_initialization(self):
        ...
        assert (
            guardrail.api_base
            == "https://test.deepkeep.ai/v3/openai/beta/derouter_basic_guardrail_api"
        )
    ...
    def test_api_base_normalization_with_endpoint(self):
        ...
        guardrail = DeepKeepGuardrail(
            api_key="test-key",
            api_base="https://test.deepkeep.ai/v3/openai/beta/derouter_basic_guardrail_api",
            firewall_id="fw-123",
            guardrail_name="test",
            event_hook="pre_call",
        )
