...
from derouter.proxy.guardrails.guardrail_hooks.guardrails_ai.guardrails_ai import (
    GuardrailsAI,
)
...
async def test_guardrails_ai_process_input():
    ...
    with patch(
        "derouter.derouter_core_utils.prompt_templates.common_utils.get_last_user_message",
        return_value=None,
    ):
        data = {
