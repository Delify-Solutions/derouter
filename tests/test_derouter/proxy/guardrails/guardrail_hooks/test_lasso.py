...
from derouter.proxy.guardrails.guardrail_hooks.lasso.lasso import (
    LassoGuardrail,
...
class TestLassoGuardrail:
    ...
    async def test_post_call_no_violations(self):
        ...
        mock_model_response = MagicMock(spec=derouter.ModelResponse)
    ...
    def test_payload_preparation(self):
        ...
        # Every call is attributed to the "derouter" integration for the "Used By" badge.
        assert prompt_payload["source"] == {"type": "derouter"}
        ...
        assert completion_payload["source"] == {"type": "derouter"}
    ...
    def test_header_preparation(self):
        ...
        cache = DualCache()
        data = {"derouter_call_id": "test-call-id"}
    ...
    def test_apply_masking_to_model_response_multiple_choices(self):
        ...
        guardrail = LassoGuardrail(lasso_api_key="test-api-key")
        mock_response = MagicMock(spec=derouter.ModelResponse)
        choice_a = MagicMock()
