...
from derouter.proxy.guardrails.guardrail_hooks.xecguard.xecguard import (
    XecGuardGuardrail,
...
class TestXecGuardGrounding:
    ...
    @pytest.mark.asyncio
    async def test_grounding_metadata_falls_back_to_derouter_metadata(
        self, xecguard_guardrail
    ):
        request_data = {
            "messages": [
    ...
    async def test_grounding_metadata_missing_returns_empty(self, xecguard_guardrail):
        """No ``metadata`` and no ``derouter_metadata`` keys at all means
...
class TestXecGuardInitializer:
    def test_initializer_registry_has_entry(self):
        from derouter.proxy.guardrails.guardrail_hooks.xecguard import (
    ...
    def test_initializer_creates_instance(self):
        ...
        cb = initialize_guardrail(derouter_params=params, guardrail=guardrail)
