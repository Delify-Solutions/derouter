...
def _make_model(model_name: str, model_id: str, access_groups: list[str] = None):
    ...
    return {
        ...
        "derouter_params": {"model": model_name},
        "model_info": {
            "id": model_id,
...
async def test_filter_resolves_access_group_names():
    ...
    mock_prisma.db.derouter_teamtable.find_unique = AsyncMock(return_value=team_db)
    ...
    call_kwargs = mock_prisma.db.derouter_proxymodeltable.find_many.call_args[1]
