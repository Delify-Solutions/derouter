...
Related issue: https://github.com/Delify-Solutions/derouter/issues/21305
"""
...
class TestSpendCalculateOpenAPISchema:
    ...
    def test_response_schema_has_description(self):
        ...
        from derouter.proxy.spend_tracking.spend_management_endpoints import router
...
class TestCredentialEndpointsOpenAPISchema:
    ...
    def test_by_name_and_by_model_are_separate_handlers(self):
        ...
        """
        from derouter.proxy.credential_endpoints.endpoints import router
    ...
    def test_by_model_route_does_not_require_credential_name(self):
        ...
        """
        import inspect
        from derouter.proxy.credential_endpoints.endpoints import (
...
class TestWebSocketStubInjection:
    ...
    def test_responses_post_routes_registered_on_router(self):
        ...
        """
        from derouter.proxy.response_api_endpoints.endpoints import router
