...
def test_add_key_level_controls_with_none_metadata():
    ...
    result = DeRouterProxyRequestSetup.add_key_level_controls(
...
def test_batch_create_with_derouter_sdk():
    """
    Test creating a batch using derouter SDK with metadata=None.
    This is a more direct test of the original issue.
    """
    # Mock the OpenAI batches instance to avoid actual API calls
    with patch("derouter.batches.main.openai_batches_instance") as mock_openai_batches:
        # Mock the response
...
if __name__ == "__main__":
    ...
    test_batch_create_with_derouter_sdk()
    print("✓ test_batch_create_with_derouter_sdk passed")
