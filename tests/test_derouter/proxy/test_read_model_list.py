"""Tests for derouter.proxy.read_model_list (Rust AI gateway config bridge)."""

from derouter.proxy.read_model_list import read_model_list
...
def test_read_model_list_resolves_os_environ(monkeypatch, tmp_path):
    ...
    params = model_list[0]["derouter_params"]
