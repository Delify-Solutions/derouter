...
_COLLECT = "derouter.proxy.pass_through_endpoints.passthrough_guardrails.PassthroughGuardrailHandler.collect_guardrails"
...
def test_modify_response_exception_importable_from_both_paths():
    ...
    from derouter.exceptions import ModifyResponseException as FromExceptions
    from derouter.integrations.custom_guardrail import (
