...
from derouter.integrations.custom_guardrail import (  # noqa: E402
    CustomGuardrail,
...
from derouter.proxy.common_utils.user_api_key_cache import UserApiKeyCache  # noqa: E402
from derouter.proxy.utils import ProxyLogging  # noqa: E402
from derouter.types.guardrails import GuardrailEventHooks  # noqa: E402

_PT_MOD = "derouter.proxy.pass_through_endpoints.pass_through_endpoints"
_COLLECT = (
...
from derouter.proxy.pass_through_endpoints.pass_through_endpoints import (  # noqa: E402
...
async def _drive(response_text: str):
    ...
    saved_callbacks = list(derouter.callbacks)
    derouter.callbacks = [guardrail, otel]
    ...
    patches = [
        ...
        patch("derouter.proxy.proxy_server.open_telemetry_logger", otel),
    ...
    try:
        ...
        derouter.callbacks = saved_callbacks
