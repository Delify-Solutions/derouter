...
from derouter.proxy.pass_through_endpoints.llm_provider_handlers.cohere_passthrough_logging_handler import (
...
class TestCoherePassthroughLoggingHandler:
    ...
    @patch("derouter.llms.cohere.embed.v1_transformation.CohereEmbeddingConfig._transform_response")
    ...
    @patch(
        "derouter.proxy.pass_through_endpoints.llm_provider_handlers.base_passthrough_logging_handler.BasePassthroughLoggingHandler.passthrough_chat_handler"
    )
    @patch("derouter.completion_cost")
