...
from derouter.proxy.pass_through_endpoints.llm_provider_handlers.gemini_passthrough_logging_handler import (
...
class TestGeminiPassthroughLoggingHandler:
    ...
    @patch(
        "derouter.derouter_core_utils.derouter_logging.get_standard_logging_object_payload"
    )
    ...
    @pytest.mark.asyncio
    @patch(
        "derouter.proxy.pass_through_endpoints.llm_provider_handlers.gemini_passthrough_logging_handler.derouter.completion_cost",
