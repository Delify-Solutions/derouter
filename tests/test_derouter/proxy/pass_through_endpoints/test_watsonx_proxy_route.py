...
class TestWatsonxProxyRoute:
    ...
    async def test_watsonx_proxy_route_success_non_streaming(self):
        ...
        with (
            patch(
                "derouter.proxy.pass_through_endpoints.llm_passthrough_endpoints.ProviderConfigManager.get_provider_passthrough_config",
            ...
            assert (
                ...
                == derouter.WATSONX_DEFAULT_API_VERSION
            )
    ...
    async def test_watsonx_proxy_route_multipart_form_data(self):
        ...
        with (
            ...
            patch(
                "derouter.proxy.pass_through_endpoints.llm_passthrough_endpoints.get_form_data",
