...
from derouter.proxy.client.credentials import CredentialsManagementClient
from derouter.proxy.client.exceptions import UnauthorizedError
from derouter.proxy.credential_endpoints.endpoints import CredentialHelperUtils
...
def test_encrypt_credential_values_does_not_mutate_original(monkeypatch):
    ...
    monkeypatch.setenv("DEROUTER_SALT_KEY", "test-key")
