...
from derouter.proxy.client.cli.commands import debug as debug_module
from derouter.proxy.client.cli.commands.debug import (
    SLASH_COMMAND_NAME,
...
def env(monkeypatch, tmp_path):
    monkeypatch.setenv("DEROUTER_PROXY_URL", PROXY)
    monkeypatch.setenv("DEROUTER_PROXY_API_KEY", "sk-test")
