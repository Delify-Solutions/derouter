...
from derouter.proxy.client.cli.commands.autoroute import commands as commands_module
from derouter.proxy.client.cli.commands.autoroute import process as process_module
from derouter.proxy.client.cli.commands.autoroute.commands import down, up
from derouter.proxy.client.cli.commands.autoroute.process import PidRecord, ProcessLaunchError, write_pid_record
from derouter.proxy.client.cli.commands.up import BackupRecord as ClaudeBackupRecord
from derouter.proxy.client.cli.commands.up import write_backup
...
class TestUpCommand:
    ...
    def test_refuses_with_actionable_error_when_proxy_runtime_missing(self, monkeypatch, tmp_path):
        """`up` launches a real derouter proxy, which the thin `derouter[cli]` install cannot run.
        ...
        assert "derouter[proxy]" in result.output
