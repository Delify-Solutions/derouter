...
from derouter.proxy.client.cli.commands.autoroute import wizard as wizard_module
from derouter.proxy.client.cli.commands.autoroute.config import DiscoveredModel
from derouter.proxy.client.cli.commands.autoroute.wizard import run_configure_wizard
...
def _router_config(config_path) -> Dict[str, Any]:
    ...
    return autorouter["derouter_params"]["complexity_router_config"]
