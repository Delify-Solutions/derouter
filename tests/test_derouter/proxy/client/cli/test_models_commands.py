...
from derouter.proxy.client.cli.commands.models import (
...
def mock_client():
    ...
    with patch("derouter.proxy.client.cli.commands.models.Client") as MockClient:
        yield MockClient
...
def mock_env():
    ...
    with patch.dict(
        os.environ,
        {
            "DEROUTER_PROXY_URL": "http://localhost:4000",
            "DEROUTER_PROXY_API_KEY": "sk-test",
        },
    ):
        yield
...
def mock_models_info(mock_client):
    ...
    mock_client.return_value.models.info.return_value = [
        {
            "model_name": "gpt-4",
            "derouter_params": {"model": "gpt-4", "derouter_credential_name": "openai-1"},
            "model_info": {
                "id": "model-123",
...
def test_models_import_only_models_matching_regex(tmp_path, mock_client, cli_runner):
    ...
    yaml_content = {
        "model_list": [
            ...
            },
            {
                ...
                "derouter_params": {"model": "llama2"},
                "model_info": {"id": "id-3"},
            },
            {
                "model_name": "other-model",
                "derouter_params": {"model": "other"},
                "model_info": {"id": "id-4"},
            },
        ]
    }
    ...
    # Only match models containing 'gpt' in their derouter_params.model
    ...
    yaml_content = {
        "model_list": [
            ...
            },
            {
                ...
                "derouter_params": {"model": "no-access"},
                "model_info": {"id": "id-5"},
            },
        ]
    }
