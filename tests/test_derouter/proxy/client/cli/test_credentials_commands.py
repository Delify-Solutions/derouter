...
from derouter.proxy.client.cli.main import cli
...
def mock_credentials_client(monkeypatch):
    ...
    monkeypatch.setattr(
        "derouter.proxy.client.credentials.CredentialsManagementClient",
        mock_client,
    )
    monkeypatch.setattr(
        "derouter.proxy.client.cli.commands.credentials.CredentialsManagementClient",
        mock_client,
    )
    return mock_client
