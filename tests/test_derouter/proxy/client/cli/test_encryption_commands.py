"""CLI tests for the ``derouter-proxy encryption migrate`` command.
...
from derouter.proxy.client.cli import main as cli_main
from derouter.proxy.client.cli.commands import encryption as enc_cli
