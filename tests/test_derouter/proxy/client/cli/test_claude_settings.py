...
from derouter.derouter_core_utils.cli_token_utils import CliTokenRecord
from derouter.proxy.client.cli import cli
from derouter.proxy.client.cli.commands.claude_settings import (
...
CLAUDE_SETTINGS_MODULE = "derouter.proxy.client.cli.commands.claude_settings"
...
class TestApiKeyHelperIsActuallyInvocable:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("C:\\Program Files\\DeRouter\\lite.EXE", "https://gateway.example.com/?a=1&b=2"),
...
class TestConflictingOwnersOfTheSettingsFile:
    ...
    def test_the_registry_matches_the_paths_the_commands_actually_use(self):
        ...
        from derouter.proxy.client.cli.commands.autoroute.process import AUTOROUTE_DIR
