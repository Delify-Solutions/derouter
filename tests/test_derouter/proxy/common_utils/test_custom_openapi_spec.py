...
class TestCustomOpenAPISpec:
    ...
    @patch(
        "derouter.proxy.common_utils.custom_openapi_spec.CustomOpenAPISpec.add_request_schema"
    )
    def test_add_chat_completion_request_schema(
        ...
        with patch("derouter.proxy._types.ProxyChatCompletionRequest") as mock_model:
    ...
    def test_add_embedding_request_schema(self, mock_add_schema, base_openapi_schema):
        ...
        with patch("derouter.types.embedding.EmbeddingRequest") as mock_model:
    ...
    def test_add_responses_api_request_schema(
        ...
        with patch("derouter.types.llms.openai.ResponsesAPIRequestParams") as mock_model:
