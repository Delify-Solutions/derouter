...
from derouter.proxy.common_utils.load_config_utils import get_file_contents_from_s3
...
class TestGetFileContentsFromS3:
    ...
    @patch("boto3.client")
    @patch("derouter.main.bedrock_converse_chat_completion")
    ...
    def test_get_file_contents_from_s3_no_temp_file_creation(
        ...
        Relevant issue/PR: https://github.com/Delify-Solutions/derouter/pull/12078
        """
        # Mock credentials
