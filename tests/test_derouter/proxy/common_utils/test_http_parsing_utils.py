...
async def test_surrogate_repair_skipped_above_size_limit(monkeypatch):
    ...
    """
    import derouter.proxy.common_utils.http_parsing_utils as http_parsing_utils
...
def test_get_tags_from_request_body_with_derouter_metadata_tags():
    """
    Test that tags are correctly extracted from request body when using derouter_metadata.
    """
    request_body = {
        "model": "gpt-4",
        "derouter_metadata": {"tags": ["tag1", "tag2", "tag3"]},
    }
...
def test_get_tags_from_request_body_with_dict_tags():
    ...
    request_body = {
        ...
        "metadata": {
            "tags": {
                "derouter_id": "derouter_ratelimit_test",
...
def test_get_tags_from_request_body_with_null_metadata():
    ...
    This is a regression test for https://github.com/Delify-Solutions/derouter/issues/17263
