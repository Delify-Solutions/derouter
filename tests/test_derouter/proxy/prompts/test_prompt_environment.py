...
async def test_create_prompt_stores_environment_and_created_by():
    ...
    from derouter.proxy.prompts.prompt_endpoints import create_prompt, Prompt
    ...
    mock_prisma_client.db.derouter_prompttable.create = AsyncMock(
        return_value=mock_db_entry
    )
    mock_prisma_client.db.derouter_prompttable.find_many = AsyncMock(return_value=[])
    ...
    with patch("derouter.proxy.proxy_server.prisma_client", mock_prisma_client):
        with patch(
            ...
            mock_registry.initialize_prompt.return_value = PromptSpec(
                ...
                derouter_params=request.derouter_params,
            ...
            create_call = mock_prisma_client.db.derouter_prompttable.create.call_args
...
async def test_update_prompt_stores_environment_and_created_by():
    ...
    from unittest.mock import AsyncMock, patch
    from derouter.proxy._types import UserAPIKeyAuth, LitellmUserRoles
    from derouter.proxy.prompts.prompt_endpoints import update_prompt, Prompt
