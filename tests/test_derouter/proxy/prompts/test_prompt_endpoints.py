...
class TestPromptVersioning:
    ...
    def test_get_latest_prompt_versions(self):
        ...
        """
        from derouter.proxy.prompts.prompt_endpoints import get_latest_prompt_versions
        ...
        assert jack_prompt.derouter_params.dotprompt_content == "v3 content"
    ...
    def test_get_version_number(self):
        ...
        """
        from derouter.proxy.prompts.prompt_endpoints import get_version_number
    ...
    def test_get_base_prompt_id(self):
        ...
        """
        from derouter.proxy.prompts.prompt_endpoints import get_base_prompt_id
...
class TestPromptVersionsEndpoint:
    ...
    async def test_get_prompt_versions_returns_all_versions(self):
        ...
        from derouter.proxy.prompts.prompt_endpoints import get_prompt_versions
...
class TestAdminViewerReadAccess:
    ...
    async def test_list_prompts_returns_all_prompts_for_admin_viewer(self):
        ...
        from derouter.proxy._types import LitellmUserRoles, UserAPIKeyAuth
        from derouter.proxy.prompts.prompt_endpoints import list_prompts
        ...
        assert jack.derouter_params.dotprompt_content == "v2"
...
class TestConfigPromptInfoWithEnvironment:
    ...
    def _prisma_client_with_empty_prompt_table(self):
        ...
        mock_prisma.db.derouter_prompttable.find_many = AsyncMock(return_value=[])
        return mock_prisma
    ...
    async def test_get_prompt_info_with_environment_falls_back_to_registry(self):
        ...
        assert response.prompt_spec.derouter_params.dotprompt_content == "AHOY {{user_message}}"
