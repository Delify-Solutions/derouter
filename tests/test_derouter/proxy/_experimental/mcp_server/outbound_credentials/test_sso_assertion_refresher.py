...
async def test_a_basic_auth_login_gets_a_basic_auth_refresh():
    ...
    expected = base64.b64encode(b"derouter:s3cret").decode()
...
async def test_a_body_credential_login_gets_a_body_credential_refresh():
    ...
    _url, form = transport.calls[0]
    assert form["client_id"] == "derouter"
...
@pytest.mark.parametrize(
    ...
    [
        {},
        {"GENERIC_CLIENT_ID": "derouter", "GENERIC_CLIENT_SECRET": "s"},
        {"GENERIC_TOKEN_ENDPOINT": TOKEN_ENDPOINT, "GENERIC_CLIENT_SECRET": "s"},
        {"GENERIC_TOKEN_ENDPOINT": TOKEN_ENDPOINT, "GENERIC_CLIENT_ID": "derouter"},
        {"GENERIC_TOKEN_ENDPOINT": "", "GENERIC_CLIENT_ID": "derouter", "GENERIC_CLIENT_SECRET": "s"},
    ],
)
...
def test_the_configured_sso_client_is_the_one_the_login_used():
    ...
    assert config.client_id == "derouter"
