...
The envelope is the single client-held bearer carrying both a derouter identity and the
...
@pytest.mark.parametrize("hostile_iss", [["derouter-mcp-bridge"], 5, {"iss": "x"}])
...
def test_open_size_guard_measures_bytes_not_characters():
    ...
    from derouter.proxy._experimental.mcp_server.outbound_credentials import envelope
