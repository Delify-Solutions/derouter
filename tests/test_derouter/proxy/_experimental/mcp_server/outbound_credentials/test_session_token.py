...
def test_alg_none_token_is_rejected():
    unsigned = jwt.api_jws.encode(b'{"iss":"derouter-mcp-gateway"}', key=None, algorithm="none")
...
def test_alg_none_token_with_the_current_kid_is_rejected_in_rs256_mode():
    unsigned = jwt.api_jws.encode(
        b'{"iss":"derouter-mcp-gateway"}', key=None, algorithm="none", headers={"kid": RSA_KEYS.kid}
    )
