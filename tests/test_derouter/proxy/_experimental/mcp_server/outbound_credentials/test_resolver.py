...
async def test_id_jag_exchanges_the_stored_sso_assertion_when_the_caller_presents_no_token():
    """The agent-triggered flow: a brokered DeRouter credential carries no IdP token, so leg 1's
...
_DRIVER_DETAIL = "could not connect to host=pg-primary.internal port=5432 user=derouter"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        _id_jag_config().model_copy(update={"client_id": "derouter-rotated"}),
