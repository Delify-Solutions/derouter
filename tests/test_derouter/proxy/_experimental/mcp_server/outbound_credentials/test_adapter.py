...
from derouter.proxy._experimental.mcp_server.exceptions import MCPServerURLCredentialsError
...
def _id_jag_server(**overrides) -> MCPServer:
    defaults = dict(
        ...
        client_id="derouter-client-id",
        client_secret="derouter-client-secret",
...
def test_id_jag_client_secret_maps_to_config():
    ...
    assert spec.config.client_id == "derouter-client-id"
    ...
    assert spec.config.client_auth.client_secret.get_secret_value() == ("derouter-client-secret")
