...
async def test_resolve_mcp_auth_fetches_oauth2_token():
    ...
    with patch(
        "derouter.proxy._experimental.mcp_server.oauth2_token_cache.get_async_httpx_client",
...
async def test_token_cached_across_calls():
    ...
    with (
        ...
        patch(
            "derouter.proxy._experimental.mcp_server.oauth2_token_cache.mcp_oauth2_token_cache",
            cache,
        ),
    ):
