"""
Tests for the short-ID MCP tool prefix (DEROUTER_USE_SHORT_MCP_TOOL_PREFIX).
...
def _reset_env(monkeypatch):
    monkeypatch.delenv("DEROUTER_USE_SHORT_MCP_TOOL_PREFIX", raising=False)
    yield
...
class TestShortPrefixHelpers:
    ...
    def test_flag_truthy_values(self, monkeypatch, value):
        monkeypatch.setenv("DEROUTER_USE_SHORT_MCP_TOOL_PREFIX", value)
