...
Verifies fix for https://github.com/Delify-Solutions/derouter/issues/25081
"""

import pytest

from derouter.proxy._experimental.mcp_server.utils import is_tool_name_prefixed
