...
def _mock_get_model_info(model, **kwargs):
    """Mock derouter.get_model_info using our test data."""
...
class TestSelectModelByPriority:
    ...
    @patch("derouter.get_model_info", side_effect=_mock_get_model_info)
    ...
    def test_speed_priority_is_neutral_when_no_tps_data(self):
        ...
        with patch("derouter.get_model_info", side_effect=info):
