...
from derouter.proxy._experimental.mcp_server.cost_calculator import MCPCostCalculator


class TestMCPCostCalculator:
    def test_calculate_mcp_tool_call_cost_none_logging_obj(self):
        """Test that when derouter_logging_obj is None, it returns 0.0"""
    ...
    def test_calculate_mcp_tool_call_cost_no_cost_configuration(self):
        ...
        # Mock the derouter_logging_obj with minimal metadata
        mock_logging_obj = MagicMock()
        mock_logging_obj.model_call_details = {
    ...
    def test_calculate_mcp_tool_call_cost_empty_metadata(self):
        ...
        # Mock the derouter_logging_obj with empty model_call_details
        mock_logging_obj = MagicMock()
        mock_logging_obj.model_call_details = {}
