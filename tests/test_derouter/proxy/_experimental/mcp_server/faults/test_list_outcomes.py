...
def test_auth_challenge_and_status_come_from_the_causal_response():
    ...
    from derouter.proxy._experimental.mcp_server.faults.list_outcomes import upstream_auth_challenge
...
def test_raise_classified_list_failure_routes_auth_to_upstream_auth_error():
    ...
    from derouter.proxy._experimental.mcp_server.faults.list_outcomes import raise_classified_list_failure
