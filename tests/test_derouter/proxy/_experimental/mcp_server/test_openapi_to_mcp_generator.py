...
GET_ASYNC_CLIENT_TARGET = "derouter.proxy._experimental.mcp_server.openapi_to_mcp_generator.get_async_httpx_client"
...
class TestRegisterToolsFromOpenAPI:
    ...
    def test_github_style_operation_ids_are_sanitized(self, monkeypatch):
        ...
        from derouter.proxy._experimental.mcp_server import openapi_to_mcp_generator
