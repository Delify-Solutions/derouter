...
from derouter.proxy._experimental.mcp_server.proxy_api_credentials import lookup_consent_teams, mint_proxy_credential
from derouter.proxy.auth.auth_checks import ExperimentalUIJWTToken
from derouter.proxy.management_endpoints.ui_sso import CliSsoTeamDetail

_LOAD_USER = "derouter.proxy._experimental.mcp_server.proxy_api_credentials.load_active_user_by_id"
_FETCH_TEAMS = "derouter.proxy._experimental.mcp_server.proxy_api_credentials.fetch_cli_sso_team_details"
...
def _user(**overrides) -> DeRouter_UserTable:
...
def _salt_key(monkeypatch):
    monkeypatch.setenv("DEROUTER_SALT_KEY", "sk-proxy-api-credentials-tests")
