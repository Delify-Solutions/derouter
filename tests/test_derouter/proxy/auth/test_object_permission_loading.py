...
from derouter.proxy.auth.auth_checks import get_key_object, get_team_object
...
async def test_get_key_object_loads_object_permission():
    ...
    with (
        ...
        patch("derouter.proxy.auth.auth_checks._cache_key_object", AsyncMock()),
...
async def test_get_team_object_loads_object_permission():
    ...
    with (
        patch(
            "derouter.proxy.auth.auth_checks._get_team_db_check",
        ...
        patch("derouter.proxy.auth.auth_checks._cache_team_object", AsyncMock()),
        patch("derouter.proxy.auth.auth_checks._should_check_db", return_value=True),
        patch("derouter.proxy.auth.auth_checks._update_last_db_access_time"),
        patch("derouter.proxy.proxy_server.proxy_logging_obj", mock_proxy_logging_obj),
    ):
