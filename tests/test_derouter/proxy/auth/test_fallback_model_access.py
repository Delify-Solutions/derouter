...
from derouter.proxy.auth.fallback_model_access import (
        ...
        model_list=[
            {
                ...
                "derouter_params": {"model": "openai/open", "api_key": "k"},
                "model_info": {"access_groups": ["open-group"]},
            },
            {
                "model_name": "secret-model",
                "derouter_params": {"model": "openai/secret", "api_key": "k"},
...
async def test_proxy_check_reads_enforce_fallback_model_access_from_general_settings(
    ...
    monkeypatch.setattr("derouter.proxy.proxy_server.general_settings", general_settings)
