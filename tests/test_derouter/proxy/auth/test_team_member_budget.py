...
from derouter.proxy.auth.auth_checks import common_checks, get_team_membership
...
async def test_team_member_budget_check_exceeds_budget():
    ...
    with (
        ...
        patch("derouter.proxy.proxy_server.user_api_key_cache", mock_user_api_key_cache),
    ):
...
async def test_team_member_budget_check_no_budget_set():
    ...
    team_membership = DeRouter_TeamMembership(
        ...
        team_id="test-team-1",
        spend=0.0,
        derouter_budget_table=None,  # No budget set
    )
