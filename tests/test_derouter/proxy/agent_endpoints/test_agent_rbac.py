...
async def test_get_agents_blocked_for_internal_user_when_disabled():
    ...
    from derouter.proxy.agent_endpoints.endpoints import get_agents
    ...
    with patch.dict("derouter.proxy.proxy_server.general_settings", gs, clear=True):
...
async def test_get_agents_allowed_when_not_disabled():
    ...
    with patch.dict("derouter.proxy.proxy_server.general_settings", {}, clear=True):
        with patch(
...
async def test_get_agent_daily_activity_blocked_when_disabled():
    from derouter.proxy.agent_endpoints.endpoints import get_agent_daily_activity
