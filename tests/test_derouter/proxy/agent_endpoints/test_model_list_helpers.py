...
Maps to: derouter/proxy/agent_endpoints/model_list_helpers.py
"""
...
async def test_append_agents_to_model_info():
    ...
    with patch(
        ...
        with patch(
            ...
            assert result[0]["derouter_params"]["model"] == "a2a/test-agent"
            assert result[0]["derouter_params"]["custom_llm_provider"] == "a2a"
