...
def _build_agents_client():
    ...
    from derouter.proxy.google_endpoints.agents_endpoints import router as agents_router
...
def _patch_base_process(return_value=None):
    ...
    return patch(
        "derouter.proxy.google_endpoints.agents_endpoints.ProxyBaseLLMRequestProcessing.base_process_llm_request",
