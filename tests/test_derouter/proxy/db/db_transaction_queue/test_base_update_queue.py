...
from derouter.constants import MAX_IN_MEMORY_QUEUE_FLUSH_COUNT
...
async def test_queue_flush_limit():
    ...
    # The default DEROUTER_ASYNCIO_QUEUE_MAXSIZE (1000) equals MAX_IN_MEMORY_QUEUE_FLUSH_COUNT,
...
def test_misconfigured_queue_thresholds_warns():
    """
    Test that a warning is logged when MAX_SIZE_IN_MEMORY_QUEUE >= DEROUTER_ASYNCIO_QUEUE_MAXSIZE.
    ...
    """
    import derouter.proxy.db.db_transaction_queue.base_update_queue as bq_module

    with (
        patch.object(bq_module, "MAX_SIZE_IN_MEMORY_QUEUE", 2000),
        patch.object(bq_module, "DEROUTER_ASYNCIO_QUEUE_MAXSIZE", 1000),
