...
from derouter.proxy.db import shadow_eval_funnel
from derouter.proxy.db.shadow_eval_funnel import (
...
async def test_increments_aggregate_per_job_and_flush_upserts_and_clears():
    ...
    assert '"DeRouter_ShadowEvalFunnel".not_sampled + EXCLUDED.not_sampled' in sql
