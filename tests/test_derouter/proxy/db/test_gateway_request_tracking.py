...
from derouter.types.proxy.gateway_requests import GatewayRequestCounts, GatewayRequestKey
...
class FakeBatcher:
    def __init__(self, table: FakeTable) -> None:
        self.derouter_dailygatewayrequests = table
