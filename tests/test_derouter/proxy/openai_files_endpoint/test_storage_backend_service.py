...
from derouter.proxy.openai_files_endpoints import storage_backend_service
...
class _FakeManagedFilesHook(BaseFileEndpoints):
    ...
    async def acreate_file(
        self, create_file_request, llm_router, target_model_names_list, derouter_parent_otel_span, user_api_key_dict
    ):
        raise NotImplementedError

    async def afile_retrieve(self, file_id, derouter_parent_otel_span, llm_router=None):
        raise NotImplementedError

    async def afile_list(self, purpose, derouter_parent_otel_span, **data):
        raise NotImplementedError

    async def afile_delete(self, file_id, derouter_parent_otel_span, llm_router, **data):
        raise NotImplementedError

    async def afile_content(self, file_id, derouter_parent_otel_span, llm_router, **data):
        raise NotImplementedError
