...
class TestStandardLoggingPayloadExcludedFields:
    ...
    def setup_method(self):
        """Reset derouter settings before each test."""
        derouter.standard_logging_payload_excluded_fields = None
    ...
    def test_exclude_single_field(self):
        ...
        derouter.standard_logging_payload_excluded_fields = ["response"]
    ...
    def test_exclude_multiple_fields(self):
        ...
        derouter.standard_logging_payload_excluded_fields = ["response", "messages"]
    ...
    def test_exclude_metadata_field(self):
        ...
        derouter.standard_logging_payload_excluded_fields = ["metadata"]
    ...
    def test_exclude_hidden_params(self):
        ...
        derouter.standard_logging_payload_excluded_fields = ["hidden_params"]
    ...
    def test_exclude_nonexistent_field_no_error(self):
        ...
        derouter.standard_logging_payload_excluded_fields = [
            "nonexistent_field",
            "response",
        ]
    ...
    def test_combined_with_turn_off_message_logging(self):
        ...
        derouter.standard_logging_payload_excluded_fields = ["metadata", "hidden_params"]
...
class TestExcludedFieldsIntegration:
    ...
    def test_custom_callback_receives_filtered_payload(self):
        ...
        # Simulate what derouter_logging.py does
        filtered_details = (
...
class TestExcludedFieldsConfigLoading:
    """Test that the config is properly loaded from derouter_settings."""
    ...
    def test_config_attribute_exists(self):
        """Test that the config attribute exists on derouter module."""
        assert hasattr(derouter, "standard_logging_payload_excluded_fields")

    def test_config_default_is_none(self):
        """Test that the default value is None."""
        # Reset to ensure we're testing the default
        derouter.standard_logging_payload_excluded_fields = None
        assert derouter.standard_logging_payload_excluded_fields is None

    def test_config_can_be_set_to_list(self):
        """Test that the config can be set to a list."""
        derouter.standard_logging_payload_excluded_fields = ["response", "messages"]
        assert derouter.standard_logging_payload_excluded_fields == [
            "response",
            "messages",
        ]
    ...
    def test_config_setattr_simulates_proxy_loading(self):
        ...
        # Simulating how proxy_server.py sets derouter_settings
        config_value = ["response", "messages", "metadata"]
        setattr(derouter, "standard_logging_payload_excluded_fields", config_value)

        assert derouter.standard_logging_payload_excluded_fields == config_value
