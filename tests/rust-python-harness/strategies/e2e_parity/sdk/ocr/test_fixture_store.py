...
from .....shared.parity.fixtures.cassette import deserialize_cassette
from .....shared.parity.fixtures.pytest_support import parametrize_recorded_fixtures
from .....shared.parity.fixtures.store import FixtureEnvelope, read_fixture, recorded_fixtures
...
def test_recorded_fixture_parametrization_applies_case_specific_marks() -> None:
    ...
    reducto_parameters: Final = tuple(
        ...
        if parameter.values[0].derouter_input.contract in {"reducto_v3", "reducto_legacy"}
    )
