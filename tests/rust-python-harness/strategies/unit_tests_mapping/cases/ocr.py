...
_CORE_TARGET: Final = RustTarget(package="derouter-core", name="derouter_core", kind="lib")
_GATEWAY_TARGET: Final = RustTarget(
    package="derouter-ai-gateway",
    name="derouter_ai_gateway",
    kind="lib",
)
...
_AZURE_TRANSFORM_FILE: Final = "tests/test_derouter/llms/azure_ai/test_azure_document_intelligence_ocr_transformation.py"
_AZURE_PAGES_FILE: Final = "tests/ocr_tests/test_ocr_azure_document_intelligence.py"
_AZURE_BASE_FILE: Final = "tests/test_derouter/ocr/test_ocr_azure_document_intelligence_api_base.py"
_RUST_BRIDGE_FILE: Final = "tests/test_derouter/ocr/test_rust_bridge.py"
...
_AZURE_PORT_MAPPINGS: Final = _test_mappings(
    ...
    (
        ...
        (
            "tests/test_derouter/llms/azure_ai/test_azure_ai_entra_auth.py::test_ocr_authenticates_with_entra_token",
...
_REDUCTO_PORT_MAPPINGS: Final = _test_mappings(
    ...
    (
        (
            "tests/test_derouter/llms/reducto/test_parse_v3.py::test_parse_v3_reducto_id_passthrough_skips_upload",
            "test_parse_v3_reducto_id_passthrough_skips_upload",
        ),
        (
            "tests/test_derouter/llms/reducto/test_parse_legacy.py::test_parse_legacy_wraps_enhance_under_options",
            "test_parse_legacy_wraps_enhance_under_options",
        ),
        (
            "tests/test_derouter/llms/reducto/test_upload.py::test_parse_v3_image_data_uri_upload_uses_image_mime",
            "test_parse_v3_image_data_uri_upload_uses_image_mime",
        ),
        (
            "tests/test_derouter/llms/reducto/test_upload.py::test_parse_v3_uses_programmatic_api_key_over_env",
...
_REDUCTO_GATEWAY_MAPPING: Final = TestMapping(
    python="tests/test_derouter/llms/reducto/test_parse_v3.py::test_parse_v3_file_upload_and_response_mapping",
...
_GATEWAY_PORT_MAPPINGS: Final = _test_mappings(
    ...
    (
        (
            "tests/test_derouter/ocr/test_ocr_native_format.py::test_native_format_rejected_for_provider_without_support_as_bad_request",
            "native_format_rejected_for_provider_without_support_as_bad_request",
        ),
        (
            "tests/test_derouter/ocr/test_ocr_native_format.py::test_unknown_format_rejected_for_provider_without_support_as_bad_request",
...
_FAMILY_PORT_MAPPINGS: Final = (
    ...
    TestMapping(
        python="tests/test_derouter/llms/reducto/test_upload.py::test_parse_v3_rejects_plain_http_urls",
...
OCR_CONTRACT: Final = UnitTestContract(
    mapping=MappingSpec(
        python_functions=PythonFunctionDiscoverySpec(
            ...
            includes=(
                "tests/test_derouter/llms/azure_ai/test_azure_document_intelligence_ocr_transformation.py",
                "tests/test_derouter/llms/mistral/ocr",
                "tests/test_derouter/llms/ocr",
                "tests/test_derouter/ocr",
                "tests/test_derouter/proxy/ocr_endpoints",
            ),
            exclusions=(
        ...
        mappings=(
            TestMapping(
                python="tests/test_derouter/llms/azure_ai/test_azure_document_intelligence_ocr_transformation.py::test_transform_ocr_response_preserves_azure_native_fields",
                rust=_rust_test(_CORE_TARGET, _AZURE_OCR_TESTS, "document_intelligence_response_normalizes_pages"),
            ),
            TestMapping(
                python="tests/test_derouter/llms/azure_ai/test_azure_document_intelligence_ocr_transformation.py::test_map_ocr_params_features",
                rust=_rust_family(_CORE_TARGET, _AZURE_OCR_TESTS, "document_intelligence_maps_features"),
            ),
            TestMapping(
                python="tests/test_derouter/llms/azure_ai/test_azure_document_intelligence_ocr_transformation.py::test_map_ocr_params_empty_features_list_omitted",
                rust=_rust_test(_CORE_TARGET, _AZURE_OCR_TESTS, "document_intelligence_url_omits_empty_feature_list"),
            ),
            TestMapping(
                python="tests/test_derouter/llms/azure_ai/test_azure_document_intelligence_ocr_transformation.py::test_map_ocr_params_invalid_features_raises",
                rust=_rust_family(
                    _CORE_TARGET,
                    _AZURE_OCR_TESTS,
            ...
            TestMapping(
                python="tests/test_derouter/llms/azure_ai/test_azure_document_intelligence_ocr_transformation.py::test_get_complete_url_appends_features_query",
                rust=_rust_test(_CORE_TARGET, _AZURE_OCR_TESTS, "document_intelligence_url_normalizes_features"),
            ),
            TestMapping(
                python="tests/test_derouter/llms/azure_ai/test_azure_document_intelligence_ocr_transformation.py::test_get_complete_url_combines_pages_and_features",
                rust=_rust_test(
                    _CORE_TARGET, _AZURE_OCR_TESTS, "document_intelligence_url_combines_pages_and_feature_list"
                ),
            ),
            TestMapping(
                python="tests/test_derouter/llms/mistral/ocr/test_mistral_ocr_transformation.py::TestGetSupportedOcrParams::test_extract_header_in_supported_params",
                rust=_rust_test(_CORE_TARGET, _MISTRAL_OCR_TESTS, "extract_header_is_a_supported_ocr_param"),
            ),
            TestMapping(
                python="tests/test_derouter/llms/mistral/ocr/test_mistral_ocr_transformation.py::TestGetSupportedOcrParams::test_extract_footer_in_supported_params",
                rust=_rust_test(_CORE_TARGET, _MISTRAL_OCR_TESTS, "extract_footer_is_a_supported_ocr_param"),
            ),
            TestMapping(
                python="tests/test_derouter/llms/mistral/ocr/test_mistral_ocr_transformation.py::TestGetSupportedOcrParams::test_existing_params_still_present",
                rust=_rust_test(_CORE_TARGET, _MISTRAL_OCR_TESTS, "existing_ocr_params_remain_supported"),
            ),
            TestMapping(
                python="tests/test_derouter/llms/mistral/ocr/test_mistral_ocr_transformation.py::TestMapOcrParams::test_extract_header_passed_through",
                rust=_rust_test(_CORE_TARGET, _MISTRAL_OCR_TESTS, "map_ocr_params_forwards_extract_header"),
            ),
            TestMapping(
                python="tests/test_derouter/llms/mistral/ocr/test_mistral_ocr_transformation.py::TestMapOcrParams::test_extract_footer_passed_through",
                rust=_rust_test(_CORE_TARGET, _MISTRAL_OCR_TESTS, "map_ocr_params_forwards_extract_footer"),
            ),
            TestMapping(
                python="tests/test_derouter/llms/mistral/ocr/test_mistral_ocr_transformation.py::TestMapOcrParams::test_extract_header_and_footer_together",
                rust=_rust_test(_CORE_TARGET, _MISTRAL_OCR_TESTS, "map_ocr_params_forwards_extract_header_and_footer"),
            ),
            TestMapping(
                python="tests/test_derouter/llms/mistral/ocr/test_mistral_ocr_transformation.py::TestMapOcrParams::test_unknown_param_is_dropped",
                rust=_rust_test(_CORE_TARGET, _MISTRAL_OCR_TESTS, "map_ocr_params_drops_unknown_params"),
            ),
            TestMapping(
                python="tests/test_derouter/llms/mistral/ocr/test_mistral_ocr_transformation.py::TestNewSupportedParams::test_new_param_in_supported_list",
                rust=_rust_test(_CORE_TARGET, _MISTRAL_OCR_TESTS, "new_ocr_params_are_supported"),
            ),
            TestMapping(
                python="tests/test_derouter/llms/mistral/ocr/test_mistral_ocr_transformation.py::TestNewParamsMapOcr::test_new_param_passed_through",
                rust=_rust_test(_CORE_TARGET, _MISTRAL_OCR_TESTS, "map_ocr_params_forwards_new_ocr_params"),
            ),
            TestMapping(
                python="tests/test_derouter/llms/mistral/ocr/test_mistral_ocr_transformation.py::TestTransformOcrRequest::test_param_included_in_request_body",
                rust=_rust_test(_CORE_TARGET, _MISTRAL_OCR_TESTS, "transform_ocr_request_includes_each_optional_param"),
            ),
            TestMapping(
                python="tests/test_derouter/llms/mistral/ocr/test_mistral_ocr_transformation.py::TestTransformOcrRequest::test_multiple_new_params_together",
                rust=_rust_test(_CORE_TARGET, _MISTRAL_OCR_TESTS, "transform_ocr_request_includes_multiple_new_params"),
            ),
            TestMapping(
                python="tests/test_derouter/llms/mistral/ocr/test_mistral_ocr_transformation.py::TestTransformOcrResponseOcr4Fields::test_blocks_and_confidence_scores_preserved",
                rust=_rust_test(
                    _CORE_TARGET, _MISTRAL_OCR_TESTS, "transform_ocr_response_preserves_blocks_and_confidence_scores"
                ),
            ),
            TestMapping(
                python="tests/test_derouter/llms/mistral/ocr/test_mistral_ocr_transformation.py::TestTransformOcrResponseOcr4Fields::test_ocr4_fields_survive_model_dump",
    ...
    unit_parity=UnitParitySpec(
        ...
        exclusions=(
            UnitParityExclusionSpec(
                nodeid="tests/test_derouter/ocr/test_rust_bridge.py::test_rust_toggles_flag",
                reason="This test asserts the process-level backend flag selected by the parity runner.",
            ),
        ),
    ),
    rust=RustUnitSpec(
        cargo_manifest="derouter-rust/Cargo.toml",
        cargo_filter="ocr",
    ),
)
