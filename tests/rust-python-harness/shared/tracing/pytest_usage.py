...
def collect_python_function_tests(
    ...
    *,
    ...
    with tempfile.TemporaryDirectory(prefix="derouter-function-tests-") as directory:
        ...
        config: Final = _WorkerConfig(
            ...
            source_root=source_root or repo_root / "derouter",
            output=output_path,
            pytest_args=tuple(
                (
                    "-o",
        ...
        import_roots: Final = tuple(
            dict.fromkeys(
                (
                    str(repo_root),
                    str(source_root or repo_root / "derouter"),
                    *(
