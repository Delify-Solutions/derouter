...
# import pytest
# import derouter
# from derouter import embedding, completion
# import asyncio
...
#     response = await derouter.aembedding(model="ollama/mistral", input=input)
#     print(response)
...
#     derouter.set_verbose = True
#     input = "The food was delicious and the waiter..."
#     response = derouter.embedding(model="ollama/mistral", input=input)
#     print(response)
...
#             }
#         ]
#         response = derouter.completion(model="ollama/mistral",
#                                              messages=messages,
#                                              functions=functions,
#                                              stream=True)
...
#     try:
#         derouter.set_verbose = False
#         response = await derouter.acompletion(model="ollama/mistral-openorca",
...
#     params = {
#         "messages": prepare_messages_for_chat("What is derouter? tell me 10 things about it who is sihaan.write an essay"),
#         "api_base": "http://localhost:11434",
#         "model": "ollama/llama2",
#         "stream": True,
#     }
#     response = await derouter.acompletion(**params)
#     return response
...
#     response = await derouter.acompletion(
#         model="ollama/llama2",
#         messages=prepare_messages_for_chat("What is derouter? respond in 2 words"),
#     )
