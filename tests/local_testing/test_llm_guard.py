...
import derouter
from derouter_enterprise.enterprise_callbacks.llm_guard import _ENTERPRISE_LLMGuard
...
def test_llm_guard_key_specific_mode():
    ...
    """
    derouter.llm_guard_mode = "key-specific"
...
def test_llm_guard_request_specific_mode():
    ...
    """
    derouter.llm_guard_mode = "request-specific"
