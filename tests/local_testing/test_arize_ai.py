...
from derouter import Choices
import pytest
from dotenv import load_dotenv

import derouter
from derouter._logging import verbose_logger, verbose_proxy_logger
from derouter.integrations.arize.arize import ArizeConfig, ArizeLogger
...
async def test_async_otel_callback():
    ...
    derouter.success_callback = ["arize"]
