...
import derouter
from derouter.proxy._types import SpendCalculateRequest
from derouter.proxy.spend_tracking.spend_management_endpoints import calculate_spend
...
async def test_spend_calc_model_on_router_messages():
    from derouter.proxy.proxy_server import llm_router as init_llm_router
    ...
    setattr(derouter.proxy.proxy_server, "llm_router", temp_llm_router)
    ...
    setattr(derouter.proxy.proxy_server, "llm_router", init_llm_router)
