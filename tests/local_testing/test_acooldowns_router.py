...
def test_multiple_deployments_parallel():
    derouter.set_verbose = False  # Corrected the syntax for setting verbose to False
    results = []
    futures = {}
    kwargs = _make_kwargs()
...
# Assuming derouter, router, and executor are defined somewhere in your code
...
async def test_cooldown_same_model_name(sync_mode):
    ...
    try:
        ...
        if sync_mode:
            ...
            print("\n derouter model ids ", model_ids)

            # example derouter_model_names ['azure/gpt-4.1-mini-ModelID-64321', 'azure/gpt-4.1-mini-ModelID-63960']
            assert (
