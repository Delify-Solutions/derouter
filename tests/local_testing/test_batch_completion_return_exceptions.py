"""https://github.com/Delify-Solutions/derouter/pull/3397/commits/a7ec1772b1457594d3af48cdcb0a382279b841c7#diff-44852387ceb00aade916d6b314dfd5d180499e54f35209ae9c07179febe08b4b."""
...
def test_batch_completion_return_exceptions_true():
    ...
    assert isinstance(
        res[0],
        (
            derouter.exceptions.AuthenticationError,
            derouter.exceptions.InternalServerError,
        ),
