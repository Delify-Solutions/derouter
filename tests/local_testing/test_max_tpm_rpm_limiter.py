...
# from derouter.proxy.utils import ProxyLogging, hash_token
# from derouter.proxy._types import UserAPIKeyAuth
# from derouter.caching.caching import DualCache, RedisCache
# from derouter.proxy.hooks.tpm_rpm_limiter import _PROXY_MaxTPMRPMLimiter
# from datetime import datetime
...
#     kwargs = {"derouter_params": {"metadata": {"user_api_key": _api_key}}}
...
#     cache_params = {"type": "redis", "namespace": "derouter_default"}

#     ## INIT CACHE ##
#     proxy_config = ProxyConfig()
#     setattr(derouter.proxy.proxy_server, "proxy_config", proxy_config)

#     proxy_config._init_cache(cache_params=cache_params)

#     redis_cache: Optional[RedisCache] = getattr(
#         derouter.proxy.proxy_server, "redis_usage_cache"
#     )

#     ## CHECK IF NAMESPACE SET ##
#     assert redis_cache.namespace == "derouter_default"
...
#     cache_key = "derouter_default:usage:{}".format(precise_minute)
