...
import derouter
from derouter import APIConnectionError, Router
...
@patch("derouter.secret_managers.get_azure_ad_token_provider.os")
...
async def test_audio_speech_router():
    """
    Test that router uses OpenAI/Azure OpenAI Client initialized during init for derouter.aspeech
    """
    ...
    with patch("derouter.aspeech") as mock_aspeech:
        ...
        print(
            "derouter.aspeech was called with kwargs = ", mock_aspeech.call_args.kwargs
        )
