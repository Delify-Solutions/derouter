...
from derouter.integrations.gcs_bucket.gcs_bucket import (
    GCSBucketLogger,
    StandardLoggingPayload,
)
from derouter.types.utils import StandardCallbackDynamicParams
from derouter.types.integrations.gcs_bucket import GCSLoggingConfig
    ...
    with (
        ...
        try:
            response = await derouter.acompletion(
                ...
                max_tokens=10,
                user="ishaan-2",
                mock_response=derouter.BadRequestError(
                    model="gpt-3.5-turbo",
