...
from derouter.proxy.enterprise.enterprise_hooks.blocked_user_list import (
...
from derouter.proxy.utils import PrismaClient, ProxyLogging, hash_token
...
async def test_block_user_check(prisma_client):
    """
    - Set a blocked user as a derouter module value
    ...
    derouter.blocked_user_list = ["user_id_1"]
