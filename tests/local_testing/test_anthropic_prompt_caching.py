...
@pytest.mark.asyncio
async def test_derouter_anthropic_prompt_caching_tools():
    ...
    with patch(
        ...
        # Act: Call the derouter.acompletion function
...
async def test_anthropic_api_prompt_caching_with_content_str():
    ...
    translated_system_message = derouter.AnthropicConfig().translate_system_message(
...
@pytest.mark.asyncio
async def test_derouter_anthropic_prompt_caching_system():
...
def test_is_prompt_caching_enabled(anthropic_messages):
    assert derouter.utils.is_prompt_caching_valid_prompt(
        messages=anthropic_messages,
        tools=None,
