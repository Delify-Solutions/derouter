...
# this tests debug logs from derouter router and derouter proxy server
from derouter._logging import verbose_logger, verbose_proxy_logger, verbose_router_logger
from derouter.llms.custom_httpx.async_client_cleanup import close_derouter_async_clients


# this tests debug logs from derouter router and derouter proxy server
def test_async_fallbacks(caplog):
    # THIS IS A PROD TEST - DO NOT DELETE THIS. Used for testing if derouter proxy verbose logs are human readable
    ...
    expected_logs = [
        ...
        "derouter.acompletion(model=azure/gpt-4.1-mini)\x1b[32m 200 OK\x1b[0m",
