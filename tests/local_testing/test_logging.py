...
#             raise Exception("Required log message not found!")
#         elif "Logging Details DeRouter-Success Call" not in output:
#             raise Exception("Required log message not found!")
#         score += 1
...
#         response = embedding(model="text-embedding-ada-002", input=["good morning from derouter"])
...
# #     elif "Logging Details Post-API Call" not in output:
# #         raise Exception("Required log message not found!")
# #     elif "Logging Details DeRouter-Failure Call" not in output:
# #         raise Exception("Required log message not found!")
