...
They are skipped by default — run manually with:
    ...
    pytest tests/test_derouter/llms/sagemaker/test_sagemaker_nova_integration.py -v --no-header -rN
...
class TestSagemakerNova2LiteIntegration:
    ...
    Run with:
        ...
        pytest tests/test_derouter/llms/sagemaker/test_sagemaker_nova_integration.py::TestSagemakerNova2LiteIntegration -v
    """
