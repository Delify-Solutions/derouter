...
def test_router_timeouts():
    ...
    for question in questions_list:
        ...
        prompt_tokens = derouter.token_counter(text=question["content"], model="gpt-4")
...
def test_router_timeout_with_retries_anthropic_model(num_retries, expected_call_count):
    ...
    derouter.num_retries = num_retries
    derouter.request_timeout = 0.000001
...
def test_router_stream_timeout(model):
    ...
    from dotenv import load_dotenv
    import derouter
    from derouter.router import Router, RetryPolicy, AllowedFailsPolicy
