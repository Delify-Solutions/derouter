...
def test_weighted_selection_router():
    ...
    # users can pass rpms as a derouter_param
    try:
        ...
        for _ in range(1000):
            ...
            selected_model_id = selected_model["derouter_params"]["model"]
...
def test_usage_based_routing():
    ...
    Then at some point, we exceed the TPM limit (set in the derouter_params)
        ...
        model_list = [
            {
                ...
                "derouter_params": get_azure_params("chatgpt-low-tpm"),
                "tpm": 100,
            },
            {
                "model_name": "azure/gpt-4",
                "derouter_params": get_azure_params("chatgpt-high-tpm"),
                "tpm": 1000,
            },
        ]
...
def test_get_available_deployment_for_pass_through():
    ...
    try:
        ...
        assert selected_model["derouter_params"]["model"] == "gpt-3.5-turbo"
        assert selected_model["derouter_params"]["use_in_pass_through"] is True
