...
def test_is_prompt_management_model_optimization():
    ...
    original_callbacks = derouter._known_custom_logger_compatible_callbacks.copy()
    if "langfuse_prompt" not in derouter._known_custom_logger_compatible_callbacks:
        derouter._known_custom_logger_compatible_callbacks.append("langfuse_prompt")
    ...
    try:
            ...
            model_list=[
                {
                    ...
                    "derouter_params": {"model": "langfuse_prompt/actual_prompt_id"},
                },
            ]
        )
        ...
        derouter._known_custom_logger_compatible_callbacks = original_callbacks
