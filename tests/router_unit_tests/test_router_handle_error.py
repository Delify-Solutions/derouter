...
async def test_async_raise_no_deployment_exception():
    ...
    """
    from derouter.router_utils.handle_error import async_raise_no_deployment_exception
    ...
    with patch(
        "derouter.router_utils.handle_error._async_get_cooldown_deployments_with_debug_info",
