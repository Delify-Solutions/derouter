...
def test_extract_partial_responses_usage_bridge_iterator_no_completed_response():
    ...
    (DeRouterCompletionStreamingIterator) overrides __init__ without calling
    ...
    iterator = DeRouterCompletionStreamingIterator(
        ...
        derouter_custom_stream_wrapper=wrapper,
        request_input="hi",
...
async def test_aresponses_fallback_on_in_stream_error_event():
    ...
    from derouter.types.llms.openai import ErrorEvent, ErrorEventError
    ...
    assert isinstance(raised.original_exception, derouter.APIError)
