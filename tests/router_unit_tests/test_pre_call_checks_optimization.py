...
class TestPreCallChecksOptimization:
    ...
    def test_no_mutation_of_input_list(self):
            ...
            model_list=[
                {
                    ...
                    "derouter_params": {"model": "gpt-5-mini", "api_key": "sk-test"},
                    "model_info": {"id": "test-1"},
                },
                {
                    "model_name": "gpt-5-mini",
                    "derouter_params": {"model": "gpt-5.5", "api_key": "sk-test2"},
        ...
        original_derouter_params_ids = [id(d["derouter_params"]) for d in deployments]
        ...
        assert [
            id(d["derouter_params"]) for d in deployments
        ] == original_derouter_params_ids, "Nested dicts replaced!"
    ...
    def test_filtering_still_works(self):
        ...
        router = Router(
            model_list=[
                ...
                {
                    "model_name": "test",
                    "derouter_params": {"model": "gpt-5.5", "api_key": "sk-test"},
