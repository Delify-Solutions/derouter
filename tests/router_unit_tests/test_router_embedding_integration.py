...
class TestRouterEmbeddingIntegration:
    ...
    def test_vector_store_request_metadata_prefers_derouter_metadata(self):
    ...
    def test_embedding_metadata_propagation(self):
        ...
        router = Router(
            model_list=model_list,
            default_derouter_params={"metadata": {"environment": "test", "service": "embedding-service"}},
        )
    ...
    async def test_async_embedding_with_multiple_retries(self):
        ...
        with patch("derouter.aembedding", new_callable=AsyncMock) as mock_aembedding:
    ...
    def test_embedding_with_multiple_deployments_load_balancing(self):
        ...
        router = Router(
            model_list=model_list,
            default_derouter_params={"headers": {"X-Shared-Header": "shared-value"}},
        )
    ...
    async def test_embedding_with_fallback_configuration(self):
        ...
        router = Router(
            ...
            default_derouter_params={"headers": {"X-Fallback-Test": "test-value"}},
        )
    ...
    def test_embedding_with_custom_provider_headers(self):
        ...
        router = Router(
            model_list=model_list,
            default_derouter_params={"headers": {"X-Custom-Azure-Header": "azure-value"}},
        )
