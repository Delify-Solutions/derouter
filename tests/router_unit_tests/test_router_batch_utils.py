...
def test_router_metadata_variable_name():
    ...
    assert (
        _get_router_metadata_variable_name(function_name="batch") == "derouter_metadata"
    )
    assert (
...
def test_non_json_input():
    ...
    from derouter.router_utils.batch_utils import replace_model_in_jsonl
...
def test_should_replace_model_in_jsonl():
    ...
    from derouter.router_utils.batch_utils import should_replace_model_in_jsonl
