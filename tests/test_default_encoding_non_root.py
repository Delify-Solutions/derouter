...
import derouter.derouter_core_utils.default_encoding as default_encoding
...
def test_default_encoding_uses_bundled_tokenizers_by_default(monkeypatch):
    ...
    """
    _reload_default_encoding(monkeypatch, DEROUTER_NON_ROOT="true")
...
def test_custom_tiktoken_cache_dir_override(monkeypatch, tmp_path):
    ...
    with patch(
        "derouter.derouter_core_utils.default_encoding.tiktoken.get_encoding",
