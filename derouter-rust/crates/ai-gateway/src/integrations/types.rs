//! Typed payloads for the DeRouter `/v1/callbacks/logs` realtime-logging contract.
//!
...
//!
//! Mirrors Python `derouter/integrations/` + the proxy `CallbackLogsRequest`
//! contract 1:1.
...
pub struct StandardLoggingPayload {
    ...
    /// Spend ($) written to DeRouter_SpendLogs.spend.
...
/// Cost-attribution keys. The replayer maps these into derouter_params.metadata,
