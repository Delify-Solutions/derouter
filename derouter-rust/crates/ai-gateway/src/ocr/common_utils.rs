...
use derouter_core::error::Error;
use derouter_core::ocr::transformation::OcrProviderConfig;
use reqwest::Url;
use serde_json::{Map, Value};

use derouter_core::providers::azure_ai::ocr::transformation::{
    AZURE_AI_OCR_CONFIG, AZURE_DOCUMENT_INTELLIGENCE_OCR_CONFIG,
};
use derouter_core::providers::mistral::ocr::transformation::MISTRAL_OCR_CONFIG;
use derouter_core::providers::reducto::ocr::transformation as reducto;
use derouter_core::providers::vertex_ai::ocr::transformation as vertex_ai;
use derouter_core::providers::vertex_ai::ocr::transformation::{
...
#[tracing::instrument(target = "derouter::function_trace", level = "trace", skip_all)]
            ...
            value
                ...
                .ok_or_else(|| {
                    Error::InvalidRequest(format!(
                        ...
                        derouter_core::error::json_type_name(&value)
                    ))
                })
        })
        .collect()
...
#[cfg(test)]
mod tests {
    use derouter_core::ocr::transformation::OcrResponseHandling;
    use serde_json::json;
