...
use derouter_core::call_lifecycle::{CallLifecycleContext, CallLifecycleRequest};
...
pub struct OcrRequest<'a> {
    ...
    pub derouter_call_id: Option<&'a str>,
}

pub(crate) struct PreparedOcrRequest {
    pub(crate) config: Result<&'static dyn OcrProviderConfig, derouter_core::Error>,
    pub(crate) model: String,
    pub(crate) custom_llm_provider: String,
    pub(crate) derouter_call_id: String,
