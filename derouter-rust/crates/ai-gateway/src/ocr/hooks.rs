use derouter_core::call_lifecycle::{CallLifecycleContext, CallLifecycleHooks, CallLifecycleTiming};
use derouter_core::error::Error;
use derouter_core::providers::reducto::ocr::transformation::{
...
impl OcrLifecycleHooks {
    ...
    fn standard_logging_payload(
        ...
        StandardLoggingPayload {
            id: context.derouter_call_id.clone(),
            derouter_call_id: context.derouter_call_id.clone(),
