...
use derouter_ai_gateway::io::responses_ws::ResponsesWebSocketConnection as RustResponsesWebSocketConnection;
use pyo3::prelude::*;
...
impl ResponsesWebSocketConnection {
    ...
    fn connect<'py>(
        ...
        py: Python<'py>,
        url: String,
        #[pyo3(from_py_with = derouter_python_interop::from_py)] headers: Option<Value>,
