...
use derouter_core::chat_completions::types::{ChatCompletionsRequest, ChatCompletionsResponse};
use derouter_core::chat_completions::{
...
fn chat_completions_decline(
    model: String,
    #[pyo3(from_py_with = derouter_python_interop::from_py)] messages: Value,
    #[pyo3(from_py_with = derouter_python_interop::from_py)] optional_params: Option<Value>,
...
bridge_route! {
    ...
    required = {
        model: String,
        #[pyo3(from_py_with = derouter_python_interop::from_py)]
