...
The generated client is a pure function of ``derouter/proxy/schema.prisma`` and
...
SCHEMA = REPO_ROOT / "derouter" / "proxy" / "schema.prisma"
STAMP = Path(sys.prefix) / "derouter-prisma-schema.stamp"
