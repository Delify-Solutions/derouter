...
export const CLOSED_MARKER = "<!-- derouter:closed-as-duplicate -->";
...
const NOTICE_MARKER = /<!-- derouter:potential-duplicate candidates=([\d,]*) -->/;
    ...
    request: async <T>(method: "GET" | "POST" | "PATCH" | "DELETE", path: string, body?: object): Promise<T> => {
      const response = await fetch(`https://api.github.com${path}`, {
        ...
        headers: {
          ...
          "User-Agent": "derouter-auto-close-duplicates",
