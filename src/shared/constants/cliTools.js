...
# cs45 -> cc/claude-sonnet-4-5-20250929`,
  ...
  jcode: {
    ...
    notes: [
      ...
      {
        type: "info",
        text: "Configure derouter as an OpenAI-compatible provider to route all jcode requests through derouter's optimization layer."
      },
      {
        type: "warning",
  ...
  "grok-build": {
    ...
    notes: [
      {
        type: "info",
        text: "Grok Build uses ~/.grok/config.toml. derouter writes a [model.derouter] custom model and sets it as the default.",
      },
      {
        type: "info",
        text: "After Apply, run grok (or /model derouter) to use the routed model. Switch back anytime with /model grok-build.",
      },
      {
        type: "warning",
