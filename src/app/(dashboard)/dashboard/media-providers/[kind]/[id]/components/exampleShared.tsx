...
// ===== Types for KIND_EXAMPLE_CONFIG =====

type ExtraFieldType = "select" | "text" | "number";
...
interface KindExampleConfigEntry {
  inputLabel: string;
...
export type KindExampleConfig = Record<string, KindExampleConfigEntry>;
...
export const KIND_EXAMPLE_CONFIG: KindExampleConfig = {
  webSearch: {
    inputLabel: "Query",
