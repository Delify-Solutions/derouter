...
import type { KeyGroup, GroupListResponse, UsageKeySummary, UsageKeySummaryResponse } from "@/shared/types";
...
export default function KeyUsageTable() {
  const [items, setItems] = useState<UsageKeySummary[]>([]);
  ...
  const loadSummary = useCallback(async () => {
    ...
    try {
      ...
      const data = await apiGet<UsageKeySummaryResponse>(`/api/usage/key-summary?${params}`);
      setItems(data.items || []);
    } catch (e) {
