...
// Build TOML config for derouter (openai provider mode)
const buildderouterConfig = (baseUrl, apiKey, model) => {
...
// Detect derouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildderouterConfig(baseUrl, apiKey || "sk_derouter", model);
